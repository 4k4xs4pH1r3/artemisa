	...
	<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" bordercolor=\"#E9E9E9\" width=\"750\">";
        ...
        if (!$_GET['completado']) {
            ...
            $mensaje = "Por favor verifique que su E-mail este escrito correctamente" .
                    ...
                    " Recuerde que esta direccion tambien se utilizara para mantenerlo " .
                    " informado durante todo su proceso de inscripcion";
...
//            }
            ...
            if ($sigue) {
                ...
                $mensaje = "Felicitaciones ya completo el paso 1. Genere su clave" .
                        "\\n revise su correo " . $_POST['correo'] .
                        " para continuar con el proceso de inscripción y activar su cuenta";
