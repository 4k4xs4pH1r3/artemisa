...
// Find initial left position of slider   
    	var leftPos;   
    	leftPos = this.sliderValueReversed ? Math.round(((this.sliderMaxValue-this.initialValue)/ this.sliderMaxValue)* this.sliderSize)-1 : Math.round((this.initialValue / this.sliderMaxValue)* this.sliderSize);   
...
// Find initial left position of slider   
    	var topPos;   
    	topPos = !this.sliderValueReversed ? Math.floor(((this.sliderMaxValue-this.initialValue)/ this.sliderMaxValue)* this.sliderSize) : Math.floor((this.initialValue / this.sliderMaxValue)* this.sliderSize);   
...
// Don't allow values larger the slider size	   
   	...
   	if(sliderObj.sliderDirection=='hor'){   
 		...
 		returnValue = !sliderObj.sliderValueReversed ? Math.round((handlePos/sliderObj.sliderSize)* (sliderObj.sliderMaxValue-sliderObj.sliderMinValue)) : Math.round(((sliderObj.sliderSize-handlePos)/sliderObj.sliderSize)* (sliderObj.sliderMaxValue-sliderObj.sliderMinValue));			   
 	}else{   
