...
// {{{ isDateWithinValidRange()   
    ...
    *@public	   
	...
	var month=String(inputDate.month);   
	if(month.length==1)month='0'+month;   
	var day=String(inputDate.day);   
...
// {{{ __getDisplayedHourWithLeadingZeros()   
    ...
    *@private	   
	...
	{   
	var retVal=String(this.__getDisplayedHour());   
...
// {{{ __getDisplayedMinuteWithLeadingZeros()   
    ...
    *@private	   
	...
	{   
	var retVal=String(this.__getDisplayedMinute());   
	if(retVal.length==1)retVal='0'+retVal;   
	return retVal;   
	}   
...
// {{{ __getDisplayedDayWithLeadingZeros()   
    ...
    *@private	   
	...
	{   
	var retVal=String(this.__getDisplayedDay());   
	if(retVal.length==1)retVal='0'+retVal;   
	return retVal;   
	}   
...
// {{{ __getDisplayedMonthNumberWithLeadingZeros()   
    ...
    *@private	   
	...
	{   
	var retVal=String(this.__getDisplayedMonthNumber());   
	if(retVal.length==1)retVal='0'+retVal;   
	return retVal;   
	}   
...
// Disable text selection in the heading   
	...
	DHTMLSuite.commonObj.addEvent(document.documentElement,'click',function(e){ DHTMLSuite.variableStorage.arrayDSObjects[ind].__autoHideDropDownBoxes(e); },String(ind));   
