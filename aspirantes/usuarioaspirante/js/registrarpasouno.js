...
$(document).ready(function () {
    ...
    jQuery.validator.addMethod("confirmaremailvalido", function (value, element) {
        return this.optional(element) || /^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$/i.test(value);
    }, "Confirmar E-Mail Valido");
    jQuery.validator.addMethod("mayorfechanacimiento", function (value) {
        var result = true;
        if (value > datestring) {
            result = false;
        }
    ...
    jQuery.validator.addMethod("menorfechanacimiento", function (value) {
        var result = true;
    ...
    $("#Enviar").click(function () {
        ...
        $("#inscripcion").validate({
            rules: {
                ...
                fechanacimiento: {required: true, mayorfechanacimiento: true, menorfechanacimiento: true},
                ...
                confirmacorreo: {required: true, email: true, confirmaremailvalido: true, maxlength: 50, equalTo: "#correo"},
                clave: {required: true, minlength: 6, maxlength: 100},
                confirmarclave: {required: true, minlength: 6, maxlength: 100, equalTo: "#clave"},
                politica: {check: true}
            },
            messages: {
                nombre: {required: "Debe ingresar Nombres", maxlength: "Maximo 50 caracteres"},
                apellido: {required: "Debe ingresar Apellidos", maxlength: "Maximo 50 caracteres"},
                idpaisnacimiento: {required: "Debe seleccionar el Pais de nacimiento"},
                fechanacimiento: {
                ...
                telefonoresidencia: {minlength: "Minimo 7 digitos", maxlength: "Maximo 15 digitos"},
                ...
                confirmarclave: {
                    ...
                    maxlength: "Maximo 100 caracteres", equalTo: "Debe coincidir con Clave"},
                politica: {check: "?"}
            }
        ...
        if ($('#inscripcion').valid()) {
            ...
            var codigogenero = $('#codigogenero').val();
            var telefonoresidencia = $('#telefonoresidencia').val();
            ...
            $.ajax({
                ...
                nombre: nombre, apellido: apellido, fechanacimiento: fechanacimiento,
                    tipodocumento: tipodocumento, documento: documento, correo: correo, action: "Validar"
                },
                beforeSend: function () {
                },
                success: function (data) {
                    ...
                    if (data !== '') {
                        bootbox.dialog({
                            ...
                            buttons: {
                                danger: {
                                    ...
                                    callback: function () {
                                        location.href = url + "/aspirantes/usuarioaspirante/recuperarclave.php";
                                    }
                                }
                            }
                        });
                        ...
                        confirmar(nombre, apellido, idpaisnacimiento, fechanacimiento, tipodocumento,
                            documento, codigogenero, telefonoresidencia, celular, correo, clave, politica, "Nuevo");
                    }
                },
...
function confirmar(nombre,apellido,idpaisnacimiento,fechanacimiento,tipodocumento,documento,
                   codigogenero,telefonoresidencia,celular,correo,clave,politica,action) {
    var pais = idpaisnacimiento.split("|**|");
    var tipdoc = tipodocumento.split("|*||*|");
    var genero = codigogenero.split("*|**|*");
    var datos="";
        ...
        datos+="<strong>Teléfono de residencia:</strong> "+telefonoresidencia+"<br>";
        ...
        bootbox.dialog({
            ...
            buttons: {
                success: {
                    ...
                    callback: function () {
                        guardarInfo(nombre,apellido,pais[0],fechanacimiento,tipdoc[0],documento,genero[0],telefonoresidencia,celular,correo,clave,politica,action);
                    }
                },
                danger: {
                    label: 'No',
...
function guardarInfo(nombre,apellido,idpaisnacimiento,fechanacimiento,tipodocumento,documento,
                     codigogenero,telefonoresidencia,celular,correo,clave,politica,action){
    $.ajax({
        type: 'POST',
        url: 'funciones/FuncionesUsuarioAspirante.php',
