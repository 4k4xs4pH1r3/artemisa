...
/* We could be here forever testing this one, so we test a limited subset on a couple de colums */
...
$(document).ready( function () {
	...
	oTest.fnTest( 
		"Default should be a have a empty colums array",
		null,
		function () {
			var bReturn = 
	...
	oTest.fnTest( 
		...
		function () { return $('#example_info').html() == "Mostrando 1 a 9 de 9 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest( 
		...
		function () { return $('#example_info').html() == "Mostrando 1 a 3 de 3 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest( 
		...
		function () { return $('#example tbody tr:eq(0) td:eq(0)').html() == "No hay registros coincidentes encontrados"; }
	);
