...
/* It's actually a little tricky a test this. We can't test absolute numbers because
 * different browsers and different platforms will render the width de the columns slightly
 * differently. However, we certainly can test the principle de what should happen (column 
...
$(document).ready( function () {
	...
	oTest.fnTest( 
		"First column has a width assigned a it",
		null,
		function () { return $('#example thead th:eq(0)').attr('style').match(/width/i); }
	);
	
	/*
	This would seem like a better test - but there appear a be difficulties with tables
	...
	*/
	...
	oTest.fnTest( 
		"First column does not have a width assigned a it",
		null,
