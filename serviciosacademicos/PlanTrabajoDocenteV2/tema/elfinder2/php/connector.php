...
$opts = array(
	...
	'roots' => array(
		array(
            ...
            'path'          => '../../../documentos/'.$idDocente.'/'.$idPeriodo.'/'.$idPrograma.'/'.$idVocacion.'/'.$idMateria.'/',
            'startPath'		=> '../../../documentos/'.$idDocente.'/'.$idPeriodo.'/'.$idPrograma.'/'.$idVocacion.'/'.$idMateria.'/',
            'URL'           => dirname($_SERVER['PHP_SELF']) . '../../../../documentos/'.$idDocente.'/'.$idPeriodo.'/'.$idPrograma.'/'.$idVocacion.'/'.$idMateria.'/',
            'alias'         => 'Archivos',
            'disabled' 		=> array('mkdir','mkfile', 'upload', 'rename'),
