...
<html>
    <head>
        ...
        <script data-main="./main.default.js" src="js/js.js"></script>
        <script>
            define('elFinderConfig', {
                ...
                defaultOpts: {
                    url: 'php/connector.minimal.php?idDocente=<?php echo $idDocente; ?>&idPrograma=<?php echo $idPrograma;?>&idPeriodo=<?php echo $idPeriodo;?>' // connector URL (REQUIRED)
                    , commandsOptions: {
                        edit: {
                            extraOptions: {
