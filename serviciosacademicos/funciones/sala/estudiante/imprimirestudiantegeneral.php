...
?>
<input type="hidden" name="fecha1" value="<?php echo $fechanacimientoestudiantegeneral[0]; ?>">
...
?>
         ...
         <tr>
          ...
          <td><font size="2">
          <?php echo $this->emailestudiantegeneral; ?> 		
...
?>
          ...
          <td><?php echo $this->telefono1casoemergenciallamarestudiantegeneral; ?>
          </td>
        </tr>
		 <tr>
		   <td id="tdtitulogris">Tel&eacute;fono2</td>
	       <td><?php echo $this->telefono2casoemergenciallamarestudiantegeneral; ?></td>
		 </tr>
      </table>   
