...
class seguimiento
{
    ...
    function seguimiento($codigocarrera, $codigoperiodo)
    {
    ...
    function totalInteresadosSeguimiento()
    {
        ...
        and p.codigoperiodo = '$this->codigoperiodo'
        and ps.codigotipoestudianteseguimiento <> '999'
        group by 2";
        $rta = $db->Execute($sql);
        $totalRows_rta = $rta->RecordCount();
        $row_rta = $rta->FetchRow();
    ...
    function totalAspirantes()
    {
        ...
        $sql="SELECT count(distinct ee.codigoestudiante) as total, ee.codigoperiodo,  e.codigosituacioncarreraestudiante
