...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario, $raiz = "", $valor = "", $desabilitado = ""){
	//global $raiz;
	echo '
	<INPUT name="'.$nombrecampo.'" size="10" readonly onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')" value='.$valor.' '.$desabilitado.'>
