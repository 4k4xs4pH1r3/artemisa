...
function ADODB_Error_Handler($dbms, $fn, $errno, $errmsg, $p1, $p2, &$thisConnection)
{
	...
	case 'EXECUTE':
		$sql = $p1;
		$inputparams = $p2;
		$s = '<script language="javascript">alert("Esta intentando insertar un campo erroneo en la base de datos, verifique que los campos digitados sean correctos\n\n'.$dbms.' error: ['.$errno.': '.$errmsg.'] in '.$fn.'(\"'.$sql.'\")"); history.go(-1);</script>';
		break;
