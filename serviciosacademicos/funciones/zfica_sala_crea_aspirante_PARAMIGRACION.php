...
function genera_prodiverso_PARAMIGRACION($sala, $numeroordenpago) { // funcion
	...
	$datos=compact($vars);
	require_once($_SESSION['path_live'].'consulta/interfacespeople/ordenesdepago/reportarordenespagosala_PARAMIGRACION.php');
	return $result;
