...
class ADODB_Active_Record {
	...
	global $_ADODB_ACTIVE_DBS;
		...
		if (isset($table->flds['iddetalleprematricula'])) {
            
            $correccion = array();
            $correccion['idDetallePrematricula'] = $table->flds['iddetalleprematricula']; 
            $table->flds = array_merge($correccion,$table->flds);           
            unset($table->flds['iddetalleprematricula']);
 
            $table->keys['idDetallePrematricula'] = 'idDetallePrematricula';
            unset($table->keys['iddetalleprematricula']);          
		}
