...
<body>
<div align="center">
<h1 align="center">SE HA IMPRESO LA ORDEN <?php echo $_GET['ordenpago']; ?></h1>
<?php
...
$servidor_ftp = $_GET['ipimpresora'];

//echo "asdasd $servidor_ftp";
//exit();
// Credito y cartera
...
?>
<input name="regresar" type="button" id="imprimir" value="Regresar" onClick="history.go(-2)">&nbsp;&nbsp; 
</div>
</body>
</html>
