...
?>	
    ...
    <td width="200" class="Estilo4 Estilo1"><div align="center"><span class="Estilo6"><input type="text" name="fecha" style="font-size:9px" size="8" maxlength="10" id="fecha" readonly="true"></span></div></td>
