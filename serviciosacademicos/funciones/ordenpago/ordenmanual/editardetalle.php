...
?>
	...
	<td class="Estilo4 Estilo1" width="20%" align="right"><span class="Estilo6">&nbsp;<input type="submit" name="Editar<?php echo $row_deudas['codigoconcepto'];?>" value="Editar"></span></td>
  </tr>
<?php
		}
		else
