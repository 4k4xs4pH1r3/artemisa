...
class Ordenpago {
    ...
    function espensioncolegio() {
        ...
        $arrayconceptospension = array("159", "C9076", "C9077");
...
//													//
 ...
 /* $query_selmaxnumeroordenpago = "SELECT d.codigoconcepto
        ...
        if ($row_selmaxnumeroordenpago <> "") {
            $resultado = genera_prodiverso($this->sala, $this->numeroordenpago, $this->itemnbrps);
        } else {
            $resultado = crea_estudiante($this->sala, $this->numeroordenpago, $idgrupo, $this->itemnbrps); //$numeroordenpago = '1019832';
        }
	//print_r($resultado);
...
//													//
    ...
    function crear_ordenpago_estadodecuenta($conceptointeres,$valorinterescuota,$conceptocuota,$valorcuota,$valortotalcuota,$fechadetallefechafinanciera,$numerodocumentoplandepagosap,$numerorodenpagoplandepagosap,$porcentajedetallefechafinanciera=0, $totalconrecargo=0, $itemnbrps=0){
    ...
    // foreach ($valorconcepto as $key => $value) {
            ...
            from detalleordenpago
            where codigoconcepto = '$conceptocuota'
   ...
   $this->insertardetalleordenpago($conceptocuota, 1, $valorcuota, $codigotipodetalle);
  

if($conceptointeres<>"")
{
$valorcuota=$valorinterescuota;
	$this->insertardetalleordenpago($conceptointeres, 1, $valorcuota, 1);
	
}

        $this->insertarfechaordenpago($fechadetallefechafinanciera, $porcentajedetallefechafinanciera, $valortotalcuota);
        $this->insertarbancosordenpago();
...
//													//
  ...
  function tomar_saldocontra() {
	...
	//echo "<h1>Entro Aqui en imprimir</h1>";
	
        require('tomar_saldofavorcontra.php');
        
        if ($retorno == 8) {
			//echo "<h1>Entro REtorno</h1>";
            return $retorno;
        }
...
<?php
    ...
    function mostrar_ordenpagoproceso($ruta, $rutaimpresion="") {
		...
		//echo "<h1>Entro aqui a orden proceso</h1>";
        ...
        if (ereg("^6.+$", $this->codigoestadoordenpago)) {
            ...
            // Muestra orden en proceso de pago
            echo $query_ordenesenproceso = "select l.TransValue as valorfechaordenpago, l.SoliciteDate, l.TicketId
			from LogPagos l
...
?>
        ...
        <?php
                ...
                if (!$this->es_ordenplandepago()) {		
                    ...
                    if ($estaapazysalvo and $estasindeudas ) {
        ...
        <?php
								...
								//echo "<h1>Entro aqui a pagos Electronico</h1>";
        ...
        <?php
                ...
                /* else if($this->codigoimprimeordenpago == "02")
                  ...
                  <?php
                    ...
                    //echo "No se le imprime orden de pago debido a que no ha tienen deudas pendientes";
                    // Este mensaje es cuando tiene deudas en sap
                    $onClick = "alert('NO SE ENCUENTRA A PAZ Y SALVO, POR FAVOR REVISE SU ESTADO DE CUENTA')";
                } else {
    ...
    function imprimir_ordenpdf($ruta, $nombre="Imprimir") {
        ...
        if (!ereg("^4.+$", $this->codigoestadoordenpago)) {
            ...
            if ($fechavencimiento = $this->ordenvigente()) {
              ...
              /*echo "<h1>Entro aqui a codigoordensd</h1><pre>";
					print_r($esmatricula);
					echo "</pre>";*/
                ...
                if ($esmatricula) {
                   ...
                   //echo "<h1>No entro esmatricula</h1>";
                    $estaapazysalvo = $this->valida_pazysalvoestudiante();
                     //echo "Paz y SAlvo".$estaapazysalvo."<br>";
                    $sindocumentospendientes = $this->valida_documentosestudiante();
                     //echo "sindocumentospendientes".$sindocumentospendientes."<br>";
                    $tieneevaluaciondocente = $this->valida_evaluaciondocenteestudiante();
                     //echo "tieneevaluaciondocente".$tieneevaluaciondocente."<br>";
                                         
                    $estasindeudas = $this->valida_saldoencontra();
                     //echo "tieneevaluaciondocente".$estasindeudas."<br>";
...
<?php
                    ...
                    // Este mensaje es cuando tiene deudas en sap
?>
                    <input name="imprimir" type="button" id="imprimir" value="<?php echo $nombre; ?>" onClick="alert('NO SE ENCUENTRA A PAZ Y SALVO, POR FAVOR REVISE SU ESTADO DE CUENTA')">&nbsp;&nbsp;&nbsp;&nbsp;
<?php
...
<?php
    ...
    function valida_pazysalvoestudiante() {
     ...
     //echo "<h1>Entro a PAz y SALvo</h1>";
    ...
    /*function valida_saldoencontra($objordendepago) {
    $saldoencontra = $objordendepago->tomar_saldocontra();
    ...
    function valida_saldoencontra() {
		...
		//echo "<h1>Entro Aqui SaldoContra</h1>";

        if ($this->existe_bloqueo()) {
			//echo "<h1>Entro AquiBloqueo</h1>";
