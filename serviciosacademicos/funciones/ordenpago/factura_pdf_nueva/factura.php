...
/*
//DESCOMENTAR PARA FACTURAS EN BLANCO DE PRUEBAS
$datos->estudiante['nombrecortodocumento']="";
$datos->estudiante['numerodocumento']="";
$datos->estudiante['nombre']="";
$datos->estudiante['semestreprematricula']="";*/
//listar($fechas);
 ...
 *Se cambia nombre HELM BANK por ITAU
 *@since May 3 ,2019
 */
/*primer bloque*/
