...
if(!$this->existe_conceptosxcodigoreferencia($codigoreferenciaconcepto))
{
	$valordeverdad = false;
}
// 2. Que exista valor pecuniario para el periodo y para inscripcion
if(!$this->existe_valorpecuniarioxcodigoreferencia($codigoreferenciaconcepto))
{
	$valordeverdad = false;
}
// 3. Que exista factura para la carrera del estudiante y para el periodo activo
if(!$this->existe_facturavalorpecuniario($codigoreferenciaconcepto))
{
	$valordeverdad = false;
}
...
if(!$this->existe_detallefacturavalorpecuniarioxcodigoreferencia($codigoreferenciaconcepto))
{
	$valordeverdad = false;
}
...
if(!$this->existe_fechacarreraconcepto($codigoconcepto))
{
	$valordeverdad = false;
}
