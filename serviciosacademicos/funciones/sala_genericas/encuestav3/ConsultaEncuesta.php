    ...
    function recuperarrespuestapreguntausuario($idusuario) {
     ...
     //echo"<h1>Entro </h1>";  
       ...
       ;
        ...
        $nombreidtabla="rp.codigomateria";
        $idtabla=$_REQUEST['codigomateria'];
        $condicion="
...
//echo "<br>";
    ...
    function muestraformulariopreguntas($ramapregunta,$idpregunta,$idencuesta) {
       ...
       /* echo "<H1>ENTRO AQUI ENCUESTA</H1><pre>";
print_r($idencuesta);
echo "</pre>";*/
...
group by e.codigoestudiante ";
 ...
 function listaEstudiantesEncuestaElectiva($periodo) {
...
and dp.idprematricula=p.idprematricula
and dp.codigoestadodetalleprematricula in (10,30)
and dp.codigomateria in (select em.codigomateria from encuestamateria em where em.codigomateria=dp.codigomateria and em.codigomateria='".$_REQUEST['codigomateria']."') 
