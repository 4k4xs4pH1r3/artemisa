...
echo"<h1>ENTRO AQUI	</h1>";
    ...
    function imprimirEncuesta($tituloinicial="") {
      ...
      // echo "<h1>Entro Aqui IMPRIMIR ENCUESTA</h1>";
    ...
    function imprimirResultadosEncuesta($tituloinicial="",$cadenaparametros,$tablasadicionales) {
        ...
        //echo "<h1>ENTRO RESULTADOS ENCUESTA</h1>";
		...
		<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" bordercolor=\"#E9E9E9\" width=\"750\">";
          ...
          /*echo "<h1>No impreme nada</h1><pre>";
				print_r( $this->objconsultaencuesta->arrayNotas);
				echo "</pre>";*/
	...
	z-index:1;'>";
         echo "<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" bordercolor=\"#E9E9E9\" width=\"750\">";
         //  $notaporpestana=number_format($sumanotastotal/$numeronotastotal,2);
