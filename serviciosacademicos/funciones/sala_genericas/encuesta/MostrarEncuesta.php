...
echo"</pre>";*/
    ...
    $notatotaltotal=round($sumanotastotal/$totalnumeronotas,2);
    ...
    z-index:1;'>";
         ...
         //  $notaporpestana=round($sumanotastotal/$numeronotastotal,2);
            $this->formulario->dibujar_fila_titulo("<b>Nota Total</n> ".$notatotaltotal,'tdtituloencuestadescripcion',"4","align='left'","td");
        echo "</table>";
echo "</div>";
    }
    function botonesFormulario() {
         ...
         * Se colocan las tildes en sus resoectivas palabras
         * @since Julio 24, 2018
        */
        $this->formulario->dibujar_fila_titulo('<b>Gracias por su colaboraci&oacute;n, sus respuestas son &uacute;tiles para el mejoramiento de nuestra Instituci&oacute;n</b>','',"2","align='center'","td");
