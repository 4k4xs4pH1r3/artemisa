    ...
    function listaUsuarioEstudianteMatriculado($codigocarrera) {
        ...
        if (isset($this->cacheusuarioestudiante[$codigocarrera]) &&
            ...
            foreach ($arregloestudiantesmatriculados as $idarreglo => $estudiantematriculado) {
                /**
                 * Caso 454
                 * Luis Dario Gualteros Castro <castroluisd@unbosque.edu.co>
                 * Adición del campo Semestre al reporte "Listas De Usuario De Correo". 
                 * Marzo 27 del 2019.
                 */
                ...
                $usuarioestudiante[$i]["Semestre"] = $datosestudiante['semestre'];
                $i++;
                //End Caso 454.    
            }
        }
