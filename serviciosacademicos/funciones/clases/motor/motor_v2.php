...
class matriz
{
	...
	function matriz($matriz,$titulo="",$archivo_origen="",$filtrasino="si",$numerarsino="no",$atras="",$link_recarga="")
	{
		error_reporting(0);
		$this->matriz=$matriz;
		$this->titulo=$titulo;
 ...
 */
	...
	function recargar($link_destino)
	{
		$cadena=$link_destino."?";
		foreach ($_SESSION['array_recarga'] as $llave => $valor)
		{
	...
	function listar($matriz="",$texto="",$link="",$filtros="si",$numerar="no",$totalizar="no",$campos_edicion="no")
	{
		...
		if($campos_edicion=="si")//si se quieren mostrar botones de editar,quitar y eliminar
		{
		...
		for($i=0; $i < count($matriz); $i++)
		{
			...
			if($this->mostrar_botones_edicion==true)
			{
				...
				if($this->mostrar_boton_agregar==true)
				{
					...
					echo '<td nowrap><a href="'.$this->link_destino_edicion.'?adicionar&'.$this->llave_principal_edicion.'='.$this->matriz[$i][$this->llave_principal_edicion].'&'.$this->llave_secundaria_edicion.'='.$this->matriz[$i][$this->llave_secundaria_edicion].'"><img src="imagenes/adicionar.png" width="23" height="23" border="0"></a>&nbsp;</td>'."\n";
				}
				if($this->mostrar_boton_editar==true)
				{
					echo '<td nowrap><a href="'.$this->link_destino_edicion.'?editar&'.$this->llave_principal_edicion.'='.$this->matriz[$i][$this->llave_principal_edicion].'&'.$this->llave_secundaria_edicion.'='.$this->matriz[$i][$this->llave_secundaria_edicion].'"><img src="imagenes/editar.png" width="23" height="23" border="0"></a>&nbsp;</td>'."\n";
				}
				if($this->mostrar_boton_borrar==true)
				{
					echo '<td nowrap><a href="'.$this->link_destino_edicion.'?eliminar&'.$this->llave_principal_edicion.'='.$this->matriz[$i][$this->llave_principal_edicion].'&'.$this->llave_secundaria_edicion.'='.$this->matriz[$i][$this->llave_secundaria_edicion].'"><img src="imagenes/eliminar.png" width="23" height="23" border="0"></a>&nbsp;</td>'."\n";
				}
			}
			//botones_col_botones_edicion
		}
