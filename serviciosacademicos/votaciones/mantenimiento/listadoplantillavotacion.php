...
$query="select pv.idplantillavotacion,
CONCAT(pv.resumenplantillavotacion,'...') Resumen,
pv.nombreplantillavotacion,
 tp.nombretipoplantillavotacion,dp.nombredestinoplantillavotacion
,c.nombrecarrera from plantillavotacion pv, tipoplantillavotacion tp, destinoplantillavotacion dp,
 carrera c
where tp.idtipoplantillavotacion=pv.idtipoplantillavotacion and
dp.iddestinoplantillavotacion=pv.iddestinoplantillavotacion and
pv.codigoestado like '1%' and
c.codigocarrera=pv.codigocarrera
order by idplantillavotacion desc
";
...
$motor->agregarllave_drilldown('Resumen','listadoplantillavotacion.php','plantillas.php','','idplantillavotacion',"",'','','','','onclick= "return ventanaprincipal(this)"');
