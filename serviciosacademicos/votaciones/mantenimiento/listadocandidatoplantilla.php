...
$query="select iddetalleplantillavotacion, dp.fechainscripcioncandidatodetalleplantillavotacion,
 ...
 c.nombrecargo, pv.nombreplantillavotacion, cv.numerotarjetoncandidatovotacion
...
and v.idvotacion=pv.idvotacion
and (NOW() between fechainiciovigenciacargoaspiracionvotacion and fechafinalvigenciacargoaspiracionvotacion)
...
$motor->agregarllave_drilldown('resumen','listadodetalleplantillavotacion.php','candidatoplantilla.php','','iddetalleplantillavotacion',"",'','','','','onclick= "return ventanaprincipal(this)"');
