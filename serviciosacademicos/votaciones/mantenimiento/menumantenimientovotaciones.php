...
{
	//history.back();
	document.location.href="<?php echo '../../consulta/facultades/menuopcion.php';?>";
}
...
<input type="hidden" name="AnularOK" value="" onChange="">
	...
	<?php 
	$formulario->dibujar_fila_titulo('MANTENIMIENTO VOTACIONES','labelresaltado',"2","align='center'");
	...
	<?php 	
		//$formulario->dibujar_fila_titulo('Asignacion de codigos EPS y ARP','labelresaltado');
 		$formulario->filatmp['candidatoplantilla.php']="Candidatos y Plantilla";
 		$formulario->filatmp['candidatovotacion.php']="Candidatos";
  		$formulario->filatmp['plantillas.php']="Plantillas";
  		$formulario->filatmp['detalleplantillavotacion.php']="Inscripcion de candidatos";
  		$formulario->filatmp['crearvotosenblanco.php']="Votos En Blanco";
    		//$formulario->filatmp['../informes/escrutinioajax.php']="Informe Votaciones";
		//$direccionreporte="../../Reporteador/ReporteCentral.php?reportUnit=%2FReportes%2FVotaciones%2Fresultadosvotaciones";
    		//$formulario->filatmp[$direccionreporte]="Informe Total Votaciones";
