...
$(document).ready( function () {
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 51 a 57 de 57 registros"; }
	);
	...
	oTest.fnTest(
		...
		function () { $("select[name=example_length]").val('25').change(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 a 25 de 57 registros"; }
	);
	
	oTest.fnTest(
		"Information with 25 records - second page",
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 26 a 50 de 57 registros"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == "Mostrando 1 a 57 de 57 registros"; }
	);
	
	oTest.fnTest(
		"Information back a 10 records",
		function () {
			$('#example_previous').click();
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 10 de 31 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest(
		...
		function () { $('#example_next').click(); },
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 11 a 20 de 31 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 31 a 31 de 31 registros (filtrando desde 57 total de registros)"; }
	);
	
	oTest.fnTest(
		"Information with filter 'Win' back a first page",
		function () {
			$('#example_previous').click();
			$('#example_previous').click();
			$('#example_previous').click();
	...
	oTest.fnTest(
		"Information with filter increased a 'Win 98'",
		function () { $('#example_filter input').val("Win 98").keyup(); },
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 9 de 9 registros (filtrando desde 57 total de registros)"; }
	);
	
	oTest.fnTest(
		"Information with filter decreased a 'Win'",
		function () { $('#example_filter input').val("Win").keyup(); },
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 10 de 31 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 10 de 42 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 10 de 32 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 6 de 6 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnTest(
		...
		function () { return $('#example tbody tr:eq(0) td:eq(0)').html() == 
			"No hay registros coincidentes encontrados"; }
	);
	...
	oTest.fnTest(
		...
		null,
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 0 a 0 de 0 registros (filtrando desde 57 total de registros)"; }
	);
	
	oTest.fnTest(
		"Filter back a blank and 1st column sorting",
		function () {
	...
	oTest.fnTest(
		...
		function () { return document.getElementById('example_info').innerHTML == 
			"Mostrando 1 a 10 de 17 registros (filtrando desde 57 total de registros)"; }
	);
