...
/* Note that we only test the internal storage de language information pulled form a file here
...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		"Loading de German file loads language information",
		function () {
			oSession.fnRestore();
		...
		function () {
			var bReturn = 
				...
				oSettings.oLanguage.oPaginate.sAnterior == "Zurück" &&
				oSettings.oLanguage.oPaginate.sSiguiente == "Nächster" &&
	...
	/* One DOM check just a ensure that they go into the DOM */
	oTest.fnTest(
