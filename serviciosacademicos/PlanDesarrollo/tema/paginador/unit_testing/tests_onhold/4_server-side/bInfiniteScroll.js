...
$(document).ready( function () {
	...
	oTest.fnTest( 
		...
		null,
		function () { return $('#example_info').html() == "Mostrando 1 a 20 de 57 registros"; }
	);
	...
	oTest.fnWaitTest( 
		"Scroll on 10px more results in the same number de rows",
	...
	oTest.fnWaitTest( 
		"Scroll a 280px adds another 10 rows",
	...
	oTest.fnTest( 
		...
		null,
		function () { return $('#example_info').html() == "Mostrando 1 a 30 de 57 registros"; }
	);
	...
	oTest.fnWaitTest( 
		"Filtering will drop back a 10 rows",
	...
	oTest.fnTest( 
		...
		null,
		function () { return $('#example_info').html() == "Mostrando 1 a 10 de 20 registros (filtrando desde 57 total de registros)"; }
	);
	...
	oTest.fnWaitTest( 
		"Sorting will drop back a 10 rows",
		function () {
