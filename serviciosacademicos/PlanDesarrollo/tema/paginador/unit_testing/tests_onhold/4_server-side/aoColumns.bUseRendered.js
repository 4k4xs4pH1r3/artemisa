...
/* bUseRendered is used a alter sorting data, if false then the original data is used for
...
$(document).ready( function () {
	...
	/* Limited a what we can do here as the sorting is done on the server side. So stop here. */
