 ...
 */ 
 ...
 class Usuario extends Persona{
	...
	*Se  añade parametro de busqueda en la consulta  C.codigoCarrera = ?
	para realzar filtro de facultad por carrera actual 	$this->persistencia->setParametro( 2 , $this->getCarrera( ) , false );
	*Since March 15,2018
	*/
	public function buscar( ){
		$sql = "
				SELECT DISTINCT U.idusuario, U.nombres, U.apellidos, U.usuario, R.idrol, R.nombrerol, CU.claveusuario, 
		...
		$this->persistencia->setParametro( 2 , $this->getCarrera( ) , false );
