 ...
 class Carrera{
	...
	public function consultarCarrera( $idFacultad ){
		$carreras = array( );
		  ...
		  * se modifica consulta con el fin que cargue los planes de desarrollo de las facultadades
		  * @since  March 07, 2017
		  */
		  /*@modified Diego RIvera<riveradiego@unbosque.edu.co>
			...
			$sql="	
				SELECT
					...
					pd.NombrePlanDesarrollo as nombrecarrera
				FROM
					PlanDesarrollo pd
				WHERE
