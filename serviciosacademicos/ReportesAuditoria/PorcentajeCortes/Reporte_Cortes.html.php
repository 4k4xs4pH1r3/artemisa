...
switch($_REQUEST['actionID']){
	case 'Buscar':{
		...
		global $C_Porcentaje_Cortes,$userid,$db;
		MainGeneral();
		JsGenral();
		...
		$C_Porcentaje_Cortes->Buscar($id_carrera,$Periodo);
...
function MainGeneral(){
		...
		require('Reporte_Cortes.class.php');  $C_Porcentaje_Cortes = new CortesPorcentaje();
		...
		function autoCompleModalidad(){
			/********************************************************/	
				$('#Modalidad').autocomplete({
						...
						source: "Reporte_Cortes.html.php?actionID=autoCompleModalidad",
						minLength: 2,
		...
		function autoCompleteCarrera(){
			...
			if(!$.trim(id_modalidad)){
				...
				$('#carrera').autocomplete({
						...
						source: "Reporte_Cortes.html.php?actionID=autoCompleteCarrera&id_Movilidad="+id_modalidad,
						minLength: 2,
						select: function( event, ui ) {
