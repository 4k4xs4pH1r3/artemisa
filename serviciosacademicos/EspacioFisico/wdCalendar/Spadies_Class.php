...
class Spadies{
    ...
    public function Display(){
        ...
        <div class="titulo">Reportes Spadies</div>
            <fieldset >
                ...
                <br />
                <table border="0" cellpadding="0" cellspacing="0" class="display" aling="center" width="100%">
                    <thead>
                        <tr>
 ...
 public function Reportes($TypeRepote,$Carrera_id,$Periodo,$TypeSemestre,$OP='',$Modalidad){
    global $db;
    ...
    if($TypeRepote==0 || $TypeRepote=='0'){
        /***********************************************************************/
        $this->PrimerNivel($Carrera_id,$Periodo,$TypeSemestre,$OP,$Modalidad);
        /***********************************************************************/
    }
    /***************************************************************************/
    if($TypeRepote==1 || $TypeRepote=='1'){
        /***********************************************************************/
        $this->Matriculados($Carrera_id,$Periodo,$TypeSemestre,$OP,$Modalidad);
        /***********************************************************************/
    }
    /***************************************************************************/
    if($TypeRepote==2 || $TypeRepote=='2'){
        /***********************************************************************/
        $D_Graduados =$this->Graduados($Carrera_id,$Periodo,$Modalidad);
 ...
 public function PrimerNivel($Carrera_id,$Periodo,$TypeSemestre,$op='',$Modalidad){
    global $db,$userid;
       ...
       $D_Estudiante = array();
        ...
        for($i=0;$i<count($Carrera);$i++){
            ...
            $Carrera_id    = $Carrera[$i]['codigocarrera'];
                 ...
                 //$C_PrimerNivel  = $D_Estadista->obtener_datos_estudiantes_matriculados_nuevos($Carrera_id,'arreglo', $Carrera[$i]['codigomodalidadacademicasic'],''); 
           ...
           //echo '<br>num->'.count($C_PrimerNivel);
            ...
            for($j=0;$j<count($D_Estudiante);$j++){
                ...
                */
                ...
                if($D_Estudiante[$j]['CodigoEstudiante']){
                  ...
                  ?>
                    <tr>
                        <td><?PHP echo $D_Estudiante[$j]['Apellido']?></td>
                        <td><?PHP echo $D_Estudiante[$j]['Nombre']?></td>
                        <td><?PHP echo $Tipo_Doc?></td>
                        <td><?PHP echo $D_Estudiante[$j]['Documento']?></td>
                        <td><?PHP echo $D_Estudiante[$j]['Programa']?></td>
 ...
 public function DataEstudianteMatriculados($CodigoEstudiante,$Periodo,$Semestre='',$op){
    global $db;
     ...
     $SQL='SELECT 
      ...
      $SQL_A='SELECT 
        ...
        $SQL='SELECT
                ...
                WHERE
                	o.codigoestudiante = "'.$CodigoEstudiante.'"
                AND o.codigoperiodo = "'.$Periodo.'"
               ';// AND o.codigoestadoordenpago IN ("40","41")
                
                if($Data=&$db->Execute($SQL)===false){
                    echo 'Error en el SQl De Data Estudiante en Orden de Pago...<br><br>'.$SQL;
                    die;
                 }   
              $Materias = 0;
              $AProbadas = 0;
              
            $CodigoEstudiante   = $CodigoEstudiante;//$Data->fields['codigoestudiante'];
            $Nombre             = $Data->fields['nombresestudiantegeneral'];
            $Apellido           = $Data->fields['apellidosestudiantegeneral'];
            $Tipo_Doc           = $Data->fields['nombrecortodocumento'];
            $Codigo_Doc         = $Data->fields['tipodocumento'];
      ...
      return $C_Data;
 }// public function DataEstudianteMatriculados 
 ...
 public function Matriculados($Carrera_id,$Periodo,$TypeSemestre,$op='',$Modalidad){
    global $db,$userid;
    ...
    //echo '<pre>';print_r($D_Estudiante);
     ...
     if($Carrera_id==0 || $Carrera_id=='0'){
        ...
        for($i=0;$i<count($Carrera);$i++){
            ...
            $D_Estudiante = $D_Estadista->obtener_total_matriculados($Carrera_id,'arreglo');
            $D_CarresaName[$Carrera[$i]['nombrecarrera']] = $D_Estadista->obtener_total_matriculados($Carrera_id,'arreglo');
            $Num = count($D_CarresaName[$Carrera[$i]['nombrecarrera']]);
            //echo '<br>Num->'.$Carrera[$i]['nombrecarrera'].'->'.count($D_CarresaName[$Carrera[$i]['nombrecarrera']]);
            //echo '<pre>';print_r($D_CarresaName[$Carrera[$i]['nombrecarrera']]);die;
            $Total = $Total+$Num;
            $Q= $Q+count($D_Estudiante);
        ...
        // echo '<br>Total->'.$Total;
        //echo '<pre>';print_r($C_Matriculados);die;
        ...
        $D_Estudiante = $D_Estadista->obtener_total_matriculados($Carrera_id,'arreglo');
         ...
         $C_Matriculados  = array();
            ...
            for($i=0;$i<count($D_Estudiante);$i++){
                ...
                $D_Matriculados  = $this->DataEstudiante($D_Estudiante[$i]['codigoestudiante'],$Periodo,$TypeSemestre,$X);
            ...
            for($j=0;$j<count($C_Matriculados);$j++){
                if($C_Matriculados[$j]['CodigoEstudiante']){
                 ...
                 <tr>
                    ...
                    <td><?PHP echo $C_Matriculados[$j]['Apellido']?></td>
                    <td><?PHP echo $C_Matriculados[$j]['Nombre']?></td>
                    <td><?PHP echo $Tipo_Doc?></td>
                    <td><?PHP echo $C_Matriculados[$j]['Documento']?></td>
                    <td><?PHP echo $C_Matriculados[$j]['Programa']?></td>
 ...
 public function Graduados($Carrera_id,$CodigoPeriodo,$Modalidad){
    global $db,$userid;
     ...
     $SQL='SELECT 
            ...
            r.fechagradoregistrograduado>="'.$Fecha->fields['fecha'].'"
            '.$Consulta;
         ...
         $Graduados = $Data->GetArray();
         
         return $Graduados;
 }//public function Graduados
 public function TableGraduados($DataGraduado,$op=''){
    global $db,$userid;
     ...
     <table border="1" aling="center">
        ...
        <tbody>
            ...
            for($i=0;$i<count($DataGraduado);$i++){
                ...
                ?>
                <tr>
                    <td><?PHP echo $DataGraduado[$i]['apellidosestudiantegeneral']?></td>
                    <td><?PHP echo $DataGraduado[$i]['nombresestudiantegeneral']?></td>
                    <td><?PHP echo $Tipo_Doc?></td>
                    <td><?PHP echo $DataGraduado[$i]['numerodocumento']?></td>
                    <td><?PHP echo $DataGraduado[$i]['nombrecarrera']?></td>
                </tr>
                <?PHP
                /**********************************************/
            }//for
    ...
    <table border="1" aling="center">
        ...
        $N=1;
            for($i=0;$i<count($C_Data['codigoestudiante']);$i++){
                ...
                ?>
                 <tr>
                    <td><?PHP echo $C_Data['Apellido'][$i]?></td>
                    <td><?PHP echo $C_Data['Nombre'][$i]?></td>
                    <td><?PHP echo $Tipo_Doc?></td>
