...
function writeHeader($title, $bd=false, $rutaCss="../../mgi/",$classBody="body",$Botones="../css/") {
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?PHP echo $Botones?>Botones.css" type="text/css" /> 
        ...
        <!--<script type="text/javascript" language="javascript" src="<?php echo $rutaCss; ?>js/functions.js"></script>Errorrrrrrr-->    
