...
if(strcmp($action,"save")==0){
	...
	$result = $utils->processData("inactivate","firmaEscaneadaEducacionContinuada","idfirmaEscaneadaEducacionContinuada");
	if($result == 0){ 
		// Set up associative array
		$data = array('success'=> false,'message'=>'Ha ocurrido un problema al tratar de eliminar la firma.');
	} else { 
		$data = array('success'=> true,'message'=> "La firma se ha eliminado de forma correcta.");
	}
