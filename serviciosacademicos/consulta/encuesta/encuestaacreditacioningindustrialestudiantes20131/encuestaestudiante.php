...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        //$direccionfalta = "encuestaestudiante.php?idusuario=" . $_GET['idusuario'];
        $direccionfalta = "encuestaestudiante.php?&codigocarrera=".$_GET['codigocarrera']."&idusuario=" . $_GET['idusuario'];
