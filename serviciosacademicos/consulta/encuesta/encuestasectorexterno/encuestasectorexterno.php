...
if (!is_array($preguntasfacultades)|| (count($preguntasfacultades)<1)) {
  ...
  echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=ingresosectorexterno.php'>";
...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        $direccionexito = "ingresosectorexterno.php";
        //$direccionfalta = "ingresodocenteencuesta.php?idusuario=" . $_GET['idusuario'];
        $direccionfalta = "encuestasectorexterno.php?idencuesta=".$_GET['idencuesta']."&codigocarrera=".$_GET['codigocarrera']."&idusuario=" . $_GET['idusuario'];
