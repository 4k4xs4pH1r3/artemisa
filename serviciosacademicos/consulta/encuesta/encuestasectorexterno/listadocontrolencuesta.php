...
<script LANGUAGE="JavaScript">
    ...
    function reCarga(){
        document.location.href="<?php echo 'listadocontrolencuesta.php'; ?>";
...
$_SESSION['idencuestacontrolencuesta'] = 62;
$_SESSION['tablarespuestacontrolencuesta'] = "respuestasectorexterno";
...
order by c.nombrecarrera";
    ...
    and c2.codigomodalidadacademica like '2%' ) group by numerodocumento) t,
     carrera c where 1= '1' and t.codigocarrera=c.codigocarrera AND c.codigocarrera in (10,11   )
     group by c.codigocarrera
    order by c.nombrecarrera";
...
unset($filacarreras);
$_REQUEST['idencuesta'] = 62;
$_REQUEST['tablarespuesta'] = "respuestasectorexterno";
