...
<html>
    <head>
        ...
        $formulario->dibujar_fila_titulo('Asignar materia encuesta ','labelresaltado',"2","align='center'");
        ...
        $resultmaterias=$objetobase->recuperar_resultado_tabla($tablas, "p.codigocarrera", $_POST['codigocarrera'], $condicion,"",1);
