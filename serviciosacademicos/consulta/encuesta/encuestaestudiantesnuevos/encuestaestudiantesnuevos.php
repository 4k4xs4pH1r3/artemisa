...
$tabla = "respuestaestudiantesnuevos";
...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        $direccionexito = "encuestaestudiantesnuevos.php?idusuario=" . $_GET['idusuario']."&codigocarrera=".$_GET['codigocarrera'];
        $direccionfalta = "encuestaestudiantesnuevos.php?idusuario=" . $_GET['idusuario']."&codigocarrera=".$_GET['codigocarrera'];
