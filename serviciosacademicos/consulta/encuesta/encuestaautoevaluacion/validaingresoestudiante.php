...
if($siga) {
    ...
    if($diligenciarencuesta) {
        //echo "IN1";
        //exit();
        echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaautoevaluacion/encuestainduccion.php?idencuesta=56&idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]."&codigocarrera=$codigocarrera'>";
       ...
       // echo "IN2";
        ...
        if($completoencuesta) {
            if($_POST["tipousuario"]!="700") {
                ...
                echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaautoevaluacion/encuestainduccion.php?idencuesta=56&tipoentrada=1&idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]."&codigocarrera=$codigocarrera'>";
                //alerta_javascript("formularioencuesta.php?idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]);
            }
        }
        else
