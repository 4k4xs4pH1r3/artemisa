...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        $direccionexito = "encuestainduccion.php?idusuario=".$_GET['idusuario']."&aux_redireccion=".$_GET['aux_redireccion'];
        //$direccionfalta = "encuestainduccion.php?idusuario=" . $_GET['idusuario'];
        $direccionfalta = "encuestainduccion.php?&codigocarrera=".$_GET['codigocarrera']."&idusuario=" . $_GET['idusuario'];
