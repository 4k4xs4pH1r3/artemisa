 ...
 * */
   ...
   $query=" select c.nombrecarrera,c.codigocarrera, count(distinct e.codigoestudiante)  estudiantes
...
group by c.nombrecarrera,c.codigocarrera";
...
unset($filacarreras);
$_REQUEST['idencuesta'] = 56;
$_REQUEST['tablarespuesta'] = "respuestainstitucional";
