...
$condicion =" and o.numeroordenpago=d.numeroordenpago
					and eg.idestudiantegeneral=e.idestudiantegeneral
						...
						AND o.codigoperiodo='20122'
						AND o.codigoestadoordenpago LIKE '4%'
						AND e.codigoperiodo='20122'
...
if($siga) {
    ...
    if($diligenciarencuesta) {
        //echo "IN1";
        //exit();
        echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaprimersemestre/encuestainduccion.php?idencuesta=70&idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]."'>";
       ...
       // echo "IN2";
        ...
        if($completoencuesta) {
            if($_POST["tipousuario"]!="700") {
                ...
                echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaprimersemestre/encuestainduccion.php?idencuesta=70&tipoentrada=1&idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]."'>";
                //alerta_javascript("formularioencuesta.php?idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]);
            }
        }
        else
    ...
    echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaautofacultad/encuestaautofacultad.php?idencuesta=50&idusuario=".$_GET["idusuario"]."&codigotipousuario=".$_GET["codigotipousuario"]."'>";
}
