...
/*	$query="select	 c.codigocarrera
	...
	$query="select	 c.codigocarrera
		...
		where codigocarrera in (71,25,38,53,58,61,62,72,52,57,31,29,15,16,19,20,17,333,66,299,43,54,301,297,32,56,77,64,40,24,35,47)
		group by c.codigocarrera
			,c.nombrecarrera
		order by c.nombrecarrera ";
...
unset($filacarreras);
$_REQUEST['idencuesta'] = 66;
$_REQUEST['tablarespuesta'] = "respuestaegresadosposgrado20122";
