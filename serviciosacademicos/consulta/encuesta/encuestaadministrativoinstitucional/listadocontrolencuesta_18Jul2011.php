 ...
 * */
   ...
   $query="
select codigocarrera, nombrecarrera from carrera c where
(c.codigocarrera not in (7,560,554)) and 
( c.codigomodalidadacademica in  ('200')
...
and codigocarrera not in (1,2,156,124,119,134,496,484,483,417,492) or  
   (c.codigomodalidadacademica like '5%' and 
  codigocarrera not in (1,2,156,124,119,134,496,484,483,417,492) ) 
...
unset($filacarreras);
$_REQUEST['idencuesta'] = 53;
$_REQUEST['tablarespuesta'] = "respuestainstitucionaladministrativo";
