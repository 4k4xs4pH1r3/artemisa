...
Cuando haga click en el botón finalizar, habrá terminado la evaluación.</b>', 'tdtituloencuestadescripcion', "2", "align='left'", "td");
                    ...
                    if ($_REQUEST['tipousuario'] == "500") {
                        ...
                        $modalidades = " (c.codigocarrera in(90,93))
                    ...
                    if ($_REQUEST['tipousuario'] == "610") {
                        ...
                        $modalidades = "( c.codigomodalidadacademica in ('200','300')) and c.codigocarrera not in (101)
                            and now() between fechainiciocarrera and fechavencimientocarrera";
                    }
...
or codigocarrera in (3) 
 ";
                    ...
                    if ($_REQUEST['tipousuario'] == "700") {
                        $formulario->dibujar_fila_titulo('<b>Tenga en cuenta que una vez seleccione una dependencia e ingrese , no podra diligenciar el instrumento para otra dependencia </b>  ', 'tdtituloencuestadescripcion', "2", "align='left'", "td");
                        $modalidades = " ( c.codigomodalidadacademica in ('200','300')) and now() between fechainiciocarrera and fechavencimientocarrera";
                    }
...
//echo "<BR>TIPOUSUARIO=".$_POST["tipousuario"];
                        switch ($_POST["tipousuario"]) {
                            ...
                            case "620":
                                $siga = validaEntradaEncuesta(
                                                ...
                                                "nombresestudiantegeneral",
                                                "apellidosestudiantegeneral",
                                                "ordenpago o, detalleordenpago d, estudiante e, carrera c, concepto co, prematricula pr,estudiantegeneral eg",
                                                "eg.numerodocumento",
                                                $_POST["numerodocumento"],
                                                $objetobase,
                                                "and o.numeroordenpago=d.numeroordenpago and eg.idestudiantegeneral=e.idestudiantegeneral AND e.codigoestudiante=pr.codigoestudiante AND pr.codigoperiodo='20112' AND e.codigoestudiante=o.codigoestudiante AND c.codigocarrera=e.codigocarrera AND d.codigoconcepto=co.codigoconcepto AND co.cuentaoperacionprincipal=151 AND o.codigoperiodo='20112' AND o.codigoestadoordenpago LIKE '4%' and c.codigomodalidadacademica in ('300')");
                                break;
                            case "700":
                                ...
                                switch ($_POST["tipousuario"]) {
                                    ...
                                    case "500":
                                        ...
                                        if (!isset($datosrespuestadocente["codigocarrera"])) {
                                            echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=encuestadocente.php?idencuesta=57&codigocarrera=" . $_POST['codigocarrera'] . "&idusuario=" . $_POST["numerodocumento"] . "'>";
                                        } else {
                                    ...
                                    case "610":
                                        ...
                                        if (!isset($datosrespuestadocente["codigocarrera"])) {
                                             echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaegresadoinstitucional/encuestaegresado.php?idencuesta=52&codigocarrera=" . $_POST['codigocarrera'] . "&idusuario=" . $_POST["numerodocumento"] . "'>";
                                           // echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=encuestadocente.php?idencuesta=49&codigocarrera=" . $_POST['codigocarrera'] . "&idusuario=" . $_POST["numerodocumento"] . "'>";
                                        } else {
                                            if ($datosrespuestadocente["codigocarrera"] != $_POST["codigocarrera"]) {
                                                $condicion = "";
					...
					if($datosnombrespostgrado=$objetobase->recuperar_datos_tabla("ordenpago o, detalleordenpago d, estudiante e, carrera c, concepto co, prematricula pr,estudiantegeneral eg","eg.numerodocumento",$_REQUEST['numerodocumento'],$condicion,'',0)) {
					    $codigocarrera=$datosnombrespostgrado['codigocarrera'];
					    $idusuario=$datosnombrespostgrado['idestudiantegeneral'];
					    echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaestudiantespostgrado/encuestaestudiantespostgrado.php?idencuesta=55&idusuario=".$idusuario."&codigotipousuario=".$_REQUEST["tipousuario"]."&codigocarrera=$codigocarrera&aux_redireccion=true'>";
					} else {
