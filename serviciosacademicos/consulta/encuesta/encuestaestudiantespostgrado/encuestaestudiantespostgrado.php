...
$tabla = "respuestaestudiantespostgrado";
...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        $direccionexito = "encuestaestudiantespostgrado.php?idusuario=".$_GET['idusuario']."&aux_redireccion=".$_GET['aux_redireccion'];
        //$direccionfalta = "encuestaestudiantespostgrado.php?idusuario=" . $_GET['idusuario'];
        $direccionfalta = "encuestaestudiantespostgrado.php?&codigocarrera=".$_GET['codigocarrera']."&idusuario=" . $_GET['idusuario'];
