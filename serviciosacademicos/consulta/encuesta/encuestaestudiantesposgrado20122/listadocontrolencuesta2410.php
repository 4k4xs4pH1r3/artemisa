...
where 
o.numeroordenpago=d.numeroordenpago and eg.idestudiantegeneral=e.idestudiantegeneral AND e.codigoestudiante=pr.codigoestudiante AND pr.codigoperiodo='20122' AND e.codigoestudiante=o.codigoestudiante AND c.codigocarrera=e.codigocarrera AND d.codigoconcepto=co.codigoconcepto AND co.cuentaoperacionprincipal=151 AND o.codigoperiodo='20122' AND o.codigoestadoordenpago LIKE '4%' and c.codigomodalidadacademica in ('300')
group by c.codigocarrera
order by c.nombrecarrera ";*/

/*$query="select	 c.nombrecarrera
		,c.codigocarrera
		,count(distinct e.codigoestudiante) estudiantes
	from estudiante e
	,carrera c
	...
	where eg.idestudiantegeneral=e.idestudiantegeneral
		...
		and e.codigoperiodo in ('20111','20112','20121','20122')
...
$query="select   c.nombrecarrera
	...
	,carrera c
	,estudiante e  
	where e.codigocarrera in (71,25,38,53,58,61,62,72,52,57,31,29,15,16,19,20,17,333,66,299,43,54,301,297,32,56,77,64,40,24,35,47)
		and e.codigocarrera=c.codigocarrera
		and ee.codigoestudiante=e.codigoestudiante
		and ee.codigoperiodo in ('20121','20122')
...
unset($filacarreras);
$_REQUEST['idencuesta'] = 68;
$_REQUEST['tablarespuesta'] = "respuestaestudiantesposgrado20122";
