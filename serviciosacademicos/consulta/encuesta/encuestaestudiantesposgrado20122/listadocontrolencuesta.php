...
where 
o.numeroordenpago=d.numeroordenpago and eg.idestudiantegeneral=e.idestudiantegeneral
AND e.codigoestudiante=pr.codigoestudiante AND pr.codigoperiodo='20122' 
AND e.codigoestudiante=o.codigoestudiante AND c.codigocarrera=e.codigocarrera 
AND d.codigoconcepto=co.codigoconcepto AND co.cuentaoperacionprincipal=151 AND o.codigoperiodo='20122' 
AND o.codigoestadoordenpago LIKE '4%' and c.codigomodalidadacademica in ('200') and c.codigocarrera=125
group by c.codigocarrera
order by c.nombrecarrera
