...
/*$query ="
select max(codigocarrera) maxcarrera from (
SELECT e.codigocarrera
 FROM estudiantegeneral eg, estudiante e, registrograduadoantiguo r, documento d, registrograduado rg, foliotemporal f
 where eg.numerodocumento = '".$_GET['idusuario']."'
 ...
 union
 SELECT c.codigocarrera
 FROM estudiantegeneral eg, estudiante e, carrera c, registrograduado r, titulo t, documento d, foliotemporal f
 where eg.numerodocumento ='".$_GET['idusuario']."'
 and eg.idestudiantegeneral=e.idestudiantegeneral
 ...
 and eg.tipodocumento= d.tipodocumento
 and f.idregistrograduado=r.idregistrograduado) tabla1";
$resultcarrera=$objetobase->conexion->query($query);
$rowcarreraregistro=$resultcarrera->fetchRow();
$codigocarrera=$rowcarreraregistro["maxcarrera"];*/
$codigocarrera=$_GET['codigocarrera'];



$objvalidaautoevaluacion = new ValidaEncuesta($objetobase, '20131', '1');
...
$tabla = "respuestaegresadospsicologia20131";
...
/*echo "SALE ALGO?<pre>";
        print_r($objvalidaautoevaluacion);
        echo "</pre>";
*/
...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        $direccionexito = "../encuestadocentesinstitucional/ingresodocenteencuesta.php";
        $direccionfalta = "encuestaegresado.php?idencuesta=".$_GET['idencuesta']."&codigocarrera=".$_GET['codigocarrera']."&idusuario=" . $_GET['idusuario'];
