...
$listaestudiantes=$objconsultaencuesta->listaEstudiantesEncuesta($_SESSION["codigoperiodo_autoenfermeria"], $carrera);
...
echo "<table width='100%'><tr><td align='center'><h3>LISTADO DE ESTUDIANTES EN PROCESO DE EVALUACION DOCENTE DEL PROGRAMA ".$datoscarrera["nombrecarrera"]." EN EL PERIODO ".$_SESSION['codigoperiodo_autoenfermeria']."</h3></td></tr></table>";
