...
grupo g, materia m, carrera c where g.codigoperiodo='20122'
and g.codigomateria = m.codigomateria
and g.codigoestadogrupo like '1%'
and c.codigocarrera=m.codigocarrera
and c.codigomodalidadacademica like '2%'
...
carrera c2 where  c2.codigocarrera=m2.codigocarrera and g2.codigoperiodo='20122' and
...
order by c.nombrecarrera";*/
    $query = "	select	 c.nombrecarrera
		...
		where  g.codigomateria = m.codigomateria
			and c.codigocarrera=m.codigocarrera
			and c.codigocarrera in (71,25,38,53,58,61,62,72,52,57,31,29,15,16,19,20,17,333,66,299,43,54,301,297,32,56,77,64,40,24,35,47)
...
unset($filacarreras);
$_REQUEST['idencuesta'] = 67;
$_REQUEST['tablarespuesta'] = "respuestainstitucionaldocente20122";
