...
Cuando haga click en el botón finalizar, habrá terminado la evaluación.</b>', 'tdtituloencuestadescripcion', "2", "align='left'", "td");
                    ...
                    if ($_REQUEST['tipousuario'] == "500") {
                       ...
                       /* $modalidades = "( c.codigomodalidadacademica in ('200','300')) and c.codigocarrera in (71,25,38,53,58,61,62,72,52,57,31,29,15,16,19,20,17,333,66,299,43,54,301,297,32,56,77,64,40,24,35,47)
                            ...
                            $modalidades = "( c.codigomodalidadacademica in ('200')) and c.codigocarrera in (133)
                            and now() between fechainiciocarrera and fechavencimientocarrera";
                    }
                    if ($_REQUEST['tipousuario'] == "610") {
                        ...
                        $modalidades = "( c.codigomodalidadacademica in ('200','300')) and c.codigocarrera in (126,8)
                            and now() between fechainiciocarrera and fechavencimientocarrera";
                        /*$modalidades = "( c.codigomodalidadacademica in ('200','300')) and c.codigocarrera in (71,25,38,53,58,61,62,72,52,57,31,29,15,16,19,20,17,333,66,299,43,54,301,297,32,56,77,64,40,24,35,47)
                            and now() between fechainiciocarrera and fechavencimientocarrera";*/
                    }
...
//echo "<BR>TIPOUSUARIO=".$_POST["tipousuario"];
                        switch ($_POST["tipousuario"]) {
                            ...
                            case "500":
                                ...
                                $siga = validaEntradaEncuesta(
                                                ...
                                                "td.nombredocente",
                                                "td.apellidodocente",
                                                "tmpdocentescompletopersonal td",
                                                "td.numerodocumento",
                            ...
                            case "610":
                                   ...
                                   $siga = validaEntradaEncuesta(
                                                ...
                                                $_POST["numerodocumento"],
                                                $objetobase,
                                                " and eg.idestudiantegeneral=e.idestudiantegeneral and e.codigosituacioncarreraestudiante in ('104','400') and e.codigocarrera in (126,8)");
                                break;
								case "400":
                        ...
                        if ($siga) {
                            if ($formulario->valida_formulario()) {
                                switch ($_POST["tipousuario"]) {
                                    ...
                                    case "500":
                                        $tabla = "respuestadocentespsicologiaacreditacion20131";
                                        $condicion = " and codigoperiodo='20131'";
                                        ...
                                        if (!isset($datosrespuestadocente["codigocarrera"])) {
                                            echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaacreditacionpsicologiadocentes20131/encuestadocente.php?codigocarrera=" . $_POST['codigocarrera'] . "&idusuario=" . $_POST["numerodocumento"] . "'>";
                                        } else {
					...
					$datos = $objetobase->recuperar_datos_tabla("estudiante join estudiantegeneral using(idestudiantegeneral)", "numerodocumento", $_POST["numerodocumento"], " and codigocarrera=".$_POST['codigocarrera'], "", 0);

                                        if (isset($datos["codigocarrera"])) {
                                        	echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=../encuestaacreditacionindustrialegresados20131/encuestaegresado.php?codigocarrera=".$_POST['codigocarrera']."&idusuario=".$_POST["numerodocumento"]."'>";
