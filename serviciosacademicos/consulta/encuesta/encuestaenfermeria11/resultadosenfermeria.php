...
$_SESSION["codigoperiodo_autoenfermeria"]='20112';//$_SESSION['codigoperiodosesion'];
...
r.codigoperiodo='".$_SESSION["codigoperiodo_autoenfermeria"]."' and
g.idgrupo=dp.idgrupo and
g.numerodocumento=d.numerodocumento and
g.codigoperiodo='".$_SESSION["codigoperiodo_autoenfermeria"]."' and
