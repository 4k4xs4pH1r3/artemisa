...
$_SESSION["codigoperiodo_autoenfermeria"]='20121';//$_SESSION['codigoperiodosesion'];
...
r.iddocentemodulo=d.iddocentemodulo
and r.codigomodulopostind=md.codigomodulopostind and
 r.codigomateria='".$_POST["codigomateria"]."' and r.codigomodulopostind='".$_POST["codigomodulopostind"]."'
  and r.iddocentemodulo='".$_POST["iddocente"]."'
