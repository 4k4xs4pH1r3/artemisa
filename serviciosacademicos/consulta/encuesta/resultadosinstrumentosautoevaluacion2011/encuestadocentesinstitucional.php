...
if ($_REQUEST['accion']=='Generar reporte') {
	...
	$nombre_archivo_excel='resultados_encuesta_docentes_institucional_2011.xls';
	$idencuesta=($_REQUEST['periodo']==20111)?49:57;
	...
	echo "<b>Resultados encuesta docentes institucional 2011</b><br><br>";
