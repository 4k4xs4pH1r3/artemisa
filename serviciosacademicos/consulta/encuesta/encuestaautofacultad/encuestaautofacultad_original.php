...
$tabla = "respuestaevaluacionfacultad";
...
if (!is_array($preguntasfacultades)||
 ...
 //echo "<script type='text/javascript'>parent.continuar();</script>";
 $urlexito="../encuestaenfermeria/encuestaenfermeria.php?codigoestudiante=" . $_GET['codigoestudiante'];
...
$condicionactualizaadicion=" and codigoperiodo='".$filaadicional["codigoperiodo"]."'";
       ...
       // echo "<h1>ENTRO1</h1>";
        ...
        $direccionfalta = "encuestaautofacultad.php?codigoestudiante=" . $_GET['codigoestudiante'];
        $direccionexito = "../encuestaenfermeria/encuestaenfermeria.php?codigoestudiante=" . $_GET['codigoestudiante'];
