...
r.codigomateria='".$rowmateria["codigomateria"]."'
    ...
    $formulario->dibujar_fila_titulo('Encuesta evaluacion docente seleccion de asignaturas- Por favor reconfirme las respuestas de la autoevalución del semestre anterior. Gracias ','labelresaltado',"2","align='center'");
