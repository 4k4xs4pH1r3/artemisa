...
<html>
<head>
<title>Listados notas por materia</title>
...
$query_cursos = "SELECT  *
						...
						WHERE g.codigomateria = '".$codigomateria."'
...
mysql_select_db($database_sala, $sala);
$query_nombremateria = "SELECT materia.nombremateria,materia.codigomateria, grupo.numerodocumento
FROM materia,grupo
WHERE grupo.codigomateria = '".$_SESSION['materias']."'
AND grupo.idgrupo = '".$_SESSION['grupos']."'AND grupo.codigomateria = materia.codigomateria
...
$colname_docente = $row_nombremateria['numerodocumento'];
...
<table width="600" border="1" cellpadding="1" cellspacing="0"
	...
	<tr>
		<td>
		<div align="center"><font size="1" face="Tahoma"><?php echo "<a href='cargavariablesnotasfacultades.php?materia=".$row_cursos['codigomateria']."&grupo=".$row_cursos['idgrupo']."&nombreperiodo=".$row_periodo['codigoperiodo']."&facultad=".$row_cursos['codigocarrera']."'>".$row_cursos['codigomateria']."</a>"; ?></font></div>
		</td>
		<td>
...
if ($row_area <> "")
{
	...
	<tr>
		<td>
		<div align="center"><font size="1" face="Tahoma"><?php echo $row_cursos['codigomateria']; ?></font></div>
		</td>
		<td>
		<div align="center"><font size="1" face="Tahoma"><?php echo $row_cursos['idgrupo']; ?></font></div>
		</td>
...
<br>
<br>
<input type="button" onclick="window.location.href='menucursossalafacultades.php'" name="Regresar" value="Regresar">
