...
unset($_SESSION['periodos']);
unset($_SESSION['grupos']);
unset($_SESSION['materias']);
unset($_SESSION['facultades']);
?>
...
function reCarga(){
	document.location.href="<?php echo 'menucursossalafacultades.php';?>";
...
echo "<form name=\"form1\" action=\"cursossalafacultades.php\" method=\"post\"  >
<input type=\"hidden\" name=\"AnularOK\" value=\"\">
	<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" bordercolor=\"#E9E9E9\" width=\"750\">";

 	$formulario->dibujar_fila_titulo('ESTADISTICAS  NOTAS DEFINITIVAS POR PERIODOS','labelresaltado',"2","align='center'");
	...
	$formulario->filatmp=$objetobase->recuperar_datos_tabla_fila("periodo","codigoperiodo","codigoperiodo","codigoperiodo=codigoperiodo order by codigoperiodo desc");
	$codigoperiodofinal=$_SESSION['codigoperiodofinal'];
	if(isset($_POST['codigoperiodo']))
	$codigoperiodofinal=$_POST['codigoperiodofinal'];
	if(isset($_GET['codigoperiodo']))
	$codigoperiodofinal=$_GET['codigoperiodofinal'];	
	$campo='menu_fila'; $parametros="'codigoperiodofinal','".$codigoperiodofinal."',''";
