    			...
    			foreach ($list as $xs) {
		            ...
		            foreach ($xs->imports as $ns2 => $list2) {
		                for ($ii = 0; $ii < count($list2); $ii++) {
		                	if (! $list2[$ii]['loaded']) {
						//ESTA LINEA SE COMENTO DEBIDO AL WARNING QUE ESTABA SALIENDO SEGUN LO Q SE INVESTIGO ESTO SE DEBE A LA VERSION DE PHP Y LA LINEA DEL FOR FUNCIONA  COMO UN PARCHE.
		                		//$this->schemas[$ns]->imports[$ns2][$ii]['loaded'] = true;
						//EL FOR REEMPLAZA LA LINEA DE ARRIBA COMENTADA EN CASO DE QUE PASE ALGO DESCOMENTAR LA LINEA DE ARRIBA Y COMENTAR EL FOR.
