...
$query="select coalesce(sum(valorconcepto),0) as vlr_saldoafavor from detalleordenpago where codigoconcepto in ('007','C9022','C9022','C9061', 'C9062', 'C9063', 'C9067', 'C9068','114','996', 'C9037','C9049','C9050','C9051','C9052','C9053','C9054','C9055','C9060','C9065') and numeroordenpago='".$datos['numeroordenpago']."'";
$exec = mysql_query($query, $sala) or die("$query" . mysql_error());
$row=mysql_fetch_array($exec);
$vlr_saldoafavor_cc=$row['vlr_saldoafavor'];


$query="select tipocuenta from (select numeroordenpago,codigoconcepto from detalleordenpago where codigoconcepto not in ('007','C9022','C9022','C9061', 'C9062', 'C9063', 'C9067', 'C9068','114','996', 'C9037','C9049','C9050','C9051','C9052','C9053','C9054','C9055','C9060','C9065')) dop join carreraconceptopeople ccp on dop.codigoconcepto=ccp.codigoconcepto where numeroordenpago='".$datos['numeroordenpago']."' group by tipocuenta";
$exec = mysql_query($query, $sala) or die("$query" . mysql_error());
...
if(in_array("MAT",$arrTiposCuenta)) {
	...
	$query="SELECT	 COALESCE(ccp.itemcarreraconceptopeople,ccp2.itemcarreraconceptopeople) as itemcarreraconceptopeople
			...
			,dop.valorconcepto 
		FROM (select numeroordenpago,valorconcepto,codigoconcepto from detalleordenpago where codigoconcepto not in ('007','C9022','C9022','C9061', 'C9062', 'C9063', 'C9067', 'C9068','114','996', 'C9037','C9049','C9050','C9051','C9052','C9053','C9054','C9055','C9060','C9065')) as dop 
	...
	if(mysql_num_rows($exec)==0) {
		$query2="SELECT	 COALESCE(ccp.itemcarreraconceptopeople,ccp2.itemcarreraconceptopeople) as item_ccp
			...
			LEFT JOIN carreraconceptopeople ccp ON dop.codigoconcepto=ccp.codigoconcepto and ".$datos['codigocarrera']."=ccp.codigocarrera
			LEFT JOIN carreraconceptopeople ccp2 ON dop.codigoconcepto=ccp2.codigoconcepto AND 1=ccp2.codigocarrera
			LEFT JOIN (     select distinct f.numeroordenpago, f.fechaordenpago, f.porcentajefechaordenpago, f.valorfechaordenpago+$vlr_saldoafavor_cc as valorfechaordenpago, '010210020002' as itempagoextraordinario
	...
	*/
	...
	$query="select count(*) as conteo from (select numeroordenpago,codigoconcepto from detalleordenpago where codigoconcepto not in ('007','C9022','C9022','C9061', 'C9062', 'C9063', 'C9067', 'C9068','114','996', 'C9037','C9049','C9050','C9051','C9052','C9053','C9054','C9055','C9060','C9065')) dop join concepto c on dop.codigoconcepto=c.codigoconcepto where numeroordenpago ='".$datos['numeroordenpago']."' and cuentaoperacionprincipal='153' and cuentaoperacionparcial='0001'";
	$exec = mysql_query($query, $sala) or die("$query" . mysql_error());
	$row=mysql_fetch_array($exec);
	if($row['conteo']>0) {
...
if($band==0) {
	...
	$result = array("ERRNUM"=>"66","DESCRLONG"=>"No se reporta a PS, orden de plan de pago");
	$query="INSERT INTO logtraceintegracionps (transaccionlogtraceintegracionps,enviologtraceintegracionps,respuestalogtraceintegracionps,documentologtraceintegracionps) VALUES ('Creacion Orden Pago','".$xml."','id:".$result['ERRNUM']." descripcion: ".$result['DESCRLONG']."',".$datos['numeroordenpago'].")";
	$orden = mysql_query($query, $sala) or die("$query" . mysql_error());
}
