...
{ 
    ...
    if (tipo == 1)
	{
		window.location.href="modificarhistoricobusquedamedicina.php?busqueda=nombre"; 
	} 
    if (tipo == 2)
	{
		window.location.href="modificarhistoricobusquedamedicina.php?busqueda=apellido"; 
	} 
    if (tipo == 3)
	{
		window.location.href="modificarhistoricobusquedamedicina.php?busqueda=documento"; 
    } 
...
{ 
    ...
    if (busca != 0)
	{
		window.location.reload("modificarhistoricobusquedamedicina.php?buscar="+busca); 
	} 
} 
</script>
<body>
<div align="center" class="Estilo1">
<form name="f1" action="modificarhistoricobusquedamedicina.php" method="get" onSubmit="return validar(this)">
...
<?php
	...
	if(!$vacio)
	{
		...
		while($solicitud = mysql_fetch_assoc($res_solicitud))
		{
			...
			$fac = $car;
			echo "<tr>
				<td><a href='modificahistoricoformulariomedicina.php?codigoestudiante=$cod&documento=$cc&facultad=$fac'>$est&nbsp;</a></td>
				<td>$cc&nbsp;</td>
				<td>$nombrecarrera&nbsp;</td>				
			</tr>";
		}
...
function recargar()
{
	window.location.href="modificarhistoricobusquedamedicina.php";
}
</script>
</html>