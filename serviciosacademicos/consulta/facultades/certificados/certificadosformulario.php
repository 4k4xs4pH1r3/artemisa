<?php
    ...
    include_once(PATH_ROOT."/serviciosacademicos/utilidades/ValidarSesion.php");
    $ValidarSesion = new ValidarSesion();
    $ValidarSesion->Validar($_SESSION);
    
    require_once(PATH_ROOT.'/serviciosacademicos/Connections/sala2.php');
    require(PATH_ROOT.'/serviciosacademicos/funciones/notas/funcionequivalenciapromedio.php');
    require (PATH_ROOT.'/serviciosacademicos/funciones/notas/redondeo.php');
    require (PATH_ROOT.'/serviciosacademicos/funciones/sala_genericas/FuncionesCadena.php');
    require ('../registro_graduados/carta_egresados/functionsElectivasPendientes.php');
    ...
    if($_GET['tipocertificado'] == "semestre") {
        echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=certificados_semestre/certificadosformulario.php?tipocertificado=semestre&codigo=".$_GET['codigo']."&fechaexpedicion=".$_GET['fechaexpedicion']."&concredito=".$_GET['concredito']."&tiponota=".$_GET['tiponota']."&ppsa=".$_GET['ppsa']."'>";
        exit();
    }

    require_once('nombrePromedio.php');

    //Consulta informacion del Secretario o secretaria General
    $query_secretario = "SELECT cargodirectivo from directivo where ".
    " cargodirectivo like '%GENERAL%' and cargodirectivo like '%SECRETAR%' and codigotipodirectivo = 100".
    " and fechavencimientodirectivo > now()";
    $arr_secretario=  $db->GetRow($query_secretario);
    ...
    $query_tipousuario = "SELECT codigotipousuariofacultad FROM usuariofacultad where usuario = '".$usuario."'";
    $row_tipousuario = $db->GetRow($query_tipousuario);
    $graduadoegresado = false;
    if($_GET['tipocertificado'] == "todo" || $_GET['tipocertificado'] == "pasadas") {
        ?>
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                <link type="text/css" rel="stylesheet" href="<?php echo HTTP_ROOT ?>/../../../../sala/assets/css/bootstrap.css">
            ...
            <body>
                ...
                <form name="form1" method="post" action="" id="form1">
                    ...
                    <?php
                    $query_historico = "SELECT c.nombrecortocarrera,eg.expedidodocumento,ti.nombretitulo, ".
                    " eg.numerodocumento, eg.nombresestudiantegeneral,eg.apellidosestudiantegeneral, ".
                    " e.codigoestudiante,e.codigosituacioncarreraestudiante, doc.nombredocumento, ".
                    " e.codigotipoestudiante,e.codigocarrera,c.codigomodalidadacademica, ".
                    " f.nombrefacultad,f.codigofacultad,eg.codigogenero,ti.nombreTituloGenero ".
                    " FROM estudiante e,carrera c,titulo ti,documento doc,estudiantegeneral eg, ".
                    " facultad f ".
                    " WHERE e.idestudiantegeneral = eg.idestudiantegeneral ".
                    " and e.codigoestudiante = '".$codigoestudiante."' ".
                    " AND eg.tipodocumento = doc.tipodocumento AND e.codigocarrera = c.codigocarrera ".
                    " AND c.codigotitulo = ti.codigotitulo AND f.codigofacultad = c.codigofacultad";
                    $solicitud_historico = $db->GetRow($query_historico);
                        ...
                        if($solicitud_historico['codigosituacioncarreraestudiante'] == 400) {
                            ...
                            <table width="80%"  border="0" align="center" cellpadding="0">
                                    ...
                                    <td colspan="7">
                                        <div align="center" class="Estilo1 Estilo2">
                                            ...
                                            if($row_tipousuario['codigotipousuariofacultad'] == 200 and !isset($_GET['periodos'])) {
                                                ...
                                                <?php
                                            }elseif($row_tipousuario['codigotipousuariofacultad'] == 100 and !isset($_GET['periodos'])) {
                                                ?>
                                                ...
                                                if(preg_match("/ESPECIALIZAC|MAESTRIA|DOCTORADO/",$solicitud_historico['nombrecortocarrera'])) {
                                                    ...
                                                    if(preg_match("/DOCTORADO/",$solicitud_historico['nombrecortocarrera'])) {
                                                        ?>DEL<?php echo $solicitud_historico['nombrecortocarrera']; ?><?php
                                                    }else {
                                                        ?>DE LA <?php echo $solicitud_historico['nombrecortocarrera']; ?><?php
                                                    }
                                                }else {
                                                    ?>SECRETARIO ACADÉMICO<br>DE LA <?php echo $solicitud_historico['nombrefacultad']; ?><?php
                                                }
                                                ?>
                                                </a></strong></span><br>
                                                En cumplimiento de lo dispuesto en el literal h) del art&iacute;culo 29 del Reglamento General de la Universidad<br>
                                                Vigilada Mineducación<?php
                                            }if ($_SESSION['rol'] <> 1 and !isset($_GET['periodos'])) {
                                                ?>
                                                <p class="Estilo3">HACE CONSTAR:</p>
                                                <p align="justify">Que <strong><?php echo $solicitud_historico['nombresestudiantegeneral'],"&nbsp;",$solicitud_historico['apellidosestudiantegeneral']; ?></strong>,
                                                    identificado(a) con <?php echo $solicitud_historico['nombredocumento']; ?> No. <?php echo $solicitud_historico['numerodocumento']; ?> de <?php
                                                    echo $solicitud_historico['expedidodocumento']; ?><!-- , con c&oacute;digo estudiantil No. <?php //echo $solicitud_historico['codigoestudiante']; ?> -->, curs&oacute;
                                                <?php
                                            }
                                            if ($solicitud_historico['codigosituacioncarreraestudiante'] == 400 and $row_tipousuario['codigotipousuariofacultad'] == 200 and !isset($_GET['periodos'])) {
                                                ?>
                                                y aprob&oacute; las asignaturas correspondientes al programa de <?php echo $solicitud_historico['nombrecortocarrera']; ?>, y obtuvo el t&iacute;tulo de <strong><?php echo $tituloObtener; ?></strong>.</p>
                                                <?php
                                            } else if ($solicitud_historico['codigosituacioncarreraestudiante'] <> 400 and $_SESSION['rol'] <> 1 and !isset($_GET['periodos'])) {
                                                ?>
                                ...
                                if (! isset ($_GET['totalperiodos']) ) {
                                    $query_historicoperiodos = "SELECT distinct n.codigoperiodo, p.nombreperiodo, ".
                                    ...
                                    " and e.codigoestudiante = n.codigoestudiante and e.codigocarrera = cp.codigocarrera ".
                                    " and cp.codigoperiodo = p.codigoperiodo and n.codigoperiodo = cp.codigoperiodo ".
                                    " and n.codigoestadonotahistorico like '1%' order by 1";//sirve app movil
                                ...
                                for ($i=1;$i<=$_GET['totalperiodos'];$i++) {
                                    if ($_GET["periodo".$i] == true) {
                                        ...
                                        if ($_GET['tipocertificado'] == "todo") {
                                            ...
                                            " m.nombremateria,m.codigomateria,n.codigomateriaelectiva, ".
                                            " n.notadefinitiva,c.nombrecortocarrera,eg.expedidodocumento,ti.nombretitulo,".
                                            " t.nombretiponotahistorico,eg.nombresestudiantegeneral, ".
                                            " eg.apellidosestudiantegeneral,e.codigoestudiante,eg.numerodocumento, ".
                                            " (m.ulasa+m.ulasb+m.ulasc) AS total,m.codigoindicadorcredito, ".
                                            " m.numerocreditos,pe.nombreperiodo,doc.nombredocumento, ".
                                            " e.codigotipoestudiante,n.codigotiponotahistorico, ".
                                            " m.codigotipocalificacionmateria ".
                                            " FROM notahistorico n,materia m,tiponotahistorico t,estudiante e,".
                                            " carrera c,titulo ti,periodo pe,documento doc,estudiantegeneral eg ".
                                            " WHERE e.idestudiantegeneral = eg.idestudiantegeneral ".
                                            ...
                                            " and m.codigomateria = n.codigomateria and pe.codigoperiodo = n.codigoperiodo ".
                                            " AND pe.codigoperiodo = '".$_GET["periodo".$i]."' ".
                                            " and c.codigotitulo = ti.codigotitulo ORDER BY 1,2";
                                        ...
                                        }else if ($_GET['tipocertificado'] == "pasadas") {
                                            $query_historico = "SELECT 	n.idnotahistorico, n.codigoperiodo, ".
                                            " m.nombremateria,m.codigomateria,n.codigomateriaelectiva, ".
                                            " n.notadefinitiva,c.nombrecortocarrera,eg.expedidodocumento, ".
                                            " ti.nombretitulo, t.nombretiponotahistorico,eg.nombresestudiantegeneral, ".
                                            " eg.apellidosestudiantegeneral,e.codigoestudiante,eg.numerodocumento, ".
                                            " (m.ulasa+m.ulasb+m.ulasc) AS total,m.codigoindicadorcredito, ".
                                            " m.numerocreditos,pe.nombreperiodo,doc.nombredocumento, ".
                                            " e.codigotipoestudiante, n.codigotiponotahistorico, ".
                                            " m.codigotipocalificacionmateria, CASE n.notadefinitiva > '5' ".
                                            " WHEN 0 THEN n.notadefinitiva WHEN 1 THEN n.notadefinitiva / 100 * 1 ".
                                            " END AS notadefinitiva, CASE m.notaminimaaprobatoria > '5' ".
                                            " WHEN 0 THEN m.notaminimaaprobatoria ".
                                            " WHEN 1 THEN m.notaminimaaprobatoria / 100 * 1 END AS notaminimaaprobatoria ".
                                            " FROM notahistorico n,materia m,tiponotahistorico t,estudiante e, ".
                                            " carrera c,titulo ti,periodo pe,documento doc,estudiantegeneral eg ".
                                            " WHERE e.idestudiantegeneral = eg.idestudiantegeneral ".
                                            " AND n.codigoestudiante = '".$codigoestudiante."' ".
                                            ...
                                            " AND m.codigomateria = n.codigomateria AND pe.codigoperiodo = n.codigoperiodo ".
                                            " AND pe.codigoperiodo = '".$_GET["periodo".$i]."' ".
                                            " AND c.codigotitulo = ti.codigotitulo GROUP BY 1 ".
                                            " HAVING notadefinitiva >= notaminimaaprobatoria ORDER BY 1,2";
                                            $res_historico = mysql_query($query_historico, $sala) or die("$query_historico".mysql_error());
                                            $solicitud_historico = mysql_fetch_assoc($res_historico);
                                        }
                                        do {
                                            ...
                                            $mostrarpapa = "";
                                            if ($_GET['tipocertificado'] == "todo") {
                                                $query_materia = "SELECT * FROM notahistorico "."
                                                    WHERE codigoperiodo = '".$solicitud_historico['codigoperiodo']."'
                                                    AND codigoestudiante = '".$codigoestudiante."'
                                                    AND codigoestadonotahistorico LIKE '1%'";//sirve app movil
                                            ...
                                            if($totalRows_materiaelectiva != "") {
                                                ...
                                                $mostrarpapa = $row_materiaelectiva['nombremateria'];
                                            }else {
                                                //Valiadacion de padre con estado 1
                                                $sqlpadre = "SELECT DISTINCT m.codigomateria, m.nombremateria ".
                                                " FROM detallelineaenfasisplanestudio d, materia m WHERE ".
                                                " d.codigomateriadetallelineaenfasisplanestudio = ".
                                                " '".$solicitud_historico['codigomateria']."' AND m.codigomateria = d.codigomateria";
                                                $materiapadre = mysql_query($sqlpadre, $sala) or die("$sqlpadre".mysql_error());
                                                $row_materiapadre = mysql_fetch_assoc($materiapadre);
                                                if($row_materiapadre != '')
                                                {
                                                  $mostrarpapa = $row_materiapadre['nombremateria'];
                                                }else{
                                            ...
                                            if ($periodo <> $solicitud_historico['codigoperiodo']) {
                                                ...
                                                <tr>
                                                    <td colspan="7"><span class="Estilo1 Estilo2">
                                                        <strong><?php echo $solicitud_historico['nombreperiodo'];?></strong>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <?php
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <span class="Estilo1 Estilo2"><?php echo $solicitud_historico['codigomateria'];?></span>
                                                </td>
                                                <td>
                                                    <span class="Estilo1 Estilo2"><?php if ($mostrarpapa <> "") echo "$mostrarpapa /  ";
                                                    ...
                                                    if ($row_detallemateria <> "") {
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0">
                                                            ...
                                                            do {
                                                                ...
                                                                <tr>
                                                                    <td class="Estilo10">
                                                                        - <?php echo $row_detallemateria['descripciontemasdetalleplanestudio'];?>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                            ...
                                            if ($cuentacambioperiodo == $totalRows) {
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <span class="Estilo2 Estilo1">
                                                            <strong><?php echo $nombrePromPonderado; ?></strong></span>
                                                    </td>
                                                    <?php
                                                    if($_GET['concredito'] == 1) {
                                                        ...
                                                        <td>
                                                            <div align="center">
                                                                <span class="Estilo2 Estilo1">
                                                                    <strong><?php echo $sumaulas;?></strong>
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div align="center">
                                                                <span class="Estilo2 Estilo1">
                                                                    <strong><?php echo $sumacreditos;?></strong>
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <?php
                                                    ...
                                                    <td>
                                                        <div align="center">
                                                            <span class="Estilo2 Estilo1"><strong>
                                                            <?php
                                                ...
                                                if($_GET['ppsa'] == 3) {
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <span class="Estilo2 Estilo1">
                                                                <strong><?php echo $nombrePromPonderadoAcumulado; ?></strong>
                                                            </span>
                                                        </td>
                                                        <?php
                                                        if($_GET['concredito'] == 1) {
                            ...
                            <tr>
                                ...
                                if($carreraestudiante == 10) {
                                    ...
                                    <td colspan="2">
                                        <span class="Estilo2 Estilo1">
                                            <strong>Promedio Ponderado Acumulado a <?php echo $nombreultimoperiodo;
                                        ?></strong></span>
                                    </td>
                                    <?php
                                }else {
                                    ?>
                                    <td colspan="2">
                                        <br><span class="Estilo2 Estilo1">
                                            <strong>Promedio Ponderado Acumulado </strong></span>
                                    </td>
                                    <?php
                                }
                                ?>
            ...
            <?php
            if ($_SESSION['rol'] <> 1 and !isset($_GET['periodos'])) {
                $query_detallemateria = "select * from  carrerarangonota cr,estudiante e ".
                " where e.codigoestudiante='".$codigoestudiante."' and e.codigocarrera=cr.codigocarrera ".
  	...
  	De conformidad con lo dispuesto   <?php echo $articulo; ?> , la escala de calificaciones que aplica la Institución est&aacute; dentro de un rango de cero punto cero (0.0) a cinco punto cero (5.0) y la calificación m&iacute;nima aprobatoria es de <?php echo "$notaletra ($notanumero)"; ?> sobre cinco punto cero (5.0).</p>
                <p align="justify" class="Estilo1 Estilo2">La presente certificaci&oacute;n se expide a solicitud del interesado(a), en Bogot&aacute; D.C., a los
                            ...
                            <table id='firmaDirectivos' style='width:100%'>
                                <tr>
                                <?php
                                $query_responsable = "SELECT * FROM directivo d,directivocertificado di,certificado c ".
	                            " WHERE d.codigocarrera = '".$codigocarrera."' AND d.iddirectivo = di.iddirectivo ".
	                            ...
	                            " AND c.idcertificado = '2' ORDER BY fechainiciodirectivo";
                                ...
                                do {
                                    ?>
                                    <td>
                                        <p class="Estilo1 Estilo2">
                                            <strong>
                                                <a class="Estilo4"style='cursor: pointer' onClick='JavaScript:window.print()' ><?php echo $row_responsable['nombresdirectivo'],"&nbsp;",$row_responsable['apellidosdirectivo'];?>
                                                </a>
                                                <br>
                                                <?php
                                ...
                                }while($row_responsable = mysql_fetch_assoc($responsable) and $_GET['tipocertificado'] !== 'pasadas');
                                ?>
                            </tr>
                        </table>
                    </td>
...
if($_GET['tipocertificado'] == "reglamento" || $_GET['tipocertificado'] == "equivalencias") {
    if(isset($_GET['periodos'])) {
        $query_selperiodos = "SELECT distinct codigoperiodo from notahistorico ".
	    " where codigoestudiante = '".$codigoestudiante."' order by 1";
	...
	$query_electivasLibresVistas = getQueryMateriasElectivasCPEstudiante($codigoestudiante, true);
	$electivasLibresVistas = mysql_query($query_electivasLibresVistas, $sala) or die(mysql_error()." Query=".$query_electivasLibresVistas);
	$electivasLibresVistas = mysql_fetch_assoc($electivasLibresVistas);
	$query_electivasRequeridasPlanEstudio = getCreditosElectivasPlanEstudio($codigoestudiante,null,true);
	$electivasRequeridasPlanEstudio = mysql_query($query_electivasRequeridasPlanEstudio, $sala) or die(mysql_error()." Query=".$query_electivasRequeridasPlanEstudio);
	$electivasRequeridasPlanEstudio = mysql_fetch_assoc($electivasRequeridasPlanEstudio);
	$queryComplemento = "AND ((";
	
	$queryComplemento .= "n.codigomateriaelectiva<>1 and n.notadefinitiva>=m.notaminimaaprobatoria
        OR (dp.codigotipomateria <> 4 AND n.notadefinitiva >= m.notaminimaaprobatoria)
		OR (dp.codigotipomateria <> 4	
			AND n.notadefinitiva < m.notaminimaaprobatoria
			AND n.codigomateriaelectiva NOT IN (SELECT nh.codigomateriaelectiva 
			FROM notahistorico nh 
			INNER JOIN materia m on nh.codigomateria = m.codigomateria  
			AND nh.notadefinitiva >= m.notaminimaaprobatoria
			WHERE
				n.codigoestudiante = '$codigoestudiante')
			)		
		) OR n.codigomateriaelectiva=1)";
	
    $query_materiashistorico = "select n.codigomateria, n.notadefinitiva, case n.notadefinitiva > '5'
	when 0 then n.notadefinitiva
	when 1 then n.notadefinitiva / 100
	end as nota, n.codigoperiodo, m.nombremateria, n.codigomateriaelectiva 
	...
	LEFT JOIN detalleplanestudio dp ON dp.idplanestudio = pe.idplanestudio 
	AND dp.codigomateria = n.codigomateriaelectiva
	where n.codigoestudiante = '$codigoestudiante'
	AND codigoestadonotahistorico LIKE '1%' 
	$queryComplemento 
	order by 5, 3 ";
	...
	if($_GET['tipocertificado'] == "equivalencias"){
		 $query_materiashistorico = "select 
		IF(rpe.codigomateria IS NULL, n.codigomateria,rpe.codigomateria) as codigomateria,
		MAX(n.notadefinitiva) as notadefinitiva, 
		case n.notadefinitiva > '5' when 0 then MAX(n.notadefinitiva) when 1 then n.notadefinitiva / 100 end as nota, 
		n.codigoperiodo, 
		IF(rpe.codigomateria IS NULL, m.nombremateria,m2.nombremateria) as nombremateria, n.codigomateriaelectiva 
		from notahistorico n
		INNER JOIN materia m on n.codigomateria = m.codigomateria 
		INNER JOIN planestudioestudiante pe on pe.codigoestudiante = n.codigoestudiante
		AND pe.codigoestadoplanestudioestudiante <> 200
		INNER JOIN referenciaplanestudio rpe on rpe.codigomateriareferenciaplanestudio=m.codigomateria 
		AND rpe.codigoestadoreferenciaplanestudio like '1%' AND rpe.idplanestudio=pe.idplanestudio
		INNER JOIN materia m2 on m2.codigomateria=rpe.codigomateria 
		LEFT JOIN detalleplanestudio dp ON dp.idplanestudio = pe.idplanestudio 
		where n.codigoestudiante = '$codigoestudiante' 
		AND codigoestadonotahistorico LIKE '1%' 
		$queryComplemento 
		GROUP BY codigomateria,n.codigoperiodo 
		...
		case n.notadefinitiva > '5' when 0 then MAX(n.notadefinitiva) when 1 then n.notadefinitiva / 100 end as nota, 
		n.codigoperiodo, 
		m.nombremateria, n.codigomateriaelectiva 
		from notahistorico n
		INNER JOIN materia m on n.codigomateria = m.codigomateria 
		INNER JOIN planestudioestudiante pe on pe.codigoestudiante = n.codigoestudiante
		AND pe.codigoestadoplanestudioestudiante <> 200
		...
		AND (dp.codigomateria = n.codigomateriaelectiva 
			OR dp.codigomateria=n.codigomateria)
		where n.codigoestudiante = '$codigoestudiante'
		AND codigoestadonotahistorico LIKE '1%' 
		$queryComplemento 
		GROUP BY codigomateria,n.codigoperiodo
    ...
    while($row_materiashistorico = mysql_fetch_assoc($materiashistorico)) {
        ...
        if($materiapapaito = seleccionarequivalenciapapa($row_materiashistorico['codigomateria'],$codigoestudiante,$sala)) {
			...
			if($_GET['tipocertificado'] == "equivalencias"){
				$row_materiashistorico['notadefinitiva']=$row_mejornota['notadefinitiva'];
				$row_materiashistorico['nota'] =  $row_mejornota['nota'];
				$Array_materiashistorico[$row_materiashistorico['codigomateria']] = $row_materiashistorico;
			} else {
				$Array_materiashistorico[$row_mejornota['codigomateria']] = $row_mejornota;
			}
        }
        else {
			...
			if($_GET['tipocertificado'] == "equivalencias"){
				if($row_materiashistorico['codigomateriaelectiva']<>1){
					if(isset($arregloElectivas[$row_materiashistorico['codigomateriaelectiva']])){
						if($arregloElectivas[$row_materiashistorico['codigomateriaelectiva']]['notadefinitiva']<$row_materiashistorico['notadefinitiva']){
							//elimino la electiva anterior para no pintarla
							unset($Array_materiashistorico[$arregloElectivas[$row_materiashistorico['codigomateriaelectiva']]['codigomateria']]);
							//reemplazo la electiva con mayor nota
							$arregloElectivas[$row_materiashistorico['codigomateriaelectiva']]=$Array_materiashistorico[$row_materiashistorico['codigomateria']];
						} else {
							unset($Array_materiashistorico[$row_materiashistorico['codigomateria']]);
						}
					} else {
						$arregloElectivas[$row_materiashistorico['codigomateriaelectiva']]=$Array_materiashistorico[$row_materiashistorico['codigomateria']];
					}
   ...
   $Array_materiashistoricoinicial = $Array_materiashistorico;
    ...
    foreach($Array_materiashistorico as $codigomateria => $row_materia) {
        ...
        $cadenamateria2 = "$cadenamateria2 ( (n.codigomateria = '".$row_materia['codigomateria']."' or rpe.codigomateria= '".$row_materia['codigomateria']."') and (n.notadefinitiva = '".$row_materia['nota']."' or n.notadefinitiva = '$otranota')) or";
    ...
    $cadenamateria2 = $cadenamateria2."fin";
    $cadenamateria2 = ereg_replace("orfin","",$cadenamateria2);
