    ...
    <table width="80%"  border="0" align="center" cellpadding="0">
        <tr>
            <td colspan="7"><div align="center" class="Estilo1 Estilo2">
                    <p>
                                <?php if($row_tipousuario['codigotipousuariofacultad'] == 200 and !isset($_GET['periodos'])) { ?>
        ...
        echo $dias; ?> (<?php echo $ano;?>).</p>
            ...
            ?>
                        <td>
                            ...
                            <?php echo $row_responsable['cargodirectivo']; ?></strong></td>
                            <?php
