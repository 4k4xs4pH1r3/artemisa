...
{
 echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=certificados_semestre/certificadosformulario.php?tipocertificado=semestre&codigo=".$_GET['codigo']."&concredito=".$_GET['concredito']."&tiponota=".$_GET['tiponota']."'>";
 exit();
}
...
<?php 
	    ...
	    { 
?>
	     <span class="Estilo4"><strong><a class="Estilo4"style="cursor: pointer" onClick="window.location.href='../../prematricula/matriculaautomaticaordenmatricula.php?programausadopor=facultad'">EL SUSCRITO</a></strong></span><br>
...
?>
	<tr>
      ...
      <td><span class="Estilo1 Estilo2"><?php if ($mostrarpapa <> "") echo "$mostrarpapa /  "; echo $solicitud_historico['nombremateria'].$lugaresderotacion;?>
	  <?php 
...
<?php
					...
					{	
                        ...
                        $promediosemestralperiodo = PeriodoSemestralTodo($codigoestudiante,$periodosemestral,$_GET['tipocertificado'],$sala);
?>
    <tr>
...
<tr>
  <td colspan="7">
  	...
  	De conformidad con lo dispuesto en el art&iacute;culo 51 del reglamento estudiantil de la Universidad, la escala de calificaciones que aplica la Institución est&aacute; dentro de un rango de cero punto cero (0.0) a cinco punto cero (5.0) y la calificación m&iacute;nima aprobatoria es de <?php echo "$notaletra ($notanumero)"; ?> sobre cinco punto cero (5.0).</p>
...
<? 
	...
	require('convertirnumeros.php'); 
	echo $dias;
?> (<?php echo $dia;?>) d&iacute;as del mes de <?php echo $meses;?> (<?php echo $mes;?>) del a&ntilde;o dos mil <?php $day = substr($ano,3,4); require('convertirnumeros.php'); echo $dias; ?> (<?php echo $ano;?>).</p>
