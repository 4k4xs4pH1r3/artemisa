...
$factura->SetFont('Arial','B',6);
$factura->SetY(2.3);
$factura->Cell(8,0.3,"RECIBO DE PAGO No.      ".$numeroordenpago,1,1,'L');
$factura->SetFont('Arial','',6);
$factura->Cell(8,0.3,"PROGRAMA: ".$datos->estudiante['codigosucursal']."-".$datos->estudiante['centrocosto']." ".$datos->estudiante['nombrecarrera'],1,1,'L');
...
$factura->Cell(1.5,0.3,"NOMBRE: ",1,0,'C');
$factura->Cell(9.5,0.3,$datos->estudiante['nombre'],1,1,'C');
$factura->Cell(11,0.3,"PROGRAMA:             ".$datos->estudiante['codigosucursal']."-".$datos->estudiante['centrocosto']." ".$datos->estudiante['nombrecarrera'],1,1,'L');
