...
function seleccionaCarrera(codigocarrera){
	http.open('post','cambiacarrera.php?codigocarrera='+codigocarrera);
	http.onreadystatechange=function handler(){
		if(http.readyState==4 && http.status==200){
			hRefIzq('facultadesl_alt.php');
...
<?php
if(!empty($_SESSION['codigo']) and !empty($_SESSION['rol']))
{
	...
	function sndReq(action) {
		http.open('get', 'centralTimer.php');
	...
	if(!empty($numerodocumento)){
		...
		if($cantVotos==0){
			$_SESSION['datosvotante']=array('codigoestudiante'=>$_SESSION['codigo'],'numerodocumento'=>$numerodocumento,'codigocarrera'=>$codigocarrera,'tipovotante'=>$tipovotante,'cantVotos'=>$cantVotos);
		}
	}
	}
...
<br>
<br>
<div id="bienvenidaTEXTO" style="position:absolute; width:200px; height:115px; z-index:2; left: 370px; top: 199px;"><img src="imagesAlt2/segundac.gif" ></div>
<?php if(!empty($idvotacion)){?>
<p><br>
...
<table width="500" border="0">
  <tr><?php if($cantVotos==0){?>
    <td width="154"><div align="right"><br>
      ...
      <br>
      <br>
      <a href="../votaciones/datosVotacion.php"><img src="vote.jpg" width="110" height="78"></a></td><?php }else{echo "Usted ya votó";}?>
    <td width="330"><div align="center" id="bienvenida"><img src="urna.jpg" width="200" height="211"></div></td>
  </tr>
</table>
<p>&nbsp;</p>
<?php }?>
