<?php /* Smarty version 2.3.0, created on 2008-04-08 16:42:37
         compiled from Default/take_survey_question_S.tpl */ ?>
<div class="whitebox">
...
?>
    <p><input type="text" name="answer[<?php echo $this->_tpl_vars['q']['qid']; ?>
][<?php echo $this->_sections['na']['index']; ?>
]" size="50" value="<?php echo $this->_tpl_vars['q']['answer'][$this->_sections['na']['index']]; ?>
"></p>
  <?php endfor; endif; ?>
</div>