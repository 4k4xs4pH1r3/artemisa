...
function validacion_plan_de_pagos($codigoestudiante,&$plandepagosvencidos)
   ...
   /* if(strcmp($_SERVER["SERVER_ADDR"], "172.16.3.248")==0 || strcmp($_SERVER["SERVER_ADDR"], "172.16.3.227")==0){
        /************** PRE PRODUCCION ***********************/
    /*    $client = new soapclient("http://pswebserver2.unbosque.edu.co:8055/PSIGW/PeopleSoftServiceListeningConnector/UBI_ESTADO_CUENTA_SRV.1.wsdl", true);
    }
    else{
        /************** PRODUCCION ***********************/
    /*    $client = new soapclient("http://campus.unbosque.edu.co/PSIGW/PeopleSoftServiceListeningConnector/UBI_ESTADO_CUENTA_SRV.1.wsdl", true);
