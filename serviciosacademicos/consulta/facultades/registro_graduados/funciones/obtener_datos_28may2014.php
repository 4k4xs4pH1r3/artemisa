...
class datos_registro_graduados
{
	...
	function obtener_codigos_estudiante_egresados()
	{
		foreach ($this->array_obtener_carreras as $llave => $valor)
		{
			...
			FROM registrograduado rg, estudiante e, autorizacionregistrograduado arg, estado est, tiporegistrograduado trg, 
                        carrera c, estudiantegeneral eg, genero gen 
			WHERE 
			e.codigoestudiante=rg.codigoestudiante
			AND eg.idestudiantegeneral=e.idestudiantegeneral
                        AND gen.codigogenero=eg.codigogenero 
