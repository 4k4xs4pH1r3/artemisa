...
if(isset($_GET['documento'])){
	...
	$query_buscaincentivos="select * from documentograduado where idregistrograduado='".$_GET['idregistrograduado']."' and codigoestado='100' and codigotipodocumentograduado='3' and idincentivoacademico='$idincentivoacademico' and idregistroincentivoacademico='$idregistroincentivoacademico'";
	//echo $query_buscaincentivos,"<br>";
...
if(isset($_POST['Enviar']))
{
	/*if($totalrows_buscaincentivos==0){
		...
		*/foreach($_POST as $vpost => $valor)
		...
		echo '<script language="javascript">alert("Datos ingresados correctamente")</script><script language="javascript">window.close();</script>';echo '<script language="javascript">window.opener.recargar();</script>';
	/*}*/
}
?>
