...
AND date(n.fechaprocesonotahistorico) = '".date("Y-m-d")."'
...
if ($row_generado <> "")
 {
   //echo '<script language="JavaScript">alert("El Cierre Académico en este momento se esta generando, y puede tardar varios minutos"); history.go(-1);</script>';
    echo '<script language="JavaScript">alert("El Cierre Académico No se puede realizar, se han realizado modificaciones en el Historico de notas d\u00cda de hoy"); history.go(-1);</script>';
   exit();
 }   
	   mysql_select_db($database_sala, $sala);
