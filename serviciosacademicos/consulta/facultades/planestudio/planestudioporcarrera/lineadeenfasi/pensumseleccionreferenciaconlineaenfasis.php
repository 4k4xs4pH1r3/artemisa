...
<TR><TD align="center"><p align="center"><strong><h3>PLAN DE ESTUDIO CON LA LINEA DE ENFASIS <?php echo strtoupper($row_planestudio['nombrelineaenfasisplanestudio']); ?></h3></strong></p></TD></TR>
</table>

<table width="780"  cellpadding="2" cellspacing="1" >
  <tr bgcolor="#C5D5D6">
...
<table width="1100" border="1" cellspacing='0' bordercolor='#FFE6B1'>
  <tr id="trgris">
<?php
$hayelectiva = false;
  ...
  <tr>
	...
	for($columnamateria=1; $columnamateria<=$row_planestudio['cantidadsemestresplanestudio']; $columnamateria++)
	{
		...
		if($codmateria != "")
		{
			...
			// En el if imprime las materias que no son líneas de énfasis
			//if(!$tieneenfasislocal)
			//{
?>
...
?>
  ...
  <tr>
    <td colspan="<?php echo $row_planestudio['cantidadsemestresplanestudio'];?>" align="center"><table border="1" class="Estilo2" cellpadding="2" cellspacing="1" bordercolor="B0B6C2">
        <tr>
          <td>
		  <table border="1" class="Estilo2" width="104" height="50" cellpadding="2" cellspacing="1" bordercolor="#B0B6C2">
              <tr>
...
&nbsp;</td>
		  ...
		  <table align="center" border="0" height="80">
              ...
              <tr>
                <td bgcolor="#B9B9FF" colspan="2"><strong>Prerequisitos, Corequisitos y Equivalencias</td>
              </tr>
          </table>
		  </td>
<?php
