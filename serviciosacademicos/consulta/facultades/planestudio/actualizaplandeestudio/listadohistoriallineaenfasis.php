...
$query="select p.nombreplanestudio, l.nombrelineaenfasisplanestudio,le.codigoestudiante,
le.fechaasignacionfechainiciolineaenfasisestudiante, le.fechainiciolineaenfasisestudiante,
le.fechavencimientolineaenfasisestudiante  from 
lineaenfasisestudiante le,planestudio p, lineaenfasisplanestudio l where
codigoestudiante='".$_GET['codigoestudiante']."' and
l.idlineaenfasisplanestudio=le.idlineaenfasisplanestudio and
p.idplanestudio=le.idplanestudio ";
