...
<body>
<div align="center">
<form action="nuevoplanestudioestudiante.php?<?php echo "estudiante=".$_GET['estudiante']."&planestudio=".$_GET['planestudio']."";?>" method="post" name="f1">
...
if(isset($_POST['aceptar']))
{
	if($formulariovalido)
	{
		...
		VALUES('".$_GET['planestudio']."', '".$_GET['estudiante']."', '".date("Y-m-d",time())."', '$fechainicio', '$fechavencimiento', '101')";
