...
<table width="50%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td><table width="100%"  border="0">
      <tr>
        <td>N&uacute;mero de corte </td>
        <td>
          <input name="numerocorte" type="text" id="numerocorte">
        </td>
      </tr>
      <tr>
        <td>Semestre</td>
...
if(isset($_POST['Enviar']))
{
	...
	{ ?>
	    <script language="javascript">window.location.reload("certificado_notas_masivo.php?numerocorte=<?php echo $_POST['numerocorte']?>&semestre=<?php echo $_POST['semestre']?>&codigoestudiante=<?php echo $_GET['codigoestudiante']?>")</script>
	<?php }
	else
	{
