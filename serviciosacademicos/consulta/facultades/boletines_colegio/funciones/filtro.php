...
class filtro
{
	...
	function agregaragrupamiento($nombrecolumna)
	{
		$this->agrupamiento=$nombrecolumna;
	}
	function filtrar()
	{
		...
		if(isset($this->agrupamiento) and $this->agrupamiento!="")
		{
			//echo $this->agrupamiento;
			$query_filtro=$query_filtro." GROUP BY ".$this->agrupamiento;
		}
