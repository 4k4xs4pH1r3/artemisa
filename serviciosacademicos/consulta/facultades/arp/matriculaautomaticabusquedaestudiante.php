...
$graduar_estudiantes = "";
if(isset($_GET['graduar_estudiantes']))
{
	$graduar_estudiantes = "&graduar_estudiantes";
}
...
{ 
    ...
    if (tipo == 1)
	{
		window.location.reload("matriculaautomaticabusquedaestudiante.php?busqueda=nombre<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
	} 
    if (tipo == 2)
	{
		window.location.reload("matriculaautomaticabusquedaestudiante.php?busqueda=apellido<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
	} 
    if (tipo == 3)
	{
		window.location.reload("matriculaautomaticabusquedaestudiante.php?busqueda=codigo<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
    } 
    if (tipo == 4)
	{
		window.location.reload("matriculaautomaticabusquedaestudiante.php?busqueda=documento<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
    } 
} 
...
{ 
    ...
    if (busca != 0)
	{
		window.location.reload("matriculaautomaticabusquedaestudiante.php?buscar="+busca); 
	} 
} 
</script>
...
?>	  </select>
  ...
  <tr>
	...
	{
	?>
	<input type="hidden" name="graduar_estudiantes" value="<?php echo $_GET['graduar_estudiantes'];?>">
	<?php
	}
	?>
...
<?php
	...
	//{
		...
		while($solicitud = mysql_fetch_assoc($res_solicitud))
		{
			...
			//manda los parametros tal cual lo tenia fernando
			if(!isset($_GET['aplicaarp']) and !isset($_GET['graduar_estudiantes']))
			{
				echo "<tr>
					<td class='Estilo1'><a href='../facultades/creacionestudiante/estudiante.php?codigocreado=$codigoestudiante'>$nombre&nbsp;</a></td>
					<td class='Estilo1' align='center'>$numerodocumento&nbsp;</td>
					<td class='Estilo1'>$nombreperiodo&nbsp;</td>				
					</tr>";
			}
			
			elseif(isset($_GET['aplicaarp']))
			{
				echo "<tr>
					<td class='Estilo1'><a href='estudiantearpmenu.php?idestudiantegeneral=$idestudiantegeneral'>$nombre&nbsp;</a></td>
					<td class='Estilo1' align='center'>$numerodocumento&nbsp;</td>
					<td class='Estilo1'>$nombreperiodo&nbsp;</td>				
					</tr>";
			}
			
			elseif(isset($_GET['graduar_estudiantes']))
			{
				echo "<tr>
					<td class='Estilo1'><a href='../facultades/graduar_estudiantes/graduar_estudiantes_menu.php?codigoestudiante=$codigoestudiante'>$nombre&nbsp;</a></td>
					<td class='Estilo1' align='center'>$numerodocumento&nbsp;</td>
					<td class='Estilo1'>$nombreperiodo&nbsp;</td>				
					</tr>";
			}
