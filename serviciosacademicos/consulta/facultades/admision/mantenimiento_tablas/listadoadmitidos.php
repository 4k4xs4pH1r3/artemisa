...
$dataexcel->read('/tmp/admitidosadmision.xls');
	...
	//$array_internotmp2[$conarray]["segunda_opcion"]="";
	$array_internotmp2[$conarray]['estado']='ADMITIDO';
...
$tituloprincipal="UNIVERSIDAD EL BOSQUE\n".$datoscarrera["nombrecarrera"]." \nADMITIDOS EN PROCESO DE ADMISIONES PERIODO ".$_SESSION['admisiones_codigoperiodo']." \n ".$vigilada."  ";
...
$objetopdfhtml=new DocumentoPDF($tituloprincipal,'L');
    ...
    $objetopdfhtml->lineasxpagina=41;
...
{
	cargarresultados($cantidadestmparray,$_SESSION['admisiones_codigocarrera'],$_SESSION['admisiones_codigoperiodo'],'6',$objetobase);
	//unlink("/tmp/admitidosadmision.xls");
}
