...
echo "</pre>";*/
	...
	if(is_array($cantidadestmparray)){
		...
		{
			cargarresultados($cantidadestmparray,$rowcarreraspost['codigocarrera'],$_SESSION['admisiones_codigoperiodo'],'6',$objetobase);
		}
		/*echo "matrizcampos<pre>";
		print_r($objetopdfhtml->matrizcampos);
		echo "</pre>";*/
		$vigilada = utf8_decode("Vigilada Mineducación");
		$objetopdfhtml->tituloprincipal="UNIVERSIDAD EL BOSQUE\n".$rowcarreraspost["nombrecarrera"]." \n ADMITIDOS PROCESO DE ADMISIONES PERIODO ".$_SESSION['admisiones_codigoperiodo']." \n ".$vigilada."  ";
