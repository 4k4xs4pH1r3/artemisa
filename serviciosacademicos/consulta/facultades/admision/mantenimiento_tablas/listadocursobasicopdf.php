...
where
codigoestadoestudianteadmision = 102
...
$objetopdfhtml=new DocumentoPDF($tituloprincipal,'P');
    ...
    $objetopdfhtml->lineasxpagina=43;
...
{
	cargarresultados($cantidadestmparray,$_SESSION['admisiones_codigocarrera'],$_SESSION['admisiones_codigoperiodo'],'1',$objetobase);
}
