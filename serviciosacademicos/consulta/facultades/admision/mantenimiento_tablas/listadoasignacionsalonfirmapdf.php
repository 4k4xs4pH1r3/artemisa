...
$pdf->SetTitle('Listado Salon Firma');
$pdf->SetSubject('Listado Salon Firma');
...
foreach ($array_salones as $clave=>$valor) {
    ...
    <tr><td style="color:#40482D;font-size:1em;"><B>SALON '.$nombresalon[codigosalon].' FIRMAS</B></td></tr>
    <tr><td style="color:#40482D;font-size:1em;">'.$vigilada.'</td></tr></table><br>	';
    
    $html.='<table   border="1" CellPadding="4">
    <tr><td style="font-size:1em;" align="center" width="5%"><b>No.</b></td>
    <td style="font-size:1em;" align="center" width="15%"><b>DOCUMENTO</b></td>
    <td style="font-size:1em;" align="center" width="40%"><b>NOMBRE</b></td>
    <td style="font-size:1em;" align="center" width="9%"><b>SALON</b></td>
    <td style="font-size:1em;" align="center" width="31%"><b>FIRMA</b></td>
    </tr>';
	...
	$html.='<tr>
	<td style="font-size:1em;" align="center">'.$numeracion.'<br></td>
	<td style="font-size:1em;">'.$salonestudiante[numerodocumento].'<br></td>
	<td style="font-size:1em;">'.$salonestudiante[nombre].'<br></td>
	<td style="font-size:1em;">'.$salonestudiante[codigosalon].'<br></td>
...
$pdf->Output('Listado_Salon_Firma.pdf', 'I');
