...
$i=count($arrayponderado)-1;
foreach($arrayponderado as $llave=>$valorpuntaje){
	$array_interno[$llave]["Puesto"]=$i+1;
	$array_interno_nuevo[$i]=$array_interno[$llave];

	$i--;
}
/*echo "array_interno_nuevo<pre>";
print_r($array_interno_nuevo);
echo "</pre>";*/
return $array_interno_nuevo;
}
