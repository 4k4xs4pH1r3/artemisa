...
require_once('subirarchivoadmitidos.php' ); 
...
<body>
<h1 align="center">Carga Archivo Con Resultados de Admitidos en la Carrera <?php echo $datoscarrera["nombrecarrera"]?></h1>
<br>
...
<?php
echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=listadoadmitidos.php'>";
}
?>
</body>
</html>
