...
<br>
	<form action="subirarchivosegundoexamen.php" method="post" enctype="multipart/form-data">
	  <div align="center"> <input type="hidden" name="cadenatexto" size="20" maxlength="100">
            ...
            <br>
		    <br><br><br>
		    <input type="submit" value="Cargar Nuevo Archivo">&nbsp;<input type="button" value="Regresar" Onclick="window.location.reload('menuadministracionresultados.php')">
		</div>
	</form>
<b>Formato del archivo: </b>
<table><TR><TD>DOCUMENTO</TD><TD>SALON</TD><TD>EDIFICIO</TD><TD>FECHA</TD><TD>HORA</TD></TR></table>
<?php
