...
if($array_listado_asignacion_salones=$admisiones_consulta->GenerarArrayListadoAsignacionSalones($codigocarrera,$idsubperiodo)){
...
$tabla->agregarllave_emergente('codigosalon','listado_general.php','cambiosalon.php','idestudianteadmision','idestudianteadmision','idsubperiodo='.$idsubperiodo.'&codigocarrera='.$codigocarrera,670,300);
$tabla->agregarllave_emergente('nombre','listado_general.php','modificarestudianteadmision.php','idestudianteadmision','idestudianteadmision','idsubperiodo='.$idsubperiodo.'&codigocarrera='.$codigocarrera,670,300);
