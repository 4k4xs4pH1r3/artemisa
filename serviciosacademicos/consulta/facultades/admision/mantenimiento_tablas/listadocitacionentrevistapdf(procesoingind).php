	...
	if($confilas==0){
		...
		//echo "<br>$conarray)array_horario[$ch][$j]";
			...
			$cupomaximo=$array_horario[$ch][$j]['cupomaximosalon'];
				...
				unset($arrayinternotmp[$conarray]["genero"]);
						...
						/*SE COMENTA ESTA CONDICION PARA GENERAR EL PDF PARA EL PROCESO DE INGENIERIA INDUSTRIAL DEL PERIODO 20132 NOTA SE DEBE QUITAR EL COMENTARIO LUEGO DE QUE PASE ESTE PROCESO PARA NO AFECTAR LOS DEMAS PROCESOS.
