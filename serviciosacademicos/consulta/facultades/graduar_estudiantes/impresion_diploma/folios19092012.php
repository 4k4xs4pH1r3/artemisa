                ...
                <table width="50%"  border="1"  cellpadding="3" cellspacing="3">
                    ...
                    <tr>
                        <td colspan="7">
                            ...
                            <input type="button" name="generamasivo" value="Generar Masivo Diplomas" onclick="window.open('http://172.16.3.202/~dmolano/desarrollo/serviciosacademicos/consulta/diplomas/diplomas.php?desde=<?php echo $_REQUEST['desde']."&hasta=".$_REQUEST['hasta']."&registro=".$_REQUEST['registro']."&codigo=".$_REQUEST['codigo']."&nombreestudiante=".$_REQUEST['nombreestudiante']."&doc=".$_REQUEST['doc']."&titulo=".$_REQUEST['titulo']."&tipogeneracion=".$_REQUEST['tipogeneracion']; ?>')">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($_REQUEST['tipogeneracion']=="generacionestudiante" || $_REQUEST['tipogeneracion']=="generacionduplicado"){ ?>
                                <a target="_blank" id="aparencialink" href="http://172.16.3.202/~dmolano/desarrollo/serviciosacademicos/consulta/diplomas/diplomas.php?idregistrograduado=<?php echo $row_folio['idregistrograduado']."&codigomodalidadacademica=".$row_folio['codigomodalidadacademica']."&tipogeneracion=".$_REQUEST['tipogeneracion']; ?>"><?php echo $row_folio['nombre']; ?></a>
                            <?php
                            } else {
