...
e.idestudiantegeneral = eg.idestudiantegeneral order by nombre
";
}
else
{
...
*/
//echo "<h1>Este procedimiento puede demorar varios minutos, porfavor no oprima ning?n bot?n del explorador, hasta que aparezcan datos</h1>"
?>
...
echo "<div id='progress' style='position:relative;padding:0px;width:2048px;height:60px;left:25px;'>";
	...
	echo '<img src="barra.JPG">';
    	...
    	barra();
		//echo "documentos ",$pendiente_documentos," ",$row_egresados['numerodocumento'],"<br>";
...
if(isset($_GET['facultad'])){
echo '<script language="javascript">window.location.reload("tabla_elegibles_general.php?datos");</script>';
}
else
{
echo '<script language="javascript">window.location.reload("tabla_elegibles_general.php?cartas");</script>';
}
?>
