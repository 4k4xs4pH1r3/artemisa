...
if(isset($_GET['Enviar']))
{
	...
	{
		echo '<script language="javascript">window.location.href="registros_antiguos_lista.php?codigomodalidadacademica='.$_GET['codigomodalidadacademica'].'&codigocarrera='.$_GET['codigocarrera'].'&codigoperiodo='.$_GET['codigoperiodo'].'";</script>';
	}
	else
	{
