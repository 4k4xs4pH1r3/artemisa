...
session_start();
//require_once('funciones/seguridadprematricula.php');
...
{ 
    ...
    if (tipo == 1)
	{
		window.location.reload("busquedaestudiante.php?busqueda=nombre<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
	} 
    if (tipo == 2)
	{
		window.location.reload("busquedaestudiante.php?busqueda=apellido<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
	} 
    if (tipo == 3)
	{
		window.location.reload("busquedaestudiante.php?busqueda=codigo<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
    } 
    if (tipo == 4)
	{
		window.location.reload("busquedaestudiante.php?busqueda=documento<?php if(isset($_GET['aplicaarp'])){echo $aplicararp;}elseif(isset($_GET['graduar_estudiantes'])){echo $graduar_estudiantes;}?>"); 
    } 
} 
...
{ 
    ...
    if (busca != 0)
	{
		window.location.reload("busquedaestudiante.php?buscar="+busca); 
	} 
} 
</script>
...
<body>
<div align="center">
<form name="f1" action="busquedaestudiante.php" method="get">
...
<?php
	...
	//{
		...
		while($solicitud = mysql_fetch_assoc($res_solicitud))
		{
			...
			{
				echo "<tr>
					<td class='Estilo1'><a href='../facultades/arp/estudiantearpmenu.php?idestudiantegeneral=$idestudiantegeneral'>$nombre&nbsp;</a></td>
					<td class='Estilo1' align='center'>$numerodocumento&nbsp;</td>
					<td class='Estilo1'>$nombreperiodo&nbsp;</td>				
					</tr>";
			}
			...
			{
				echo "<tr>
					<td class='Estilo1'><a href='graduar_estudiantes_menu.php?codigoestudiante=$codigoestudiante'>$nombre&nbsp;</a></td>
					<td class='Estilo1' align='center'>$numerodocumento&nbsp;</td>
					<td class='Estilo1'>$nombreperiodo&nbsp;</td>				
					</tr>";
			}
