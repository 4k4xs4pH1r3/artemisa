...
function maximaLongitud(texto,maxlong) {
  ...
  return true;
		...
		//theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code,|,insertdate,inserttime,preview,|,forecolor,backcolor,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak,restoredraft",
                                    theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,code,|,insertdate,inserttime,preview,|,forecolor,backcolor,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,restoredraft",
		//theme_advanced_buttons3 : "tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,iespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen,|,insertlayer,moveforward,movebackward,absolute",
		...
		template_replace_values : {
			...
			staffid : "991234"
                ...
                autosave_warning_message : 'algo va a pas',
                save_onsavecallback : "mysave",
                restore_content : "Guardar contenido autom\u00E1ticamente",
                plugin_preview_pageurl : 'toPdf.php?codigomateria=<?=$_REQUEST['codigomateria']?>'
                //plugin_mceNewDocument_callback : 'mu',
	});         
        function mysave(){
        ...
        <form name="form1" id="form1"  method="POST" action="" enctype="multipart/form-data">
			...
			group by semestredetalleplanestudio";
                   ...
                   <tr id="trtitulogris" align="left" >
                    ...
                    <tr id="trtitulogris" align="left" >
                        <TD id="tdtitulogris">Código Asignatura</TD>
                        <TD align="left" ><?php echo $row_pertenecemateria['codigomateria']; ?></TD>
                        <TD id="tdtitulogris">Periodo</TD>
                        <TD align="left" colspan="2"><?php echo $_SESSION['codigoperiodosesion']; ?></TD>
                    ...
                    <tr id="trtitulogris" align="left" >
                        ...
                        <TD align="left" colspan="7" >
                            Obligatoria <input name="1" type="checkbox" <?php if($row_pertenecemateria['codigotipomateria']==1){ echo "checked" ;} ?> disabled>
                   ...
                   <tr id="trtitulogris" align="left" >
                    ...
                    <tr id="trtitulogris" align="left" >
                        <TD id="tdtitulogris">Número de Créditos</TD>
		    ...
		    limit 1";
                    ...
                    echo "</tr>";
                    echo "<tr><td></td><td colspan=3 align='left'>Numero de horas Trabajo Indenpendiente/semana</td><td><input type=text name=horastrabajoindependiente size=2 maxlength=3  value=".$row_registros['horastrabajoindependiente']."></td></tr>";
                    echo "</table>";
			...
			echo "<div id=titulo_div><a href=javascript:mostrardetalle()>Ver información de Periodos Anteriores</a></div>";                        		
			echo '<table id=tabladetalle width="70%"  border="1"  cellpadding="3" cellspacing="3" style="display:none">';	  
				...
				echo "<tr><td>".$query_registros_anteror_row["codigoperiodo"]."</td>";
                                    if($query_registros_anteror_row["codigoperiodo"] > 20112){
                                            echo "<td><a href='toPdf.php?codigomateria=".$_REQUEST['codigomateria']."&type=1' target='_blank' title='Syllabus' >Ver Documento</a></td>";
                                            echo "<td><a href='toPdf.php?codigomateria=".$_REQUEST['codigomateria']."&type=2' target='_blank' title='Asignatura'>Ver Documento</a></td></tr>";
                                    }else{
			...
			echo "</table>";
                    ...
                    if($total_Rows_registros ==""){
                        ...
                        if ($row_tipocontenido['codigotipodetallecontenidoprogramatico'] == 100){
                            echo '<tr><td>Información General</td></tr>';
                        }
                    ...
                    ?>
                    <table width="70%"  border="1"  cellpadding="3" cellspacing="3">
                        <tr onclick="javascript:help('elm1');"><td style='color: #F38A01; cursor: pointer;'>Para tener mayor información de como diligenciar el formato de contenidos seleccione aqui la ayuda en linea &nbsp;<img src='jscripts/tiny_mce/themes/advanced/img/help.jpg' title="ayuda"></td></tr>
 ...
 ?>
	...
	<script>
		...
		function ucultardetalle(){
			...
			document.getElementById("titulo_div").innerHTML = "<a href=javascript:mostrardetalle()>Ver información de Periodos Anteriores</a></div>";
		}
        </script>
    </body>    
</html>