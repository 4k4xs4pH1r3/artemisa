  ...
  return true;
		...
		template_replace_values : {
			...
			staffid : "991234"
                ...
                plugin_preview_pageurl : 'http://172.16.3.227/serviciosacademicos/consulta/facultades/materiasgrupos/contenidoprogramatico/toPdf.php?codigomateria=<?=$_REQUEST['codigomateria']?>&periodosesion=<?=$periodo_rst['codigoperiodo']?>&usuariosesion=<?=$_SESSION['MM_Username']?>'
        ...
        <form name="form1" id="form1"  method="POST" action="" enctype="multipart/form-data">
		    ...
		    limit 1";
                    ...
                    if(!$idcontenidoprogramatico){                            
                            $db->Execute ("INSERT INTO contenidoprogramatico (`codigomateria`, `codigoperiodo`, `codigoestado`) VALUES (".$_REQUEST['codigomateria'].", '".$periodo_rst['codigoperiodo']."', '100');") or die(mysql_error());
                    }
                    $registros = $db->Execute ($query_registros) or die("$query_registros".mysql_error());
                    $total_Rows_registros= $registros->RecordCount();
                    $row_registros = $registros->FetchRow();
			...
			echo '<table id=tabladetalle width="70%"  border="1"  cellpadding="3" cellspacing="3" style="display:none">';	  
				...
				echo "<tr><td>".$query_registros_anteror_row["codigoperiodo"]."</td>";
                                    if($query_registros_anteror_row["codigoperiodo"] > 20121){
                                            echo "<td><a href='http://172.16.3.227/serviciosacademicos/consulta/facultades/materiasgrupos/contenidoprogramatico/toPdf.php?codigomateria=".$_REQUEST['codigomateria']."&type=1&periodosesion=".$query_registros_anteror_row["codigoperiodo"]."&usuariosesion=".$_SESSION['MM_Username']."' target='_blank' title='Syllabus' >Ver Documento</a></td>";
                                            echo "<td><a href='http://172.16.3.227/serviciosacademicos/consulta/facultades/materiasgrupos/contenidoprogramatico/toPdf.php?codigomateria=".$_REQUEST['codigomateria']."&type=2&periodosesion=".$query_registros_anteror_row["codigoperiodo"]."&usuariosesion=".$_SESSION['MM_Username']."' target='_blank' title='Asignatura'>Ver Documento</a></td></tr>";
                                    }else{
