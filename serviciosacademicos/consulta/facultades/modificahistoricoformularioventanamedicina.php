...
$alerta = $C_ValidarFecha->ValidarIngresoModulo($_SESSION['usuario'], $ip, 'NotaHistorico-Formulario ventana medicina');
...
session_start();
$id=$_GET['idhistorico'];
$direccion = "modificahistoricoformulariomedicina.php";
//$nuevogrupo = $row_maxgrupo['maximogrupo'] + 1;
mysql_select_db($database_sala, $sala);
$query_Recordset1 = "SELECT *
					FROM notahistorico n,materia m,estadonotahistorico e,tiponotahistorico t
...
<form name="form1" method="get" action="modificahistoricoformularioventanamedicina.php">
...
if ($_GET['Submit'])
 {
		if ((!eregi("^[0-9]{1,3}\.[0-9]{1,1}$", $_GET['nota'])) ) //((!eregi("^[0-5]{1,1}\.[0-9]{1,1}$", $_GET['nota'])) or ($_GET['nota'] > 5))
		  {
