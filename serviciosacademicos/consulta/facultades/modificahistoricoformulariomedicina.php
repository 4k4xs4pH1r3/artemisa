...
$alerta = $C_ValidarFecha->ValidarIngresoModulo($_SESSION['usuario'], $ip, 'NotaHistorico-Formulario Medicina');
...
if (isset($_GET['periodo']))
 ...
 if ($_GET['Submit3'])
 {
   ...
   echo '<script language="JavaScript">window.location.href="modificahistoriconuevamateriamedicina.php?codigoestudiante='.$codigoestudiante.'&periodo='.$periodo.'&documento='.$documento.'";</script>';
 }
if ($_GET['Submit2'])
 {
   ...
   if ($row_tipousuario['codigotipousuariofacultad'] == 100)
    ...
    {
      echo '<script language="JavaScript">window.location.href="modificarhistoricobusquedamedicina.php";</script>';
    }
...
$totalRows_valoracion = mysql_num_rows($valoracion);
 ...
 ?>
      ...
      <a style="cursor: pointer" onClick="window.open('modificahistoricoformularioventanamedicina.php?idhistorico=<?php echo $row_Recordset1["idnotahistorico"];?>','modificahistorico','width=800,height=200,left=150,top=50,scrollbars=yes')"><img src="../../../imagenes/editar.png" width="23" height="23" alt="Modificar"></a>&nbsp;</div></td>
      <td  class="Estilo1"><div align="center" class="Estilo8">
      <a style="cursor: pointer" onClick="window.open('modificahistoricorotacionmedicina.php?idhistorico=<?php echo $row_Recordset1["idnotahistorico"]."&codmateria=".$row_Recordset1['codigomateria']."&periodo=".$_GET['periodo']."&codigoestudiante=".$_GET['codigoestudiante'];?>','modificahistorico','width=700,height=400,left=150,top=50,scrollbars=yes')">
...
{
    window.location.href="modificahistoricoformulariomedicina.php"+dir;
    history.go();
}
</script>
<script language="javascript">
