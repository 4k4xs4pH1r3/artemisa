...
and p.codigoestadoplanestudio like '101%'";
...
{
?>
<p align="center"><strong>PLANES DE ESTUDIO EN CONSTRUCCION</strong></p>
...
?>
<p align="center"><strong>PLANES DE ESTUDIO ACTIVOS</strong></p>
<table width="500" border="1" cellpadding="2" cellspacing="1" bordercolor="#003333">
  <tr> 
  	<td width="250" rowspan="4">
	<select name='identplanestudio2' size="7" style="width: 250px">
<?
$query_planesdeestudioactivos = "select c.nombrecarrera, p.nombreplanestudio, p.idplanestudio
from planestudio p, carrera c
where c.codigocarrera = p.codigocarrera
and c.codigocarrera = '$codigocarrera'
and p.codigoestadoplanestudio like '100%'";
...
if(isset($_POST['nuevo']))
{
	...
	window.location.reload("nuevoplandeestudio.php?nombrecarrera='.$nombreCarrera.'");
	</script>';
}
else if(isset($_POST['identplanestudio']))
{
	...
	{
		echo '<script language="javascript">
		window.location.reload("visualizarplandeestudio.php?planestudio='.$_POST['identplanestudio'].'");
		</script>';
	}
	else if(isset($_POST['eliminar']))
	{
		echo '<script language="javascript">
		window.location.reload("eliminarplandeestudio.php?planestudio='.$_POST['identplanestudio'].'");
		</script>';
	}
}
else
...
else if(isset($_POST['identplanestudio2']))
{
	...
	{
		echo '<script language="javascript">
		window.location.reload("materiasporsemestre.php?planestudio='.$_POST['identplanestudio2'].'&visualizado");
		</script>';
	}
	if(isset($_POST['asignar']))
	{
		echo '<script language="javascript">
		window.location.reload("asignacioncopiaplanestudio/asignacionplanestudio.php?planestudio='.$_POST['identplanestudio2'].'");
		</script>';
	}
}
else
