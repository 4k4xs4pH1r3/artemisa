...
?>
<form name="form1" action="listadocohortes.php" method="post">
<input type="hidden" name="AnularOK" value="">
	<table border="1" cellpadding="1" cellspacing="0" bordercolor="#E9E9E9" width="750">
<?php
 	$formulario->dibujar_fila_titulo('REPORTE COHORTES','labelresaltado',"2","align='center'");
	...
	$conboton++;
	$parametrobotonenviar[$conboton]="'button','Restablecer','Restablecer','onclick=\'regresarGET();\''";
	$boton[$conboton]='boton_tipo';
	$conboton++;
