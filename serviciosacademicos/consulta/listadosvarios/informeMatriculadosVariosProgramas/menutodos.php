...
<form name="form1" method="get" action="">
	  <p align="left" class="Estilo3"><h1>INFORME - MATRICULADOS VARIOS PROGRAMAS</h1></p>
	<p><h3>La referencia que se toma del periodo de matricula corresponde  a la carrera seleccionada.</h3></p>
...
<script language="javascript">window.location.reload("menutodos.php")</script>
<?php } ?>
<?php
if(isset($_GET['Enviar']))
{
	...
	if($validaciongeneral==true)
	{
		...
		$_SESSION['archivo_ejecuta_recarga']='informetodos.php';
		$_SESSION['array_recarga']=$array_recarga;


		echo '<script language="javascript">reCarga("informetodos.php?codigomodalidadacademica='.$_GET['codigomodalidadacademica'].'&codigocarrerainf='.$_GET['codigocarrera'].'&codigoperiodoinf='.$_GET['codigoperiodo'].'");</script>';
	}
	else
	{
