 ...
 <body>
     <form action=""  name="form1" method="POST">
             <table  border="0" cellpadding="3" cellspacing="3">
                 <TR>
                     <TD id="tdtitulogris" align="center" colspan="4">
                         <label id="labelresaltadogrande" >PERDIDA ASIGNATURA <?php echo $row_carrera['nombrecarrera']; ?></label>
                     </TD>
                 </TR>                 
                  <tr>
         ...
         if(isset($_REQUEST['generar'])){
             if(isset($_POST['idplanestudio']) && $_POST['idplanestudio']==''){
             ...
             elseif($varguardar == 0) {
                 ...
                 window.location.href='listadoasignaturas.php?codigocarrera=".$codigocarrera."&idplanestudio=".$_POST['idplanestudio']."&codigoperiodo=".$_POST['periodo']."&menucarrera=1';
                </script>";
