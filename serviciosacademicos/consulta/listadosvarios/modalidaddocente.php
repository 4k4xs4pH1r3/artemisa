...
function redireccionar()
{
    ...
    window.location.href='listadosdocentescontratos.php?<?php echo "codigomodalidadacademica=".$_REQUEST['codigomodalidadacademica']."&nacodigocarrera=".$_REQUEST['nacodigocarrera']. "&nanombrecarrera="; ?>' + nombrecarrera;
}
         </SCRIPT>
    </head>
 <body>
        ...
        <table width="20%"  border="0" align="center" cellpadding="3" cellspacing="3">
            ...
            <TR><TD id="tdtitulogris" align="center"><H2>Listado Docentes con Contrato</H2></TD></TR>
                ...
                $totalRows_modalidadacademica = $modalidadacademica->RecordCount();
                        ...
                        where codigomodalidadacademica='".$_GET['codigomodalidadacademica']."'
                   ...
                   <tr>
                    <td width="22%" id="tdtitulogris" >Seleccione la Modalidad
                        <div align="center">
                            ...
                            <?php
                                 if($row_modalidadacademica['codigomodalidadacademica']==$_GET['codigomodalidadacademica']) {
                                echo "Selected";
                                 }?>>
