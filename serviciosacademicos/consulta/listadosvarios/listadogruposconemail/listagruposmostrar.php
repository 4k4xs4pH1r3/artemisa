...
<table  border="1" cellpadding="2" cellspacing="1" bordercolor="#003333" align="center">
  <tr bgcolor="#C5D5D6">
    ...
    <td width="349" align="center" class="Estilo9"><strong>E-mail Personal</strong>&nbsp;</td>
    <td width="349" align="center" class="Estilo9"><strong>E-mail Institucional</strong>&nbsp;</td>
  </tr>
<?php
	while($inscritos = mysql_fetch_assoc($res_inscritos))
	{
		...
		$emailpersonal=$inscritos["emailestudiantegeneral"];
        /**
         * Caso 2927
         * @modified Luis Dario Gualteros C <castroluisd@unbosque.edu.co>
         * Se elimina validación del campo $emailinstitucional ya que viene validada desde la consulta SQL
         * @since  Julio 22, 2019.
         */
		 $emailinstitucional=$inscritos["usuario"];
		...
		*/
		echo "<tr>				
			...
			<td align='center'><font face='Tahoma' size='2'>$nombreestudiante&nbsp;</td>
            <td align='center'><font face='Tahoma' size='2'>$emailpersonal&nbsp;</td>
            <td align='center'><font face='Tahoma' size='2'>$emailinstitucional&nbsp;</td>
		</tr>";
	}
	...
	while($inscritos2 = mysql_fetch_assoc($res_inscritos2))
	{
		...
		$nombrefacultad=$inscritos2["nombrecarrera"];
                $emailpersonal=$inscritos2["emailestudiantegeneral"];
                $emailinstitucional=$inscritos2["usuario"]."@unbosque.edu.co";
		/* OJO Este codigo es para efectuar el cambio de grupo
...
<table  border="1" cellpadding="2" cellspacing="1" bordercolor="#003333" align="center">
  <tr bgcolor="#C5D5D6">
    ...
    <td width="349" align="center" class="Estilo9"><strong>E-mail Personal</strong>&nbsp;</td>
    <td width="349" align="center" class="Estilo9"><strong>E-mail Institucional</strong>&nbsp;</td>
    <td width="349" align="center" class="Estilo9"><strong>Fecha Pago Orden Matricula</strong>&nbsp;</td>
    <td width="349" align="center" class="Estilo9"><strong>Fecha de Inscripción de la Materia</strong>&nbsp;</td>
  </tr>
  <?php
	while($matriculados = mysql_fetch_assoc($res_matriculados))
	{
		...
		$nombrefacultad=$matriculados["nombrecarrera"];
                $emailpersonal=$matriculados["emailestudiantegeneral"];
				$emailinstitucional="";
				if($matriculados["usuario"]!=""){
					$emailinstitucional=$matriculados["usuario"]."@unbosque.edu.co";
				}
                $fechapago=$matriculados["fechapagosapordenpago"];
                $fechainscripcion=$matriculados["fechalogfechadetalleprematricula"];
				if($fechainscripcion==null || $fechainscripcion===""){
					$fechainscripcion=$matriculados["fechaprematricula"];
				} else {
		...
		echo "<tr>				
			...
			<td align='center'><font face='Tahoma' size='2'>$nombreestudiante&nbsp;</td>
                        <td align='center'><font face='Tahoma' size='2'>$emailpersonal&nbsp;</td>
                        <td align='center'><font face='Tahoma' size='2'>$emailinstitucional&nbsp;</td>
                        <td align='center'><font face='Tahoma' size='2'>$fechapago&nbsp;</td>
						<td align='center'><font face='Tahoma' size='2'>$fechainscripcion&nbsp;</td>
		</tr>";
	}
?>
</table>
