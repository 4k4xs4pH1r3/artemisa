...
<p align="center"><strong> VISUALIZACION DE HORARIOS POR PLAN DE ESTUDIO</strong></p>
<?php
...
if(isset($_POST['seleccionar']))
{
	if(isset($_POST['identplanestudio']))
	{
		...
		window.location.reload("listadohorarios.php?planestudio='.$_POST['identplanestudio'].'&filtro=todos");
		</script>';
	}
	else if(isset($_POST['identplanestudio2']))
	{
		...
		{
			echo '<script language="javascript">
			window.location.reload("listadohorarios.php?planestudio='.$_POST['identplanestudio2'].'&filtro=todos");
			</script>';
		}
	}
	else
