...
function reCarga()
{
	document.location.href="<?php echo 'menuusuarioclavefacultad.php';?>";
}
...
$query="select eg.apellidosestudiantegeneral Apellidos,eg.nombresestudiantegeneral Nombres,
eg.numerodocumento Documento,
eg.emailestudiantegeneral Email,u.usuario Usuario from ordenpago o, estudiante e,detalleordenpago d,estudiantegeneral eg
...
o.codigoperiodo=".$codigoperiodo." and
...
$datoscarrera=$objetobase->recuperar_datos_tabla('carrera','codigocarrera',$_SESSION['codigocarrerausuarioclave'],"","",0);
echo "<table width='400'><tr><td align='center'><h3>LISTADO USUARIOS NUEVOS EN ".$datoscarrera["nombrecarrera"]." PERIODO ".$_SESSION['codigoperiodousuarioclave']."</h3></td></tr><tr><td>";
