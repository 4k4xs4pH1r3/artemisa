...
* @version 1.0
* @param colorProperties - associative array of color properties. possible keys: rgbCode, colorName and pantoneName, rgbCode should be in the format #RRGGBB or RRGGBB
* @author	Alf Magne Kalleland(www.dhtmlgoodies.com)
**/

DHTMLSuite.colorPalette = function()
{
	var divElement;
	var layoutCSS;
