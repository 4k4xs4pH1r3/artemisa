...
<?php $formulario->celda_horizontal_combo("codigoperiodo","Periodo","periodo","","codigoperiodo","codigoperiodo","requerido","","","codigoperiodo desc");?>
</table>
...
if(isset($_POST['Enviar']))
{
	...
	if($valido)
	{
		echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=aplicaarp_listado.php?codigomodalidadacademica=".$_POST['codigomodalidadacademica']."&codigocarrera=".$_POST['codigocarrera']."&codigoperiodo=".$_POST['codigoperiodo']."'>";
	}
}
?>
</body>
