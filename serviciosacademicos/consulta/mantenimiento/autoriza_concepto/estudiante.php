...
if(isset($_GET['codigocreado']))
{
	...
	function recargar() 
	{
		window.location.replace("estudiante.php?codigocreado='.$_GET['codigocreado'].'");
	}
	</script>';
}
elseif(isset($_GET['codigoestudiante']))
{
	...
	function recargar() 
	{
		window.location.replace("estudiante.php?codigoestudiante='.$_GET['codigoestudiante'].'");
	}
	</script>';
}
?>
	...
	if($insertar)
		{
			...
			if(isset($_GET['codigoestudiante']))
			{
				echo "<script language='javascript'>window.location.replace('estudiante.php?codigoestudiante=".$_GET['codigoestudiante']."');</script>";
			}
			else
			{
				echo "<script language='javascript'>window.location.replace('estudiante.php?codigocreado=".$_GET['codigocreado']."');</script>";
			}
		}
...
if(isset($_POST['Regresar'])){
	...
	if(isset($_GET['codigocreado']))
	{
		echo "<script language='javascript'>window.location.replace('busqueda_estudiante.php');</script>";
	}
	elseif(isset($_GET['codigoestudiante']))
	{
		echo "<script language='javascript'>window.location.replace('../../prematricula/matriculaautomaticaordenmatricula.php');</script>";
	}
}
