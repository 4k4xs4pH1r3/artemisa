...
/**
* @package SPLIB
* @version $Id: Menu.php,v 1.1 2007/05/16 14:50:55 Abraham Castro Exp $
*/
/**
* Define constants for table column names
*/
@define ('MENU_LOCATION','posicionmenuopcion'); # URI of menu
...
@define ('MENU_DESCRIPTION','transaccionmenuopcion'); # Description of menu item (for humans);
/**
* Menu Class
    ...
    */
	function readMenu () {
		...
		if($this->administrador==true){
			...
			" WHERE codigoestadomenuopcion = '01' ORDER BY ".MENU_LOCATION.", ".MENU_NAME;
		}
		else{
			$sql="select
			mu.*
			...
			ORDER BY '".MENU_LOCATION."', '".MENU_NAME."'";
		}
