...
<table width="707" border="1" cellpadding="2" cellspacing="1" bordercolor="#003333">
  <tr class="Estilo2">
    <td width="380" align="center" bgcolor="#C5D5D6">Nombre Estudiante</td>
    <td width="310" align="center" bgcolor="#C5D5D6">Documento</td>	
	</tr>
<?php
  	$vacio = false;
	$strperiodo = "";
	...
	if(isset($_GET['busqueda_nombre']))
	{
		...
		{
			$query_solicitud = "SELECT DISTINCT est.codigoestudiante,eg.idestudiantegeneral, concat(eg.apellidosestudiantegeneral,' ',eg.nombresestudiantegeneral) AS nombre,eg.numerodocumento, p.nombreperiodo
	...
	//{
		...
		while($solicitud = mysql_fetch_assoc($res_solicitud))
		{
			...
			?>
					<tr>
					<td class="Estilo1"><div align="center"><a href="descuentoestudianteeducacioncontinuada_listado.php?aplicacion=si&numerodocumento=<?php echo $numerodocumento?>&nombreestudiante=<?php echo $nombre?>&codigoestudiante=<?php echo $codigoestudiante?>"><?php echo $nombre?></a>
					  </div>
					<td class='Estilo1' align='center'><?php echo $numerodocumento?></td>
					</tr>
			<?php } ?>
