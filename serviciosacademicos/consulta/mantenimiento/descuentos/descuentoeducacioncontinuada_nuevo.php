...
<form name="form1" method="post" action="">
  <p align="center" class="Estilo3">DESCUENTO EDUCACION CONTINUADA - NUEVO </p>
    ...
    <tr>
      <td><table width="100%" border="0">
        <tr>
          ...
          <td bgcolor="#FEF7ED"><?php $validacion['nombredescuentoeducacioncontinuada']=campotexto_valida_post("nombredescuentoeducacioncontinuada","requerido","Nombre","30","descuentoeducacioncontinuada","iddescuentoeducacioncontinuada",$_GET['iddescuentoeducacioncontinuada'],"nombredescuentoeducacioncontinuada")?></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Concepto</div></td>
          <td bgcolor="#FEF7ED"><?php $validacion['codigoconcepto']=combo_valida_post("codigoconcepto","concepto","codigoconcepto","nombreconcepto","","codigoestado='100' and codigotipoconcepto='02'","nombreconcepto asc","si","concepto")?></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Tipo descuento </div></td>
          <td bgcolor="#FEF7ED"><?php $validacion['codigotipodescuentoeducacioncontinuada']=combo_valida_post("codigotipodescuentoeducacioncontinuada","tipodescuentoeducacioncontinuada","codigotipodescuentoeducacioncontinuada","nombredescuentoeducacioncontinuada",'onChange=enviar()',"","","si","Tipo descuento")?></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Descuento</div></td>
          <td bgcolor="#FEF7ED"><?php if($_POST['codigotipodescuentoeducacioncontinuada']=='100'){$validacion['porcentajedescuentoeducacioncontinuada']=campotexto_valida_post("porcentajedescuentoeducacioncontinuada","porcentaje","Descuento, porcentaje","10","descuentoeducacioncontinuada","iddescuentoeducacioncontinuada",$_GET['iddescuentoeducacioncontinuada'],"porcentajedescuentoeducacioncontinuada");}
			elseif($_POST['codigotipodescuentoeducacioncontinuada']=='200'){$validacion['porcentajedescuentoeducacioncontinuada']=campotexto_valida_post("porcentajedescuentoeducacioncontinuada","numero","Descuento, numerico","10","descuentoeducacioncontinuada","iddescuentoeducacioncontinuada",$_GET['iddescuentoeducacioncontinuada'],"porcentajedescuentoeducacioncontinuada");}else{echo '<input type="text" name="textfield">';}
	...
	?></td>
        ...
        <tr>
          ...
          <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2"><span class="Estilo5">
            <?php $validacion['fechadesdedescuentoeducacioncontinuada']=campotexto_valida_post("fechadesdedescuentoeducacioncontinuada","fecha","Fecha desde","7");?>
            <button id="btfechadesdedescuentoeducacioncontinuada">...</button>
          </span></span></span></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Fecha hasta </div></td>
          <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2"><span class="Estilo5">
            <?php $validacion['fechahastadescuentoeducacioncontinuada']=campotexto_valida_post("fechahastadescuentoeducacioncontinuada","fecha","Fecha hasta","7");?>
            <button id="btfechahastadescuentoeducacioncontinuada">...</button>
          </span></span></span></td>
        </tr>
        <tr bgcolor="#CCDADD">
...
if(isset($_POST['Enviar']))
{
	...
	if($validaciongeneral==true)
	{
		...
		$insertar=$descuentoeducacioncontinuada->insert();
		if($insertar)
		{
