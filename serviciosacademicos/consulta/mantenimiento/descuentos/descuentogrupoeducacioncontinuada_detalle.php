...
<form name="form1" method="post" action="">
  <p align="center"><span class="Estilo3">DESCUENTO GRUPOS EDUCACION CONTINUADA - EDITAR </span></p>
    ...
    <tr>
      <td><table width="100%"  border="0">
        <tr>
          ...
          <td bgcolor="#FEF7ED"><?php $validacion['descripciondescuentogrupoeducacioncontinuada']=campotexto_valida_post_bd("descripciondescuentogrupoeducacioncontinuada","requerido","Descripci&oacute;n","50","descuentogrupoeducacioncontinuada","iddescuentogrupoeducacioncontinuada",$_GET['iddescuentogrupoeducacioncontinuada'],"descripciondescuentogrupoeducacioncontinuada")?></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Grupo</div></td>
          <td bgcolor="#FEF7ED"><?php $validacion['idgrupo']=combo_valida_post_bd("idgrupo","grupo","idgrupo","nombregrupo","",'codigoperiodo='.$_GET['codigoperiodo'].' and codigomateria='.$_GET['codigomateria'].' and codigoestadogrupo like "1%"',"si","grupo","descuentogrupoeducacioncontinuada","iddescuentogrupoeducacioncontinuada",$_GET['iddescuentogrupoeducacioncontinuada'],"idgrupo")?></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Descuento</div></td>
          <td bgcolor="#FEF7ED"><?php $validacion['iddescuentoeducacioncontinuada']=combo_valida_post_bd("iddescuentoeducacioncontinuada","descuentoeducacioncontinuada","iddescuentoeducacioncontinuada","nombredescuentoeducacioncontinuada","","fechahastadescuentoeducacioncontinuada>='".$fechahoy."'","si","Descuento","descuentogrupoeducacioncontinuada","iddescuentogrupoeducacioncontinuada",$_GET['iddescuentogrupoeducacioncontinuada'],"iddescuentoeducacioncontinuada")//fechadesdedescuentoeducacioncontinuada<='".$fechahoy."' and ?></td>
        </tr>
        <tr>
          ...
          <td bgcolor="#FEF7ED"><select name="iddirectivo">
              ...
              <?php do{ ?>
              <option value="<?php echo $directivo->iddirectivo?>" <?php if($descuentogrupoeducacioncontinuada->iddirectivo==$directivo->iddirectivo){echo "selected";}?>><?php echo $directivo->apellidosdirectivo,' ',$directivo->nombresdirectivo?></option>
        ...
        <tr>
          ...
          <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2"><span class="Estilo5">
            <?php $validacion['fechadesdedescuentogrupoeducacioncontinuada']=campotexto_valida_post_bd("fechadesdedescuentogrupoeducacioncontinuada","fecha","Fecha desde","7","descuentogrupoeducacioncontinuada","iddescuentogrupoeducacioncontinuada",$_GET['iddescuentogrupoeducacioncontinuada'],"fechadesdedescuentogrupoeducacioncontinuada")?><button id="btfechadesdedescuentogrupoeducacioncontinuada">...</button>
          </span></span></span></td>
        </tr>
        <tr>
          <td bgcolor="#CCDADD" class="Estilo2"><div align="center">Fecha hasta </div></td>
          <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2"><span class="Estilo5">
            <?php $validacion['fechahastadescuentogrupoeducacioncontinuada']=campotexto_valida_post_bd("fechahastadescuentogrupoeducacioncontinuada","fecha","Fecha hasta","7","descuentogrupoeducacioncontinuada","iddescuentogrupoeducacioncontinuada",$_GET['iddescuentogrupoeducacioncontinuada'],"fechahastadescuentogrupoeducacioncontinuada")?><button id="btfechahastadescuentogrupoeducacioncontinuada">...</button>
          </span></span></span></td>
        </tr>
        <tr bgcolor="#CCDADD">
...
if(isset($_POST['Enviar']))
{
	...
	if($validaciongeneral==true)
	{
		...
		$descuentogrupoeducacioncontinuada->idgrupo=$_POST['idgrupo'];
		...
		//DB_DataObject::debugLevel(5);
		$actualizar=$descuentogrupoeducacioncontinuada->update();
...
{
	$descuentogrupoeducacioncontinuada->fechadesdedescuentogrupoeducacioncontinuada='0000-00-00';
	$descuentogrupoeducacioncontinuada->fechahastadescuentogrupoeducacioncontinuada='0000-00-00';
	$actualizar=$descuentogrupoeducacioncontinuada->update();
	//DB_DataObject::debugLevel(0);
	if($actualizar)
	{
