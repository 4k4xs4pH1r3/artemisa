...
<?php
$informe=new matriz($array_interno,"MANTENIMIENTO CARRERAS","consultarcarrera.php","si","si","menu.php");
$informe->agregarllave_drilldown('nombrecarrera','consultarcarrera.php','insertar2.php','carreradetalle','codigocarrera','','','','','',"");
/*
