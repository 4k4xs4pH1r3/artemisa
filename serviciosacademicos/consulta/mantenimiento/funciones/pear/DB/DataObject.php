 ...
 * @version    CVS: $Id: DataObject.php,v 1.4 2007/02/07 16:40:24 Abraham Castro Exp $
...
class DB_DataObject extends DB_DataObject_Overload
{
    ...
    */
	...
	/*Se quita el $ a la variable k por problemas de version en PHP*/
        $this->k = $v;
        return $this->find(1);
    }
    ...
    function databaseStructure()
    {
        ...
        if ($args = func_get_args()) {
            ...
            if (count($args) == 1) {
                ...
                require_once '../funciones/pear/DB/DataObject/Generator.php';
    ...
    function _connect()
    {
        ...
        if ($db_driver == 'DB') {
            ...
            /* assumption is MDB2 */
            require_once '../funciones/pear/MDB2.php';
    ...
    */
    ...
    function validate()
    {
        require_once '../funciones/pear/Validate.php';
        $table = $this->table();
        $ret   = array();
        $seq   = $this->sequenceKey();
    ...
    function fromValue($col,$value) 
    {
        ...
        switch (true) {
            ...
            case ($cols[$col] & DB_DATAOBJECT_DATE):
                ...
                // try date!!!!
                require_once '../funciones/pear/Date.php';
                $x = new Date($value);
    ...
    */
    ...
    function raiseError($message, $type = null, $behaviour = null)
    {
        ...
        if (PEAR::isError($message)) {
            ...
            require_once '../funciones/pear/DB/DataObject/Error.php';
