...
class DataObjects_Departamento extends DB_DataObject 
{
    ...
    var $iddepartamento;                  // int(11)  not_null primary_key auto_increment
    var $nombrecortodepartamento;         // string(10)  not_null
    var $nombredepartamento;              // string(100)  not_null
    var $idpais;                          // int(11)  not_null multiple_key
    var $codigosapdepartamento;           // string(20)  not_null
