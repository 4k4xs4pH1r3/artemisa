...
class DataObjects_Concepto extends DB_DataObject 
{
    ...
    var $codigoconcepto;                  // string(3)  not_null primary_key
    var $nombreconcepto;                  // string(25)  not_null
    ...
    var $codigoindicadorconceptoprematricula;    // string(3)  not_null multiple_key
    var $codigoindicadoraplicacobrocreditosacademicos;    // string(3)  not_null multiple_key
    var $codigoindicadoraplicacontabilizacionplanpagos;    // string(3)  not_null multiple_key
