...
function arreglarfecha($fechainicial)
{
		...
		$fechaarreglada=date("Y-m-d",$fechasinformato);
		//echo "<br>",$fechaconvertida;
		return $fechaarreglada;
}
function campofecha_valida_post_bd($nombrevar,$validacion,$mensaje,$tamano,$tablaexistente,$indicetablaexistente,$valorindicetablaexistente,$datotablaexistente)
{ 
	$$tablaexistente = DB_DataObject::factory($tablaexistente);
	$$tablaexistente->get($indicetablaexistente,$valorindicetablaexistente);
	//echo $$tablaexistente->$datotablaexistente;
	$fechareparada=arreglarfecha($$tablaexistente->$datotablaexistente);
	//echo $fechareparada;
	
?>
<input name="<?php echo $nombrevar;?>" type="text" id="<?php echo $nombrevar;?>" value="<?php echo $fechareparada?>" size="<?php echo $tamano;?>">
<?php 
