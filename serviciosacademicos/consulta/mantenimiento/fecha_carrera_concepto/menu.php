...
<form name="aplicaarp" method="post" action="">
  <p align="center" class="Estilo3">FECHA CARRERA CONCEPTO - MENU PRINCIPAL </p>
...
{ 
    ...
    if (tipo == 1)
	{
		window.location.href = "crear_fecha_carrera_concepto.php"; 
	} 
	if (tipo == 2)
	{
		window.location.href ="modificar_fecha_carrera_concepto.php"; 
	} 
}
</script>