...
mysql_select_db($database_sala, $sala);
$query_sel_codigocarrera = "SELECT  * FROM carrera c  where c.codigomodalidadacademica='".$_GET['modalidadacademica']."' order by c.nombrecarrera
 ";
...
<p align="center"><span class="Estilo3">CREAR MATERIAS - INSERTAR</span>
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="Estilo1"><span class="style2">
          <select name="codigomodalidadmateria" id="codigomodalidadmateria">
            ...
            do {
?>
            <option value="<?php echo $row_sel_modalidadmateria['codigomodalidadmateria']?>"<?php if($_POST['codigomodalidadmateria'] == $row_sel_modalidadmateria['codigomodalidadmateria']){echo "selected";}?>><?php echo $row_sel_modalidadmateria['nombremodalidadmateria']?></option>
            <?php
...
?>
      ...
      <tr>
        <td bgcolor="#CCDADD"><div align="center" class="Estilo3"><span class="Estilo2" style="color: ;">periodo<span class="Estilo2 Estilo1 phpmaker" style="color: ;"><strong><span class="Estilo4">*</span></strong></span></span></div></td>
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="Estilo1"><span class="style2">
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="Estilo1"><span class="style2">
          <select name="codigolineaacademica" id="codigolineaacademica">
            ...
            do {
?>
            <option value="<?php echo $row_sel_lineaacademica['codigolineaacademica']?>"<?php if($_POST['codigolineaacademica'] == $row_sel_lineaacademica['codigolineaacademica']){echo "selected";}?>><?php echo $row_sel_lineaacademica['nombrelineaacademica']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="Estilo1"><span class="style2">
          <select name="codigocarrera" id="codigocarrera">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigocarrera['codigocarrera']?>"<?php if($_POST['codigocarrera'] == $row_sel_codigocarrera['codigocarrera']){echo "selected";}?>><?php echo $row_sel_codigocarrera['nombrecarrera']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="style2">
          <select name="codigoindicadorgrupomateria" id="codigoindicadorgrupomateria">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigoindicadorgrupomateria['codigoindicadorgrupomateria']?>"<?php if($_POST['codigoindicadorgrupomateria'] == $row_sel_codigoindicadorgrupomateria['codigoindicadorgrupomateria']){echo "selected";}?>><?php echo $row_sel_codigoindicadorgrupomateria['nombreindicadorgrupomateria']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2">
          <select name="codigotipomateria" id="codigotipomateria">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigotipomateria['codigotipomateria']?>"<?php if($_POST['codigotipomateria'] == $row_sel_codigotipomateria['codigotipomateria']){echo "selected";}?>><?php echo $row_sel_codigotipomateria['nombretipomateria']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2">
          <select name="codigoestadomateria" id="codigoestadomateria">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigoestadomateria['codigoestadomateria']?>"<?php if($_POST['codigoestadomateria'] == $row_sel_codigoestadomateria['codigoestadomateria']){echo "selected";}?>><?php echo $row_sel_codigoestadomateria['nombreestadomateria']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2">
          <select name="codigoindicadoretiquetamateria" id="codigoindicadoretiquetamateria">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigoindicadoretiquetamateria['codigoindicadoretiquetamateria']?>"<?php if($_POST['codigoindicadoretiquetamateria'] == $row_sel_codigoindicadoretiquetamateria['codigoindicadoretiquetamateria']){echo "selected";}?>><?php echo $row_sel_codigoindicadoretiquetamateria['nombreindicadoretiquetamateria']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2">
          <select name="codigotipocalificacionmateria" id="codigotipocalificacionmateria">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigotipocalificacionmateria['codigotipocalificacionmateria']?>"<?php if($_POST['codigotipocalificacionmateria'] == $row_sel_codigotipocalificacionmateria['codigotipocalificacionmateria']){echo "selected";}?>><?php echo $row_sel_codigotipocalificacionmateria['nombretipocalificacionmateria']?></option>
            <?php
      ...
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker"><span class="style2">
          <select name="codigoindicadorcredito" id="codigoindicadorcredito" onChange="enviar()">
            ...
            do {
?>
            <option value="<?php echo $row_sel_codigoindicarcredito['codigoindicarcredito']?>"<?php if($_POST['codigoindicadorcredito'] == $row_sel_codigoindicarcredito['codigoindicarcredito']){echo "selected";}?>><?php echo $row_sel_codigoindicarcredito['nombreindicarcredito']?></option>
            <?php
...
?>
      ...
      <?php if(@$_POST['codigoindicadorcredito']==100){ ?>
	  <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="numerocreditos" type="text" id="numerocreditos" value="<?php echo $_POST['numerocreditos']?>">
        </span></td>
      </tr>
	  <?php } ?>
      <?php if(@$_POST['codigoindicadorcredito']==200){ ?>
	  <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="ulasa" type="text" id="ulasa" value="<?php echo $_POST['ulasa']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="ulasb" type="text" id="ulasb" value="<?php echo $_POST['ulasb']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="ulasc" type="text" id="ulasc" value="<?php echo $_POST['ulasc']?>">
        </span></td>
      </tr>
      <?php } ?>
	  <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="nombrecortomateria" type="text" id="nombrecortomateria" value="<?php echo $_POST['nombrecortomateria']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="nombremateria" type="text" id="nombremateria" value="<?php echo $_POST['nombremateria']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="notaminimaaprobatoria" type="text" id="notaminimaaprobatoria" value="<?php echo $_POST['notaminimaaprobatoria']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="notaminimahabilitacion" type="text" id="notaminimahabilitacion" value="<?php echo $_POST['notaminimahabilitacion']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="numerosemana" type="text" id="numerosemana" value="<?php echo $_POST['numerosemana']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="numerohorassemanales" type="text" id="numerohorassemanales" value="<?php echo $_POST['numerohorassemanales']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="porcentajeteoricamateria" type="text" id="porcentajeteoricamateria" value="<?php echo $_POST['porcentajeteoricamateria']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="porcentajepracticamateria" type="text" id="porcentajepracticamateria" value="<?php echo $_POST['porcentajepracticamateria']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="porcentajefallasteoriamodalidadmateria" type="text" id="porcentajefallasteoriamodalidadmateria" value="<?php echo $_POST['porcentajefallasteoriamodalidadmateria']?>">
        </span></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#FEF7ED"><span class="phpmaker">
          <input name="porcentajefallaspracticaamodalidadmateria" type="text" id="porcentajefallaspracticamodalidadmateria" value="<?php echo $_POST['porcentajefallaspracticamodalidadmateria']?>">
        </span></td>
      </tr>
      <tr>
...
if(isset($_POST['Enviar'])){
	...
	$validacion['flot_porcentajepracticamateria']=validar($_POST['porcentajepracticamateria'],"flotante",'<script language="JavaScript">alert("No digitado correctamente el porcentaje de prúctica de la materia")</script>', true);
	...
	$validacion['req_codigoperiodo']=validar($_POST['codigoperiodo'],"requerido",'<script language="JavaScript">alert("No seleccionado el periodo de la materia")</script>', true);
	...
	if($_POST['porcentajefallasmodalidadmateria'] > 100)
	{
	...
	if($validaciongeneral==true)
	{
		...
		else
		{
			...
			echo "<script language='javascript'>alert('Fallo Actualizacion, no se puede duplicar nombrecortomateria');</script>";
			unset($_POST['Enviar']);
			exit();
