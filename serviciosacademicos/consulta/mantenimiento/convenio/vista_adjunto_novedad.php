...
//print_r($_REQUEST);
$idnovedadesconvenio = $_REQUEST['idnovedadesconvenio'];
$adjunto_novedad = new adjunto_novedad();
if(isset($_REQUEST['enviar'])) {
//$db->debug = true;
    $adjunto_novedad->adjuntarArchivoUnico("novedadesconvenio");
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        $(function() {
            var p = parent;
            var idnovedadesconvenio = p.$("#idnovedadesconvenio").attr("value");
...
?>
            $("#div1").after('<input type="hidden" name="idnovedadesconvenio" value="' + idnovedadesconvenio +'"/>');
    })
<?php
if($adjunto_novedad->error == 1 && isset($_REQUEST['enviar'])) {
    ?>
