...
if(empty($_GET['usuario'])){
	$query="SELECT usuario.usuario, $tabla.* FROM $tabla
...
<?php
$informe=new matriz($arreglo_titulo,"LISTADO PREGUNTA SECRETA CLAVE USUARIO","logActividadUsuario.php","si","no","menu.php",'',false);
$informe->botonRegresar=false;
$informe->botonRecargar=false;
$informe->mostrarTitulo=true;
$informe->agregarllave_emergente('usuario','referenciaClaveUsuarioListado.php','referenciaClaveusuario.php','referenciaclaveusuario','idusuario','',450,200);
$informe->mostrar();
?>