...
<form name="aplicaarp" method="post" action="">
  <p align="center" class="Estilo3">ORDEN INTERNA SAP - MENU PRINCIPAL </p>
    ...
    <tr>
      ...
      <td width="49%" bordercolor="#FFFFFF" bgcolor='#FEF7ED'><div align="center">
          <select name="tipo" id="tipo" onChange="cambia_tipo()">
            ...
            <option value="1">Insertar nuevos registros</option>
...
{ 
    ...
    if (tipo == 1)
	{
		window.location.reload("crear_orden_interna_sap.php"); 
	} 
	if (tipo == 2)
	{
		window.location.reload("modificar_orden_interna_sap.php"); 
	} 
}
</script>