		...
		";
			...
			semestrefinalaplicaarp='".$_POST['semestrefinalaplicaarp']."' WHERE codigocarrera = '".$_GET['codigocarrera']."' and codigotipoaplicaarp='100'";
  			...
  			if($modificar_aplicaarp)
  			{
  				...
  				echo "<script language='javascript'>window.location.reload('aplicaarpconsultar.php?codigoperiodo=".$_GET['codigoperiodo']."&modalidadacademica=".$_GET['modalidadacademica']."&codigocarrera=".$_GET['codigocarrera']."');</script>";
  			}
  			else
  			{
  				echo mysql_error();
  	...
  	elseif ($numrows_consultacarrera==0)
  	{
		...
		";
  			...
  			$query_insertar_aplicaarp="insert into aplicaarp(nombreaplicaarp,codigocarrera,codigoperiodo,idempresasalud,valorbaseaplicaarp,
				...
				'".$row_fecha['fechainiciofinancierosubperiodo']."','".$row_fechas['fechafinalfinancierosubperiodo']."','100','".$_POST['codigoconcepto']."',
  		...
  		{	echo "<script language='javascript'>alert('No ha digitado todos los datos requeridos')</script>";
...
?>
  ...
  {
  	$query_modificar_aplicaarp="update aplicaarp set codigotipoaplicaarp='200' WHERE codigocarrera = '".$_GET['codigocarrera']."' and codigotipoaplicaarp='100' and codigoperiodo='".$_GET['codigoperiodo']."'";
  	$modificar_aplicaarp=mysql_query($query_modificar_aplicaarp,$sala) or die($query_modificar_aplicaarp.mysql_error());
  	if($modificar_aplicaarp)
  	{
  		echo "<script language='javascript'>alert('Datos modificados correctamente')</script>";
