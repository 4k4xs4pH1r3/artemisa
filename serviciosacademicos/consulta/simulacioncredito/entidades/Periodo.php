...
class Periodo {
     ...
     * Se modifican el nombre del atributo siguientePeriodo por periodoSiguiente
     * @since December 20, 2018
     */
    private $periodoSiguiente;
    ...
    public function getPeriodoActualSiguiente() {
         ...
         * Se agrega LIMIT 1 en los subquerys anidados para que no genere error de Mysql: 1242 - Subquery returns more than 1 row
         * @since Febrero 22, 2019
         */
        $sql = "SELECT * 
		FROM (
                    SELECT codigoperiodo AS periodoactivo
                    FROM periodo 
                    WHERE codigoestadoperiodo = 1 or codigoestadoperiodo = 3 or codigoestadoperiodo = 4 LIMIT 1
                ) sub1
                CROSS JOIN (
                    ...
                    WHERE codigoperiodo >= (
                            ...
                            FROM periodo
                            WHERE codigoestadoperiodo =2 or codigoestadoperiodo =3 or codigoestadoperiodo =4 or codigoestadoperiodo =1  order by codigoperiodo DESC LIMIT 1
                        )
