...
function reconocimiento($objetobase,$formulario){
	...
	echo "<table border='1' cellpadding='1' cellspacing='0' bordercolor='#E9E9E9' width=100%>";
			...
			$fila["Tipo_De_Reconocimiento"]="";
			$fila["Reconocimiento_Otorgado"]="";		
			$fila["Ciudad"]="";
			$fila["Fecha_De_Reconocimiento"]="";
			...
			$resultado=$objetobase->recuperar_resultado_tabla("reconocimientodocente d, ciudad c","d.iddocente",$_SESSION['sissic_iddocente'],$condicion,"",0);
			echo "<tr>";		
			echo "<td valign='top'>";
