...
function escalafon($objetobase,$formulario){
	...
	echo "<table border='1' cellpadding='1' cellspacing='0' bordercolor='#E9E9E9' width=100%>";
			...
			$condicion=" and d.codigoestado like '1%'
					and e.codigoescalafon=d.codigoescalafon";

			$resultado=$objetobase->recuperar_resultado_tabla("escalafondocente d, escalafon e ","d.iddocente",$_SESSION['sissic_iddocente'],$condicion,"",0);
			echo "<tr>";		
			echo "<td valign='top'>";
			...
			while($row=$resultado->fetchRow()){
				...
				$fila[]=$row["fechainicioescalafondocente"];
