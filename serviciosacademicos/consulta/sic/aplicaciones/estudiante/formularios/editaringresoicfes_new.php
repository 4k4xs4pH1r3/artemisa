...
include ("../../../../prematricula/inscripcionestudiante/calendario/calendario.php");
@session_start();
?>
<html>
    <head>
...
WHERE eg.idestudiantegeneral = '".$_GET["idestudiante"]."'
...
and e.idestudiantegeneral = '".$_REQUEST['idestudiante']."'";
...
order by a.idasignaturaestado";			  
                        ...
                        <table width="100%"  border="1" cellpadding="1" cellspacing="0" bordercolor="#E9E9E9">
                            ...
                            <tr>
                                <td colspan="4" id="tdtitulogris">Asignatura</td>
...
echo "</pre></td></tr>";*/
                                if ($row_datosgrabados <> "") {
                                    do {
                                        ?>
                            <tr>
                                <td colspan="4"><?php echo $row_datosgrabados['nombreasignaturaestado'] ;?> <input type="hidden" name="asignatura<?php echo $cuentaidioma;?>" value="<?php echo $row_datosgrabados['idasignaturaestado'] ; ?>"> </td>
   ...
   <a onClick="vista()" style="cursor: pointer"><img src="../../../../imagenes/vistaprevia.gif" width="25" height="25" alt="Vista Previa"></a>  
    ...
    <!-- 	<input type="button" value="Vista Previa" onClick="vista()"> -->
      ...
      <!-- <a onClick="regresar()" style="cursor: pointer"><img src="../../../../imagenes/izquierda.gif" width="20" height="20" alt="Regresar"></a>  <input type="hidden" name="grabado" value="grabado">
            -->
            <input type="button" onClick="window.location.href='estudiosRealizados.php?<?php echo $_SESSION['fppal']; ?>'" name="Regresar" value="Regresar">
                <?php
                $banderagrabar = 0;
