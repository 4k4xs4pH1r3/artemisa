...
$inscripcion->archivoComienzo = "aspectosFamiliares.php";
// Se mete esta modalidad para que pregunte los aspectos familiares que se le preguntan a pregrado
$inscripcion->codigomodalidadacademica = 100;
...
<html>
    <head>
        ...
        <title>ASPECTOS FAMILIARES</title>
    ...
    <body>
        <form action="" method="post" name="informacion">
            <fieldset>
                <legend>ASPECTOS FAMILIARES</legend>
                <?php
                $inscripcion->informacionFamiliar();
                ?>
                <table width="100%">
                    <tr>
                        <td align="left">
