...
require_once("../../../../prematricula/inscripcionestudiante/calendario/calendario.php");
@session_start();
...
if ($row_datosgrabados <> "") {
    echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=editaringresoicfes_new.php?inicial&idestudiante=".$_GET['idestudiante']."'>";
    exit();
}
?>
<html>
...
and e.idestudiantegeneral = '".$_GET['idestudiante']."'
...
FROM estudiantegeneral eg, estudiante e, carrera c,ciudad ci, modalidadacademica m
WHERE eg.idciudadnacimiento = ci.idciudad
AND e.codigocarrera = c.codigocarrera
...
ORDER BY 1";
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%"  border="1" cellpadding="1" cellspacing="0" bordercolor="#E9E9E9">
                            ...
                            <tr>
                                <td colspan="6" id="tdtitulogris"><label id="labelresaltado">ATENCION! Para los resultados icfes que tengan Ciencias Sociales, por favor diligenciar ese puntaje en Historia y Geografia.</label></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input name="fecha1" type="text" id="fecha1"  value="<?php echo substr($row_datosgrabados['fecharesultadopruebaestado'],0,10)?>"><button id="btfechavencimiento">...</button></td>
    ...
    <!--	<input type="button" value="Vista Previa" onClick="vista()">  -->
            ...
            <input type="hidden" name="idestudiante" value="<?php echo $_POST['idestudiante'];?>">
                ...
                ?>
            <input type="button" onClick="window.location.href='estudiosRealizados.php?<?php echo $_SESSION['fppal']."#ancla".$_SESSION['modulosesion']; ?>'" name="Regresar" value="Regresar">
	  ...
	  VALUES(0,'".$_POST['nombre']."','".$_POST['idestudiante']."','".$_POST['registro']."','".$_POST['puesto']."','".$_POST['fecha1']."','".$_POST['descripcion']."','100' )";
            ...
            <script language="javascript">
                ...
                {
                    window.location.href="idiomas.php"+dir;
                    history.go();
                }
            </script>
        </form>
