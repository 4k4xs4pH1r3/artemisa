...
function cambia_tipo()
{
    ...
    if (tipo == 1)
	{
	  window.location.href='editarestudiantecolegio.php?busqueda=nombre';
	} 
}
</script>
<script language="javascript"> 
...
{ 
    ...
    if (busca != 0)
	{
		window.location.href="editarestudiantecolegio.php?buscar="+busca;
	} 
} 
</script>
<body>
...
?>
  ...
  <tr>
    <td width="250"  id="tdtitulogris">Nombre del municipio</td>
	<td>&nbsp;
<?php
	 echo "<input name='busqueda_municipio' type='text' size='30' value='".$colegioultimo5['municipioinstitucioneducativa']."'>";
?>
</td>
 </tr>
  <tr>
...
<?php
	...
	if(isset($_GET['busqueda_nombre']))
	{
		...
		and municipioinstitucioneducativa like '%$municipio%'
...
function recargar()
{
	window.location.href="modificarhistoricobusqueda.php";
}
</script>
<script language="javascript">
function crear()
{
	window.location.href="editarestudiantecolegionuevo.php";
}
</script>
</html>