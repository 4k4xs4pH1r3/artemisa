...
<?php	
   ...
   {
?>
	 <input type="button" name="Eliminar<?php echo $row_deudas['codigoconcepto'];?>" value="Eliminar" onClick="confirmar('<?php echo "eliminardetalle.php?numeroordenpago=$numeroordenpago&codigoestudiante=$codigoestudiante&codigocarrera=$codigocarrera&codigoperiodo=$codigoperiodo&codigoconcepto=".$row_deudas['codigoconcepto'];?>')"></span></td>
<?php	
   }
?> 
  </tr>
