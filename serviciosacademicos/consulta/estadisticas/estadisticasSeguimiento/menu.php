...
if(isset($_GET['Enviar']))
{
	...
	if($validaciongeneral==true)
	{
		...
		echo '<script language="javascript">reCarga("principal.php?codigomodalidadacademica='.$_GET['codigomodalidadacademica'].'&codigocarrera='.$_GET['codigocarrera'].'&codigoperiodo='.$_GET['codigoperiodo'].'");</script>';
	}
	else
	{
