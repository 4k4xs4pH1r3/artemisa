			...
			foreach($arrayvertical as $llave=>$arrayrecursivo){
				//if($arrayrecursivo["total"]>0){
					...
					if(!isset($arrayrecursivo["fin"])&&$llave!="total"){
						...
						if($llave!="total")
						{
							$cadena .= "<td  width ='".$this->anchocelda."' ".$this->estilocolumna." height='".$this->altocelda."'>".$arrayrecursivo["total"]." ".substr(ucwords(strtolower($llave)),0,28)."</td>";
							$cadena .= "</tr>";
							$cadena .= "<tr>";
							$rowspan++;
			...
			if($fila=="")
			{
				...
				foreach($this->arraycolumnas as $llavecolumna=>$columna){
					...
					else
					{
						...
						if($exportar){
							$cadena.="<td  width ='".($this->anchocelda)."' height='".$this->altocelda."' bgcolor='".$color."' 	".$this->estilocolumna."><table border='1' cellpadding='0' cellspacing='0'><td width='40'>".$arrayarea[$fila][$columna]["valor"]."</td><td> ".$arrayarea[$fila][$columna]["porcentaje"]."</td></table></td>";
						}
						else{
						$cadena.="<td  width ='".($this->anchocelda)."' height='".$this->altocelda."' bgcolor='".$color."' 	".$this->estilocolumna."><table border='0' cellpadding='0' cellspacing='0'><td width='40'>".$arrayarea[$fila][$columna]["valor"]."</td><td> ".$arrayarea[$fila][$columna]["porcentaje"]."</td></table></td>";
						}
					}
				}
				$cadena.="</tr>";
