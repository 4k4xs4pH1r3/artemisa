...
<script type="text/javascript">
    window.location.href="listado.php?<?php echo "nacodigoareadisciplinar=".$_REQUEST['nacodigoareadisciplinar']."&nacodigomodalidadacademicasic=".$_REQUEST['nacodigomodalidadacademicasic']."&nacodigocarrera=".$_REQUEST['nacodigocarrera']; ?>";
</script>
<?php
}
?>
