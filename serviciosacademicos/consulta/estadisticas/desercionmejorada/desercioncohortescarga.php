...
$modalidadacademicados="and c.codigomodalidadacademica in (200,300)";
}
else{
$carreradestinodos="";
...
$query1="SELECT e.codigoestudiante,e.semestre,eg.apellidosestudiantegeneral,eg.nombresestudiantegeneral,
...
group by hh.codigoestudiante
                             ...
                             left join situacioncarreraestudiante sce on
                              ...
                              e.codigosituacioncarreraestudiante =sce2.codigosituacioncarreraestudiante
                               ...
                               and c.codigomodalidadacademica in ($codigomodalidadacademica)
...
$query2="SELECT e.codigoestudiante,e.semestre,eg.apellidosestudiantegeneral,eg.nombresestudiantegeneral,
eg.numerodocumento,c.nombrecarrera,e.codigoperiodo periodoingreso,pr.codigoperiodo periodo_salida,
sce.nombresituacioncarreraestudiante Situacion_Periodo_Salida,sce2.nombresituacioncarreraestudiante Situacion_Actual
                               FROM ordenpago o, detalleordenpago d, carrera c,
                               concepto co, prematricula pr, estudiantegeneral eg, estudiante e
...
//$row_operacion=$operacion->fetchRow();
	...
	{unset ($filadeser);
		$array_interno[]=$row_operacion;
                ...
                $filadeser['codigoestudiante']=$row_operacion['codigoestudiante'];
                $filadeser['codigoperiodo']=$row_operacion['periodoingreso'];
                $filadeser['nombrecarrera']=$row_operacion['nombrecarrera'];
                $filadeser['numerodocumento']=$row_operacion['numerodocumento'];
                $filadeser['apellidosestudiantegeneral']=$row_operacion['apellidosestudiantegeneral'];
                $filadeser['nombresestudiantegeneral']=$row_operacion['nombresestudiantegeneral'];
                $filadeser['semestre']=$row_operacion['semestre'];
                $condicionactualiza=" codigoestudiante='".$row_operacion['codigoestudiante']."'";
                  //              echo "<pre>";
                //print_r($filadeser);
                $objetobase->insertar_fila_bd("tmp_desertados", $filadeser, 0, $condicionactualiza);
              //echo "</pre>";
...
//$materiastmparray=encuentra_array_materias($codigocarrera,$_POST['codigoperiodo'],$objetobase,0);
$objetobase->conexion->query("delete from tmp_desertados");
$condicion=" and codigoperiodo < (select codigoperiodo from periodo where codigoestadoperiodo=1)
    and codigoperiodo > '20051'";
$resperiodos=$objetobase->recuperar_resultado_tabla("periodo p", "codigoestadoperiodo","2", $condicion);
while($rowperiodo=$resperiodos->fetchRow()){
$cantidadestmparray=encuentra_array_materias("1","todos","'200','300'",$rowperiodo['codigoperiodo'],$objetobase,0);
}
