...
if(isset($_GET['Enviar']))
{
	...
	{
		if($_SESSION['rol']==7 or $_SESSION['usuario']=="admintecnologia")
		{
			echo '<script language="javascript">window.location.reload("estadisticas_egresados.php?codigomodalidadacademica='.$_GET['codigomodalidadacademica'].'&codigocarrera='.$_GET['codigocarrera'].'&codigoperiodo='.$_GET['codigoperiodo'].'");</script>';
		}
		else
		{
			echo '<script language="javascript">window.location.reload("estadisticas_egresados.php?codigomodalidadacademica='.$_GET['codigomodalidadacademica'].'&codigocarrera='.$_GET['codigocarrera'].'&codigoperiodo='.$_GET['codigoperiodo'].'");</script>';
