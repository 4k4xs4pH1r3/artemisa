...
$informe->agregarllave_drilldown('Inscritos_Evaluados','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','Inscritos_Evaluados','codigocarrera',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=201");

$informe->agregarllave_drilldown('a_seguir_inscritos_vs_matriculados_nuevos','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','inscripcionvsmatriculadosnuevos','codigocarrera',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=408");
...
$informe->agregarllave_drilldown('a_seguir_Prematriculados','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','Prematriculados','codigocarrera',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=500");
$informe->agregarllave_drilldown('a_seguir_No_prematriculados','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','Noprematriculados','codigocarrera',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=501","","","","");
...
$informe->agregar_llaves_totales('Inscritos_Evaluados','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','subtotal_Inscritos_Evaluados',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=201",'codigocarrera','','Inscritos_Evaluados');

$informe->agregar_llaves_totales('a_seguir_inscritos_vs_matriculados_nuevos','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','subtotal_a_seguir_inscripcion_vs_matriculados_nuevos',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=408",'codigocarrera','','a_seguir_inscripcion_vs_matriculados_nuevos');
...
$informe->agregar_llaves_totales('a_seguir_Prematriculados','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','subtotal_a_seguir_Prematriculados',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=500",'codigocarrera','','a_seguir_Prematriculados');
$informe->agregar_llaves_totales('a_seguir_No_prematriculados','tabla_estadisticas_matriculas.php','estadisticas_matriculas_detalle.php','subtotal_a_seguir_No_prematriculados',"codigoperiodo=".$_SESSION['codigoperiodo_reporte']."&codigoprocesovidaestudiante=501",'codigocarrera','','a_seguir_No_prematriculados');
$informe->mostrar();
?>
<?php
