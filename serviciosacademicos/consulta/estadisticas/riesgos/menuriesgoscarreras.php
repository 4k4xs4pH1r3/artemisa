...
<fieldset style="width:98%;">
	<form name="form1" action="riesgossemestrecarrera.php" method="post" id="ReporteRiesgo">
...
<br /><br />
<!--<form name="form1" action="riesgossemestrecarrera.php" method="post">
    <input type="hidden" name="AnularOK" value="">
   ...
   <script>
	...
	function ValidarDatos(){
			...
			/*************************************************************/
				...
				$.ajax({//Ajax
					  type: 'POST',
					  url: 'riesgossemestrecarrera.php',
					  async: false,
					  //dataType: 'json',
