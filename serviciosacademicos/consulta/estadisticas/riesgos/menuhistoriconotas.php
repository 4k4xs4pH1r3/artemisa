...
function Periodo(){
 ...
 function Periodo2(){
		...
		$SQL_Periodo='SELECT codigoperiodo  FROM periodo ORDER BY codigoperiodo DESC';
			...
			?>
            <select id="Periodo2" name="Periodo2" style="width:100%; text-align:center">
            	<option value="-1">Selecionar</option>
                <?PHP 
					while(!$Periodo->EOF){
						?>
	...
	function ValidarDatos(){
			...
			if(!$.trim(id_modalidad)){
				...
				if(Periodo==-1 || Periodo=='-1'){
						alert('Selecione un Periodo Inicial');
				...
				if(Periodo2==-1 || Periodo2=='-1'){
						alert('Selecione un Periodo Final');
						$('#Periodo2').css('border-color','#F00');
					    $('#Periodo2').effect("pulsate", {times:3}, 500);
						return false;
					}
				if (Periodo2<Periodo){
                                    alert('El Periodo Final debe ser mayor al inicial');
						$('#Periodo2').css('border-color','#F00');
					    $('#Periodo2').effect("pulsate", {times:3}, 500);
						return false;
                                }	
			...
			/*************************************************************/
				...
				$.ajax({//Ajax
					  type: 'POST',
					  url: 'historico_notas_detalles.php',
					  async: false,
					  //dataType: 'json',
