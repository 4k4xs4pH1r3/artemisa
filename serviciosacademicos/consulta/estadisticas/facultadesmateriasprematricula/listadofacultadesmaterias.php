...
if($codigocarrera!="todos")
	$carreraorigen="AND m.codigocarrera='".$codigocarrera."'";
else if($_SESSION['traeelectivassesion'] == "si")
	$carreraorigen="";
...
$query="select cm.nombrecarrera Carrera_Materia,cm.codigocarrera, m.codigomateria,m.nombremateria Materia
		,if(dp.idplanestudio is null,'No','Si') Plan_Estudio,
                c.codigocentrobeneficio Centro_Beneficio_Carrera_Estudiante,c.nombrecarrera Carrera_Estudiante,c.codigocarrera codigocarrerad,count(distinct e.codigoestudiante) Total_Estudiantes,
