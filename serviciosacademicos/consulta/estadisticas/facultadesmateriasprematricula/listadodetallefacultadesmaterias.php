...
$query="select e.codigoestudiante,e.semestre,eg.apellidosestudiantegeneral,eg.nombresestudiantegeneral,
		 eg.numerodocumento, m.codigomateria numerocodigomateria,c.nombrecarrera,m.nombremateria
		,m.numerocreditos Creditos_Materia, g.idgrupo, g.nombregrupo from $tablas where $condicion";
