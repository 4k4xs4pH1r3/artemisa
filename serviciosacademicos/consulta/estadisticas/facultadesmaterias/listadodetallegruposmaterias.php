...
m.codigomateria Codigo_Materia,numerohorassemanales Horas_Semanales,
if(dp.idplanestudio is null,'No','Si') Plan_Estudio,
m.numerocreditos Creditos_Materia,
		...
		//GROUP by m.codigomateria,g.idgrupo,e.codigocarrera
	if($imprimir)
	echo $query;
