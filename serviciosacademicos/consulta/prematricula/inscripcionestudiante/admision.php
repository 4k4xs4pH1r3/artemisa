...
?>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#C5D5D6" class="Estilo2"><div align="center"> Nombre Admisi&oacute;n <span class="Estilo4">*</span></div></td>

    <td colspan="5" bgcolor='#FEF7ED' class="Estilo1"><input type="text" name="nombre" value="<?php echo $_POST['nombre'];?>" size="40"></td>

  </tr>

   <tr>

    <td align="center" bgcolor="#C5D5D6" class="Estilo2"><div align="center">Cantidad seleccionados <span class="Estilo4">*</span></div></td>

    <td colspan="5" bgcolor='#FEF7ED' class="Estilo1">
   ...
   <tr>
    ...
    <td align="center" bgcolor="#C5D5D6" class="Estilo2"><div align="center">Periodo Admisi&oacute;n <span class="Estilo4">*</span></div></td>
