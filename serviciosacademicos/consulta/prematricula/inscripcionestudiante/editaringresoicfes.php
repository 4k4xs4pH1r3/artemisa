...
<body>
<form name="inscripcion" method="post" action="editaringresoicfes.php">
<?php
 ...
 {		
	 ...
	 if ($banderagrabar == 1)
	   ...
	   { 	     
		...
		echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=editaringresoicfes.php?inicial&idestudiante=".$_POST['idestudiante']."'>";
	   }
 }	
} // vista previa	  	
?>
