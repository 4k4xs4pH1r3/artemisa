...
{ // vista previa
	...
	<table width="100%"  border="1" cellpadding="1" cellspacing="0" bordercolor="#E9E9E9">
      ...
      <tr>
        ...
        <td><input type="text" name="registro" value="<?php echo $_POST['registro']; ?>"></td>
        <td colspan="2">&nbsp;</td>
      </tr>
	 <tr>
...
<?php
   ...
   ?>
<input type="button" onClick="window.location.href='formulariodeinscripcion.php?<? echo $_SESSION['fppal']."#ancla".$_SESSION['modulosesion']; ?>'" name="Regresar" value="Regresar">
