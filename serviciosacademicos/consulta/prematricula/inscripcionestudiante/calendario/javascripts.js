...
function muestraCalendario(raiz,formulario_destino,campo_destino,mes_destino,ano_destino){
	...
	ventanaCalendario = window.open("calendario/index.php?formulario=" + formulario_destino + "&nomcampo=" + campo_destino,"calendario","width=300,height=300,left=700,top=400,scrollbars=no,menubars=no,statusbar=NO,status=NO,resizable=NO,location=NO")
}
