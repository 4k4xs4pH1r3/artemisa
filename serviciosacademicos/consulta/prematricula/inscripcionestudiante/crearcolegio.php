...
$direccion = "estudiosrealizados.php";
	...
	$niveleducacion = mysql_query($query_niveleducacion, $sala) or die("$query_niveleducacion");



	$totalRows_niveleducacion = mysql_num_rows($niveleducacion);



	$row_niveleducacion = mysql_fetch_assoc($niveleducacion); 
...
<form name="f1" action="crearcolegio.php" method="POST" onSubmit="return validar(this)">



  <p align="center" class="Estilo3">CREAR INSTITUCI&Oacute;N EDUCATIVA </p>



  <table width="50%"  border="1" align="center" cellpadding="1" bordercolor="#003333">
    ...
    <tr>
      ...
      <td class="Estilo2" bgcolor="#C5D5D6">&nbsp;Instituci&oacute;n<span class="Estilo4">*</span></td>



      <td class="Estilo1"><input name="nombre" type="text" size="30"></td>
	 ...
	 <tr>
      ...
      <td class="Estilo2" bgcolor="#C5D5D6">&nbsp;C&oacute;digo Icfes <span class="Estilo4">*</span></td>



      <td class="Estilo1"><input name="codigocolegio" type="text" size="30"></td>     
    ...
    <tr>
      ...
      <td class="Estilo2" bgcolor="#C5D5D6">&nbsp;Pais<span class="Estilo4">*</span></td>



      <td class="Estilo1"><input name="pais" type="text" size="30"></td>
    ...
    <tr>
      ...
      <td class="Estilo2" bgcolor="#C5D5D6">&nbsp;Modalidad<span class="Estilo4">*</span></td>



      <td class="Estilo1"> <select name="niveleducacion">



                <option value="0" <?php if (!(strcmp("0", $row_datosgrabados['codigomodalidadacademica']))) {echo "SELECTED";} ?>>Seleccionar</option>
...
?>
                ...
                <option value="<?php echo $row_niveleducacion['codigomodalidadacademica']?>"<?php if (!(strcmp($row_niveleducacion['codigomodalidadacademica'],$_POST['niveleducacion']))) {echo "SELECTED";} ?>><?php echo $row_niveleducacion['nombreniveleducacion']?></option>
				...
				while($row_niveleducacion = mysql_fetch_assoc($niveleducacion));



				$rows = mysql_num_rows($niveleducacion);
...

					{
						...
						mysql_data_seek($niveleducacion, 0);
...
?>
	...
	<tr>
      ...
      <td class="Estilo1"><input name="localizacion" type="text" size="15"></td>       



	   <td width="17%" class="Estilo4"  bgcolor="#C5D5D6">Modalidad*</td>
  ...
  if ($_POST['guardar'])
...

   {
        ...
        $query_solicitud = "SELECT	*
				         ...
				         WHERE nombreinstitucioneducativa like '".$_POST['nombre']."%'



					     and paisinstitucioneducativa like '".$_POST['pais']."%'
       ...
       if ($solicitud <> "")
...

	     {
		    ...
		    echo '<script language="javascript">alert("Institución ya Existe")</script>'; 
	   ...
	   if ((!ereg("^([a-zA-ZáéíóúüñÁÉÍÓÚÑÜ]+([A-Za-záéíóúüñÁÉÍÓÚÑÜ]*|( [A-Za-záéíóúüñÁÉÍÓÚÑÜ]+)*))*$",$_POST['nombre']) or $_POST['nombre'] == ""))
...

		{
		  ...
		  echo '<script language="javascript">alert("El Nombre de la Institución es Requerido")</script>'; 
		...
		$codigoinstitucion = mysql_query($query_codigoinstitucion, $sala) or die("$query_codigoinstitucion");



		$totalRows_codigoinstitucion = mysql_num_rows($codigoinstitucion);



		$row_codigoinstitucion = mysql_fetch_assoc($codigoinstitucion);	
		...
		if ($row_codigoinstitucion <> "")
...

		 {
		   ...
		   echo '<script language="javascript">alert("Código de Institución ya existe")</script>'; 
...

		{
		  ...
		  echo '<script language="javascript">alert("Debe seleccionar la modalidad")</script>'; 
	  ...
	  if ($_POST['codigocolegio'] == "")
...

		{
		  ...
		  echo '<script language="javascript">alert("Debe Digitar el código del Icfes")</script>'; 
...

	   {
	     ...
	     $sql.= "VALUES('".$_POST['codigocolegio']."','".$_POST['nombre']."','01','".$_POST['pais']."','".$_POST['pais']."','".$_POST['pais']."','SIN DEFINIR','SIN DEFINIR','SIN DEFINIR','001','001','001','100','300','0','100','SIN DEFINIR','SIN DEFINIR','SIN DEFINIR','0','SIN DEFINIR','002','0','SIN DEFINIR','SIN DEFINIR','".$_POST['niveleducacion']."')"; 
