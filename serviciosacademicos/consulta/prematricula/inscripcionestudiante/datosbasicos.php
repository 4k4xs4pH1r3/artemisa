...
?>
          ...
          <td id="tdtitulogris">Expedida en (lugar)<label id="labelresaltado">*</label></td>
...
{
    //Para limpiar los espacios en blanco al final y al principio, con eso el aplicativo no los tiene en cuenta
