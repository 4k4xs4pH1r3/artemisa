...
/*$query_periodoactivo = "select codigoperiodo
from periodo
...
<?php
	...
	location.href="matriculaautomaticaordenmatricula.php?programausadopor='.$_GET['programausadopor'].'";
	</script>';
}
/////////////////////////////////////////////////  valores
...
?>
  ...
  <table width="631" border="1" align="center" cellpadding="2" cellspacing="1" bordercolor="#FF9900">
    <tr>
    <td width="232" class="Estilo4 Estilo1"><div align="center"><span class="Estilo6"><?php if($fechas['nombredetallefechafinanciera'] != ""){ echo $fechas['nombredetallefechafinanciera'];} else echo "Pago Extraordinario";?></span></div></td>
...
<?php
	...
	else
	{
		//echo "Permitido";
?>
<input name="imprimir" type="button" id="imprimir" value="Imprimir" onClick="window.location.href='impresion.php<?php echo "?ordenpago=$ordenpago&programausadopor=".$_GET['programausadopor']."&estudiante=".$_GET['estudiante'].""; ?>'">&nbsp;&nbsp;&nbsp;&nbsp;
<?php
	}
}
else
...
?>
<input name="regresar" type="button" id="imprimir" value="Regresar" onClick="window.location.href='matriculaautomaticaordenmatricula.php<?php echo "?programausadopor=".$_GET['programausadopor'].""; ?>'">&nbsp;&nbsp; &nbsp;&nbsp;
<?php
...
<form name="form2" method="post" action="../../../libsoap/class.sendws.php" onSubmit="return disableForm(this);" target="_parent">
  ...
  <input type="submit" name="enviar" value="Pagar"> </form>
  <table width="11%"  border="0" align="center" cellpadding="1"
cellspacing="1">
  <tr>
    <td><a href="http://www.achcolombia.com.co/pse.html"
target="_blank"><img src="../../../imagenes/LogoPSE.gif" width="103"
height="87"></a></td>
  </tr>
</table>
<?php
