...
<script language="javascript">
	alert("El estudiante no ingreso en un periodo activo, por lo tanto la generación de la orden debe hacerse manual");	history.go(-1);
</script>
<?php
}
?>
...
<body>
<div align="center">
<form action="generarprimersemestreindividual.php" name="f1" method="get">
<input type="hidden" name="estudiante" value="<?php echo $codigoestudiante; ?>">
<p align="center"><strong>Fecha de plazo de pago de la orden para estudiantes nuevos 
</strong></p>
