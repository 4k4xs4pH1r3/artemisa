...
<body>
<P>Ordenes de pago activas con concepto 151 que se repiten mas de 2 veces</P>
...
//{
	...
	{
		$sqlini = "select count(*) as cuenta, e.codigoestudiante, eg.numerodocumento ,c.nombrecarrera, dc.valordetallecohorte, do.valorconcepto
		from ordenpago o, estudiante e, detalleordenpago do, estudiantegeneral eg, carrera c, cohorte coh, detallecohorte dc
		...
		and coh.codigoperiodo = o.codigoperiodo
		and coh.codigoperiodoinicial <= e.codigoperiodo
		and coh.codigoperiodofinal >= e.codigoperiodo
		and dc.idcohorte = coh.idcohorte
		and dc.semestredetallecohorte = e.semestre
		group by 2
		having cuenta > 1";
	}
	//$sqlfin =" group by 1";
	...
	$pager->Render($rows_per_page,'width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#E9E9E9"', array('Cuenta','Código','Documento','Carrera','Valor Cohorte','Valor Concepto')); 
?>
<br>
<input type="submit" value="Enviar" name="naenviar">
<!-- <input type="button" value="Restablecer" onClick="window.location.reload('ordenesdepagopagas.php')"><input type="button" value="Regresar" onClick="window.location.reload('ordenesdepago.php')"> -->
<?php
//}
?>
</form>
