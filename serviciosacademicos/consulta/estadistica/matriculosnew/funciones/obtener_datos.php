...
class obtener_datos_matriculas {
    ...
    function ObtenerMetas($codigocarrera,$codigoperiodo,$retorno) {
         $query="select meta from obs_metas_admisiones where codigocarrera='".$codigocarrera."' and codigoperiodo='".$codigoperiodo."'";
         //echo $query;
      ...
      function ObtenerMatriculadosDia($codigocarrera,$codigoperiodo,$retorno,$fecha) {
         $query="select matriculados_totales from obs_admisiones_estadisticas where codigocarrera='".$codigocarrera."' and fecha_crear like '%".$fecha."%'";
         //echo $query;
         $operacion=$this->conexion->query($query);
         $row_operacion=$operacion->fetchRow();
         $conteo=$row_operacion[0];
         if(empty($conteo)){
             $query="SELECT matriculados_totales FROM obs_admisiones_estadisticas where fecha_crear <'".$fecha."' and codigocarrera='".$codigocarrera."' ";
                //echo $query;
                $operacion=$this->conexion->query($query);
                $row_operacion=$operacion->fetchRow();
                $conteo=$row_operacion[0];
...
ORDER BY c.codigocarrera
    ...
    function seguimiento_inscripcionvsmatriculadosnuevos($codigocarrera,$retorno) {
        ...
        $array_matriculados_nuevos=$this->obtener_datos_estudiantes_matriculados_nuevos($codigocarrera,'arreglo');
        //echo "<br/><br/>";echo "2 carrera <pre>";print_r($array_inscripcion);echo "<br/><br/>";
        //echo "<pre>";print_r($array_matriculados_nuevos);echo "<br/><br/>";
    ...
    function seguimiento_inscripcionvsmatriculadosnuevos_modalidad_carrera($modalidad,$codigoperiodo,$retorno) {
        ...
        $contadores = array();
        //echo "<br/><br/>";echo "2 <pre>";print_r($array_inscripcion[132]);echo "<br/><br/>";
        //echo "<pre>";print_r($array_matriculados_nuevos[132]);echo "<br/><br/>";
        ...
        //echo "<pre>";print_r($array_diferencia[132]);echo "<br/><br/>";
        if($retorno=='conteo') {
            return $contadores;
        }
        elseif ($retorno=='arreglo') {
...
group by hh.codigoestudiante
    ...
    /*function obtener_datos_cuentaoperacionprincipal_ordenesnopagas($codigoperiodo,$codigocarrera,$cuentaoperacionprinicipal,$retorno) {
     ...
     function obtener_datos_cuentaoperacionprincipal_ordenesnopagas($codigoperiodo,$codigocarrera,$cuentaoperacionprinicipal,$retorno,$detNuevo) {

	if($detNuevo==1){
           $estnuevo="AND e.codigoperiodo=".$codigoperiodo;
        }
	else{
           $estantiguo="AND e.codigoperiodo <>".$codigoperiodo;
        }
    ...
    function ObtenerDatosCuentaOperacionPrincipalIncluyeInscritosSinPago($codigoperiodo,$codigocarrera,$cuentaoperacionprincipal,$retorno,$codigomodalidadacademicasic=null) {
        ...
        //echo "$query";
        //exit();
        $query="SELECT ee.codigoestudiante, ee.codigoperiodo, ee.codigoprocesovidaestudiante, e.codigocarrera,ee.estudianteestadisticafechafinal 
                FROM estudianteestadistica ee
                INNER JOIN estudiante e ON e.codigoestudiante=ee.codigoestudiante
                INNER JOIN carrera c ON c.codigocarrera=e.codigocarrera $carrera $modalidad
                  and ee.codigoperiodo = '$codigoperiodo'
    ...
    function ObtenerDatosCuentaOperacionPrincipalInscritosNoEvaluado($codigoperiodo,$codigocarrera,$cuentaoperacionprincipal,$retorno,$codigomodalidadacademicasic=null) {
        ...
        and eci.idnumeroopcion = '1'
                $carrera
                ";*/
        $query="SELECT ee.codigoestudiante
                    ,ee.codigoperiodo
                ...
                where                     
                    ee.codigoestudiante=e.codigoestudiante
                    and ee.codigoperiodo = '$codigoperiodo'
                    and ee.codigoprocesovidaestudiante= 200
                    and ee.codigoestado like '1%'
                    and e.codigosituacioncarreraestudiante in (107,111)
    ...
    function obtener_datos_estudiantes_matriculados_nuevos($codigocarrera,$retorno,$codigomodalidadacademicasic=null,$codigomodalidadacademica=null) {
        $carrera = "";
        if(trim($codigocarrera)!='')
            $carrera = " AND e.codigocarrera='".$codigocarrera."'";
    ...
    function obtener_datos_estudiantes_matriculados_antiguos_tipoestudiante($codigocarrera,$codigotipoestudiante,$retorno,$codigomodalidadacademica=null) {
        $carrera = "";
        $modalidad = "";
        if(trim($codigocarrera)!='')
            $carrera = " AND e.codigocarrera='".$codigocarrera."'";
...
/*Arreglar el codigo periodo por ".$this->codigoperiodo."*/
    ...
    function obtener_colegio_estudiante($codigoestudiante,$codigomodalidadacademica) {
        $query="
		SELECT
		       if(i.idinstitucioneducativa=1,ie.otrainstitucioneducativaestudianteestudio,i.nombreinstitucioneducativa) nombreinstitucion, 
                    ie.anogradoestudianteestudio, ie.colegiopertenececundinamarca,
                    if(i.idinstitucioneducativa=1,ie.ciudadinstitucioneducativa,i.municipioinstitucioneducativa) ciudadinstitucioneducativa
		FROM
...
$row_operacion['anogradoestudianteestudio']="NO DEFINIDA";
       ...
       // echo "<br/><br/>"; var_dump($row_operacion);
...
//echo "<BR><H1>MODALIDAD ACADEMICA =</H1>".$codigomodalidadacademica."<BR>";
    ...
    function obtener_datos_estudiante($codigoestudiante) {
		...
		ba.estudiantebarrio as localidad, 
...
//		having
    ...
    function No_Admitidos($Carrera,$retorno){
           ...
           $SQL='SELECT 
                ...
                WHERE codigosituacioncarreraestudiante =113 AND codigoperiodo ="'.$this->codigoperiodo.'" AND codigocarrera ="'.$Carrera.'"';
