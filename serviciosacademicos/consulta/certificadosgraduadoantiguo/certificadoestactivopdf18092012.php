...
/*IDENTIFICADO*/
    ...
    $pdf->Ln(10);
    $pdf->SetX(20);
    $pdf->Cell(0, 0, 'VERIFICACIÓN DE INFORMACIÓN ESTUDIANTE ACTIVO ', 0, 2, 'C');
    $pdf->Ln(15);
    $pdf->SetX(20);
    $pdf->SetFontSize(12);
    $pdf->MultiCell(0, 5.5, 'La Secretaría General certifica que verificado el sistema académico de la universidad, se encuentra el registro de  '.$trato.' ' . $row_datos['nombre'] . ' '.$identificado.' con ' . $row_datos['nombredocumento'] . ' Nº ' . $row_datos['numerodocumento'] . ', quien adelanta estudios en esta institución, conforme a la siguiente información:', 0, 'J');
    $pdf->Ln(10);
    $pdf->SetX(55);
    $pdf->SetFontSize(10);
    ...
    do {
        $pdf->Ln(6);
        $pdf->SetX(55);
        $pdf->celda(60, 5.5, $row_datos['nombrecarrera'], 0, 'C', 1, 0);
