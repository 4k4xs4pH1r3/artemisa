...
//print_r($_SESSION);
echo "<form name=\"form2\" action=\"listadocierreaportes.php\" method=\"post\"  >
...
*/
	unset($formulario->filatmp);
	$formulario->filatmp["1"]="Normal";$formulario->filatmp["2"]="Extemporaneo";$formulario->filatmp["3"]="Normal o Extemporaneo";
	$formulario->filatmp["4"]="No ingresados"; $formulario->filatmp["0"]="NA";
 	$defecto="NA";
	...
	$conboton++;
	$parametrobotonenviar[$conboton]="'planopdf.php','planopdf','Archivo PDF','600','400','form2','yes'";
	$boton[$conboton]='ventana_emergente_submit';
	$conboton++;
	$parametrobotonenviar[$conboton]="'informeporepspdf.php','informeeps','Informe EPS','600','400','form2','yes'";
	$boton[$conboton]='ventana_emergente_submit';
	$conboton++;
...
$query=querylistadocierre($pagoeps,$pagoarp,$codigoperiodo,$codigomodalidadacademica,0,"15/".$_POST['mescierre']);
//echo $query."<br>";
//exit();
...
if(isset($row_operacion['idestudiantegeneral'])||($row_operacion['idestudiantegeneral']!='')){	
		...
		$datos_estudiante=$datos_bd->Qrecuperar_datos_tabla("estudiante e, carreracentrotrabajoarp c","idestudiantegeneral",$row_operacion['idestudiantegeneral'],$condicion,', max(codigoestudiante) numeroestudiante',$imprimir);*/
		...
		//$row_temp['Numero']=$total+1;
		//$row_operacion=InsertarColumnaFila($row_operacion,$row_temp,0);
...
$motor->agregarllave_drilldown('numerodocumento','listadocierreaportes.php','ingresoaportes.php','','codigoestudiante',"",'','','','','onclick= "return ventanaprincipal(this)"');
