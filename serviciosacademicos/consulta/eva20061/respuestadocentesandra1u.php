...
where r.codigoperiodo='20061' and 
...
?>
        ...
        if ($_POST['odigodocente'] <> 0)
         {  // if 1  
			...
			$_SESSION['codigodocente']= $_POST['odigodocente'];
			//echo $_POST['odigodocente'];
			$query_ddd = "SELECT DISTINCT d.nombredocente,d.apellidodocente,r.codigodocente,m.nombremateria,m.codigomateria FROM docente d, respuestas r,materia m where r.codigoperiodo='20061' and d.numerodocumento=r.codigodocente and m.codigomateria=r.codigomateria and r.codigodocente='".$_POST['odigodocente']."' ORDER BY m.nombremateria";
			//echo $query_car;
...
?>
        ...
        if ($_POST['odigomateria'] <> 0)
         {  // if 1  
			$query_periodo = "SELECT DISTINCT idgrupo FROM respuestas where codigoperiodo='20061' and codigodocente='".$_POST['odigodocente']."' and codigomateria='".$_POST['odigomateria']."' ORDER BY idgrupo";
