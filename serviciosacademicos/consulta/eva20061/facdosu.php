...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  //$digo=123;
  //$digo=$_GET['di'];
  //echo "aqui esta codigo carrera $digo";
  include("pconexionbase.php");
  $sql_carre= "SELECT  nombrecarrera FROM carrera where codigocarrera = '$digo'";
...
<p align="center" class="style1 Estilo1 Estilo2"><strong>2006-01</strong></p>
...
$sql_noencuestas= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and codigoperiodo='20061'";
...
$sql_rp1e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp1 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp1b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp1 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp1b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp1 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp1p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp1 = 'p' and codigoperiodo='20061'";
...
$sql_rp2e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp2 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp2b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp2 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp2b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp2 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp2p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp2 = 'p' and codigoperiodo='20061'";
...
$sql_rp3e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp3 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp3b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp3 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp3b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp3 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp3p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp3 = 'p' and codigoperiodo='20061'";
...
//echo "el numero de personas que respondieron la pregunta 1 son:".$contarp1;
$sql_rp4e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp4 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp4b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp4 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp4b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp4 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp4p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp4 = 'p' and codigoperiodo='20061'";
...
$sql_rp5e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp5 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp5b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp5 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp5b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp5 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp5p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp5 = 'p' and codigoperiodo='20061'";
...
$sql_rp6e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp6 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp6b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp6 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp6b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp6 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp6p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp6 = 'p' and codigoperiodo='20061'";
...
$sql_rp7e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp7 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp7b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp7 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp7b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp7 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp7p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp7 = 'p' and codigoperiodo='20061'";
...
//echo "el numero de personas que respondieron la pregunta 1 son:".$contarp1;
$sql_rp8e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp8 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp8b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp8 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp8b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp8 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp8p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp8 = 'p' and codigoperiodo='20061'";
...
$sql_rp9e= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp9 = 'e' and codigoperiodo='20061'";
...
//echo $porcenep1;
//
$sql_rp9b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp9 = 'b' and codigoperiodo='20061'";
...
//
$sql_rp9b= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp9 = 'd' and codigoperiodo='20061'";
...
//
$sql_rp9p= "SELECT  distinct codigoestudiante  FROM evafacultad where codigocarrera = '$digo' and resp9 = 'p' and codigoperiodo='20061'";
...
$sql_rp10b= "SELECT  resp10  FROM evafacultad where codigocarrera = '$digo' and codigoperiodo='20061'";
