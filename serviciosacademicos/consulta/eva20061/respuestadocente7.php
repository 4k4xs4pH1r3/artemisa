...
?>
        ...
        if ($_POST['odigodocente'] <> 0)
         ...
         {  // if 1  
			...
			$query_car = "SELECT DISTINCT d.nombredocente,d.apellidodocente,r.codigodocente,m.nombremateria,m.codigomateria FROM docente d, respuestas r,materia m where d.numerodocumento=r.codigodocente and m.codigomateria=r.codigomateria and r.codigodocente='".$_POST['odigodocente']."' and r.codigoperiodo='20072' ORDER BY m.nombremateria";
...
?>
        ...
        if ($_POST['odigomateria'] <> 0)
         ...
         {  // if 1  
			...
			$query_periodo = "SELECT DISTINCT idgrupo FROM respuestas where codigodocente='".$_POST['odigodocente']."' and codigomateria='".$_POST['odigomateria']."' and codigoperiodo='20072' ORDER BY idgrupo";
