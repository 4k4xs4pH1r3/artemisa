...
<table width="79%"  border="1">
  <tr>
    ...
    <td width="28%"><strong>ALUMOS QUE EVALUARON </strong></td>
  ...
  //$query_car = "select distinct d.nombredocente,d.apellidodocente,d.numerodocumento,e.codigocarrera,c.nombrecarrera 
			...
			//$row_car = mysql_fetch_assoc($car);
			//$totalRows_car = mysql_num_rows($car);
  while ($fcar=mysql_fetch_assoc($car))
		  {
		  $numnbt=$fcar['numerodocumento'];
$query_grup= "SELECT DISTINCT idgrupo FROM respuestas where codigoperiodo='20081' and codigodocente = '$numnbt'";
