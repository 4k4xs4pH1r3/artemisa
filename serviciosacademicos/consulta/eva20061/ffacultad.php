...
<html>
    ...
    <body>
<?php
if (isset($_GET['entradadirecta']) &&
        trim($_GET['entradadirecta']) != '') {
    $_SESSION["entradadirectaevafacultad"] = 1;
}

if (isset($_GET['codigoestudiante']) &&
        trim($_GET['codigoestudiante']) != '') {

    $_SESSION['codigo'] = $_GET['codigoestudiante'];
}
$codigoest = $_SESSION['codigo'];
/*else {
    $codigoest = $_GET['codigoestudiante'];
    $_SESSION['codigo'] = $_GET['codigoestudiante'];
}*/
//echo $_SESSION['codigo'];
//exit();
mysql_select_db($database_sala, $sala);
$ttt = "SELECT evaluof FROM evafacultad WHERE codigoestudiante='$codigoest' and codigoperiodo='20102'";
...
//echo "ejecute la evaluacion";
    //mysql_select_db($database_sala, $sala);
    //lo que viene es para evitar que el usuaria vuelva a evaluar
...
?>
        ...
        <form action="pevaluacion4.php" method="post" name="grabar" id="grabar">
                ...
                <tr bgcolor="#C5D5D6">
                    <td height="20" colspan="2" align="center"> <input name="codigopregunta" type="hidden" value="1">
                        <div class="Estilo2">EVALUACI&Oacute;N DE LA FACULTAD Y DE LOS RECURSOS
                            F&Iacute;SICOS Y TECNOL&Oacute;GICOS CON LOS QUE SE CUENTA 2010 - 02</div></td>
                </tr>
                <tr bgcolor="#ffffff">
                    <td height="77" colspan="2"><span class="Estilo1">Mediante esta encuesta,
                        ...
                        <span class="Estilo1">Eval&uacute;a la respuesta de la pregunta, bajo
                            los siguientes par&aacute;metros.</span> <span class="Estilo4">Debe responder todos los campos y las observaciones.</span><br>
                        <br>
                        <span class="Estilo2">E. Excelente  B. Bueno D. Deficiente P.
            ...
            <p align="center">
                <input name="grabar" type="submit" id="grabar" value="Enviar">
            </p>
