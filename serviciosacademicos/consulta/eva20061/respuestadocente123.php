...
?>
        ...
        <table width="95%" border="0" align="center" cellpadding="3" bordercolor="#ffffff">
          ...
          <tr bgcolor='#FFFFFF'> 
			...
			$query_car = "SELECT DISTINCT codigoperiodo FROM respuestas";
...
?>
              ...
              <select name="perio" id="select12" onChange="enviar()">

               

                <option value="0" <?php if (!(strcmp("0", $_POST['perio']))) {echo "SELECTED";} ?>>Seleccionar</option>
...
?>
                ...
                <option value="<?php echo $row_car['codigoperiodo']?>"<?php if (!(strcmp($row_car['codigoperiodo'], $_POST['perio']))) {echo "SELECTED";} ?>><?php echo $row_car['codigoperiodo']?></option>
...
?>
        ...
        if ($_POST['odigodocente'] <> 0)
         ...
         {  // if 1  
			...
			$query_car = "SELECT DISTINCT d.nombredocente,d.apellidodocente,r.codigodocente,m.nombremateria,m.codigomateria FROM docente d, respuestas r,materia m where d.numerodocumento=r.codigodocente and m.codigomateria=r.codigomateria and r.codigodocente='".$_POST['odigodocente']."' and r.codigoperiodo='20061' ORDER BY m.nombremateria";
...
?>
        ...
        if ($_POST['odigomateria'] <> 0)
         ...
         {  // if 1  
			...
			$query_periodo = "SELECT DISTINCT idgrupo FROM respuestas where codigodocente='".$_POST['odigodocente']."' and codigomateria='".$_POST['odigomateria']."' and codigoperiodo='20061' ORDER BY idgrupo";
...
$sql_noencuestas= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li'";
...
$sql_rp1a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp1 = 'a'";
...
//echo $porcenep1;
//
$sql_rp1p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp1 = 'p'";
...
//
$sql_rp1d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp1 = 'd'";
...
$sql_rp1exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa1 = 'e'";
...
//
$sql_rp1exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb1 = 'e'";
...
//
$sql_rp1exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc1 = 'e'";
...
//
//
$sql_rp1buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa1 = 'b'";
...
//
$sql_rp1bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb1 = 'b'";
...
//
$sql_rp1bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc1 = 'b'";
...
//
$sql_rp1rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa1 = 'r'";
...
//
$sql_rp1regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb1 = 'r'";
...
//
$sql_rp1regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc1 = 'r'";
...
//
$sql_rp1defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa1 = 'd'";
...
//
$sql_rp1defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb1 = 'd'";
...
//
$sql_rp1defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc1 = 'd'";
...
//
$sql_rp1nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa1 = 'n'";
...
//
$sql_rp1nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb1 = 'n'";
...
//
$sql_rp1nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc1 = 'n'";
...
$sql_rp2a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp2 = 'a'";
...
//echo $porcenep1;
//
$sql_rp2p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp2 = 'p'";
...
//
$sql_rp2d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp2 = 'd'";
...
$sql_rp2exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa2 = 'e'";
...
//
$sql_rp2exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb2 = 'e'";
...
//
$sql_rp2exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc2 = 'e'";
...
//
//
$sql_rp2buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa2 = 'b'";
...
//
$sql_rp2bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb2 = 'b'";
...
//
$sql_rp2bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc2 = 'b'";
...
//
$sql_rp2rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa2 = 'r'";
...
//
$sql_rp2regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb2 = 'r'";
...
//
$sql_rp2regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc2 = 'r'";
...
//
$sql_rp2defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa2 = 'd'";
...
//
$sql_rp2defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb2 = 'd'";
...
//
$sql_rp2defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc2 = 'd'";
...
//
$sql_rp2nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa2 = 'n'";
...
//
$sql_rp2nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb2 = 'n'";
...
//
$sql_rp2nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc2 = 'n'";
...
$sql_rp3a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp3 = 'a'";
...
//echo $porcenep1;
//
$sql_rp3p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp3 = 'p'";
...
//
$sql_rp3d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp3 = 'd'";
...
$sql_rp3exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa3 = 'e'";
...
//
$sql_rp3exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb3 = 'e'";
...
//
$sql_rp3exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc3 = 'e'";
...
//
//
$sql_rp3buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa3 = 'b'";
...
//
$sql_rp3bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb3 = 'b'";
...
//
$sql_rp3bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc3 = 'b'";
...
//
$sql_rp3rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa3 = 'r'";
...
//
$sql_rp3regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb3 = 'r'";
...
//
$sql_rp3regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc3 = 'r'";
...
//
$sql_rp3defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa3 = 'd'";
...
//
$sql_rp3defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb3 = 'd'";
...
//
$sql_rp3defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc3 = 'd'";
...
//
$sql_rp3nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa3 = 'n'";
...
//
$sql_rp3nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb3 = 'n'";
...
//
$sql_rp3nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc3 = 'n'";
...
$sql_rp4a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp4 = 'a'";
...
//echo $porcenep1;
//
$sql_rp4p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp4 = 'p'";
...
//
$sql_rp4d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp4 = 'd'";
...
$sql_rp4exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa4 = 'e'";
...
//
$sql_rp4exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb4 = 'e'";
...
//
$sql_rp4exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc4 = 'e'";
...
//
//
$sql_rp4buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa4 = 'b'";
...
//
$sql_rp4bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb4 = 'b'";
...
//
$sql_rp4bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc4 = 'b'";
...
//
$sql_rp4rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa4 = 'r'";
...
//
$sql_rp4regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb4 = 'r'";
...
//
$sql_rp4regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc4 = 'r'";
...
//
$sql_rp4defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa4 = 'd'";
...
//
$sql_rp4defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb4 = 'd'";
...
//
$sql_rp4defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc4 = 'd'";
...
//
$sql_rp4nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa4 = 'n'";
...
//
$sql_rp4nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb4 = 'n'";
...
//
$sql_rp4nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc4 = 'n'";
...
$sql_rp5a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp5 = 'a'";
...
//echo $porcenep1;
//
$sql_rp5p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp5 = 'p'";
...
//
$sql_rp5d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp5 = 'd'";
...
$sql_rp5exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa5 = 'e'";
...
//
$sql_rp5exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb5 = 'e'";
...
//
$sql_rp5exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc5 = 'e'";
...
//
//
$sql_rp5buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa5 = 'b'";
...
//
$sql_rp5bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb5 = 'b'";
...
//
$sql_rp5bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc5 = 'b'";
...
//
$sql_rp5rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa5 = 'r'";
...
//
$sql_rp5regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb5 = 'r'";
...
//
$sql_rp5regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc5 = 'r'";
...
//
$sql_rp5defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa5 = 'd'";
...
//
$sql_rp5defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb5 = 'd'";
...
//
$sql_rp5defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc5 = 'd'";
...
//
$sql_rp5nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa5 = 'n'";
...
//
$sql_rp5nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb5 = 'n'";
...
//
$sql_rp5nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc5 = 'n'";
...
//echo "el numero de personas que respondieron la pregunta 1 son:".$contarp1;
$sql_rp6a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp6 = 'a'";
...
//echo $porcenep1;
//
$sql_rp6p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp6 = 'p'";
...
//
$sql_rp6d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp6 = 'd'";
...
$sql_rp6exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa6 = 'e'";
...
//
$sql_rp6exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb6 = 'e'";
...
//
$sql_rp6exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc6 = 'e'";
...
//
//
$sql_rp6buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa6 = 'b'";
...
//
$sql_rp6bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb6 = 'b'";
...
//
$sql_rp6bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc6 = 'b'";
...
//
$sql_rp6rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa6 = 'r'";
...
//
$sql_rp6regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb6 = 'r'";
...
//
$sql_rp6regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc6 = 'r'";
...
//
$sql_rp6defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa6 = 'd'";
...
//
$sql_rp6defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb6 = 'd'";
...
//
$sql_rp6defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc6 = 'd'";
...
//
$sql_rp6nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa6 = 'n'";
...
//
$sql_rp6nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb6 = 'n'";
...
//
$sql_rp6nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc6 = 'n'";
...
//echo "el numero de personas que respondieron la pregunta 1 son:".$contarp1;
//echo "el numero de personas que respondieron la pregunta 5 son:".$contarp5;
$sql_rp7a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp7 = 'a'";
...
//echo $porcenep1;
//
$sql_rp7p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp7 = 'p'";
...
//
$sql_rp7d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp7 = 'd'";
...
$sql_rp7exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa7 = 'e'";
...
//
$sql_rp7exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb7 = 'e'";
...
//
$sql_rp7exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc7 = 'e'";
...
//
//
$sql_rp7buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa7 = 'b'";
...
//
$sql_rp7bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb7 = 'b'";
...
//
$sql_rp7bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc7 = 'b'";
...
//
$sql_rp7rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa7 = 'r'";
...
//
$sql_rp7regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb7 = 'r'";
...
//
$sql_rp7regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc7 = 'r'";
...
//
$sql_rp7defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa7 = 'd'";
...
//
$sql_rp7defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb7 = 'd'";
...
//
$sql_rp7defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc7 = 'd'";
...
//
$sql_rp7nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa7 = 'n'";
...
//
$sql_rp7nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb7 = 'n'";
...
//
$sql_rp7nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc7 = 'n'";
...
//echo "el numero de personas que respondieron la pregunta 1 son:".$contarp1;
$sql_rp8a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp8 = 'a'";
...
//echo $porcenep1;
//
$sql_rp8p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp8 = 'p'";
...
//
$sql_rp8d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp8 = 'd'";
...
$sql_rp8exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa8 = 'e'";
...
//
$sql_rp8exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb8 = 'e'";
...
//
$sql_rp8exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc8 = 'e'";
...
//
//
$sql_rp8buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa8 = 'b'";
...
//
$sql_rp8bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb8 = 'b'";
...
//
$sql_rp8bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc8 = 'b'";
...
//
$sql_rp8rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa8 = 'r'";
...
//
$sql_rp8regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb8 = 'r'";
...
//
$sql_rp8regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc8 = 'r'";
...
//
$sql_rp8defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa8 = 'd'";
...
//
$sql_rp8defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb8 = 'd'";
...
//
$sql_rp8defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc8 = 'd'";
...
//
$sql_rp8nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa8 = 'n'";
...
//
$sql_rp8nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb8 = 'n'";
...
//
$sql_rp8nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc8 = 'n'";
...
//echo "el numero de personas que respondieron la pregunta 1 son:".$contarp1;
$sql_rp9a= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp9 = 'a'";
...
//echo $porcenep1;
//
$sql_rp9p= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp9 = 'p'";
...
//
$sql_rp9d= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and resp9 = 'd'";
...
$sql_rp9exea= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa9 = 'e'";
...
//
$sql_rp9exeb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb9 = 'e'";
...
//
$sql_rp9exec= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc9 = 'e'";
...
//
$sql_rp9exed= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respd9 = 'e'";
...
//echo $porcexerp9;
//
$sql_rp9exee= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respe9 = 'e'";
...
//echo $porcexelp9;
//
$sql_rp9buna= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa9 = 'b'";
...
//
$sql_rp9bunb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb9 = 'b'";
...
//
$sql_rp9bunc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc9 = 'b'";
...
//
//
$sql_rp9bund= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respd9 = 'b'";
...
//
$sql_rp9bune= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respe9 = 'b'";
...
$sql_rp9rega= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa9 = 'r'";
...
//
$sql_rp9regb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb9 = 'r'";
...
//
$sql_rp9regc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc9 = 'r'";
...
//
$sql_rp9regd= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respd9 = 'r'";
...
//
$sql_rp9rege= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respe9 = 'r'";
...
//
$sql_rp9defa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa9 = 'd'";
...
//
$sql_rp9defb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb9 = 'd'";
...
//
$sql_rp9defc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc9 = 'd'";
...
//
$sql_rp9defd= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respd9 = 'd'";
...
//
$sql_rp9defe= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respe9 = 'd'";
...
//
$sql_rp9nopa= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respa9 = 'n'";
...
//
$sql_rp9nopb= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respb9 = 'n'";
...
//
$sql_rp9nopc= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respc9 = 'n'";
...
//
$sql_rp9nopd= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respd9 = 'n'";
...
//
$sql_rp9nope= "SELECT  distinct codigoestudiante  FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li' and respe9 = 'n'";
...
<table width="586" border="0" align="center" cellspacing="0">
  ...
  <tr> 
    ...
    <td><div align="center"><font size="1" face="tahoma"><strong>A</strong> <span class="style1 style7"><?php printf ( "%.2f", $porcenep1) ; ?>%</span></font></div></td>
  ...
  <tr> 
    ...
    <td><div align="center"><font size="1" face="tahoma"><strong>P</strong><span class="style8"> 
...
<table width="586" border="0" align="center" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="61"><div align="center"><font size="1" face="tahoma"><strong>E</strong><span class="style1 style7"> 
...
<table width="586" border="0" align="center" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="61"><div align="center"><font size="1" face="tahoma"><strong>E 
...
<table width="586" border="0" align="center" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="63"><div align="center"><font size="1" face="tahoma"><strong>E 
...
<table width="586" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td> <font size="1" face="tahoma"> 
        <?php 
$obse = "SELECT observaciones FROM respuestas where codigoperiodo=20061 and idgrupo='$yui' and codigodocente = '$li'";
