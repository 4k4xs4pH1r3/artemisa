...
?>
  ...
  <table width="586" border="1" align="center" bordercolor="#003333" cellpadding="0" cellspacing="0">
    <tr> 
      <td> 
        <?php
if ($row_data <> "")
...
?>
        <table width="95%" border="0" align="center" cellpadding="3" bordercolor="#003333">
          <tr bgcolor='#FEF7ED'> 
            <td class="Estilo2">&nbsp;Fecha de la Solicitud:</td>
            <td class="Estilo1"><?php echo date("j-n-Y g:i",time())?>&nbsp; <input name="hora" type="hidden" id="hora" value="<?php echo time()?>"> 
              <strong></strong><span class="Estilo16"> </span></td>
          </tr>
          <tr bgcolor='#FEF7ED'> 
            <td class="Estilo2">&nbsp;Docente Evaluado:</td>
            <td class="Estilo1"> <select name="odigodocente" id="select8" onChange="enviar()">
                <option value="0" <?php if (!(strcmp("0", $_POST['odigodocente']))) {echo "SELECTED";} ?>>Seleccionar</option>
                <?php
      do {  
?>
                <option value="<?php echo $row_data['numerodocumento']?>"<?php if (!(strcmp($row_data['numerodocumento'], $_POST['odigodocente']))) {echo "SELECTED";} ?>><?php echo $row_data['nombredocente']; echo $row_data['apellidodocente'];?></option>
                <?php
...
?>
              <select name="odigomateria" id="select10" onChange="enviar()">
                <?php
...
?>
              <select name="grupito" id="select6" onChange="enviar()">
<?php
...
?>
<div align="center"><font size="2" face="tahoma"><strong>FACULTAD<span class="style1"><strong><span class="style3"> 
  <?php echo "$fa"?></span></strong></span></strong> </font> </div>
