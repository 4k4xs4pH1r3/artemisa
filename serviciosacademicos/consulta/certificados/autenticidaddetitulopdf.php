...
r.fechaactaregistrograduadoantiguo, f.folio, rg.idregistrograduado, d.nombrecortodocumento, eg.expedidodocumento,c.nombrecarrera,eg.apellidosestudiantegeneral
            ...
            union
            SELECT  g.nombregenero,tr.nombretrato, eg.idestudiantegeneral, concat(eg.nombresestudiantegeneral, ' ',eg.apellidosestudiantegeneral) as nombre, eg.numerodocumento, t.nombretitulo, r.numeroactaregistrograduado, r.fechagradoregistrograduado,
...
/*echo "";
 print_r($totalRows_datoscertificado);
echo "";*/
...
$meses = array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
    ...
    observacionlogdocumentacioncertificado) VALUES(79,
...
/*IDENTIFICADO*/
              ...
              $interesado="del interesado";
               ...
               $interesado="de la interesada";
                ...
                /*DIAS LETRA*/
             /*  if ( convercionnumerotexto(date("d"))=="primer") {

              $diasletra="el ".convercionnumerotexto($dia);

              }
              else if ( convercionnumerotexto(date("d"))!="primer") {
        ...
        $pdf->SetY(60);
        $pdf->SetX(15);
        $pdf->Cell(180, 5, 'CAT Nº: ' . $consecutivo, 0, 2, 'R');
    }
 /*header('Expires: Mon, 26 Jul 1997 05:00:00 GMT' );
header('Last-Modified: ' . gmdate('D, d M Y H:i:s') . 'GMT');
header('Cache-Control: no-cache, must-revalidate');
header("Content-Disposition: attachment; filename=certificadoautenticidad.pdf\r\n\r\n");
