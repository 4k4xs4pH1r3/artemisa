...
and e.codigoestudiante =$codigoestudiante)";
        ...
        $query_nombrepais = "SELECT nombrepais FROM pais where idpais='$pais'";
        $nombrepais = $db->Execute($query_nombrepais);
        $totalRows_nombrepais = $nombrepais->RecordCount();
        $row_nombrepais = $nombrepais->FetchRow();
        $nombrepaises=$row_nombrepais['nombrepais'];
...
and e.codigoestudiante =$codigoestudiante)";
	...
	AND c.codigotitulo = ti.codigotitulo";
        ...
        $moda = $solicitud_historico['codigomodalidadacademica'];
         ...
         /*Query Calculo de Creditos Academicos*/

          $query_horacreditopais = "SELECT * FROM creditosacademicospais
        where idpais='$pais' and codigoestado=100";
         $horacreditopais = mysql_query($query_horacreditopais, $sala) or die(mysql_error());
         $totalRows_horacreditopais = mysql_num_rows($horacreditopais);
     $row_horacreditopais = mysql_fetch_assoc($horacreditopais);

      $query_horacreditopaiscolombia = "SELECT * FROM creditosacademicospais
        where idpais='1' and codigoestado=100";
        $horacreditopaiscolombia = mysql_query($query_horacreditopaiscolombia, $sala) or die(mysql_error());
          $totalRows_horacreditopaiscolombia = mysql_num_rows($horacreditopaiscolombia);
           $row_horacreditopaiscolombia = mysql_fetch_assoc($horacreditopaiscolombia);
...
/*TRATO*/
         if ($solicitud_historico['nombregenero']=="Masculino") {
               ...
               $trato=explode('(', $solicitud_historico['nombretrato'], 2);
               $trato="el"." ".$trato[0];
              }
              else if ($solicitud_historico['nombregenero']=="Femenino") {

               $trato=explode('(', $solicitud_historico['nombretrato'], 2);
               $trato=$trato[0].$trato[1];
               $trato=explode(')', $trato, 2);
               $trato="la"." ".$trato[0];
              }
/*IDENTIFICADO*/
               if ($solicitud_historico['nombregenero']=="Masculino") {
        ...
        $array_interno['3']['textodetallecertificado'] = str_replace(" <EXPLICACION_CREDITO>", $row_horacreditopais, $array_interno['3']['textodetallecertificado']);
        ...
        $array_interno['4']['textodetallecertificado'] = str_replace(" <EXPLICACIONCOLOMBIA>", $row_horacreditopaiscolombia['explicacioncreditosacademicospais'], $array_interno['4']['textodetallecertificado']);
        $array_interno['4']['textodetallecertificado'] = str_replace(" <PAIS>", $nombrepaises, $array_interno['4']['textodetallecertificado']);
        $array_interno['4']['textodetallecertificado'] = str_replace(" <FUENTE>",$row_horacreditopais['fuentecreditosacademicospais'] , $array_interno['4']['textodetallecertificado']);
        $array_interno['4']['textodetallecertificado'] = str_replace(" <EXPLICACIONPAIS>",$row_horacreditopais['explicacioncreditosacademicospais'], $array_interno['4']['textodetallecertificado']);
        ...
        $array_interno['7']['textodetallecertificado'] = str_replace(" <DIANOMBRE>", convercionnumerotexto($dia), $array_interno['7']['textodetallecertificado']);
        ...
        $array_interno['7']['textodetallecertificado'] = str_replace(" <MES>", $meses[substr($mes, -1)-1], $array_interno['7']['textodetallecertificado']);
        ...
        $pdf->celda(15, 5, 'CRÉDITOS',92, 'J', 1, 0);
                ...
                //  $pdf->celda(10, 5, 'NOTA', 107, 'J', 1, 0);
                    ...
                    if($_GET['maxcredito']) {
                         ...
                         $pdf->celda(50, 5, 'Crédito Max '.$nombrepaises, 110, 'J', 1, 0);
                       
                    }
                    if($_GET['mincredito']) {

                         $pdf->celda(50, 5, 'Crédito Min '.$nombrepaises, 145, 'J', 1, 0);
...
/*Calculo Horas creditos colombia*/

                             $horacreditoscolombia= ($row_horacreditopaiscolombia['maxhoracreditosacademicospais']*$solicitud_historico['numerocreditos']) ;
                                      /* echo "Cualquier cosa<pre>";
                            print_r($horacreditoscolombia);
                            echo "</pre>";*/
                                ...
                                if($_GET['concredito'] == 1) { // if creditos
                                                ...
                                                if($solicitud_historico['codigoindicadorcredito'] == 200) {
                                                    if (ereg("^2",$solicitud_historico['codigotipocalificacionmateria'])) {
                                                        ...
                                                        $pdf->celda(9, 5, $solicitud_historico['total'], 78, 'C', 1,0);
                                                ...
                                                if($solicitud_historico['codigoindicadorcredito'] == 100) {
                                                    if (ereg("^2",$solicitud_historico['codigotipocalificacionmateria'])) {
                                                       ...
                                                       $pdf->celda(15, 5, $solicitud_historico['numerocreditos'], 87, 'C', 1,0);
...
//echo $solicitud_historico['numerocreditos'];
                                 ...
                                 if($_GET['maxcredito'] == 1) { // if creditos

                                             
                                             $horacreditomax= ($horacreditoscolombia/$row_horacreditopais['maxhoracreditosacademicospais']) ;

                                             $pdf->celda(9, 5, $horacreditomax, 115 , 'C', 1,0);
                                                
                                }

                                 if($_GET['mincredito'] == 1) { // if creditos

                                               $horacreditomin= ($horacreditoscolombia/$row_horacreditopais['minhoracreditoacademicopais']) ;
                                                     $pdf->celda(9, 5, $horacreditomin, 150, 'C', 1,0);
                            ...
                            if ($cuentacambioperiodo == $totalRows) {
                                ...
                                $pdf->celda(9, 5, $sumaulas, 78, 'C', 1,0);
                                $pdf->celda(15, 5, $sumacreditos, 87, 'C', 1,0);
                               $horacreditosponderadocolombia= ($row_horacreditopaiscolombia['maxhoracreditosacademicospais']*$sumacreditos) ;
                               $horacreditomax= ($horacreditosponderadocolombia/$row_horacreditopais['maxhoracreditosacademicospais']) ;
                                $pdf->celda(9, 5, $horacreditomax, 115 , 'C', 1,0);
                                $horacreditomin= ($horacreditosponderadocolombia/$row_horacreditopais['minhoracreditoacademicopais']) ;
                                 $pdf->celda(9, 5, $horacreditomin, 150, 'C', 1,0);
                                                  ...
                                                  //  $pdf->celda(10, 5, $promediosemestralperiodo, 102, 'C', 1,0);
...
header('Content-Type: application/pdf');*/
    ...
    $pdf->Output('../../funciones/clases/html2fpdf/notaperiodo.pdf');
?>
