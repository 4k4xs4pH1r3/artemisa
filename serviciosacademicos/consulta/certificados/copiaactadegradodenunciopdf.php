...
$_SERVER["REMOTE_ADDR"];
 ...
 $query_datos = "SELECT e.codigocarrera,g.nombregenero,tr.nombretrato,eg.idestudiantegeneral, concat(eg.nombresestudiantegeneral, ' ',eg.apellidosestudiantegeneral) as nombre, eg.numerodocumento,  r.tituloregistrograduadoantiguo, r.numeroactaregistrograduadoantiguo, r.fechagradoregistrograduadoantiguo,r.numerodiplomaregistrograduadoantiguo,d.tipodocumento,d.nombredocumento,rg.numeroacuerdoregistrograduado,
r.fechaactaregistrograduadoantiguo, f.folio, rg.idregistrograduado, d.nombrecortodocumento, eg.expedidodocumento,c.nombrecarrera,eg.apellidosestudiantegeneral
            ...
            where eg.numerodocumento =	'$documento' and  c.codigocarrera='$codigocertificado'
            and c.codigocarrera=e.codigocarrera and tr.idtrato=eg.idtrato and g.codigogenero=eg.codigogenero
            ...
            union
            SELECT  e.codigocarrera,g.nombregenero,tr.nombretrato, eg.idestudiantegeneral, concat(eg.nombresestudiantegeneral, ' ',eg.apellidosestudiantegeneral) as nombre, eg.numerodocumento, t.nombretitulo, r.numeroactaregistrograduado, r.fechagradoregistrograduado,
...
$meses = array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
    ...
    observacionlogdocumentacioncertificado) VALUES(80,
    ...
    /*TRATO*/
      ...
      /*INTERESADO*/
              ...
              $escuela="ESCUELA COLOMBIANA DE MEDICINA";
        ...
        $array_interno['3']['textodetallecertificado'] = str_replace("<NOMBRECORTODOCUMENTO>", $row_datos['nombrecortodocumento'], $array_interno['3']['textodetallecertificado']);
        $array_interno['1']['textodetallecertificado'] = str_replace("<ESCUELAMEDICINA>", $escuela, $array_interno['1']['textodetallecertificado']);
        $array_interno['3']['textodetallecertificado'] = str_replace("<ALUMNO>", $alumno, $array_interno['3']['textodetallecertificado']);
        ...
        $array_interno['3']['textodetallecertificado'] = str_replace(" <MESNUM>", date('m'), $array_interno['3']['textodetallecertificado']);
        $array_interno['3']['textodetallecertificado'] = str_replace(" <DIANOMBRE>", convercionnumerotexto(date("d")), $array_interno['3']['textodetallecertificado']);
        $array_interno['3']['textodetallecertificado'] = str_replace(" <DIA>", date("d"), $array_interno['3']['textodetallecertificado']);
        $array_interno['3']['textodetallecertificado'] = str_replace(" <MESNUM>", date('m'), $array_interno['3']['textodetallecertificado']);
        $array_interno['3']['textodetallecertificado'] = str_replace(" <MES>", $meses[$mes], $array_interno['3']['textodetallecertificado']);
        ...
        $pdf->celda(200, 5, $array_interno['5']['textodetallecertificado'], 1, 'L', 1, 0);
        $pdf->Ln(5);
        $pdf->SetFont('Arial','',12);
        $pdf->celda(136, 5, "Secretario Academico", 1, 'R', 1, 0);
        $pdf->Ln(30);
        $pdf->SetY(220);
        $pdf->SetFont('Arial','B',12);
        $pdf->celda(174, 5, $array_interno['6']['textodetallecertificado'], 1, 'R', 1, 0);
        $pdf->Ln(5);
        $pdf->SetFont('Arial','',12);
        $pdf->celda(200, 5, "Rector", 1, 'L', 1, 0);
        ...
        $pdf->SetY(70);
        $pdf->Cell(174, 5, 'CAGD Nº: ' . $consecutivo, 0, 2, 'R');
...
header("Content-Disposition: attachment; filename=certificadoactadenuncio.pdf\r\n\r\n");
