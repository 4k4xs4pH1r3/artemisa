...
{ 
		...
		function guardarEstudianteestadocuenta($respuesta, $observacion)
		{
			global $db;
			...
			$query_ins = "INSERT INTO estudianteestadocuenta(idestudianteestadocuenta, idestadocuenta, idestudiantegeneral, respuestaestudianteestadocuenta, fechaestudianteestadocuenta, observacionestudianteestadocuenta, codigoestado) 
			select 0 as idestudianteestadocuenta, '$this->idestadocuenta' as idestadocuenta, idestudiantegeneral, '$respuesta' as respuestaestudianteestadocuenta, now() as fechaestudianteestadocuenta, '$observacion' as observacionestudianteestadocuenta, '100' as codigoestado
			from estudiante 
