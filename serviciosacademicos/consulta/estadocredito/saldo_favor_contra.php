...
if ($results <> "") {  // if 1
    foreach ($results as $valor => $total) { // foreach 1
        foreach ($total as $valor1 => $total1) { // foreach 2
            if ($valor1 == "HVORG") {
                $opprincipal = $total1;
                // echo $opprincipal,"<br>";
            }
        ...
        if ($row_concepto <> "") {
            ...
            if ($row_concepto['codigotipoconcepto'] == '02') {
                // Por solicitud de orlando sarmiento no aplicar C9017 cuando hay matricula
