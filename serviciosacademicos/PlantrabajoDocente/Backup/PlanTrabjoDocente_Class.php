...
class PlanTrabjoDocente{
    ...
    border-bottom-right-radius:2em; width:98%;  margin-bottom:2%; margin-left:2%; margin-right:2%; margin-top:2%" align="right">
    	<div style="color:#FFF; display:inline-block; font-size:32px; margin-right:20%; margin-left:2%; margin-top:2%; margin-bottom:2%" align="left">Política de Planeación y Calidad del Talento Humano  Académico</div>
        
    	<img  src="http://www.uelbosque.edu.co/sites/default/themes/ueb/images/logotipo_ueb.png"   style="margin-left:3%; margin-right:3%; display:inline-block"  width="130" />
        
        </div><br />
        <p align="justify" class="Margen">
        La Política de Planeación y Calidad del Talento Humano Académico, se elabora en el marco de la implementación de las Políticas de Calidad y Planeación y la de Gestión del Talento Humano Académico, la cual a su vez tiene como referentes el Plan de Desarrollo Institucional y la Orientación Estratégica Institucional.<br /><br />
        </p>
    	<fieldset style="border:#88AB0C solid 2px; width:95%">
            <p align="justify" class="Margen">
            	
<strong>De las políticas de planeación, ejecución y autoevaluación de actividades de los académicos</strong><br />
<br />
La Política corresponde los procesos mediante los cuales el académico y su respectiva unidad académica, realizan una planeación, ejecución  y autoevaluación de las actividades para el período académico, apuntando al desarrollo personal, de la unidad y de la Institución.<br /><br />
La implementación de estas políticas se realizará a través del diligenciamiento del instrumento que contiene los planes de trabajo, el portafolio de seguimiento, la autoevaluación y el plan de mejoramiento de los académicos para el período académico: 
            </p>
         </fieldset>   
         </div>
        <?PHP
