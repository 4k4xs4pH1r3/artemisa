 ...
 */
 ...
 class ControlUsuario{
	...
	/**
	 * actualiza tipo y numero de documento en tabla usaurio
	 * @param string $tipodocumentoAnterior , $numeroDocumentoAnterior , $tipodocumentoNuevo , $numeroDocumentoNuevo 
	 * @access public
	 * @return void
	 */
	
	public function actualizartipodocumento($tipodocumentoAnterior , $numeroDocumentoAnterior , $tipodocumentoNuevo , $numeroDocumentoNuevo ){
		$usuario = new Usuario ( $this->persistencia );
		$usuario ->actualizarUsuario($tipodocumentoAnterior, $numeroDocumentoAnterior, $tipodocumentoNuevo, $numeroDocumentoNuevo);
		return $usuario;
