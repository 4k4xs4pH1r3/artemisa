 ...
 */ 
 ...
 class Usuario extends Persona{
	...
	/**
	 * actualiza numero y tipo de documento en tabla estudiante
	 * @param string $tipodocumentoAnterior , $numeroDocumentoAnterior , $tipodocumentoNuevo , $numeroDocumentoNuevo
	 * @access public
	 * @return void
	 */
	
	
	public function actualizarUsuario( $tipodocumentoAnterior , $numeroDocumentoAnterior , $tipodocumentoNuevo , $numeroDocumentoNuevo ){
		$sql=" UPDATE
					usuario
				SET 
		...
		$this->persistencia->crearSentenciaSQL( $sql );
		$this->persistencia->setParametro( 0 , $tipodocumentoNuevo , true);
		$this->persistencia->setParametro( 1 , $numeroDocumentoNuevo , false );
		$this->persistencia->setParametro( 2 , $tipodocumentoAnterior , true );
		$this->persistencia->setParametro( 3 , $numeroDocumentoAnterior , false );
		echo $this->persistencia->getSQLListo( )."<br />";
