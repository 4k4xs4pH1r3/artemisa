...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		"Menu language is 'Mostrar _MENU_ registros' by default",
		null,
		function () { return oSettings.oLanguage.sLengthMenu == "Mostrar _MENU_ registros"; }
	);
	...
	oTest.fnTest(
		...
		function () {
			...
			var bReturn =
				anChildren[0].nodeValue == "Mostrar " &&
				anChildren[2].nodeValue == " registros";
			return bReturn;
		}
	);
