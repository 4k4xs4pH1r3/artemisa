...
oTest.fnStart( "Check behaviour de the data set functions that DataTables uses" );

$(document).ready( function () {
	// Slightly unusual test set this one, in that we don't really care about the DOM
	// but want a test the internal data handling functions but we do need a table to
	...
	oTest.fnTest(
		"Create array de nested objects",
		function () {
