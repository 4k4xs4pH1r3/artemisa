...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		"Zero records language is 'No hay registros coincidentes encontrados' by default",
		null,
		function () { return oSettings.oLanguage.sZeroRecords == "No hay registros coincidentes encontrados"; }
	);
	
	oTest.fnWaitTest(
		"Text is shown when empty table (after filtering)",
		function () { oTable.fnFilter('nothinghere'); },
		function () { return $('#example tbody tr td')[0].innerHTML == "No hay registros coincidentes encontrados" }
	);
