 ...
 */
 ...
 class ControlUsuario{
	...
	/**
	 * Busca usuario por Documento
	 * @param  String $idUsuario , $idCarrera
	 * @access public
	 * @return Usuario
	 */
	public function consultarEmailusuariofacultades ( $idUsuario , $idCarrera ) {

		$usuario = new Usuario( $this->persistencia );
	    $usuario->consultarEmailusuariofacultad( $idUsuario , $idCarrera );
		return $usuario;
	}
