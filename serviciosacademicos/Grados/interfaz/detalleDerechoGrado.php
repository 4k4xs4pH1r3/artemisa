<?php
   ...
   */
	...
	$concepto = $controlConcepto->buscarEstudianteDG( $txtCodigoEstudiante );
	
	if(count($concepto->getCodigoConcepto( )) != 0 ) { ?>
		<div class="detalles">
			<p><b>El estudiante pagó derecho de grados</b></p>
		</div>
	<?php }else{ ?>
		<div class="detalles">
			<p><b>El estudiante no ha pagado los derechos de grado</b></p>
		</div>
	<?php }
