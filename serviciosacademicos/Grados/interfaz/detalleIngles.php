<?php
   ...
   */
	...
	$documentacion = $controlDocumentacion->buscarDocIngles( $txtCodigoEstudiante, $txtCodigoCarrera );
	
	if( count($documentacion->getIdDocumentacion( ) ) != 0  ){ ?>
		<div class="detalles">
		<p>El estudiante ha cursado los niveles de Inglés exigidos por la universidad</p>
			<span><b><?php echo $documentacion->getNombreDocumentacion( ); ?></b></span>
		</div>
	<?php }else{ ?>
		<div class="detalles">
			<p><b>El estudiante aún no ha aprobado todos los niveles de Inglés exigidos por la universidad.</b></p>
		</div>
	<?php }
