	...
	switch( $tipoOperacion ){ 
		...
		case "anularActa": ?>
				...
				<tbody class="listaRadicaciones">
					<?php
						$estudiantes = $controlEstudiante->consultarEstudianteActa( );
						$i = 1; 
						foreach( $estudiantes as $estudiante ){
							...
							<tr>
								...
								<td ><?php echo $estudiante->getNombreEstudiante( ); ?></td>
								<td align="center"><input type="checkbox" id="ckAnularActa" name="ckAnularActa" value="<?php echo $txtCodigoEstudiante; ?>" /></td>
							</tr>
					<?php }					
					?>
				</tbody>
