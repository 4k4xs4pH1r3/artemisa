        ...
        AND c.cuentaoperacionprincipal = '153'";
           ...
           AND op1.numeroordenpago = '" . $numeroordenpago . "'
               and e1.codigoperiodo = '" . $row_data['codigoperiodo'] . "'";
                $inscripcionorden = mysql_db_query($database_sala, $query_conceptoorden) or die("$query_conceptoorden" . mysql_error());
                $totalRows_inscripcionorden = mysql_num_rows($conceptoorden);
                $row_inscripcionorden = mysql_fetch_array($conceptoorden);
