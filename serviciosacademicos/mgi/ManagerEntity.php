...
class ManagerEntity {
    ...
    function __construct($entity,$ruta="") {
        ...
        if(file_exists(dirname(__FILE__)."/".$ruta."/class/".$file) or file_exists(dirname(__FILE__)."\"".$ruta."\class\"".$file)){
            if(file_exists(dirname(__FILE__)."/".$ruta."/class/".$file)){
                $classfile = dirname(__FILE__)."/".$ruta."/class/".$file; 
