<?php
    ...
    writeHeader("Gestión de Reportes de Información",false);
...
<div id="container">
        ...
        $(document).ready(function() {  
            ...
            sql="SELECT g.idsiq_reporte,g.idsiq_reporte,g.nombre,g.descripcion,c.nombre as categoria,g.fecha_modificacion FROM siq_reporte g ";
