...
<div id="tableDiv">
    <table align="left" id="estructuraReporte" class="previewReport" style="text-align:left;clear:both;margin: 10px 0px;font-size:0.8em;" width="100%" >
		...
		<th class="column" colspan="4"><span>Dedicación - U. Bosque</span></th>
	    </tr>   
             <tr class="dataColumns">
		<th class="column"><span>1/4 Tiempo</span></th>
		<th class="column"><span>1/2 Tiempo</span></th>
		<th class="column"><span>3/4 Tiempo</span></th>
		<th class="column"><span>Tiempo Completo</span></th>
	    </tr>
             <tr class="dataColumns">
		<th class="column"><span>1 - 10 Horas</span></th>
		<th class="column"><span>11 - 20 Horas</span></th>
		<th class="column"><span>21 - 30 Horas</span></th>
		<th class="column"><span>31 - 40 Horas</span></th>
	    </tr>
        </thead>
        <tbody>
            <?php foreach($idiomas as $idioma) {
                ...
                $sql = "SELECT * FROM siq_formTalentoHumanoAcademicosDocentesOtroIdioma WHERE codigoestado=100 AND codigoperiodo IN $periodos AND horas>10 AND horas<=20 AND idioma=".$idioma["ididioma"];
                $medio = $db->GetAll($sql);
                $sql = "SELECT * FROM siq_formTalentoHumanoAcademicosDocentesOtroIdioma WHERE codigoestado=100 AND codigoperiodo IN $periodos AND horas>20 AND horas<=30 AND idioma=".$idioma["ididioma"];
                $trescuartos = $db->GetAll($sql);
                $sql = "SELECT * FROM siq_formTalentoHumanoAcademicosDocentesOtroIdioma WHERE codigoestado=100 AND codigoperiodo IN $periodos AND horas>30 AND idioma=".$idioma["ididioma"];
             ...
             ?>
               <tr class="dataColumns">
                       ...
                       <td class="column center"><?php echo count($trescuartos); $total3+=count($trescuartos); ?></td>
        ...
        <tfoot>
             <tr id="totalColumns">
                ...
                <td class="column center"><?php echo ($total3); ?></td>
