...
if(empty($_REQUEST['id'])){
    ...
    $url='../reportes/reportes/docentes/viewReporteDedicacionCNAPorNivelFormacion.php';
}else{
    $url='reportes/docentes/viewReporteDedicacionCNAPorNivelFormacion.php';
}
$tipo=1;
...
<form action="" method="post" id="forma2" class="report">
	...
	<fieldset>
		<label class="fixedLabel">Mes: <span class="mandatory">(*)</span></label>
                ...
                <input type="button" value="Consultar" id="consul_report_bnfor2" class="first small" />
		<!--<input type="submit" value="Consultar" class="first small" />-->
		
	</fieldset>
</form>
<div id='respuesta_forma2'></div>
<?php 
}
    ...
    <table align="center" id="estructuraReporte" class="previewReport" width="92%" >
                    <thead>            
                        <tr class="dataColumns">
                            <th class="column" colspan="9"><span>Dedicación Semanal Docentes<br>(Según categorización del CNA), por Mayor Nivel de Formación</span></th>                                    
                        </tr>
...
$(document).ready(function(){
                $("#consul_report_bnfor2").one('click', function() {
                            $.ajax({//Ajax
                              type: 'POST',
                              url: '<?php echo $url?>',
