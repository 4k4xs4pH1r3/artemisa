...
session_start();
    ...
    if(($periodo)) {
         ...
         //echo $periodo;
         $records =$utils->getDataViewExtranjerosPais($db,$periodo);
         $num = count($records);
...
<div id="tableDiv">
     ...
     <table align="center" class="previewReport" class="previewReport" width="70%" >
                    <thead>             			
					<tr id="dataColumns">
                            <th class="column borderR" ><span>País de Origen</span></th>
...
<script type="text/javascript">
	...
	function sendForm_un(){
		...
		$.ajax({
				type: 'POST',
				url: './reportes/docentes/viewReporteAcademicosExtranjerosPorPais.php',
				async: false,
				data: datos ,                
