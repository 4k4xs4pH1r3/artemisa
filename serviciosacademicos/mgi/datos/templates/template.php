...
function getBD($traerUtils=true,$rutaUtils="datos") { 
    $ruta = "../";
    ...
    while (!is_file($ruta.$rutaUtils.'/class/Utils_datos.php'))
    {
            $ruta = $ruta."../";
    }
    
    require_once ($ruta.$rutaUtils.'/class/Utils_datos.php');
...
function writeHeader($title, $bd=false, $rutaCss="../../",$classBody="body", $traerUtils=true, $rutaUtils="datos") {
    
verifySession();

if($bd){
    $db = getBD($traerUtils,$rutaUtils); 
}
//echo '<pre>';print_r($db);
//echo 'Entro...Template...pASO...Bd...';die;
?>
