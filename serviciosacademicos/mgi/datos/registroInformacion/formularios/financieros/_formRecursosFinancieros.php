...
<form action="save.php" method="post" id="form_RecursosFR3_<?php echo $_REQUEST['tipo']; ?>">
            ...
            <?php
                                if ($tipo==39){
                                    ...
                                    $t1="Saldo a diciembre 31";
                                    $t2="Saldo a diciembre 31 del<br/>año inmediatamente anterior";
                                    $c1="2";
                                    $c2="3";
                ...
                <table align="center" class="formData last" width="92%" >
                    <thead>            
                        <tr class="dataColumns">
                            <th class="column" colspan="<?php if($aprobacion) echo $c1; else echo $c2;?>"><span><?php; echo $ti ?></span></th>
                            <?php if($aprobacion){ ?>
                          ...
                          ?>
                                <tr class="dataColumns">
                                        ...
                                        <td class="column"> <center>
                                          <input type="text"  class="grid-10-12 required decimal inputTable" minlength="1" name="dato1[]" id="dato1_<?php echo $rowC["idsiq_tipoRecursosPresupuesto"]; ?>" title="presupuesto" maxlength="30" tabindex="1"  autocomplete="off" value="" />
                                       </center></td>
                                       <td class="column"> <center>
                                         <input type="text"  class="grid-10-12 required decimal inputTable" minlength="1" name="dato2[]" id="dato2_<?php echo $rowC["idsiq_tipoRecursosPresupuesto"]; ?>" title="ejecucion" maxlength="30" tabindex="1"  autocomplete="off" value="" />
                                       </center></td>
                                       <?php if ($tipo!=39) { ?>
                                       <td class="column"> <center>
                                         <input type="text"  class="grid-10-12 required decimal inputTable" minlength="1" name="dato3[]" id="dato3_<?php echo $rowC["idsiq_tipoRecursosPresupuesto"]; ?>" title="ejecucion" maxlength="30" tabindex="1"  autocomplete="off" value="" />
                                       </center></td>
                                       <?php } ?>
...
<script type="text/javascript">
    ...
    $(function(){
        $("#form_RecursosFR3_"+<?php echo $_REQUEST['tipo'] ?> + " input[type='text']").maskMoney({allowZero:true,thousands:',', decimal:'.',precision:0,allowNegative:true, defaultZero:false});
    });
