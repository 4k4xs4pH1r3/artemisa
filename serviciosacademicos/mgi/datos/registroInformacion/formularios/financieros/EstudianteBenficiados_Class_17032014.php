...
class EstudianteBenficiados{
	...
	public function Campos($i,$Progama_Name,$Campo_1,$Campo_2,$Campo_3,$Campo_4,$Programa_id,$Value,$j){
        ...
        <tr>
            ...
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_1?>" name="<?PHP echo $Campo_1?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" /></td>
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_2?>" name="<?PHP echo $Campo_2?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" /></td>
            ...
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_4?>" name="<?PHP echo $Campo_4?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" /></td>
