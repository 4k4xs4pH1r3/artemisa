<?php
    ...
    $actividades1 = $utils->getAll($db,"siq_tipoDatoBalance",$query1,"nombre");
    $query2="categoria='Activo_No_Corriente'";
    $actividades2 = $utils->getAll($db,"siq_tipoDatoBalance",$query2,"nombre");
    $query3="categoria='Pasivo_Corriente'";
    $actividades3 = $utils->getAll($db,"siq_tipoDatoBalance",$query3,"nombre");
    $query4="categoria='Pasivo_Diferido'";
    $actividades4 = $utils->getAll($db,"siq_tipoDatoBalance",$query4,"nombre");
    $query5="categoria='Pasivo_No_Corriente'";
    $actividades5 = $utils->getAll($db,"siq_tipoDatoBalance",$query5,"nombre");
    $query6="categoria='Patrimonio'";
    $actividades6 = $utils->getAll($db,"siq_tipoDatoBalance",$query6,"nombre");
    $query7="categoria='Cuentas_Orden'";
    $actividades7 = $utils->getAll($db,"siq_tipoDatoBalance",$query7,"nombre");
?>
<div id="tabs-4">
			...
			<tr class="dataColumns">                             
                         ...
                         <?php while ($row = $actividades1->FetchRow()) { ?>
                            ...
                            <tr class="dataColumns">
                                ...
                                <td class="column"> 
                                    <input type="text"  class="grid-7-12 required number" minlength="1" name="valor[]" id="valor_<?php echo $row["idsiq_tipoDatoBalance"]; ?>" maxlength="10" tabindex="1" autocomplete="off" value=""  />
                                </td>                                
