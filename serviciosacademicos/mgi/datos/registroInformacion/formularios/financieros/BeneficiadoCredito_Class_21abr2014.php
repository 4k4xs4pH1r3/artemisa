...
class BeneficiadoCredito{
		...
		public function Campos($i,$Progama_Name,$Campo_1,$Campo_2,$Campo_3,$Programa_id,$Value,$Valor_1,$Valor_2,$Valor_3,$j){
		?>
        <tr>
            ...
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_1?>" name="<?PHP echo $Campo_1?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" readonly="readonly" /></td>
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Valor_1?>" name="<?PHP echo $Valor_1?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" readonly="readonly" /></td>
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_2?>" name="<?PHP echo $Campo_2?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" readonly="readonly" /></td>
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Valor_2?>" name="<?PHP echo $Valor_2?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" readonly="readonly" /></td>
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_3?>" name="<?PHP echo $Campo_3?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" readonly="readonly" /></td>
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Valor_3?>" name="<?PHP echo $Valor_3?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" readonly="readonly" /></td>
            ...
            <thead>
				...
				$i=0;
					while(!$D_Carrera->EOF){
						...
						$this->Campos($i+1,$Name_Programa,$Campo_1,$Campo_2,$Campo_3,$Programa_id,$Value,$Valor_1,$Valor_2,$Valor_3,$i);#$i,$Progama_Name,$Campo_1,$Campo_2,$Campo_3,$Campo_4,$Programa_id,$Value
						/******************************************************************************/
						$i++;
						$D_Carrera->MoveNext();
						}
