<?php
    ...
    $actividades1 = $utils->getAll($db,"siq_tipoEstadoResultados",$query1,"orden");
    $query2="categoria='Gastos_Operacionales'";
    $actividades2 = $utils->getAll($db,"siq_tipoEstadoResultados",$query2,"orden");
    $query3="categoria='Ingresos_No_Operacionales'";
    $actividades3 = $utils->getAll($db,"siq_tipoEstadoResultados",$query3,"orden");
    $query4="categoria='Gastos_No_Operacionales'";
    $actividades4 = $utils->getAll($db,"siq_tipoEstadoResultados",$query4,"orden");
			...
			<tr class="dataColumns">                             
                         ...
                         <?php while ($row = $actividades1->FetchRow()) { ?>
                            ...
                            <tr class="dataColumns">
                                ...
                                <td class="column"> 
                                    <input type="text"  class="grid-9-12 required number" minlength="1" name="valor[]" id="valor_<?php echo $row["idsiq_tipoEstadoResultados"]; ?>" maxlength="30" tabindex="1" autocomplete="off" value=""  />
                                </td>                                
...
<script type="text/javascript">
    ...
    $(function(){
        $("#form_estadoresultados input[type='text']").maskMoney({allowZero:true,thousands:',', decimal:'.',precision:0,allowNegative:true, defaultZero:false});
    });
       ...
       /* $(document).ready(function(){  
            ...
            $(".verificarDato").change(function() {  
                ...
                $('#submitestadoresultados').click(function(event) {
                    ...
                    replaceCommas("#form_estadoresultados");
                            ...
                            if (data.success == true){
                                var i=0
                                 ...
                                 $("#form_estadoresultados #action").val("updateDynamic");
                                    addCommas("#form_estadoresultados");
