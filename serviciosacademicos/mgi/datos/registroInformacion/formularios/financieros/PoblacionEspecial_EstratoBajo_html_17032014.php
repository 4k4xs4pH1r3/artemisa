...
switch($_REQUEST['actionID']){
	...
	if($PoblacionesValida->EOF){
		...
		$SQL_Insert='INSERT INTO poblacionespcialbajos (modalidad_id,carrera_id,numespeciales,numbajos,periodo,entrydate,userid) VALUES ("'.$id_modalidad.'","'.$id_Carrera.'","'.$num_Especiales.'","'.$Num_Bajos.'","'.$Periodo.'",NOW(),"'.$userid.'")';
