...
class BeneficiadoCredito{
        ...
        <tr>
            ...
            <td style="border:#000 solid 1px" lass="column center"><input type="text" id="<?PHP echo $Campo_3?>" name="<?PHP echo $Campo_3?>" style="text-align:center" autocomplete="off" class="grid-5-12 required number disable" onkeypress="return isNumberKey(event)" /></td>
