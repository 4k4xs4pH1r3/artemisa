...
<form action="save.php" method="post" id="form_reconocimientos">
			...
			<?php $utils->pintarBotonCargar("popup_cargarDocumento(9,13,'',$('#form_reconocimientos #unidadAcademica').val())","popup_verDocumentos(9,13,'',$('#form_reconocimientos #unidadAcademica').val())"); ?>
