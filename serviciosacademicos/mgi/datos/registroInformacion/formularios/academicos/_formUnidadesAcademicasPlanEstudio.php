                    ...
                    <thead>            
                     ...
                     <tbody>
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number" minlength="1" name="numAsignaturasFundamental" id="numAsignaturasFundamental" title="Total de Asignaturas Fundamental" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number" minlength="1" name="numCreditosFundamental" id="numCreditosFundamental" title="Total de Créditos Fundamental" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>                            
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column">
                                <input type="text" class="grid-4-12 required number" minlength="1" name="numAsignaturasDiversificada" id="numAsignaturasDiversificada" title="Total de Asignaturas Diversificadas" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text" class="grid-4-12 required number" minlength="1" name="numCreditosDiversificada" id="numCreditosDiversificada" title="Total de Creditos Diversificadas" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>                            
                            <td class="column center"> 
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column">
                                <input type="text" class="grid-4-12 required number" minlength="1" name="numAsignaturasElectivas" id="numAsignaturasElectivas" title="Total de Asignaturas Electivas" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text" class="grid-4-12 required number" minlength="1" name="numCreditosElectivas" id="numCreditosElectivas" title="Total de Creditos Electivas" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column center"> 
