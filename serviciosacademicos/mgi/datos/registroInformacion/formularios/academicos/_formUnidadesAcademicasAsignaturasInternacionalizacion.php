...
<form action="save.php" method="post" id="forma<?=$_REQUEST['alias']?>">
		...
		<legend><?=$titulo; ?></legend>
                ...
                <?php $utils->pintarBotonCargar("popup_cargarDocumento(".$id.",23,$('#forma".$_REQUEST['alias']." #codigoperiodo').val(),$('#forma".$_REQUEST['alias']." #unidadAcademica').val())","popup_verDocumentos(".$id.",23,$('#forma".$_REQUEST['alias']." #codigoperiodo').val(),$('#forma".$_REQUEST['alias']." #unidadAcademica').val())"); ?>
...
<script type="text/javascript">
	...
	function sendFormInternacionalizacion(){
