...
class MovilidadAcademica{
        ...
        <span class="mandatory">* Son campos obligatorios</span>
            ...
            <form id="xxxxx" name="xxxxx">
              <fieldset>   
                ...
                <div class="vacio"></div>
            <div class="cargarArchivos" onmouseover="cargarArchivos(this)" title="">
                ...
                <div class="verArchivos" onmouseover="verArchivos(this)" title="">
                        ...
                        <table width="92%"  border="0" align="center" class="formData" >
                            <thead>   
                                <tr class="dataColumns">
                                    <th rowspan="2" class="column" colspan="2" style="border:#000 solid 1px"><span>Región a la que viaja</span></th>
              ...
              <fieldset>   
                <legend>Estudiantes de Otras Universidades que vienen a la Universidad </legend>
                    	<table width="92%"  border="0" align="center" class="formData" >
                            <thead>   
                                <tr class="dataColumns">
                                    <th rowspan="2" class="column" colspan="2" style="border:#000 solid 1px"><span>Región de la cual proviene</span></th>
                                    <th class="column" colspan="5" ><span>Tipo de movilidad</span></th>
                                </tr>
                                <tr class="dataColumns">
                                    <th class="column center" style="border:#000 solid 1px" ><span>Internado</span></th>
	...
	public function ViewData($Titulo,$Dato_1,$Dato_2,$Dato_3,$Dato_4,$Dato_5,$Suma_T){
		?>
        <tr class="dataColumns">
            <td class="column center" style="border:#000 solid 1px" ><span><?PHP echo $Titulo?></span></td>
	...
	public function Total($Dato_1,$Dato_2,$Dato_3,$Dato_4,$Dato_5){
			?>
            <tr class="dataColumns">
                <th class="column center" style="border:#000 solid 1px" ><span>Total</span></td>
                <td class="column center" style="border:#000 solid 1px" align="center"><strong><?PHP echo $Dato_1?></strong></td>
                <td class="column center" style="border:#000 solid 1px" align="center"><strong><?PHP echo $Dato_2?></strong></td>
                <td class="column center" style="border:#000 solid 1px" align="center"><strong><?PHP echo $Dato_3?></strong></td>
                <td class="column center" style="border:#000 solid 1px" align="center"><strong><?PHP echo $Dato_4?></strong></td>
	...
	public function DataResult($Modalidad,$carerra,$periodo){
         ...
         $SQL_Suma='SELECT 
			...
			?>
					<div id="tableDiv">
                        <table width="92%" border="0" align="center" class="formData previewReport" >
                            <thead>         
								<tr class="dataColumns">
									<th class="column" colspan="7"><span>Estudiantes con movilidad según al país al que viajan y el tipo de actividad o movilidad</span></th>                                    
								</tr>
                                ...
                                <tr class="dataColumns category">
                                    <th class="column center borderR" ><span>Internado</span></th>
                                    <th class="column center borderR" ><span>Pasantía</span></th>
                                    <th class="column center borderR" ><span>Práctica</span></th>
                                    <th class="column center borderR" ><span>Semestre académico</span></th>
                                    <th class="column center borderR" ><span>Doble titulación</span></th>
			...
			$SQL_Datos='SELECT 
			 ...
			 ?>
                    	...
                    	<table width="92%"  border="0" align="center" class="formData previewReport" >
                            <thead>     
								<tr class="dataColumns">
									<th class="column" colspan="7"><span>Estudiantes de Otras Universidades que vienen a la Universidad</span></th>                                    
								</tr>
                                <tr class="dataColumns category">
                                    <th rowspan="2" class="column borderR" ><span>País del cual provienen</span></th>
                                    <th class="column" colspan="6" ><span>Tipo de movilidad</span></th>
                                </tr>
                                <tr class="dataColumns category">
                                    <th class="column center borderR" ><span>Internado</span></th>
