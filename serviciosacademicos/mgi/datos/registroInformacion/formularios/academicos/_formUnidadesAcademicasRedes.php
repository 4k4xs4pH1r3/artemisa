...
<form action="save.php" method="post" id="form_redes">
            ...
            <fieldset id="numPersonas">   
				...
				<?php $utils->pintarBotonCargar("popup_cargarDocumento(9,20,$('#form_redes #codigoperiodo').val(),$('#form_redes #unidadAcademica').val())","popup_verDocumentos(9,20,$('#form_redes #codigoperiodo').val(),$('#form_redes #unidadAcademica').val())"); ?>
