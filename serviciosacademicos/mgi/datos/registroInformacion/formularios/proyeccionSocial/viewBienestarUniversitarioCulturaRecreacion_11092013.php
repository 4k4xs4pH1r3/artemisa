...
?>
				<tr class="dataColumns category">
					<th colspan="8" class="borderR"><?=$_REQUEST['semestre']?> - <?=$row2['clasificacionesinfhuerfana']?></th>               
				</tr>
...
<script type="text/javascript">
	...
	function sendForm(){
		$.ajax({
				type: 'GET',
				url: 'formularios/proyeccionSocial/viewBienestarUniversitarioCulturaRecreacion.php',
				async: false,
