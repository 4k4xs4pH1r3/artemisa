...
?>
				<tr class="dataColumns category">
					<th colspan="<?=($row2['aliasclasificacionesinfhuerfana']=='p_evu_ddbu')?8:6;?>" class="borderR"><?=$_REQUEST['semestre']?> - <?=$row2['clasificacionesinfhuerfana']?></th>
				</tr>
...
<?
						if($row2['aliasclasificacionesinfhuerfana']=='p_evu_ddbu') {
?>
							<td class="column borderR" align="center"><?=$row['beneficiarios_comunidades']?></td>
...
<?
					if($row2['aliasclasificacionesinfhuerfana']=='p_evu_ddbu') {
?>
						<th class="borderR"><?=$sum_beneficiarios_comunidades?></th>
...
?>
			...
			<tr class="dataColumns category">
				...
				<th class="borderR" style='font-size:25px'><?=$sum_tot_beneficiarios_comunidades?></th>
				<th class="borderR" style='font-size:25px'><?=$sum_tot_encuentros_presentacion_oficiales?></th>
			</tr>
		</table>
<?
	}
...
<script type="text/javascript">
	...
	function sendForm(){
		$.ajax({
				type: 'GET',
				url: 'formularios/proyeccionSocial/viewBienestarUniversitarioVoluntariadoUniversitario.php',
				async: false,
