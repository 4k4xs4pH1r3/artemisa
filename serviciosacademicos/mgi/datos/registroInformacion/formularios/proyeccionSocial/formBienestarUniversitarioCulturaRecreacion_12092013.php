...
<form action="" method="post" id="forma<?=$_REQUEST['alias']?>">
	...
	<fieldset>  
		<legend>Estadísticas área de cultura y recreación</legend>
		...
		<?php //$utils->getSemestresSelect($db,"semestre");
                 ...
                 $utils->pintarBotonCargar("popup_cargarDocumento(3,3,$('#".$idForm." #semestre').val())","popup_verDocumentos(3,3,$('#".$idForm." #semestre').val())");  ?>
...
?>
				<tr class="dataColumns category">
					<th colspan="8" class="borderR"><?=$row2['clasificacionesinfhuerfana']?></th>               
				</tr>
	...
	?>
					<tr id="contentColumns" class="row">
						...
						<td class="column borderR" align="center"><input type="text" class="required number" name="encuentros[<?=$row['idclasificacionesinfhuerfana']?>]" id="encuentros[<?=$row['idclasificacionesinfhuerfana']?>]" title="Nro. de encuentros o presentaciones oficiales" maxlength="10" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
					</tr>
	<?
				}
			}
