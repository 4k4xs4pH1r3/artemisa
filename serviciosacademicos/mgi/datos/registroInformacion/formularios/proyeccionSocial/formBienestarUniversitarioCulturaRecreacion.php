             ...
             var mes = $(formName+' #mes').val()
                ...
                var alias = "<?PHP echo  $_REQUEST['alias']?>";
                        $.ajax({
                            ...
                            data: { mes: mes, action: "getCategories", anio: anio, alias: alias },     
...
<form action="" method="post" id="forma<?PHP echo $_REQUEST['alias']?>">
	...
	<fieldset>  
		...
		<?php //$utils->getSemestresSelect($db,"semestre");
                 ...
                 $utils->pintarBotonCargar("popup_cargarDocumento(3,3,$('#".$idForm." #mes').val()+'-'+$('#".$idForm." #anio').val())","popup_verDocumentos(3,3,$('#".$idForm." #mes').val()+'-'+$('#".$idForm." #anio').val())");  ?>
...
?>
				<tr class="dataColumns category">
					<th colspan="8" class="borderR"><?PHP echo  $row2['clasificacionesinfhuerfana']?></th>               
				</tr>
