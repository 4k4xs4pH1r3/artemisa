...
?>
				<tr class="dataColumns category">
					<th colspan="<?php if($aprobacion) echo "6"; else echo "7";?>" class="borderR"><?=$row2['clasificacionesinfhuerfana']?></th>               
                                        <?php if($aprobacion){ ?>
	...
	?>
					<tr id="contentColumns" class="row">
						...
						<td class="column borderR" align="center"><input type="text" class="required number" name="cant_usuarios_ing_biblioteca[]" id="cant_usuarios_ing_biblioteca_<?=$row['idclasificacionesinfhuerfana']?>" title="Cantidad de usuarios que ingresaron a la biblioteca" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="required number" name="prestamo_equipos[]" id="prestamo_equipos_<?=$row['idclasificacionesinfhuerfana']?>" title="Prestamos de equipos" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="required number" name="prestamo_libros[]" id="prestamo_libros_<?=$row['idclasificacionesinfhuerfana']?>" title="Prestamos de libros" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="required number" name="prestamo_revistas[]" id="prestamo_revistas_<?=$row['idclasificacionesinfhuerfana']?>" title="Prestamos de revistas" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="required number" name="prestamo_trabajos_grado[]" id="prestamo_trabajos_grado_<?=$row['idclasificacionesinfhuerfana']?>" title="Prestamos de trabajos de grado" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="required number" name="prestamo_material_especial[]" id="prestamo_material_especial_<?=$row['idclasificacionesinfhuerfana']?>" title="Prestamos de material especial" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
					</tr>
	<?
				}
			}
                                   ...
                                   // $("#id").val(data.message);
                                    for (var i=0;i<data.total;i++){                                  
                                      //  alert(data[i].id+'-'+data[i].idclasificacionesinfhuerfana+'-'+data[i].cantidad+'-->>')
                                        ...
                                        $(formName + " #cant_usuarios_ing_biblioteca_"+data[i].idclasificacionesinfhuerfana).val(data[i].cant_usuarios_ing_biblioteca);
                                        $(formName + " #prestamo_equipos_"+data[i].idclasificacionesinfhuerfana).val(data[i].prestamo_equipos);
                                        $(formName + " #prestamo_libros_"+data[i].idclasificacionesinfhuerfana).val(data[i].prestamo_libros);
                                        $(formName + " #prestamo_revistas_"+data[i].idclasificacionesinfhuerfana).val(data[i].prestamo_revistas);
                                        $(formName + " #prestamo_trabajos_grado_"+data[i].idclasificacionesinfhuerfana).val(data[i].prestamo_trabajos_grado);
                                        $(formName + " #prestamo_material_especial_"+data[i].idclasificacionesinfhuerfana).val(data[i].prestamo_material_especial);
