...
?>
				<tr class="dataColumns category">
					<th colspan="3" class="borderR"><?PHP echo $periodo?> - <?PHP echo $row2['clasificacionesinfhuerfana']?></th>               
				</tr>
...
?>
					<tr id="contentColumns" class="row">
						...
						<td class="column borderR" align="center"><?PHP echo $row['titulos']?></td>
						<td class="column borderR" align="center"><?PHP echo $row['volumenes']?></td>
					</tr>
<?PHP 
...
?>
				<tr>
					...
					<th class="borderR"><?PHP echo $sum_titulos?></th>
					<th class="borderR"><?PHP echo $sum_volumenes?></th>
				</tr>
<?PHP 
...
?>
			...
			<tr class="dataColumns category">
				...
				<th class="borderR" style='font-size:25px'><?PHP echo $sum_tot_titulos?></th>
				<th class="borderR" style='font-size:25px'><?PHP echo $sum_tot_volumenes?></th>
			</tr>
		</table>
<?PHP 
	}
...
<script type="text/javascript">
	...
	function sendForm(){
		$.ajax({
				type: 'GET',
				url: '<?PHP echo $rutaInc?>formularios/recursosFisicos/viewBibliotecaVolumenesTitulosColecciones.php',
				async: false,
