...
<?php		
		...
		<table align="center" class="formData last" width="92%">
                    ...
                    <tr class="dataColumns category">
                            <th colspan="<?php if($aprobacion) echo "2"; else echo "3";?>" class="borderR"><?php echo utf8_decode($row2['clasificacionesinfhuerfana']); ?></th>      

                                <th class="column"><span>
                                    <input type="hidden" value="0" name="Verificado" id="Verificado" />
                                    <input type="checkbox"  class="grid-4-12 required number" minlength="1" name="VerEscondido" id="VerEscondido" title="Verificado" maxlength="20" tabindex="1" autocomplete="off" value="1" />
                               </span></th>  
                    </tr>
                                    <?php } ?> 
<?php 
...
?>
				<tr class="dataColumns category">
					<th colspan="3" class="borderR"><?php echo utf8_decode($row2['clasificacionesinfhuerfana']); ?></th>      
				</tr>
					...
					<tr id="contentColumns" class="row">
						<td class="column borderR">
							...
							<?php echo utf8_decode($row['clasificacionesinfhuerfana']); ?>: <span class="mandatory">(*)</span>
                                                        <input type="hidden"  class="grid-6-12 required number" minlength="1" name="idclasificacionesinfhuerfana[]" id="idclasificacionesinfhuerfana_<?php echo $row["idclasificacionesinfhuerfana"]; ?>" value="<?php echo $row["idclasificacionesinfhuerfana"]; ?>" />
                                                        <input type="hidden" name="id[]" value="" id="id_<?php echo $row["idclasificacionesinfhuerfana"]; ?>" /></td>
                           
						</td>
						<td class="column borderR" align="center">
                                                    <input type="text" class="grid-8-12 required number" name="titulos[]" id="titulos_<?php echo $row['idclasificacionesinfhuerfana']; ?>" title="Títulos" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' />
                                                </td>
<?php	
						if($row2["aliasclasificacionesinfhuerfana"]=="ci_vtc_bib") {
?>               
							<td class="column borderR" align="center">
                	                                    <input type="text" class="grid-6-12 required number" name="volumenes[]" id="volumenes_<?php echo $row['idclasificacionesinfhuerfana']; ?>" title="Volúmenes" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' />
                        	                        </td>
<?php
						}
?>
