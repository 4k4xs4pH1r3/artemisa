...
<form action="" method="post" id="forma<?=$_REQUEST['alias']?>">
	...
	<fieldset>  
		<legend>Convenios Suscritos para la adquisición y prestación de servicios de información de la Biblioteca</legend>
                ...
                $utils->pintarBotonCargar("popup_cargarDocumento(2,2,$('#".$idForm." #mes').val())","popup_verDocumentos(2,2,$('#".$idForm." #mes').val())");?>
...
?>
				<tr class="dataColumns category">
					<th colspan="<?php if($aprobacion) echo "1"; else echo "2"; ?>"  class="borderR"><?=$row2['clasificacionesinfhuerfana']?></th>               
				  <?php if($aprobacion){ ?>
	...
	?>
					<tr id="contentColumns" class="row">
						...
						<td class="column borderR" align="center"><input type="text" class="required number" name="cantidad[]" id="cantidad_<?=$row['idclasificacionesinfhuerfana']?>" title="Cantidad" maxlength="3" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
					</tr>
	<?
				}
			}
