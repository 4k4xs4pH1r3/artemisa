...
?>
	...
	?>
					<tr id="contentColumns" class="row">
						...
						<td class="column borderR" align="center"><input type="text" class="grid-11-12 required number" name="induccion_biblioteca[]" id="induccion_biblioteca_<?php echo $row['idclasificacionesinfhuerfana']?>" title="Inducción Biblioteca" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="grid-11-12 required number" name="busqueda_recuperacion_informacion[]" id="busqueda_recuperacion_informacion_<?php echo $row['idclasificacionesinfhuerfana']?>" title="Búsqueda y recuperación de información" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						...
						<td class="column borderR" align="center"><input type="text" class="grid-11-12 required number" name="seminario_taller[]" id="seminario_taller_<?php echo $row['idclasificacionesinfhuerfana']?>" title="Seminario Taller" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
					</tr>
	<?php
				}
			}
                                   ...
                                   // $("#id").val(data.message);
                                    for (var i=0;i<data.total;i++){                                  
                                      //  alert(data[i].id+'-'+data[i].idclasificacionesinfhuerfana+'-'+data[i].cantidad+'-->>')
                                        ...
                                        $(formName + " #busqueda_recuperacion_informacion_"+data[i].idclasificacionesinfhuerfana).val(data[i].busqueda_recuperacion_informacion);
