...
?>
				<tr class="dataColumns category">
					<th colspan="<?php if($aprobacion) echo "3"; else echo "4";?>" class="borderR"><?php echo $row2['clasificacionesinfhuerfana']?></th>               
                                        <?php if($aprobacion){ ?>
	...
	?>
					<tr id="contentColumns" class="row">
						...
						<td class="column borderR" align="center"><input type="text" class="grid-8-12 required number" name="usos_dentro_campus[]" id="usos_dentro_campus_<?php echo $row['idclasificacionesinfhuerfana']?>" title="Dentro del campus" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="grid-8-12 required number" name="usos_fuera_campus[]" id="usos_fuera_campus_<?php echo $row['idclasificacionesinfhuerfana']?>" title="Fuera del campus" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
						<td class="column borderR" align="center"><input type="text" class="grid-8-12 required number" name="general[]" id="general_<?php echo $row['idclasificacionesinfhuerfana']?>" title="Fuera del campus" maxlength="20" tabindex="1" autocomplete="off" size="6" style='text-align:center' /></td>
					</tr>
	<?php
				}
			}
                                   ...
                                   // $("#id").val(data.message);
                                    for (var i=0;i<data.total;i++){                                  
                                      //  alert(data[i].id+'-'+data[i].idclasificacionesinfhuerfana+'-'+data[i].cantidad+'-->>')
                                        ...
                                        $(formName + " #usos_dentro_campus_"+data[i].idclasificacionesinfhuerfana).val(data[i].usos_dentro_campus);
                                        $(formName + " #usos_fuera_campus_"+data[i].idclasificacionesinfhuerfana).val(data[i].usos_fuera_campus);
                                        $(formName + " #general_"+data[i].idclasificacionesinfhuerfana).val(data[i].general);
