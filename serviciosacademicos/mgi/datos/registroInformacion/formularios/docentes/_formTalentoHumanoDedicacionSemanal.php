...
<form action="save.php" method="post" id="form_DedicacionSemanal3_<?php echo $_REQUEST['tipo']; ?>">
            ...
            <fieldset id="numPersonas">   
                <legend>Dedicaci&oacute;n semanal de acuerdo a la categorizaci&oacute;n de la Universidad el Bosque </legend>
                    ...
                    <thead>            
                     ...
                     <tbody>
                         <?php //while ($rowC = $nivelFormacion->FetchRow()) { 
                             foreach ( $nivelFormacion  as $rowC){
                                $first = true;
                          ?>
                                <tr class="dataColumns">
...
<script type="text/javascript">
    ...
    getDataDedicacionSemanal31("#form_DedicacionSemanal3_"+<?php echo $_REQUEST['tipo'] ?>);
                ...
                function getDataDedicacionSemanal31(formName){
                                   ...
                                   // $("#actividad").val(data.actividad)
                                    for (var i=0;i<data.total;i++){   
                                      ...
                                      //  $(formName + "#idsiq_detalleformTalentoHumanoDedicacionSemanal_"+data.data[i].idCategory).val(data.data[i].idsiq_detalleformTalentoHumanoDedicacionSemanal);
                                        ...
                                        $(formName + " #tiempo1_4_"+data.data[i].idCategory).val(parseInt(data.data[i].tiempo1_4));
                                        $(formName + " #tiempo1_2_"+data.data[i].idCategory).val(parseInt(data.data[i].tiempo1_2));
                                        $(formName + " #tiempo3_4_"+data.data[i].idCategory).val(parseInt(data.data[i].tiempo3_4));
                                        $(formName + " #tiempocompleto_"+data.data[i].idCategory).val(parseInt(data.data[i].tiempocompleto));
