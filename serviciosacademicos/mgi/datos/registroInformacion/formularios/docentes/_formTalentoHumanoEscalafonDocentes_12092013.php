                    ...
                    <thead>            
                     ...
                     <tbody>
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number disable" minlength="1" name="numAcademicosPTitular" id="numAcademicosPTitular" title="Académicos Titulates" maxlength="10" tabindex="1" autocomplete="off" value="" readonly />
                            </td>
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column">
                                <input type="text" class="grid-4-12 required number disable" minlength="1" name="numAcademicosPAsociado" id="numAcademicosPAsociado" title="Académicos Asociados" maxlength="10" tabindex="1" autocomplete="off" value="" readonly />
                            </td>
                            <td class="column center"> 
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number disable" minlength="1" name="numAcademicosPAsistente" id="numAcademicosPAsistente" title="Académicos Asistentes" maxlength="10" tabindex="1" autocomplete="off" value="" readonly />
                            </td>
                            <td class="column center"> 
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number disable" minlength="1" name="numAcademicosIAsociado" id="numAcademicosIAsociado" title="Académicos como Instructor Asociado" maxlength="10" tabindex="1" autocomplete="off" value="" readonly />
                            </td>
                            <td class="column center"> 
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number disable" minlength="1" name="numAcademicosIAsistente" id="numAcademicosIAsistente" title="Académicos como Instructor Asistente" maxlength="10" tabindex="1" autocomplete="off" value="" readonly />
                            </td>
                            <td class="column center"> 
                        ...
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text" class="grid-4-12 required number disable" minlength="1" name="numAcademicosOtros" id="numAcademicosOtros" title="Otros Académicos" maxlength="10" tabindex="1" autocomplete="off" value="" readonly />
                            </td>
                            <td class="column center"> 
...
<script type="text/javascript">
    getDataEscalafon();
                ...
                function getDataEscalafon(){
                    var periodo = $('#form_escalafon #codigoperiodo').val();
