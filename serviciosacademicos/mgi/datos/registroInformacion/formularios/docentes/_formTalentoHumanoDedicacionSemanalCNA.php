...
<form action="save.php" method="post" id="form_DedicacionSemanalCNA3_<?php echo $_REQUEST['tipo']; ?>">
            ...
            <fieldset id="numPersonas">   
                <legend>Dedicaci&oacute;n semanal de acuerdo a la categorizaci&oacute;n del CNAA</legend>
                                ...
                                if (data.success == true){
                                   ...
                                   // $("#actividad").val(data.actividad)
                                    ...
                                    {   
                                        ...
                                        $(formName + " #tiempo1h_"+data.data[i].idCategory).val(parseInt(data.data[i].tiempo1h));
