<?php
    ...
    $actividades = $utils->getActives($db,"siq_dedicacionPersonal","idsiq_dedicacionPersonal");
?>
<div id="tabs-4">
<form action="save.php" method="post" id="form_indices">
            ...
            <input type="hidden" name="codigoperiodo" value="" id="codigoperiodo" />             
                ...
                <div class="vacio"></div>
                <?php $utils->pintarBotonCargar("popup_cargarDocumento(5,6,$('#form_indices #mes').val()+'-'+$('#form_indices #anio').val())","popup_verDocumentos(5,6,$('#form_indices #mes').val()+'-'+$('#form_indices #anio').val())"); ?>
