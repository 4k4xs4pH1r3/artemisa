...
<form action="save.php" method="post" id="form_formacion">
            ...
            <fieldset id="numPersonas">   
                ...
                <?php $utils->getYearsSelect("anio");  ?>
                                <?php $utils->pintarBotonCargar("popup_cargarDocumento(5,3,$('#form_formacion #mes').val()+'-'+$('#form_formacion #anio').val())","popup_verDocumentos(5,3,$('#form_formacion #mes').val()+'-'+$('#form_formacion #anio').val())"); ?>
                    ...
                    <thead>            
                     ...
                     <tbody>
                        <tr class="dataColumns">
                            ...
                            <td class="column"> 
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosDoctorado" id="numAcademicosDoctorado" title="Total de Académicos con Doctorado" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column"> 
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosDoctoradoMedico" id="numAcademicosDoctoradoMedico" title="Total de Académicos con Doctarado (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                        <tr class="dataColumns">
                            <td class="column">T. Maestría <span class="mandatory">(*)</span></td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosMaestria" id="numAcademicosMaestria" title="Total de Académicos con Maestría" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosMaestriaMedico" id="numAcademicosMaestriaMedico" title="Total de Académicos con Maestría (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                        <tr class="dataColumns">
                            <td class="column">T. Especialización <span class="mandatory">(*)</span></td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosEspecializacion" id="numAcademicosEspecializacion" title="Total de Académicos con Especialización" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosEspecializacionMedico" id="numAcademicosEspecializacionMedico" title="Total de Académicos con Especialización (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                        <tr class="dataColumns">
                            <td class="column">T. Profesional <span class="mandatory">(*)</span></td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosProfesional" id="numAcademicosProfesional" title="Total de Académicos con Titulo Profesional" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosProfesionalMedico" id="numAcademicosProfesionalMedico" title="Total de Académicos con Titulo Profesional (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                        <tr class="dataColumns">
                            <td class="column">T. Licenciado <span class="mandatory">(*)</span></td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosLicenciado" id="numAcademicosLicenciado" title="Total de Académicos con Licenciatura" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosLicenciadoMedico" id="numAcademicosLicenciadoMedico" title="Total de Académicos con Licenciatura (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                        <tr class="dataColumns">
                            <td class="column">T. Técnico/Tecnólogo <span class="mandatory">(*)</span></td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosTecnico" id="numAcademicosTecnico" title="Total de Académicos con Titulo de Técnico" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosTecnicoMedico" id="numAcademicosTecnicoMedico" title="Total de Académicos con Titulo de Técnico (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                        <tr class="dataColumns">
                            <td class="column">Sin Titulo <span class="mandatory">(*)</span></td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosNoTitulo" id="numAcademicosNoTitulo" title="Total de Académicos sin Titulo" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                            <td class="column">
                                <input type="text"  class="grid-4-12 required number" minlength="1" name="numAcademicosNoTituloMedico" id="numAcademicosNoTituloMedico" title="Total de Académicos sin Titulo (Médico-quirúrgico)" maxlength="10" tabindex="1" autocomplete="off" value="" />
                            </td>
                        </tr>
                    </tbody>
                </table>   
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            if (data.success == true){
                                 ...
                                 $("#form_formacion #action").val("update");
                                 $('#form_formacion #msg-success').css('display','block');
                                 $("#form_formacion #msg-success").delay(5500).fadeOut(800);
                            }
                            else{                        
