...
<div id="tabs" class="dontCalculate">
				<ul>
					...
					<li><a href="./formularios/docentes/_formTalentoHumanoAcademicosExtranjerosUnidadAcademica.php?id=<?php echo $id; ?>">Acad&eacute;micos extranjeros por Unidad Acad&eacute;mica</a></li>
					<li><a href="./formularios/docentes/_formTalentoHumanoAcademicosExtranjerosPais.php?id=<?php echo $id; ?>">Acad&eacute;micos extranjeros por pa&#237;s de origen</a></li>
                                        <li><a href="./formularios/docentes/_formTalentoHumanoDedicacionDocentesEscalafon.php?id=<?php echo $id; ?>">Docentes Dedicaci&oacute;n Semanal Escalaf&oacute;n</a></li>
					<li><a href="./formularios/docentes/_formTalentoHumanoDedicacionDocentesEscalafonCNA.php?id=<?php echo $id; ?>">Docentes Dedicaci&oacute;n Semanal Escalaf&oacute;n CNA</a></li>
					<li><a href="./formularios/docentes/_formTalentoHumanoAcademicosDocentesOtroIdioma.php?id=<?php echo $id; ?>">Profesores que cursan programas de idioma no materno</a></li>
                                        <li><a href="./formularios/docentes/_formTalentoHumanoDedicacionSemanal.php?tipo=1&id=<?php echo $id; ?>">Dedicaci&oacute;n de los Acad&eacute;micos Semanal - categorizaci&oacute;n de la Universidad El Bosque</a></li>
                                        <li><a href="./formularios/docentes/_formTalentoHumanoDedicacionSemanalCNA.php?tipo=1&id=<?php echo $id; ?>">Dedicaci&oacute;n de los Acad&eacute;micos Semanal - categorizaci&oacute;n del CNA</a></li>
     			</ul>
            ...
            <input type="hidden" name="codigoperiodo" value="" id="codigoperiodo" />                   
                ...
                <table align="center" class="formData" width="92%" >
                    <thead>            
                     ...
                     <tbody>
                        <tr class="dataColumns">
                            <td class="column">Semestral <span class="mandatory">(*)</span></td>
                            <td class="column"> 
                        ...
                        <tr class="dataColumns">
                            <td class="column">11 meses <span class="mandatory">(*)</span></td>
                            <td class="column">
                        ...
                        <tr class="dataColumns">
                            <td class="column">Núcleo Profesoral <span class="mandatory">(*)</span></td>
                            <td class="column">
