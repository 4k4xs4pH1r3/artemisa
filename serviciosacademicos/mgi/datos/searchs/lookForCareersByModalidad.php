...
$query_programa = "SELECT codigocarrera,nombrecarrera FROM carrera WHERE codigomodalidadacademica='".$q."' AND fechavencimientocarrera>'".$currentdate."' 
                    AND codigocarrera!=1 ORDER BY nombrecarrera ASC";
