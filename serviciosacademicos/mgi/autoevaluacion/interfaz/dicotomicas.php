                      ...
                      <input type="hidden" name="aparejamiento" id="aparejamiento" value="0" />
                            ...
                            <table align="center" width="80%" border="0">
                                    ...
                                    <tbody>
                                            <tr id="0"> 
                                                    <td width="80%" >
                                                        <input type="text" name="num[0]" id="num_0" style="width: 30px;border:0;text-align:right;border:0;text-align:right;cursor:default" value="1" readonly >
                                                     ...
                                                     for($i=1;$i<=$can;$i++){
                                                        ?>
                                                            <tr id="<?php echo $i ?>"> 
                                                                    ...
                                                                    <td><input type="text" name="valor1[<?php echo $i ?>]" id="valor1_<?php echo $i ?>" value="<?php if(!empty($data[$i]['valor'])){ echo $data[$i]['valor']; } ?>" ></td>
                                                                    <td align="right"><input type="button" value="" class="button medium clsEliminarFilaL"></td>
                                                            </tr>
                                                        <?php
                                                    }
                 ...
                 // $("#valor1_0").numeric();
                  ...
                  //alert($("#total").val());
                    $(document).on('click','.clsAgregarFilaL',function(){
                            if(i<2){
                                var strNueva_FilaL='<tr id="'+i+'">'+
                                    ...
                                    <input type="hidden" name="idsiq_Arespuesta1['+i+']" id="idsiq_Arespuesta1_'+i+'" style="width: 50px" ><input type="text" name="respuesta1['+i+']" id="respuesta1_'+i+'" style="width: 400px"></td>'+
                                        '<td><input type="text" name="valor1['+i+']" id="valor1_'+i+'"  ></td>'+
                                        '<td align="right"><input type="button" value="" class="button medium clsEliminarFilaL" ></td>'+
                                '</tr>';
                            ...
                            alert("El tipo de pregunta es dicotomica, es decir solo acepta dos respuestas");
                        }
                    });
