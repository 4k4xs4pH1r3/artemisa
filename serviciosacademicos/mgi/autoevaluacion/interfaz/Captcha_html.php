               ...
               <h1 style="font-weight: bold;padding:0;padding-top: 20px;">Datos Personales</h1>
                    ...
                    <table border="0" aling="center" >
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                Area:<span style="color:red; font-size:9px">(*)</span>  
                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                Tipo de usuario:<span style="color:red; font-size:9px">(*)  
                            </td>
                            <td>&nbsp;</td>
                            <td>
                            <?PHP 
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                Correo:<?PHP if($_REQUEST['actionID']=='Externo'){ echo '<span style="color:red; font-size:9px">(*)</span> '; }?>
                            </td>
                            <td>&nbsp;</td>
                            <td>
                        ...
                        ?>
                            ...
                            <td colspan="3" aling="center"><input type="submit"  value="Ingresar" id="submit" onclick="return validar(this);"  style="cursor:pointer;line-height: 0;padding: 0 3px;" /><!--button type="submit"--></td>
                        </tr>
                    </table>
          </fieldset>
