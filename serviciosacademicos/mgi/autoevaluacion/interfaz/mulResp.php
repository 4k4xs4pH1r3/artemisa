...
<div id="container">   
		<div class="demo_jui">
                    ...
                    <input type="hidden" name="codigoestado" id="codigoestado" value="100" />
                      ...
                      <input type="hidden" name="multiple_respuesta" id="multiple_respuesta" value="1" />
                            ...
                            <table align="center" width="80%" border="0">
                                    ...
                                    <tbody>
                                            <tr id="0"> 
                                                    ...
                                                    <td>
                                                   <input type="hidden" name="valor1[0]" id="valor1_0" value="<?php if(!empty($data[0]['valor'])){ echo $data[0]['valor']; }else{ echo "999"; } ?>" ></td>
            ...
            $(document).ready(function(){
                  ...
                  //alert($("#total").val());
                    $(document).on('click','.clsAgregarFilaL',function(){
                            var strNueva_FilaL='<tr id="'+i+'">'+
                                    ...
                                    '</td>'+
                                    '<td><input type="hidden" name="valor1['+i+']" id="valor1_'+i+'" value="0"  ></td>'+
                                    '<td align="right"><input type="button" value="" class="button medium clsEliminarFilaL" ></td>'+
                            '</tr>';
             ...
             $(':submit').click(function(event) {
                   ...
                   // alert(jc+'->'+zc+' val')
                    ...
                    if (j==0){
                       alert("Debe Tener una respuesta");
                       return false;
                   }else{
                      sendForm();
