...
<div id="container">   
		<div class="demo_jui">
                    ...
                    <input type="hidden" name="codigoestado" id="codigoestado" value="100" />
                      ...
                      <div id="titulo1">
                                <textarea style="height: 90px;" cols="90" id="analisis" name="analisis">
                                    <?php 
                                         if (empty($data_aux['analisis'] )){
                                             ?>
                                                Marque <b>A</b> si :                   <br>
                                                Marque <b>B</b> si :                   <br>
                                                Marque <b>C</b> si :                   <br>
                            ...
                            <table align="center" width="80%" border="0">
                                    ...
                                    <tbody>
                                            <tr id="0"> 
                                                    ...
                                                    <td>
                                                        <input type="checkbox" name="correcta1[0]" id="correcta1_0" <?php if ($data[0]['correcta']==1){ ?> checked="checked" <?php } ?> >
                                                        <input type="hidden" name="valor1[0]" id="valor1_0" value="999" >
                                                    </td>
                                                     ...
                                                     for($i=1;$i<=$can;$i++){
                                                        ?>
                                                            <tr id="<?php echo $i ?>"> 
                                                                    ...
                                                                    <td>
                                                                        <input type="checkbox" name="correcta1[<?php echo $i ?>]" id="correcta1_<?php echo $i ?>" <?php if ($data[$i]['correcta']==1){ ?> checked="checked" <?php } ?> >
            ...
            $(document).ready(function(){
                    ...
                    $(document).on('click','.clsAgregarFilaL',function(){
                            var strNueva_FilaL='<tr id="'+i+'">'+
                                   ...
                                   <input type="hidden" name="idsiq_Arespuesta1['+i+']" id="idsiq_Arespuesta1_'+i+'" style="width: 50px" ><input type="text" name="respuesta1['+i+']" id="respuesta1_'+i+'" style="width: 400px"></td>'+
                                    '<td><input type="checkbox" name="correcta1['+i+']" id="correcta1_'+i+'" ><input type="hidden" name="valor1['+i+']" id="valor1_'+i+'"  value="0" ></td>'+
                                    '<td align="right"><input type="button" value="" class="button medium clsEliminarFilaL" ></td>'+
                            '</tr>';
             ...
             $(':submit').click(function(event) {
                    ...
                    for (var i=0;i<CantItems;i++){
                      // alert('holaxxxx')
                       var value=$("#respuesta1_"+i).val();
                      // var resp=$("#form_test input[name='correcta1']:checkbox").is(':checked')
                      var resp=$("input[type='checkbox']:checked").length;
                       //alert('hkgjjgjhgj'+resp)
                       if (value!='' && resp!=0){
                            j++
                       }
                       if (value!='' || resp!=0){
                   ...
                   // alert(jc+'->'+zc+' val')
                    ...
                    if (j==0){
                      ...
                      document.getElementById("analisis").innerHTML = $.trim(nicEditors.findEditor('analisis').getContent());  
                      sendForm();
