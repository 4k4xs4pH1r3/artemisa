<?php
    ...
    writeHeader("Gestión de Aspectos Inactivas",false,$proyectoMonitoreo);
...
<div id="container">
            <h2>Administración de Aspectos Inactivas</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql+='inner join siq_factor f on f.idsiq_factor = c.idFactor ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=false&table=siq_aspecto&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 5, "desc" ]],
                "aoColumnDefs": [ 	
