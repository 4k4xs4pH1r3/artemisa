    ...
    <div id="contenidoSecundario">
            <h2>Responsables del Aspecto</h2>
            <div class="demo_jui">
...
<script type="text/javascript">
        ...
        $(document).ready(function() {  
            ...
            sql="SELECT g.idsiq_responsableAspecto,c.nombres,c.apellidos,t.nombre,g.usuario_modificacion,g.fecha_modificacion FROM siq_responsableAspecto g ";
            ...
            sql+='inner join siq_tipoResponsabilidad t on t.idsiq_tipoResponsabilidad = g.idTipoResponsabilidad ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_responsableAspecto&sql="+sql+"&wh=g.idAspecto&vwh=<?php echo $_REQUEST["id"]; ?>&tableNickname=g&join=true",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [ 
            ...
            $('#ToolTables_example_3').click( function () {  
                ...
                {deleteResponsable("responsableAspecto");}                
            } );
