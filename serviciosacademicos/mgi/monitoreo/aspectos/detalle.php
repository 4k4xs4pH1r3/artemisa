...
$db = writeHeader("Ver Detalle Aspecto", TRUE, $proyectoMonitoreo);
...
if (isset($_REQUEST["id"])) {
    ...
    $caracteristica = $utils->getDataEntity("caracteristica", $data["idCaracteristica"]);
...
<div id="contenido">
    <h2>Ver Detalle Aspecto</h2>
    <table class="detalle">
        <tr>
            <th>Código:</th>
            <td><?php echo $data['codigo']; ?></td>
            <th>Identificador:</th>
            <td><?php echo $data['idsiq_aspecto']; ?></td>
        </tr>
        <tr>
            <th>Nombre:</th>
