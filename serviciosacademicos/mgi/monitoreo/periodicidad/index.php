<?php
    ...
    writeHeader("Gestión de Periodicidades",false,$proyectoMonitoreo);
    
    include("./menu.php");
    writeMenu(1); 
?>
        <div id="container">
            <h2>Administración de Periodicidades</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql+='inner join siq_tipoValorPeriodicidad t on t.idsiq_tipoValorPeriodicidad = g.tipo_valor ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_periodicidad&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [ 
