...
class aspectoClass {
    ...
    public function getIdsiq_aspecto() {
        return $this->idsiq_aspecto;
    }

    public function setIdsiq_aspecto($idsiq_aspecto) {
        $this->idsiq_aspecto = $idsiq_aspecto;
    }
