<?php
    ...
    writeHeader("Gestión de Tipos de Alertas Inactivos",false,$proyectoMonitoreo);
    
    include("./menu.php");
    writeMenu(3);    ?>

<div id="container">
            <h2>Tipos de Alertas Inactivos</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql+='left join siq_tipoResponsabilidad t on t.idsiq_tipoResponsabilidad = g.idTipoResponsable';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=false&table=siq_tipoAlerta&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true&group=g.idsiq_tipoAlerta",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [  
