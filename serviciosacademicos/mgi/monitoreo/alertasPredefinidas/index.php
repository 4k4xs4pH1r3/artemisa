<?php
    ...
    writeHeader("Gestión de Alertas por Eventos",false,$proyectoMonitoreo);
    
    include("./menu.php");
    writeMenu(1);    ?>

<div id="container">
            <h2>Administración de Alertas por Eventos</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql="SELECT g.idsiq_tipoAlertaPredefinida,g.idsiq_tipoAlertaPredefinida,g.nombre,g.descripcion,g.asunto_correo,g.fecha_modificacion,g.usuario_modificacion FROM siq_tipoAlertaPredefinida g ";
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_tipoAlertaPredefinida&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [  
            ...
            $('#ToolTables_example_3').click( function () {  
                ...
                {deleteForm("tipoAlertaPredefinida");}                
            } );          
