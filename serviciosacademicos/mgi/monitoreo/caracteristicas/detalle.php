<?php
    ...
    $db = writeHeader("Ver Detalle Característica",TRUE,$proyectoMonitoreo);
    ...
    if(isset($_REQUEST["id"])){ 
       ...
       $factor = $utils->getDataEntity("factor", $data["idFactor"]);       
...
?>
        ...
        <div id="contenido">
            <h2>Ver Detalle Característica</h2>
            <table class="detalle">
                <tr>
                    <th>Código:</th>
                    <td><?php echo $data['codigo']; ?></td>
                    <th>Identificador:</th>
                    <td><?php echo $data['idsiq_caracteristica']; ?></td>
                </tr>
                <tr>
                    <th>Nombre:</th>
