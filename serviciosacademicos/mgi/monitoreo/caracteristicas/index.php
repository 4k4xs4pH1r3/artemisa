<?php
    ...
    writeHeader("Gestión de Características",false,$proyectoMonitoreo);
        ...
        $(document).ready(function() {  
            ...
            sql+='inner join siq_factor f on f.idsiq_factor = g.idFactor ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_caracteristica&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [ 
