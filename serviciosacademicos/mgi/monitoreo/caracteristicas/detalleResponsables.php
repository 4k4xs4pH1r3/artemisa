    ...
    <div id="contenidoSecundario">
            <h2>Responsables de la Característica</h2>
            <div class="demo_jui">
...
<script type="text/javascript">
        ...
        $(document).ready(function() {  
            ...
            sql="SELECT g.idsiq_responsableCaracteristica,c.nombres,c.apellidos,t.nombre,g.usuario_modificacion,g.fecha_modificacion FROM siq_responsableCaracteristica g ";
            ...
            sql+='inner join siq_tipoResponsabilidad t on t.idsiq_tipoResponsabilidad = g.idTipoResponsabilidad ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_responsableCaracteristica&sql="+sql+"&wh=g.idCaracteristica&vwh=<?php echo $_REQUEST["id"]; ?>&tableNickname=g&join=true",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [ 
						...
						{ "fnRender": function ( oObj ) { return oObj.aData[0]+" "+oObj.aData[1];
                                                ...
                                                { "sClass": "column_fecha", "aTargets": [ 4 ] }
					],
            ...
            $('#ToolTables_example_3').click( function () {  
                ...
                {deleteResponsable("responsableCaracteristica");}                
            } );
