<?php
    ...
    $db = writeHeader("Asignar Responsable a Característica",TRUE,$proyectoMonitoreo);
   ...
   $action = $_REQUEST["action"];
    ...
    if(strcmp($action,"inactivate")==0){
       $fields = array();
       $fields["idsiq_responsableCaracteristica"] = $id;
       $data = $utils->processData($_REQUEST["action"],"responsableCaracteristica", $fields);  
       ...
       if($edit){
            $relacion = $utils->getDataEntity("responsableCaracteristica", $idR); 
        ...
        <div id="contenido">
            ...
            <div id="form"> 
                ...
                <form action="save.php" method="post" id="form_test" >
                        <input type="hidden" name="entity" value="responsableCaracteristica" />
                        <input type="hidden" name="action" value="<?php echo $action; ?>" />
                        <span class="mandatory">* Son campos obligatorios</span>
                        <fieldset>   
                            <legend>Información de la Característica</legend>
                            <label class="grid-2-12">Característica: </label>
                            <p><?php echo $data["nombre"]; ?></p>        
                            <input type="hidden" name="idCaracteristica" value="<?php echo $data["idsiq_caracteristica"]; ?>" />                   
                        </fieldset>
                        <fieldset>   
                            ...
                            <?php if($edit){ ?>                                
                                ...
                                <input type="hidden" name="idsiq_responsableCaracteristica" value="<?php echo $relacion["idsiq_responsableCaracteristica"]; ?>" />
                            <?php } else { ?>
