            ...
            <div id="form"> 
                <form action="save.php" method="post" id="form_test">
                        ...
                        <fieldset>   
                            ...
                            <p style="width:84%;margin-left:15%;"><?php echo $indicadorGenerico["nombre"]." ( ".$entity["nombre"]." )"; ?></p>        
                        ...
                        <fieldset>   
                            ...
                            <label for="fin_de_mes" id="labelFinMes" class="grid-2-12 hidden">¿Siempre en fin de mes?: <span class="mandatory">(*)</span></label>
                            <?php writeYesNoSelect("fin_de_mes",$monitoreo['fin_de_mes'], "hidden"); ?>
                        </fieldset>
