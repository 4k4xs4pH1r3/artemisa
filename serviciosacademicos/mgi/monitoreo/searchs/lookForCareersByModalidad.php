...
$query_programa = "SELECT codigocarrera,nombrecarrera FROM carrera WHERE codigomodalidadacademica='".$q."' AND fechavencimientocarrera>'".$currentdate."' ORDER BY nombrecarrera ASC";
