<?php
    ...
    writeHeader("Gestión de Factores",false,$proyectoMonitoreo);
...
?>
        ...
        $(document).ready(function() {  
            var sql;
            sql="SELECT g.idsiq_factor,g.idsiq_factor as id,g.codigo,g.nombre,g.fecha_modificacion,g.usuario_modificacion,c.nombres,c.apellidos FROM siq_factor g ";
            sql+='inner join usuario c on c.idusuario = g.usuario_modificacion ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_factor&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 3, "desc" ]],
                "aoColumnDefs": [ 
