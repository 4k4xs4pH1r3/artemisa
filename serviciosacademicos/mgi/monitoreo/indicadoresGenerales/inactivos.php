<?php
    ...
    writeHeader("Definiciones de Indicadores Inactivas",false,$proyectoMonitoreo);
    
    include("./menu.php");
    writeMenu(3);    ?>

<div id="container">
            <h2>Definiciones de Indicadores Inactivas</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql+='inner join siq_factor f on f.idsiq_factor = c.idFactor ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=false&table=siq_indicadorGenerico&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 7, "desc" ]],
                "aoColumnDefs": [  
            ...
            $('#ToolTables_example_1').click( function () {  
                ...
                {activateForm("indicadorGenerico");}                
            } );
