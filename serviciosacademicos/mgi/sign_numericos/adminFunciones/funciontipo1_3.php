...
//}
        ...
        if (isset($_GET["idsiq_funcionTipo1"]) && isset($_GET["siq_funcionIndicadores"]) && isset($_GET["idPeriodo"])
                && isset($_GET["tipo"]) && isset($_GET["valor"])) {
        
            // Put parameters into local variables
            $idsiq_funcionTipo1 = $_GET["idsiq_funcionTipo1"];
            $siq_funcionIndicadores = $_GET["siq_funcionIndicadores"];
