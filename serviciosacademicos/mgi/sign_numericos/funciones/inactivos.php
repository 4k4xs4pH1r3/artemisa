<?php
    ...
    writeHeader("Gestión de Funciones Inactivos",false,$proyectoNumericos);
    
    include("./menu.php");
    writeMenu(3); 
?>
        <div id="container">
            <h2>Administración de Funciones Inactivos</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql+='inner join usuario c on c.idusuario = g.usuario_modificacion ';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true, 
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=false&table=siq_funcion&sql="+sql+"&wh=g.usuario_modificacion",
                "aaSorting": [[ 2, "desc" ]],
                "aoColumnDefs": [ 
