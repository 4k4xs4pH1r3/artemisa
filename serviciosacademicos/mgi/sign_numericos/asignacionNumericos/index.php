<?php
    ...
    writeHeader("Gestión de Indicadores",false,$proyectoNumericos);
    include("../../API_Monitoreo.php"); 
    include("./menu.php");
    writeMenu(1);    ?>

<div id="container">
            <h2>Asignación de Indicadores Numéricos</h2>
            <div class="demo_jui">
        ...
        $(document).ready(function() {  
            ...
            sql="SELECT g.idsiq_indicador,id.nombre,g.discriminacion as disc,d.nombre as discriminacion,c.nombrecarrera as carrera,e.nombre as estado,g.fecha_modificacion, i.existe , f.nombre   FROM siq_indicador g ";
            sql+='inner join siq_indicadorGenerico id on id.idsiq_indicadorGenerico = g.idIndicadorGenerico ';
            sql+='inner join siq_discriminacionIndicador d on d.idsiq_discriminacionIndicador = g.discriminacion ';
            sql+='left join carrera c on c.codigocarrera = g.idCarrera ';
            sql+='left join sala.siq_funcionIndicadores n on n.idIndicador = g.idsiq_indicador  ';
            ...
            sql+='inner join siq_estadoIndicador e on e.idsiq_estadoIndicador = g.idEstado and id.idTipo = 3 and g.inexistente = 0 ';       
            //sql+='where  id.idTipo = 3 and g.inexistente = 0';
