...
<div id="container">
        ...
        $(document).ready(function() {  
            var sql;
            sql="SELECT g.idsiq_indicador,id.nombre,g.discriminacion as disc,d.nombre as discriminacion,c.nombrecarrera as carrera,e.nombre as estado,g.fecha_modificacion FROM siq_indicador g ";
