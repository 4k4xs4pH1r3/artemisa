...
<script type="text/javascript">
        ...
        $(document).ready(function() {  
            ...
            sql="SELECT g.idsiq_funcionTipo2,i.nombre,p.nombre,g.resultado,g.porcentaje,g.usuario_modificacion,g.fecha_modificacion FROM siq_funcionTipo2 g ";
            sql+='inner join siq_funcionIndicadores f on g.funcionIndicadores = f.idsiq_funcionIndicadores ';
            sql+='left join siq_periodo p on g.idPeriodo = p.idsiq_periodo ';
            sql+='left join siq_infoIndicador i on g.tipo = i.idsiq_infoIndicador ';
            sql+='where  f.idindicador = <?php echo $_REQUEST["id"]; ?>';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
               "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_funcionTipo2&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true",
                "aaSorting": [[ 4, "desc" ]],
                "aoColumnDefs": [ 
        ...
        $(window).resize(function() {
         ...
         function insertarphp(){
		  ...
		  window.location.href= "../../sign_numericos/indicadoresNumericos/insertarTipo2.php?id="+ <?php echo $_REQUEST["id"]; ?>;
	}
