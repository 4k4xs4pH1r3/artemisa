        ...
        $(document).ready(function() {  
            ...
            //sql+='where  id.idTipo = 3';
              ...
              oTable = $('#example').dataTable({         
                ...
                "bServerSide": true,                
                "sAjaxSource": "<?php echo $rutaProcessing; ?>server_processing.php?active=true&table=siq_indicador&sql="+sql+"&wh=g.usuario_modificacion&tableNickname=g&join=true&indicadoresACargo=idsiq_indicador",
                "aaSorting": [[ 0, "desc" ]],
                "aoColumnDefs": [  
