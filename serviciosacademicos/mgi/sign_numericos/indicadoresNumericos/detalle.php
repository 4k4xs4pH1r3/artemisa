...
?>
        ...
        <div id="contenido">
            <h2>Indicador Numérico Tipo 1</h2>
            <table class="detalle">
                <tr>
                    <th>Indicador:</th>
...
if ($Permisos[1][0] == 1){
    //var_dump($ver);
    if ($ver == 1){
      include("./detalleFuncionTipo1ver.php");
    }else if ($ver == 0 || $ver == 2){
          include("./detalleFuncionTipo1.php");
      }
 ...
 echo ("El Indicador no tiene Asignado un responsable, Ni tipo de responsabilidad.");
}
