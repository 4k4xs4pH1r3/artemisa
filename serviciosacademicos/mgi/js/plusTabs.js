  ...
  var methods = {
	...
	var o = options,
	  ...
	  function showActiveTab()
	  {
	    ...
	    if (o.showCount === true)
	    {
              //le habia restado 1 por lo que no quiero que se vea la que ya esta elegida
	    ...
	    // position .allTabs
            var leftPositionMenu = $uiTabsNav.find("li.ui-state-active").outerWidth()+24;
