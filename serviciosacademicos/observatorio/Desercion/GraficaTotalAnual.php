...
//var_dump (is_file('../../mgi/datos/templates/template.php'));die;
    ...
    <html>
       ...
       // echo '<pre>';print_r($C_Datos);
        ...
        //echo '<pre>';print_r($R_Total);
        
        
        for($j=0;$j<count($R_Total);$j++){
            
            $C_Datos['Porcentaje'][] = $R_Total[$j]['TotalPorcentaje'];
        ...
        $MyData->setSerieTicks("Desercion Pregrado Total".$P_Periodo,4);   
        ...
        $MyData->setPalette(" Desercion Total Anual ".$P_Periodo,array("R"=>44,"G"=>87,"B"=>0));
