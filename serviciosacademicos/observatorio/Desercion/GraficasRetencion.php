...
//var_dump (is_file('../../mgi/datos/templates/template.php'));die;
    ...
    <html>
       ...
       <?PHP 
        ...
        $C_Datos        = $C_Desercion->CadenaProRetencion($CodigoPeriodo,$CodigoCarrera);
        $D_Total        = $C_Desercion->CadenaRetenInstitucional($CodigoPeriodo);
        ...
        */ 
        ...
        $N=max($C_Datos["Desercion"]);
        $K=max($D_Total['Total_R']);
        ...
        $MyData->addPoints($C_Datos["Desercion"],$NombreCarrera." ".$P_Periodo."-".$Ac_Periodo);
        $MyData->addPoints($D_Total['Total_R'],"Permanencia Pregrado".$P_Periodo."-".$Ac_Periodo);
        ...
        $myPicture->drawText(10,16,"Retencion Semestral",array("FontSize"=>9,"Align"=>TEXT_ALIGN_BOTTOMLEFT));
