...
?>
        ...
        <?php
                ...
                //echo $estasindeudas;
				/*echo "<br/>";var_dump($this->es_ordenplandepago());
				echo "<br/>";var_dump($estaapazysalvo);
				echo "<br/>";var_dump($estasindeudas);
				echo "<br/>";var_dump($this->es_ordenplandepagohijo());
				echo "<br/>";var_dump($totalRows_ordenesenproceso);*/
            ...
            $json['valorconcepto'] = number_format($C_OrdenEstudiante['valorconcepto'],0,',',',');
                        ...
                        if ($fechavencimiento = $this->ordenvigente()) { 
                           ...
                           $onClick      = '';
                            if ($this->codigoimprimeordenpago == "02" && !$estaapazysalvo) {
                             ...
                             $rutaImprimir  = 'http://200.31.88.58/serviciosacademicos/funciones/ordenpago/factura_pdf_nueva/factura.php?numeroordenpago='.$this->numeroordenpago.'&codigoestudiante='.$this->codigoestudiante.'&codigoperiodo='.$this->codigoperiodo.'&documentoingreso='.$this->numerodocumento_ordenpago();
             ...
             if (ereg("^4.+$", $C_OrdenEstudiante['codigoestadoordenpago']) || ereg("^5.+$", $C_OrdenEstudiante['codigoestadoordenpago'])) {
               ...
               if ($codigocomprobante = $this->existe_ticket()) {
                    ...
                    $json['ticket'] = $ruta .'http://200.31.88.58/libsoap/class.getRequest.php?s='.$clave.'&origen=1';   
             ...
             if (ereg("^6.+$", $C_OrdenEstudiante['codigoestadoordenpago'])) {
               ...
               /*****************************************************/
                ...
                $json['ticket']  =  'http://200.31.88.58/libsoap/class.getRequest.php?s='.$clave.'&origen=SALA';
               /*****************************************************/
            } 
