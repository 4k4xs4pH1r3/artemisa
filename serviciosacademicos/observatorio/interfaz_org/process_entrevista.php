...
if ($table=='admitidos_entrevista'){
     if (!empty($_REQUEST['idconP'])){
         $id_nam=$_REQUEST['idobs_admitidos_campos_evaluar'];
...
if ($table=='admitidos_cab_entrevista'){
    ...
    $entity->SetEntity($_POST);
    $_POST['documentacion_requerida']=$_POST['documentacion_requerida'];
    $_POST['idobs_estadoadmision']=$_POST['idobs_estadoadmision'];
    $_POST['recomienda_admision_porque']=$_POST['recomienda_admision_porque'];
    $_POST['seguimiento']=$_POST['seguimiento'];
    $_POST['recomienda_seguimiento']=$_POST['recomienda_seguimiento'];
    $_POST['fecha_admision']=$_POST['fecha_admision'];
    $_POST['admitido']=$_POST['admitido'];
    ...
    if (!empty($_REQUEST['iddocu'])){
        ...
        foreach($doc as $ca){
            ...
            if($ca==0){
               ...
               // echo $docP[$i].'--><br>';
                if($docP[$i]==0){
                    $_POST['idobs_documentos_pendientes']='';
                    $_POST['iddocumentos']=$ca;
                    $entity->SetEntity($_POST);
                    //$entity->debug = true;
                    $entity->insertRecord();
                    $result='Se registro exitosamente';
