...
WHERE r.codigoestado=100 
     ...
     ".$wcp." ".$woc." ".$wc."
     ".$wrf." ".$wrp." ".$wrt."
group by n_tutoria order by r.fechacreacion desc";
}
//echo $query_carrera;
            ...
            ?>
                 <tr>
                     <td> 
                         ...
                         if ($tipo=='R'){
                            ?>
                              <button type="button" id="crear" name="crear" title="Crear Tutoria" onclick="updateForm3('form_tutorias.php?id_res=<?php echo $dt['idobs_registro_riesgo'] ?>')"><img src="../img/agregar.png" width="20px" height="20px"  /></button>
                          
                         <?php
                         }else{
                             ?>
                            <button type="button" id="editar" name="editar" title="Editar" onclick="updateForm3('form_tutorias.php?id=row_<?php echo $dt['idobs_tutorias'] ?>&id_res=<?php echo $dt['idobs_registro_riesgo'] ?>')"><img src="../img/editar.png" width="20px" height="20px"  /></button>
