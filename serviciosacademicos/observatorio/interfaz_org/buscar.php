    ...
    <?php
        foreach($data_in as $dt){ 
            ...
            <?php if ($i==0){ ?>
                          ...
                          <button type="button" id="eliminar" name="eliminar" title="Eliminar" onclick="deleteRegistro('<?php echo $entity ?>','<?php echo $dt['idobs_'.$entity.''] ?>','listar_<?php echo $entity ?>.php')"><img src="../img/eliminar.png" width="20px" height="20px"  /></button>
