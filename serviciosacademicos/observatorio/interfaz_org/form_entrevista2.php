...
//                });
       ...
       function cargar(id){
        ...
        if(id==1){
                ...
                jQuery("#tabs-5")
                    .html(ajaxLoader)
                    .load('generaentrevista_paso5.php', {codigoestudiante: estudiante, Utipo:Utipo,  entity:entity, idobs_admitidos_cab_entrevista:idobs_admitidos_cab_entrevista }, function(response){					
                    if(response) {
      ...
      <input type="hidden" name="Utipo" id="Utipo" value="<?php echo $_REQUEST['Utipo'] ?>" />
        ...
        <div id="tabs" style=" width: 1350px;  ">
            <ul>
                ...
                <?php if ($tipo=='Adm') {?>
                <li style="width: 190px"><div class="stepNumber">5</div><a href="#tabs-5" onclick="cargar('5')"><span class="stepDesc">Admision<br /></span></a></li>
                <?php } ?>
            ...
            <?php if ($tipo=='Adm') {?>
            <div id="tabs-5" style=" height: 150px">
