...
<form action="" method="post" id="form_test2">
      ...
      <input type="hidden" name="Utipo" id="Utipo" value="<?php echo $_REQUEST['Utipo'] ?>" />
        <table border="0" class="CSSTableGenerator">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    <select id="idobs_admitidos_contexto_<?php echo $i ?>" name="idobs_admitidos_contexto[]" onchange="displayRiesgo(<?php echo $i ?>)">
                                                        ...
                                                        foreach($reg_op as $dt1){
                                                            if($id==14){
                                                                $id2=$dataC[7]['idobs_admitidos_contexto'];
                                                            }else{
                                                                $id2=$dataC[$id-1]['idobs_admitidos_contexto'];
                                                            }
                                                          ?>
                                              ...
                                              <td>
                                                  <div id="nivel_<?php echo $i ?>">
                                                      ...
                                                      if (!empty($dataC[$i]['idobs_admitidos_contexto'])){
                                                      $query_carrera = "SELECT idobs_admitidos_contexto, nombre, nombretiporiesgo, t.idobs_tiporiesgo
                                                                            ...
                                                                            WHERE c.idobs_admitidos_contexto='".$dataC[$i]['idobs_admitidos_contexto']."' and c.codigoestado=100; ";
                                                           //echo $query_carrera;
                        ...
                        <?php 
                           if($Utipo=='entrevistador' && empty($dataC[0]['idobs_admitidos_entrevista_conte'])){ ?>
...
<script type="text/javascript">
               ...
               function sendForm2(){
                   // alert('aca entra')
                    ...
                    var con=''
                    jQuery("select[name='idobs_admitidos_contexto[]']").each(function(){ con += "'"+$(this).val() + "',"; });
