<?php
   ...
   $db =writeHeader("Metas <br> Admisiones",true,"Admisiones",1);
   /* include("./menu.php");
    writeMenu(0);*/
    ?>
        <div id="container">
