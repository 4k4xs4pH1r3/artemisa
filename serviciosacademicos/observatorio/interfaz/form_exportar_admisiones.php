...
$db=writeHeader('Exportar Metas <br> Admitidos',true,'Admisiones',1);
                    ...
                    <table border="0" width="100%" class="CSSTableGenerator">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <?php
                                        $query_programa = "SELECT nombremodalidadacademica, codigomodalidadacademica FROM modalidadacademica where codigomodalidadacademica in (200,300)";
                                        $reg_programa =$db->Execute($query_programa);
                                        echo $reg_programa->GetMenu2('codigomodalidadacademica',$modalidad,true,false,1,' id="codigomodalidadacademica" onchange="displayCarreraM()"  style="width:295px;"');
                                 ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div id="pregrado" style=" display: none">
                                        <a href="../plantillas/admisiones_pregrado.cvs" target="_blank">Descargar</a>
                                    </div>
                                    <div id="postgrado" style=" display: none">
                                        <a href="../plantillas/admisiones_postgrado.cvs" target="_blank">Descargar</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4">
                                      <button class="submit" type="submit" tabindex="3">Guardar</button>
                                        &nbsp;&nbsp;
                                        <a href="listar_metas_admisiones.php" class="submit" tabindex="4">Regreso al men&uacute;</a>  
                                </td>
                            </tr>
                        </tbody>
                    </table>
