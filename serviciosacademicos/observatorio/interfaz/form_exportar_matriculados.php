...
$db=writeHeader('Exportar Metas <br> Matriculados',true,'Admisiones',1);
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div id="pregrado" style=" display: none">
                                        <a href="../plantillas/matriculados_pregrado.cvs" target="_blank">Descargar</a>
                                    </div>
                                    <div id="postgrado" style=" display: none">
                                        <a href="../plantillas/matriculados_postgrado.cvs" target="_blank">Descargar</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
