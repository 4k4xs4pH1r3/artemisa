...
ini_set('display_errors', '0');
   ...
   $db =writeHeader("Remisi&oacute;n<br>Psicol&oacute;gica",true,"PAE",1,'Seguimiento Psicologico');
   $fun = new Observatorio();
   $roles=$fun->roles_permi($db,$_SESSION['MM_Username'],'Seguimiento Psicologico');
                     ...
                     $.ajax({
                        ...
                        success:function(data){
                            if (data.success == true){
                                alert(data.message);
                                $(location).attr('href','form_remision_psicologia.php?id_res=<?php echo $_REQUEST['id_res'] ?>');
                            }
                            else{                        
