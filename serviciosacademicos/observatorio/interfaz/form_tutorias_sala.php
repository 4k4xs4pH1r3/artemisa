...
ini_set('display_errors', '1');
   ...
   $db =writeHeader("Seg. <br>S. Apendizaje",true,"PAE",1,'Seguimiento de salas de aprendizaje');
   $fun = new Observatorio();
   $roles=$fun->roles_permi($db,$_SESSION['MM_Username'],'Seguimiento de salas de aprendizaje');
...
?>
    ...
    <form action="save.php" method="post" id="form_test">
        ...
        <div id="tabs">
                <ul>
                <li style="width: 165px"><div class="stepNumber">1</div><a href="#tabs-1"><span class="stepDesc">Datos del<br />Docente</span></a></li>
         ...
         <div class="derecha">
              <?php if ($roles['editar']==1 && empty($_REQUEST['id'])){?>
...
<script type="text/javascript">
                ...
                function confirmar(){
                           conf=confirm("Esta seguro de la informacion que desea guardar")
                           if (conf){
                                 sendForm2()
                           } else{
                                return false
