...
$db=writeHeader('Metas Matriculados',true,'Admisiones',1,'Metas matriculados');

 include("funciones.php");
 $fun = new Observatorio();
 $roles=$fun->roles_permi($db,$_SESSION['MM_Username'],'Metas matriculados'); 
...
<script type="text/javascript">
   ...
   function displayCarreraM(){
       ...
       // alert (Periodo);
        ...
        jQuery("#carreraAjax")
            .html(ajaxLoader)
            .load('generacarrera.php', {id: optionValue, Periodo:Periodo, status: '', entity:entity}, function(response){					
            if(response) {
                                     ...
                                     ?>
                                         ...
                                         <?php
                                             ...
                                             foreach($data_in as $dt){
                                                  ...
                                                  $meta=$dt['meta'];
                                                  $idobs=$dt['idobs_metas_matriculados'];
                                                 ?>
                                                     <tr>
                                                         <td>
                                                             <input type="hidden" name="idobs_metas_matriculados1[]" id="idobs_metas_matriculados1_<?php echo $j ?>" value="<?php echo $idobs ?>" />
