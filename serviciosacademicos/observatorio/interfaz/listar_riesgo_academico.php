...
ini_set('display_errors', '0');
   ...
   if($tipo=='R'){
       $tit='Estu. Remitidos<br>Seg. Tutor&iacute;as';
   }else if($tipo=='P'){
       $tit='Estu. Atendidos<br>Seg. Tutor&iacute;as';
   }
   $db =writeHeader($tit,true,"seguimiento",1,'Tutorias');
       ...
       var semestre = ""; var nivel= ""; var causas1=""; var carrera="";
        ...
        if (modalidad==0){
           ...
           $('#result').html('<blink>Cargando...</blink>');
            $.ajax({//Ajax
                      type: 'POST',
                      url: 'buscar_remision_tutorias.php',
                      async: false,
                      //dataType: 'json',
