      ...
      <input type="hidden" name="codigoperiodo" id="codigoperiodo" value="<?php echo $codigoperiodo ?>" />
        <table border="0" class="CSSTableGenerator">
                    ...
                    <tr>
                        ...
                        <td>Documentaci&oacute;n Entregada</td>
...
/*                            $query_doc="SELECT d.nombredocumentacion, d.iddocumentacion 
                            ...
                            foreach($reg_cau as $ca){
                                $che=""; $ch1='';                                
									$query_documentosestuduante ="SELECT distinct d.idempresasalud,fechavencimientodocumentacionestudiante,codigotipovencimientodocumento,nombretipodocumentovencimiento
									 ...
									 and d.iddocumentacion = '".$ca['iddocumentacion']."'	
									 ...
									 $reg_cau =$db->Execute($query_documentosestuduante);															
									 if ((empty($reg_cau->EOF))){
										 $che="checked";
									 }									
                                ...
                                ?>
                                 <tr>
                                         ...
                                         <td>
                                             ...
                                             <input type="checkbox" class="ries_<?php echo $dt['iddocumentacion'] ?>" <?php echo $che?> id="iddocumentacion" name="iddocumentacion[]"  value="<?php echo  $ca['iddocumentacion'] ?>"   />
										</td>
                                 </tr>
                                 <?php
                                     $j++; $z++;
      ...
      <?php 	  
						if(($Utipo=='entrevistador' && empty($data['idobs_admitidos_cab_entrevista'] )) || ($Utipo=='entrevistador' && !$pasaronHoras) ){ ?>
...
<script type="text/javascript">
                ...
                function sendForm1(){
                    ...
                    $('input[name="iddocumentacion[]"]').each(function() { 
					 ...
					 if((iddocu == '') && (documentacion_requerida == 'Si') && contador>0){						
						 alert("Debe Seleccionar Documentos Requeridos");
						 return false;
					 }
