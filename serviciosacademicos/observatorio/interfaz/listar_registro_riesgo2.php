<?php
   include("../templates/templateObservatorio2.php");
   ...
   if($tipo=='R'){
       ...
       $tit='Seguimiento Estu.';
	   $tit2=' Docente';
   }else if($tipo=='SE'){
       $tit='Seguimiento <br> Estudiante';
   }

   $db =writeHeader($tit,$tit2,true,"Causas Asistencias",1,'Registro de riesgo');
...
if($tipo=='S'){
   ?>
<label style="color:#2448a5; font-size:13px">Aquí usted podrá encontrar el historial del estudiante en relación con información del seguimiento realizado por el Programa de Apoyo al Estudiante (PAE), así como la posibilidad de Citar al estudiante. Recuerde que las citaciones se guardarán en la “Citación PAE”, “Citaciones pendientes”.</label>
<?php 
   }
   if($tipo=='R'){
   ?>
