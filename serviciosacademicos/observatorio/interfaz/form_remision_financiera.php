...
ini_set('display_errors', '0');
   ...
   $db =writeHeader("Remisi&oacute;n<br>Financiera",true,"PAE",1,'Seguimiento Financiero');
   $fun = new Observatorio();
   $roles=$fun->roles_permi($db,$_SESSION['MM_Username'],'Seguimiento Financiero');
                     ...
                     $.ajax({
                        ...
                        success:function(data){
                            if (data.success == true){
                                alert(data.message);
                                $(location).attr('href','form_remision_financiera.php?id_res=<?php echo $_REQUEST['id_res'] ?>');
                            }
                            else{                        
