...
include('../templates/templateObservatorio.php');
 ...
 /*  if(!empty($codigomateria)){
       if ($codigomateria=='undefined'){
           $wcm=""; 
       }else{
        $wcm=" and  m.codigomateria='".$codigomateria."'";
       }
   }*/
   ...
   if ( $F_total1==1){
    ...
    $sql_rr="SELECT * FROM obs_registro_riesgo WHERE codigoestudiante='".$val1."' ";
...
<?php
       foreach($F_data1 as $dt){
			...
			//echo $query_carrera1;
            $E_data= $db->GetArray($query_carrera1);
           ?>
  ...
  // echo $query_carrera;
   $data_in= $db->GetArray($query_carrera);
  // $F_data1 = $data_in->GetArray();
  // $F_total1=count($F_data1);
   ...
   ?>
                <input type="hidden" name="codigoestudiante" id="codigoestudiante" value="<?php echo $dt['idestudiantegeneral'] ?>" />
                    <table border="0" width="100%" class="CSSTableGenerator">
						  ...
						  <tr>
                            ...
                            <tr>
                              ...
                              <td><?php echo $dt['celularestudiantegeneral']; ?></td>
                              <td><label class="titulo_label"><b>Fijo:</b></td>
                              <td><?php echo $dt['telefonoresidenciaestudiantegeneral']; ?></td>
                              
                            </tr>
                            <tr>
                              <td><label class="titulo_label"><b>E-mail Institucional:</b></td>
                              <td><?php echo $dt['emailestudiantegeneral']; ?></td>
                              <td><label class="titulo_label"><b>E-mail Personal:</b></td>
                              <td><?php echo $dt['email2estudiantegeneral']; ?></td>
   ...
   <?php
           ...
           echo "Este estudiante ya empezo el proceso en el PAE, no se puede registrar...";
