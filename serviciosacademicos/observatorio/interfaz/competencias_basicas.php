...
<script>
    ...
    function cargueMasivo(){
    	var tipoOperacion = "";
    	if ($("#chActualizar").is(':checked')) {
    		tipoOperacion = "actualizarCompetencias";
    	}
    	var inputFileImage = document.getElementById("cargueMasivoC");
    	var file = inputFileImage.files[0];
    	var data = new FormData();
    	//var txtActualiza = $("#chActualizar").val();
    	data.append("archivo",file);
    	$.ajax({//Ajax
                  type: 'POST',
                  url: 'servicio/cargueMasivo.php?tipoOperacion='+tipoOperacion,
                  contentType:false,
				  data:data,
				  processData:false,
				  cache:false,
...
<div id="container" style="margin-left: 70px; ">
 ...
 &nbsp;&nbsp;
            ...
            <div style="margin-top: 20px; ">
            	Nota : Por favor antes de cargar el archivo, por favor verificar que éste tenga el siguiente formato y extensión .xls Excel 97 - 2003.<br />
            	<a href="formato/FormatoArchivo.xls" id="btnFormato" style="font-size: 10pt;">Formato de Archivo a Cargar</a>
            </div>
            <div style="margin-top: 20px; ">
            	<form id="formCargueMasivo" method="post" enctype="multipart/form-data">
					...
					<input type="checkbox" id="chActualizar" name="chActualizar" >&nbsp;&nbsp;<label>Actualizar</label>
				</form>
			</div>
            <!--<input type="submit">-->
