...
ini_set('display_errors', '0');
  ...
  if (!empty($data['codigoestudiante'])){
   ...
   // $entity->debug = true;
    ...
    $id_estu = $data_estudiante[0]["idestudiantegeneral"];
    /*print_r($data);*/
    //var_dump($data);
  }else{
  	$id_estu='';
            ...
            <div id="tabs-2" style=' height:300px'>
                ...
                <?php $fun->estudiante($db, $id_estu); ?>
                   ...
                   <div class="derecha">
                        ...
                        &nbsp;&nbsp;
                        <a href="listar_estudiante_tutor.php" class="submit" tabindex="4">Regreso al menú</a>
                    </div><!-- End demo -->
    </div>   
  </form>
<script type="text/javascript">
                     ...
                     $.ajax({
                        ...
                        success:function(data){
                            ...
                            if (data.success == true){
                                alert(data.message);
                                $(location).attr('href','listar_estudiante_tutor.php');
                            }
                            else{
