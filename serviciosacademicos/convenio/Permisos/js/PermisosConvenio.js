...
function NewRolModuloConvenio(){
    ...
    if(!$('.ModulosClass').is(':checked')){
        alert('Indique los Modulos que desea Asignar...!!!');
        return false;
    }
    ...
    $.ajax({//Ajax
		  type: 'POST',
		  url: '../control/PermisosConvenio_html.php',
		  async: false,
		  dataType: 'json',
		  ...
		  success: function(data){
		       if(data.val==false){
		          ...
		          alert(data.descrip);
                  location.href='../control/PermisosConvenio_html.php';
		       }
