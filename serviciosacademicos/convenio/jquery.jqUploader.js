 ...
 **/
    jQuery.fn.jqUploader = function(options) {
        return this.each(function(index) {
            ...
            var startMessage = ($thisLabel.text() =='') ? 'seleccione Un Archivo' : $thisLabel.text();
            ...
            TerminateJQUploader = function(containerId,filename,varname){
                ...
                $this.text('').append('<span>Carga de Archivo <strong>'+filename+'</strong> listo!</span><input name="'+varname+'" type="hidden" id="'+varname+'" value="'+filename+'"/>');
