      ...
      //  alert("server_processing.php?table=siq_institucionconvenio&sql="+sql+"&wh=i.codigoestado&vwh=");
        $(document).ready(function() {
            bTable = $('#example2').dataTable({      
                ...
                "bProcessing": true,
                "bServerSide": true,                
                "sAjaxSource": "server_processing.php?table=siq_participante",
                "aoColumns": [
                { "sTitle": "Apellido" },
                { "sTitle": "Nombre" },
                { "sTitle": "Tipo" },
            ...
            $('#example2 tbody tr').live('click', function () {                
                var id = this.id;
                var app = $(this)[0].cells[0].firstChild; 
                var nom = $(this)[0].cells[1].firstChild; 
                var doc = $(this)[0].cells[3].firstChild;  
                var o = new Object();               
                o.id=id.replace('row_','');
                o.doc = doc.nodeValue;
                o.nom = nom.nodeValue;
                o.app = app.nodeValue;
                o.nombre = o.nom+' '+o.app;
               // alert(o.nombre);
