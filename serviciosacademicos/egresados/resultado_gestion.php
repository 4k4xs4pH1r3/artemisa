...
<table align="center" width="50%" style="" >
    <tr><td colspan="3">
            <div id="studiofields">
        <input class="button" type="button" onclick="document.location ='reporte_egresado.php'" value="Regresar" name="addfieldbtn"/>
        </div>
        </td></tr>
...
$formulario->dibujar_fila_titulo('RESULTADO DE GESTION EGRESADOS','labelresaltado',"2","align='center'");


$formulario->dibujar_fila_titulo('<hr>','labelresaltado',"2","align='center'");

$formulario->dibujar_fila_titulo('REPORTE','labelresaltado',"2","align='center'");
...
$campo='menu_fila';
$vlr_default_modalidad=($_POST['codigomodalidadacademicaaux2'])?$_POST['codigomodalidadacademicaaux2']:$_SESSION['codigomodalidadacademicaaux2'];
$parametros="'codigomodalidadacademicaaux2','".$vlr_default_modalidad."','OnChange=javascript:document.form3.action=\"\";document.form3.submit()'";
$formulario->dibujar_campo($campo,$parametros,"Modalidad Academica","tdtitulogris",'codigomodalidadacademicaaux2','');
//$codigofacultad="05";
...
$formulario->filatmp[""]="Seleccionar";
$vlr_default_carrera=($_POST['codigocarreraaux2'])?$_POST['codigocarreraaux2']:$_SESSION['codigocarreraaux2'];
$campo='menu_fila'; $parametros="'codigocarreraaux2','".$vlr_default_carrera."'";
$formulario->dibujar_campo($campo,$parametros,"Carrera","tdtitulogris",'codigocarreraaux2','');
$campo="boton_tipo"; $parametros="'button','accion','Generar reporte','OnClick=javascript:validar(3)'";
$formulario->dibujar_campo($campo,$parametros,"&nbsp;","tdtitulogris","","");
echo "<tr>
    <td>Color</td>
    <td><table><tr><td bgcolor=9DA242><input type=radio name=color value=9DA242 ></td>
    <td bgcolor=FF9E08><input type=radio name=color value=FF740000 ></td>
    <td bgcolor=4D89D9><input type=radio name=color value=4D89D9 ></td></tr>
    </td>
</tr>
</table>
    ";
