    ...
    $.fn.bcalendar = function(option) {
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
                ...
                { name: "action_ID", value: option.action_ID }
                ];
                if (option.extParam) {
        ...
        function tc(d) {//Color  
            ...
            function zc(c, i) {
                ...
                //var d = "DDDDDDFF01EEAD1ECD54FDFFC1F9E1FD060614FF0384879A70BFD0769F784D968C67C85A081DFAE6A7CBFF04FCFFF9C1FCE70073737372350FF1E4F3815774BEBEBEC0FC73CEC0F9";
                
                 $.ajax({//Ajax
                      type: 'POST',
                      url: '../../EspacioFisico/asignacionSalones/calendario3/wdCalendar/EventoSolicitud.php',
                      async: false,
                      dataType: 'json',
                      data:({actionID: 'Color',c:c}),
            ...
            //console.log(zc(c, 2), zc(c, 2), zc(c, 2), zc(c, 2));
            //return [zc(c, 0), zc(c, 1), zc(c, 2), zc(c, 3)];
            return [zc(c, 2), zc(c, 2), zc(c, 2), zc(c, 2)];
        }
