...
//finnumregistros
    ...
    function getReturnCodeDesc($cadena) {
        ...
        $_GET['origen']!=''){
                    $this->setstrMensaje("En este momento su orden de pago ".$this->getReference1()."
                        ...
                        al correo helpdesk@unbosque.edu.co y pregunte por el estado de la transaccion: ".$this->getTrazabilityCode());
                }
                else{
                $this->setstrMensaje("La transacción se encuentra PENDIENTE. Por favor verificar si el débito fue
realizado en el Banco.");
                }
                break;
            case "FAILED":
                $this->setstrMensaje("La transacción fué FALLIDA");
                break;
            case "FAIL_INVALIDENTITYCODE":
                $this->setstrMensaje("La transacción fué FALLIDA");
                break;
...
realizado en el Banco.");
    ...
    function insertLogPagos() {
        $pendiente = "PENDING";
        //".$this->getTicketId()."
        $strCons = "INSERT INTO LogPagos (TicketId,SrvCode,Reference1,Reference2,Reference3,PaymentDesc,TransValue,TransVatValue,SoliciteDate,BankProcessDate,FIName,StaCode,TrazabilityCode,FlagButton)
		VALUES ('".$this->getTicketId()."','" . $this->getSrvCode() . "'" . ",'" . $this->getReference1() . "'" . ",'" . $this->getReference2() . "'" . ",'" . $this->getReference3() . "','" . $this->getPaymentDesc() . "','" . $this->getTransValue() . "','" . $this->getTransVatValue() . "','" . date("Y-m-d H:i:s") . "','" . $this->getBankProcessDate() . "','" . $this->getFIName() . "','" . $pendiente . "','" . $this->getTrazabilityCode() . "','" . $this->getFlagButton() . "'". ")";
    ...
    function updateLogPagos() {
        $strConsulta = "UPDATE LogPagos SET FlagButton = '" . $this->getFlagButton() ."'".
                " WHERE  reference1='".$this->getReference1()."'
        and reference2='".$this->getReference2()."'
        and reference3='".$this->getReference3()."'";
...
?>
        <html>
            ...
            <body>
        <?php
        $query_universidad = "SELECT nombreuniversidad,direccionuniversidad,c.nombreciudad,p.nombrepais,u.paginawebuniversidad,u.imagenlogouniversidad,u.telefonouniversidad,u.faxuniversidad,u.nituniversidad,u.personeriauniversidad,u.entidadrigeuniversidad
...
and e.codigoestudiante = o.codigoestudiante";
        ...
        $query_conceptoorden = "select *
		from detalleordenpago d, concepto c
		where d.codigoconcepto = c.codigoconcepto
		and d.numeroordenpago = '" . $this->getReference1() . "'";
        $conceptoorden = mysql_query($query_conceptoorden, $this->Conexion_ID) or die(mysql_error());
        $totalRows_conceptoorden = mysql_num_rows($conceptoorden);
        $row_conceptoorden = mysql_fetch_array($conceptoorden);
        /*echo "<pre>";
        print_r($_SERVER);
        echo "</pre>";*/
        //<?php echo $row_universidad['imagenlogouniversidad']; 
        ?>
        <table width="600" border="0" align="center">
            <tr>
                <td><div align="center"><img src="../imagenes/logouniversidad.jpeg" width="200" height="62" onClick="print()"><br><span class="Estilo5"><?php echo $row_universidad['personeriauniversidad']; ?><br><?php echo $row_universidad['entidadrigeuniversidad']; ?><br><?php echo $row_universidad['nituniversidad']; ?></span></div></td>
            </tr>
        </table>
        <br>
            ...
            <tr>
                <td class='marco' bgcolor='#000000'>
                        ...
                        <tr>
                            ...
                            <td class=textogris width='90%'><table width='100%'  border='0' cellspacing='2' cellpadding='0'>
                                    <tr>
                                        ...
                                        <td><span class='Estilo1'><?php echo $row_universidad['nituniversidad']; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td class='textogris'>Empresa:</td>
                                        <td><span class='Estilo1'><?php echo $row_universidad['nombreuniversidad']; ?></span></td>
                                    </tr>
                                    <tr>
                                    <tr>
                              ...
                              <!--<td width='100%' align='center' class='textogris style1'><?php echo $this->getstrMensaje() ?></td>-->
                                        <!--<td class='textogris'>Estado de la Transacci&oacute;n: </td><td class='textogris'><span class='Estilo1'><?php echo $this->getstrMensaje() ?></span></td>
                                    </tr>-->
                                    <tr>
                                    ...
                                    <tr>
                                        <td class='textogris'>Código único de seguimiento de la transacción en PSE (CUS): </td>
                                        <td><span class='Estilo1'><?php echo $this->getTrazabilityCode(); ?></span></td>
                                    </tr>                                    <tr>
                                    <tr>
                                        <td class='textogris'>N&uacute;mero de Transacci&oacute;n: </td>
                                        <td class='textogris'><span class='Estilo1'><?php echo $this->getTicketId() ?></span></td>
                                    </tr>
                                    <tr>
                                        <td class='textogris'>N&uacute;mero de número de orden de pago: </td>
                                        <td class='textogris'><span class='Estilo1'><?php echo $this->getReference1() ?></span></td>
                                    </tr>
                                    <tr>
                                        <td class='textogris'>Descripci&oacute;n del Pago: </td>
                                        <td class='textogris'><span class='Estilo1'><?php echo $row_conceptoorden["nombreconcepto"] ?></span></td>
                                    </tr>
                                    <tr>
                                        <td class='textogris'>IP de Origen: </td>
                                        <td class='textogris'><span class='Estilo1'><?php echo $_SERVER["REMOTE_ADDR"] ?></span></td>
                                    </tr>
                    ...
                    <table width='100%'  border='0' align='center' cellpadding='1' cellspacing='1'>
                        <tr>
                            <td width='100%' align='left' class='textogris style1'><?php echo $this->getstrMensaje() ?></td>
                        </tr>
                    </table>
                    <b>&nbsp;</b>
                    <table width='100%'  border='0' align='center' cellpadding='1' cellspacing='1'>
		...
		and c.codigoreferenciaconcepto = '100'";
			...
			and c.codigoreferenciaconcepto = '600'";
                                                    ...
                                                    if ($totalRows_conceptosordenpagoinscripcion != "") {
                                                       ...
                                                       // $link = "https://artemisa.unbosque.edu.co";
                                                         //$link = "http://172.16.3.202/~javeeto/serviciosacademicos/consulta/facultades/consultafacultadesv2.htm";
                                                       /* if(isset($_GET['origen'])&&
        $_GET['origen']!=''){*/
                                                         $link = "../serviciosacademicos/consulta/prematricula/matriculaautomaticaordenmatricula.php?servicepse=1";
        /*}
                                                         else{
                                                             $link = "../serviciosacademicos/consulta/facultades/consultafacultadesv2.htm";
                                                         }*/
                                                    }
                                                }
...
<?php
                                            ...
                                            function setRefAdc1($RefAdc1 = "") {
                                                if ($RefAdc1 != "")
                                                    $this->RefAdc1 = $RefAdc1;
                                                return 0;
                                            }

                                            function setRefAdc2($RefAdc2 = "") {
                                                if ($RefAdc2 != "")
                                                    $this->RefAdc2 = $RefAdc2;
                                                return 0;
                                            }

                                            function setRefAdc3($RefAdc3 = "") {
                                                if ($RefAdc3 != "")
                                                    $this->RefAdc3 = $RefAdc3;
                                                return 0;
                                            }
