...
$(document).ready(function() {
	...
	autoClose = true;
	$('#demo-alert-close-1').on('btheme.ch.checked', function(){
		autoClose = true;
	});
	$('#demo-alert-close-2').on('btheme.ch.checked', function(){
		autoClose = false;
	});
	// =================================================================
	...
	$('#demo-alert-type-1').on('btheme.ch.checked', function(){
		prevAlert.hide();
		alertContent = $('#demo-preview-alert-1').find('.alert').html();
		$('#demo-preview-alert-1').fadeIn(300);
	}).bthemeCheck('toggleOn');

	$('#demo-alert-type-2').on('btheme.ch.checked', function(){
		prevAlert.hide();
		alertContent = $('#demo-preview-alert-2').find('.alert').html();
		$('#demo-preview-alert-2').fadeIn(300);
	});

	$('#demo-alert-type-3').on('btheme.ch.checked', function(){
		prevAlert.hide();
		alertContent = $('#demo-preview-alert-3').find('.alert').html();
		$('#demo-preview-alert-3').fadeIn(300);
	});

	$('#demo-alert-type-4').on('btheme.ch.checked', function(){
		prevAlert.hide();
