...
$(document).ready(function() {
	...
	// BOOTSTRAP TABLE - USE BTHEMECHECK TO STYLE THE CHECKBOXES
	// =================================================================
	// Require btheme.js
	// =================================================================
	$(".demo-add-bthemecheck").on('post-body.bs.table', function () {
		$(this).find('input:checkbox').not('.form-checkbox input:checkbox').wrap('<label class="form-checkbox form-icon"></label>');
		$(this).find('.form-checkbox').bthemeCheck();
	});




	// BOOTSTRAP TABLE - USE BTHEMECHECK TO STYLE THE RADIOS
	// =================================================================
	// Require btheme.js
	// =================================================================
	$(".demo-add-bthemeradio").on('post-body.bs.table', function () {
		$(this).find('input:radio').wrap('<label class="form-radio form-icon"></label>');
		$(this).find('.form-radio').bthemeCheck();
	});
