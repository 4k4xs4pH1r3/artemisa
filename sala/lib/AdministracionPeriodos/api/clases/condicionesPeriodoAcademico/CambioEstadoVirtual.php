...
/**
 * Clase CambioEstadoVirtual encargado de las validaciones de cambios de 
 * estado en periodos academicos de modalidad Virtual
 * 
 * @author Andres Alberto Ariza <arizaandres@unbosque.edu.co>
 * @copyright Dirección de Tecnología Universidad el Bosque
 * @package Sala\lib\AdministracionPeriodos\api\interfaces
 */
class CambioEstadoVirtual implements \Sala\lib\AdministracionPeriodos\api\interfaces\ICambioEstadoPeriodoAcademico{
     ...
     * que las secuencia que se deben respetar sean las siguiente
     * 2>4 (Inactivo > Inscripciones)
     * 2/4 > 1 > 3 > 2 (Inactivo/Inscripciones > Vigente > Precierre > Inactivo)
    ...
    */
    public function validarEstado($return, \PeriodoAcademico $ePeriodoAcademico) {
        ...
        $msj = "El nuevo estado debe cumplir la secuencia de modificación \"Inactivo > Inscripciones\" ó \"Inactivo/Inscripciones > Vigente > Precierre > Inactivo\"";
        
        switch ($idEstadoPeriodoNuevo){
            case "1"://Vigente
                if($idEstadoPeriodoAntiguo != 2 && $idEstadoPeriodoAntiguo != 4 && $idEstadoPeriodoAntiguo != 1){
                    $return["s"] = false;
                    $return["msj"] = $msj;
                }
                break;
