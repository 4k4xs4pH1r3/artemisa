...
<table border="0" width="50%" align="center">
  <tr>
    <td width="23%" align="center"><?php if ($pageNum_ConsPerfil > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_ConsPerfil=%d%s", $currentPage, 0, $queryString_ConsPerfil); ?>"><img src="First.gif" border=0></a>
        <?php } // Show if not first page ?>
    </td>
    <td width="31%" align="center"><?php if ($pageNum_ConsPerfil > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_ConsPerfil=%d%s", $currentPage, max(0, $pageNum_ConsPerfil - 1), $queryString_ConsPerfil); ?>"><img src="Previous.gif" border=0></a>
        <?php } // Show if not first page ?>
    </td>
    <td width="23%" align="center"><?php if ($pageNum_ConsPerfil < $totalPages_ConsPerfil) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_ConsPerfil=%d%s", $currentPage, min($totalPages_ConsPerfil, $pageNum_ConsPerfil + 1), $queryString_ConsPerfil); ?>"><img src="Next.gif" border=0></a>
        <?php } // Show if not last page ?>
    </td>
    <td width="23%" align="center"><?php if ($pageNum_ConsPerfil < $totalPages_ConsPerfil) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_ConsPerfil=%d%s", $currentPage, $totalPages_ConsPerfil, $queryString_ConsPerfil); ?>"><img src="Last.gif" border=0></a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>
