...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  ...
  <table width="841" border="0">
    ...
    <tr>
      ...
      <td colspan="2" valign="top" bgcolor="#FFFFCC" class="Estilo4"><span class="Estilo5"><strong>Asignatura:<br />
              <input name="Asignatura" type="text" value="" size="64" />
      </strong></span></td>
    </tr>
    <tr>
  ...
  <table width="832" border="0">
    ...
    <tr>
      ...
      <td height="50" bgcolor="#FFFFCC" class="Estilo4"><div align="center">
          <textarea name="IgRiNu1" cols="25" rows="2"></textarea>
      </div></td>
      <td rowspan="2" align="center" valign="middle" bgcolor="#FFFFCC" class="Estilo4"><div align="center">
    ...
    <tr>
      ...
      <td height="45" bgcolor="#FFFFCC" class="Estilo4"><div align="center">
...
Tics,  Idiomas, pedagog&iacute;a / andragog&iacute;a, servicio al cliente conocimientos espec&iacute;ficos  del &aacute;rea, otros.</p>
  ...
  <table width="845" border="0">
    ...
    <tr>
      ...
      <td rowspan="2" bgcolor="#FFFFCC" class="Estilo4"><select name="PeReAc7">
        <option value="No ha seleccionado">Escoja la periodicidad</option>
        <option value="Diario">Diario</option>
        <option value="Semanal">Semanal</option>
        <option value="Mensual">Mensual</option>
  ...
  <table width="845" border="0">
    ...
    <tr>
      ...
      <td rowspan="2" bgcolor="#FFFFCC" class="Estilo4"><select name="PeReAd7">
          <option value="No ha seleccionado">Escoja la periodicidad</option>
          <option value="Diario">Diario</option>
          <option value="Semanal">Semanal</option>
          <option value="Mensual">Mensual</option>
  ...
  <table width="840" border="0">
    <tr>
      <td><div align="center">
        <input name="submit" type="submit" value="Enviar perfil de cargo" />
      </div></td>
    </tr>
    <tr>
      <td class="Estilo4">&nbsp;</td>
