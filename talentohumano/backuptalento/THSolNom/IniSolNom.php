...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  ...
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="submit" onclick="MM_popupMsg('Estimado usuario\r\rSu solicitud ha sido enviada correctamente y ser&aacute; revisada y atendida por Talento Humano lo m&aacute;s pronto posible.\r\rCordialmente\rDepartamento de Talento HUmano')" value="Enviar solicitud"></td>
    </tr>
  </table>
