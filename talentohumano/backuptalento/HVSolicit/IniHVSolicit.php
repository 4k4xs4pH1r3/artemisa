...
?>
  ...
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="submit" onclick="MM_popupMsg('Estimado aspirante, su hoja de vida ha sido enviada correctamente.\r\rLa Universidad El Bosque agradece su interes. Estaremos estudiando su solicitud para proximas vacantes.')" value="Enviar Hoja de Vida"></td>
    </tr>
  </table>
