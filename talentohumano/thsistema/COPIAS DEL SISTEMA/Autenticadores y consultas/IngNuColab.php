...
.Estilo24 {font-family: Tahoma; color: #596221; font-weight: bold; font-size: 16px; }
-->
</style>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table>
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#FFFFCC" class="Estilo5"><div align="center"><span class="Estilo24">Por favor ingrese los datos del nuevo colaborador </span></div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#FFFFCC" class="Estilo5">&nbsp;</td>
    </tr>
    <tr valign="baseline">
      <td width="349" align="right" nowrap bgcolor="#FFFFCC" class="Estilo5"><p>Cedula</p>      </td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo5"><input type="text" name="IdColab" value="" size="32">
        <br />
      Escriba sin puntos ni espacios </td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC" class="Estilo5">Apellidos y Nombres:</td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo4"><input name="NombCol" type="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC" class="Estilo5">Cargo Colaborador :</td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo4"><input name="CarCol" type="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC" class="Estilo5">Fecha inicio contrato :</td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo5"><input type="text" name="FeInCol" value="" size="32">
        <br />
    ...
    <tr valign="baseline">
      ...
      <td width="475" bgcolor="#FFFFCC" class="Estilo5"><input type="text" name="FeReCol" value="" size="32"> 
        <br />
    ...
    <tr valign="baseline">
      ...
      <td width="475" bgcolor="#FFFFCC" class="Estilo4"><input name="CodCol" type="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC" class="Estilo5">Tipo de contrato :</td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo4"><input name="ContCol" type="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC" class="Estilo5">Departamento al que pertenece :</td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo4"><input name="DepCol" type="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" bgcolor="#FFFFCC" class="Estilo5">Llene este campo seg&uacute;n las instrucciones<br /> 
      que encuentra abajo :</td>
      <td width="475" bgcolor="#FFFFCC" class="Estilo5"><p>
        ...
        <p>EJEMPLO:<br />
          <br />
        <span class="Estilo6">APELLIDOS Y NOMBRES</span>  ----  ( cargo: <span class="Estilo6">SEC.CATEG II</span> / Fecha Ingreso: <span class="Estilo6">1996-05-02</span>/ Fecha Termina: <span class="Estilo6">indefinido</span>  / Codigo Colaborador: <span class="Estilo6">270</span> / Tipo contrato:<span class="Estilo6"> INDEFINIDO</span> / Departamento: <span class="Estilo6">Administracion  Formacion Musical</span></p>      </td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC">&nbsp;</td>
      <td width="475" bgcolor="#FFFFCC"><input type="submit" onclick="MM_popupMsg('Estimado administrador:\r\rEl nuevo colaborador ha sido ingresado con &eacute;xito. Ver&aacute; un formato en blanco por si requiere ingresar otro colaborador. De lo contrario, vaya a otra p&aacute;gina o cierre internet. Gracias')" value="Insertar registro"></td>
    </tr>
  </table>
