...
<div align="center">
  <table width="838" border="0">
    <tr>
      ...
      COLABORADORES ESTRAT&Eacute;GICO_T&Aacute;CTICOS A T&Eacute;RMINO FIJO E INDEFINIDO </div></td>
    </tr>
  </table>
  <table width="838" border="0">
    <tr>
  ...
  <table border="1" align="center" cellspacing="1" bordercolor="#C9E6B0">
    <tr>
      <td colspan="5" bgcolor="#FFFFFF" class="Estilo4"><div align="center">RESULTADOS  (los ver&aacute; una vez eval&uacute;e al colaborador) <br />
...
<table width="840" border="0" align="center">
  <tr>
    <td><div align="center">
      ...
      <p class="Estilo4 Estilo44"><span class="Estilo40">Luego presione el siguiente bot&oacute;n para ver la versi&oacute;n imprimible:</span><span class="Estilo40">
        <label></label>
  <input name="Submit" type="submit" class="Estilo33" onclick="MM_goToURL('parent','Nuevo_EvalDes_Estrategico_Tacticos_Imprimir.php?NombCol=<?php echo $row_CObtieneCamposEvaluado['NombCol']; ?>&amp;JefCol=<?php echo $row_CObtieneCamposEvaluado['JefCol']; ?>&amp;date=<?php echo $row_CObtieneCamposEvaluado['FechEval']; ?>&amp;IdColab=<?php echo $row_CObtieneCamposEvaluado['IdColab']; ?>&amp;turtle=<?php echo $_GET['turtle']; ?>');MM_popupMsg('Para Imprimir presione clic en el logo de la Universidad.');return document.MM_returnValue" value="Ver versi&oacute;n imprimible " />
        <br />
        </span><br />
        <span class="Estilo40">Una vez haya guardado e impreso, presione el siguiente bot&oacute;n o cierre la p&aacute;gina:</span><span class="Estilo4">
          <input name="submit22" type="submit" class="Estilo4" onclick="MM_goToURL('parent','NuevoCListadoEvaluados.php?turtle=<?php echo $_GET['turtle']; ?>');return document.MM_returnValue" value="EVALUAR A OTRO COLABORADOR" />
        </span></p>
