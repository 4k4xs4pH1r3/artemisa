...
&& ($totalRows_CObtieneCamposEvaluado == 0) 
  ...
  $insertSQL = sprintf("INSERT INTO nuevo_tevaldes_tacticos (NombCol, JefCol, FechEval, IdColab) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "Nuevo_EvalDes_Tacticos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset1 = "SELECT ROUND((((AVG(P1)*100/3+AVG(P2)*100/3+AVG(P3)*100/3+AVG(P4)*100/3+AVG(P5)*100/3)+AVG(P6)*100/3 +AVG(P7)*100/3)/7),0) AS xx,  ROUND(((AVG(P8)*100/3+AVG(P9)*100/3+AVG(P10)*100/3+AVG(P11)*100/3)/4),0) AS yy FROM nuevo_tevaldes_tacticos ";
...
<div align="center">
  <table width="838" border="0">
    <tr>
      ...
      COLABORADORES T&Aacute;CTICOS A T&Eacute;RMINO FIJO E INDEFINIDO </div></td>
    </tr>
  </table>
  <table width="838" border="0">
    <tr>
  ...
  <table border="1" align="center" cellspacing="1" bordercolor="#C9E6B0">
    <tr>
      <td colspan="5" bgcolor="#FFFFFF" class="Estilo4"><div align="center"><span class="Estilo39">RESULTADOS  (los ver&aacute; una vez guarde la evaluaci&oacute;n) <br />
(si alguna casilla esta vac&iacute;a, quiere decir que no respond&iacute;o alg&uacute;n &iacute;tem) </span></div></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFEC" class="Estilo39"><div align="center">Habilidades de an&aacute;lisis y ejecuci&oacute;n</div></td>
...
<table width="840" border="0" align="center">
  ...
  <label></label>
  <input name="Submit" type="submit" class="Estilo33" onclick="MM_goToURL('parent','Nuevo_EvalDes_Tacticos_Imprimir.php?NombCol=<?php echo $row_CObtieneCamposEvaluado['NombCol']; ?>&amp;JefCol=<?php echo $row_CObtieneCamposEvaluado['JefCol']; ?>&amp;date=<?php echo $row_CObtieneCamposEvaluado['FechEval']; ?>&amp;IdColab=<?php echo $row_CObtieneCamposEvaluado['IdColab']; ?>&amp;turtle=<?php echo $_GET['turtle']; ?>');MM_popupMsg('Para Imprimir presione clic en el logo de la Universidad.');return document.MM_returnValue" value="Ver versi&oacute;n imprimible " />
        <br />
        </span><br />
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    ...
    <tr height="20">
      <td colspan="6" bordercolor="#003300" bgcolor="#8CC63F" class="Estilo4"><div align="center" class="Estilo25 Estilo26">
        ...
        <span class="Estilo46">HABILIDADES DE AN&Aacute;LISIS Y EJECUCI&Oacute;N </span></span></div></td>
    </tr>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24">PLANEACI&Oacute;N<br />
        <br />
        <p>Ejerce sus  funciones determinando eficazmente las metas y prioridades de su  Dependencia&nbsp; a trav&eacute;s de planes de trabajo, que permite la  identificaci&oacute;n de las acciones, los  plazos y los recursos requeridos para alcanzarlas.</p></td>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><p>USO DE  HERRAMIENTAS TECNOL&Oacute;GICAS:</p>
        <p>Capacidad para  seleccionar y utilizar de forma pertinente, responsable y eficiente, las  herramientas tecnol&oacute;gicas que facilitan y  agilizan el desarrollo de las funciones propias del cargo.</p></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24">
        <div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><p>EXPERTICIA  PROFESIONAL</p>
        <p>Capacidad para  aplicar el conocimiento profesional en la resoluci&oacute;n de problemas y transferirlo a su entorno  laboral.</p>      </td>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><p>APRENDIZAJE CONTINUO</p>
        <p>Capacidad para  adquirir y desarrollar permanentemente conocimientos, destrezas y habilidades,  con el fin de mantener altos est&aacute;ndares de eficiencia y  eficacia en su cargo.</p></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="justify">
        ...
        <p>Capacidad para  elegir entre una o varias alternativas la opci&oacute;n m&aacute;s conveniente para la  soluci&oacute;n de un problema y la  toma de acciones concretas y consecuentes con la elecci&oacute;n realizada.</p>
        </div></td>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>INICIATIVA</strong><br />
        <br />
        <p>Capacidad para  proponer y desarrollar ideas que permitan mejorar los procesos propios del  cargo.</p></td>
    ...
    <tr>
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>CUMPLIMIENTO  OPORTUNO DE TAREAS ASIGNADAS</strong><br />
        <br />
        <p>Realizaci&oacute;n y entrega de los trabajos a tiempo, teniendo en  cuenta los requerimientos y la organizaci&oacute;n del mismo.</p>      </td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>TRABAJO  EN EQUIPO</strong><br />
        <br />
        <p>Capacidad de  integrarse al equipo de trabajo, aportar conocimientos, ideas y experiencias,  con el fin de definir objetivos, establecer roles y responsabilidades para el  cumplimiento de &eacute;stos.</p></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr>
      <td valign="baseline" bgcolor="#FFFFEC" class="Estilo24"><div align="justify"><strong>RESPONSABILIDAD  POR LOS BIENES DE LA UNIVERSIDAD</strong><br />
          <br />
          <p>Manejo y  mantenimiento de los equipos, implementos de trabajo y suministros necesarios  para el desempe&ntilde;o de su labor,  conservando su buen estado y preservando los bienes de la Universidad.</p>
      </div></td>
      <td height="20" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
