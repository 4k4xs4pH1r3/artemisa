...
&& ($totalRows_CObtieneCamposEvaluado == 0) 
  ...
  $insertSQL = sprintf("INSERT INTO nuevo_tevaldes_operativos (NombCol, JefCol, FechEval, IdColab) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "Nuevo_EvalDes_Operativos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset1 = "SELECT ROUND((((AVG(P1)*100/3+AVG(P2)*100/3+AVG(P3)*100/3+AVG(P4)*100/3+AVG(P5)*100/3)+AVG(P6)*100/3 +AVG(P7)*100/3)/7),0) AS xx,  ROUND(((AVG(P8)*100/3+AVG(P9)*100/3+AVG(P10)*100/3+AVG(P11)*100/3)/4),0) AS yy FROM nuevo_tevaldes_operativos ";
...
<div align="center">
  <table width="838" border="0">
    <tr>
      ...
      COLABORADORES OPERATIVOS A T&Eacute;RMINO FIJO E INDEFINIDO </div></td>
    </tr>
  </table>
  <table width="838" border="0">
    <tr>
  ...
  <table width="754" align="center">
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bgcolor="#FFFFFF" class="Estilo4"><span class="Estilo28">Colaborador Evaluado:&nbsp; </span></td>
      <td align="right" nowrap="nowrap" bgcolor="#FFFFFF" class="Estilo4"><div align="left"><span class="Estilo28"><?php echo $row_CObtieneCamposEvaluado['NombCol']; ?>
        </span></div>        </tr>
    <tr valign="baseline">
      <td align="right" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" class="Estilo4"><span class="Estilo28">C&eacute;dula:&nbsp;</span></td>
      <td align="right" valign="bottom" bgcolor="#FFFFFF" class="Estilo4"><div align="left"><span class="Estilo28"><?php echo $row_CObtieneCamposEvaluado['IdColab']; ?></span></div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" class="Estilo4"><span class="Estilo28">Evaluador:&nbsp;</span></td>
      <td align="right" valign="bottom" bgcolor="#FFFFFF" class="Estilo4"><div align="center" class="Estilo28">
        <div align="left"><span class="Estilo28"><?php echo $row_CObtieneCamposEvaluado['JefCol']; ?></span></div>
      </div>
      <div align="left"></div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" class="Estilo4"><span class="Estilo28">Fecha evaluaci&oacute;n:&nbsp; </span></td>
      <td align="right" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" class="Estilo4"><div align="left"><span class="Estilo28"><?php echo $row_CObtieneCamposEvaluado['FechEval']; ?><br />
      </span></div></td>
    </tr>
    <tr valign="baseline">
...
(si alguna casilla esta vac&iacute;a, quiere decir que no respond&iacute;o alg&uacute;n &iacute;tem) </div></td>
    ...
    <tr>
      <td bgcolor="#FFFFEC" class="Estilo39"><div align="center">&nbsp;Habilidades y Destrezas&nbsp;</div></td>
      ...
      <td bgcolor="#FFFFEC" class="Estilo39"><div align="center">Compromiso Institucional</div></td>
  ...
  <tr>
    <td><div align="center">
      ...
      <p class="Estilo4 Estilo44"><span class="Estilo40">Luego presione el siguiente bot&oacute;n para ver la versi&oacute;n imprimible:
        <label></label>
        <input name="Submit2" type="submit" class="Estilo33" onclick="MM_goToURL('parent','Nuevo_EvalDes_Estrategicos_Imprimir.php?NombCol=<?php echo $row_CObtieneCamposEvaluado['NombCol']; ?>&amp;JefCol=<?php echo $row_CObtieneCamposEvaluado['JefCol']; ?>&amp;date=<?php echo $row_CObtieneCamposEvaluado['FechEval']; ?>&amp;IdColab=<?php echo $row_CObtieneCamposEvaluado['IdColab']; ?>&amp;turtle=<?php echo $_GET['turtle']; ?>');MM_popupMsg('Para Imprimir presione clic en el logo de la Universidad.');return document.MM_returnValue" value="Ver versi&oacute;n imprimible " />
        <br />
      </span></p>
      <p class="Estilo4 Estilo44"><span class="Estilo40"><label><input name="Submit" type="submit" class="Estilo33" onclick="MM_goToURL('parent','Nuevo_EvalDes_Operativos_Imprimir.php?NombCol=<?php echo $row_CObtieneCamposEvaluado['NombCol']; ?>&amp;JefCol=<?php echo $row_CObtieneCamposEvaluado['JefCol']; ?>&amp;date=<?php echo $row_CObtieneCamposEvaluado['FechEval']; ?>&amp;IdColab=<?php echo $row_CObtieneCamposEvaluado['IdColab']; ?>&amp;turtle=<?php echo $_GET['turtle']; ?>');MM_popupMsg('Para Imprimir presione clic en el logo de la Universidad.');return document.MM_returnValue" value="Ver versi&oacute;n imprimible " />
        </label>
        <br />
        </span><br />
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    ...
    <tr height="20">
      <td colspan="6" bordercolor="#003300" bgcolor="#8CC63F" class="Estilo4"><div align="center" class="Estilo25 Estilo26">
        ...
        <span class="Estilo46">HABILIDADES Y DESTREZAS </span></span></div></td>
    </tr>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24">ORIENTACI&Oacute;N AL SERVICIO <br />
        <br />
Es la disposici&oacute;n para realizar el trabajo con base en el conocimiento de las necesidades y expectativas de los clientes externos e internos, reflejando un trato amable y cordial, inter&eacute;s por la persona y por la soluci&oacute;n a sus problemas. </td>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="left">B&Uacute;SQUEDA DE LA EXCELENCIA <br />
        <br />
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>ORIENTACI&Oacute;N  AL LOGRO<br />
        <br />
      Actitud para alcanzar los objetivos y la preocupaci&oacute;n por realizar bien el trabajo, teniendo en cuenta la perseverancia y dedicaci&oacute;n, logrando llevar a satisfacci&oacute;n las funciones asignadas a su cargo.</strong></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24">
        <div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>INTER&Eacute;S  POR APRENDER NUEVAS TAREAS<br />
        <br />
        Aptitud para  recibir nueva informaci&oacute;n y poner en pr&aacute;ctica lo aprendido en las tareas asignadas. Buscar herramientas, medios o motivos para estar al d&iacute;a y encontrar las formas m&aacute;s convenientes de aplicar los conocimientos al puesto de trabajo.<br />
      </strong></td>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>USO  DE HERRAMIENTAS<br />
        <br />
      Capacidad para seleccionar y utilizar de forma pertinente, responsable y eficiente, las herramientas que facilitan y agilizan el desarrollo de las funciones propias del cargo.</strong></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="justify"><strong>TOMA  DE DECISIONES</strong><br />
        <br />
        Establece  entre diferentes alternativas la m&aacute;s apropiada para la resoluci&oacute;n de las  diferentes tareas asignadas.<br />
      </div></td>
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>INICIATIVA</strong><br />
        <br />
      Capacidad  para proponer y desarrollar ideas que permitan mejorar los procesos propios del  cargo.</td>
    ...
    <tr>
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>MANEJO  DE LA INFORMACI&Oacute;N Y CONFIDENCIALIDAD<br />
        <br />
      Capacidad  de administrar la informaci&oacute;n propia del quehacer diario con sentido de  responsabilidad.</strong></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr>
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>CONOCIMIENTOS  T&Eacute;CNICOS RELACIONADOS CON EL PERFIL Y CON EL CARGO</strong><br />
        <br />
      Dominio  de habilidades y destrezas requeridas, traducida en la buena utilizaci&oacute;n de  t&eacute;cnicas y procedimientos en el desempe&ntilde;o del cargo.</td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr>
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>CUMPLIMIENTO  OPORTUNO DE TAREAS ASIGNADAS</strong><br />
        <br />
      Realizaci&oacute;n  y entrega de los trabajos a tiempo, teniendo en cuenta los requerimientos y la  organizaci&oacute;n del mismo.<br /></td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><p><strong>DISPOSICI&Oacute;N  PARA EL TRABAJO<br />
        <br />
      Actitud  positiva relacionada con las actividades diarias a desarrollar.</strong></p>      </td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>TRABAJO  EN EQUIPO</strong><br />
        <br />
      Capacidad  de integrarse al equipo de trabajo, aportar conocimientos, ideas y  experiencias, con el fin de definir objetivos.</td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>ATENCI&Oacute;N  AL USUARIO</strong><br />
        <br />
      Realizar  un servicio id&oacute;neo en el desarrollo de las responsabilidades, satisfaciendo los  requerimientos de los usuarios.</td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr height="20">
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><strong>RELACIONES  INTERPERSONALES</strong><br />
        <br />
      Capacidad  de integraci&oacute;n, interacci&oacute;n, buen trato y respeto por los seres humanos.</td>
      <td align="center" valign="middle" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr>
      <td valign="baseline" bgcolor="#FFFFEC" class="Estilo24"><strong>HABILIDADES  COMUNICATIVAS</strong><br />
        <br />
      Capacidad  para establecer comunicaciones con diferentes tipos de personas y en diferentes  contextos, haciendo uso de la empat&iacute;a, la diplomacia y la asertividad. Incluye  la capacidad para escuchar activamente, asimilar informaci&oacute;n y para argumentar  las ideas usando datos que permitan llegar a acuerdos v&aacute;lidos.</td>
    ...
    <tr>
      <td valign="baseline" bgcolor="#FFFFEC" class="Estilo24"><div align="justify"><strong>COMPROMISO  INSTITUCIONAL<br />
        <br />
        Asumir  a partir del comportamiento socio laboral, los valores de la Universidad,  orientando los propios intereses hacia las necesidades, prioridades y objetivos  de la misma.</strong></div></td>
      <td height="20" bordercolor="#003300" bgcolor="#FFFFEC" class="Estilo24"><div align="center">
    ...
    <tr>
      <td valign="baseline" bgcolor="#FFFFEC" class="Estilo24"><div align="justify"><strong>CONCIENCIA  ORGANIZACIONAL</strong><br />
        <br />
        Identificaci&oacute;n  y cumplimiento de pol&iacute;ticas y normas de la Universidad.<br />
      </div></td>
    ...
    <tr>
      <td height="20" colspan="6" align="center" bordercolor="#596221" bgcolor="#FFFFEC" class="Estilo24"><p><span class="Estilo28">Una vez terminada la evaluaci&oacute;n presione el siguiente bot&oacute;n</span></p>
...
Muchas gracias por su colaboraci&oacute;n en la construcci&oacute;n de un mejor equipo</span></span></p>
    ...
    <tr>
      <td bordercolor="#596221" bgcolor="#FFFFEC" class="Estilo33"><input name="JefeTH" type="text" class="Estilo24" style="text-align:center" value="SANDRA PATRICIA SARMIENTO GARZON" size="45" /></td>
