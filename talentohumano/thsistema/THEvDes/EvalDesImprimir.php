<?php require_once('../Connections/conexion.php'); ?><?php require_once('../Connections/conexion.php'); error_reporting(0)?>
<?php
...
<table border="1" align="center" cellspacing="1">
  ...
  <table width="795" border="2" align="center" bordercolor="#003300">
    ...
    <tr>
     ...
     <!--<tr>
     <td height="20" colspan="7" bordercolor="#596221" class="Estilo24"><div align="center">SI EST&Aacute; EVALUANDO UNA PERSONA <span class="Estilo40">CONTRATADA A T&Eacute;RMINO FIJO</span> , SEG&Uacute;N USTED &iquest;ESTA PERSONA DEBE O NO SER CONTRATADA PARA CONTINUAR LABORANDO EN LA INSTITUCI&Oacute;N?. EN CASO DE SER NEGATIVA SU RESPUESTA, EXPLIQUE POR FAVOR EL MOTIVO DE ESTA DECISI&Oacute;N<br />
          <textarea name="CoGePeTf" cols="100" rows="5" class="Estilo24"><?php echo //$row_CObtieneCamposEvaluado['CoGePeTf']; ?></textarea>
      </div></td>
    </tr>-->
  </table>
  <p>&nbsp;</p>
