...
<link href="CSS/Psicologia.css" rel="stylesheet" type="text/css" />
...
<p align="center" class="Estilo4"><strong>EL N&Uacute;MERO DE SU C&Eacute;DULA ESTA ERRADO, VUELVA A LA P&Aacute;GINA DE INGRESO </strong></p>
<div align="center">
  <p class="Estilo4">Si el problema persiste, por favor comuníquese con Leyla en Tecnología, ext 1551.
   Muchas gracias. </p>
</div>
<p align="center" class="EtiquetasGrandes"><strong><a href="FIngSistAdministradores.php">
  <label for="Submit"></label>
  <input name="Submit" type="submit" class="Estilo4" id="Submit" onclick="MM_goToURL('parent','FIngresoAEvaluaciones.php');return document.MM_returnValue" value="Volver a página de ingreso" />
</a></strong></p>
</body>
</html>
