...
if (isset($_GET['IdEvalDes'])) {
  $colname2_EvalDes = (get_magic_quotes_gpc()) ? $_GET['IdEvalDes'] : addslashes($_GET['IdEvalDes']);
}
mysql_select_db($database_conexion, $conexion);
$query_EvalDes = sprintf("SELECT *, YEAR(FechEval) FROM tevaldes WHERE NombCol = '%s' AND IdEvalDes=%s ORDER BY NombCol ASC", $colname_EvalDes,$colname2_EvalDes);
