...
<table width="838" border="0">
  <tr>
    ...
    <td width="673" bgcolor="#98BD0D"><div align="center" class="Estilo4">INGRESO DE NUEVOS JEFES <br />
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table>
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap><div align="center"><span class="Estilo4">Por favor ingrese los datos del nuevo jefe </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#FFFFCC">Jefe:</td>
