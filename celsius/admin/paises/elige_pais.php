         ...
         <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" class="style22">
                <tr>
                   <td width="150" class="style22"><div align="right"><? echo $Mensajes["ec-1"]; ?></div></td>
                        ...
                        <tr>
                          <td colspan="2"></td>
                          <td width="200"><div align="left" class="style33"><? if ($adonde==1)
         {
       ?>  
        <a href="union_pai.php?Id1=<?echo $row[1]; ?>&Nombre1=<? echo $row[0]; ?>"><? echo $Mensajes["h-4"]; ?></a>
      <? }  
         else
         {
       ?>
       <a href="union_pai.php?Id1=<?echo $Id1; ?>&Nombre1=<? echo $Nombre1; ?>&Id2=<? echo $row[1]; ?>&Nombre2=<? echo $row[0]; ?>"><? echo $Mensajes["h-4"]; ?></a>
      <? } ?>   </a></div></td>
                        </tr>
                      </table>
