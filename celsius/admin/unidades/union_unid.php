...
function buscolookup1()
{
	...
	document.forms.form1.action = "elige_unid.php";
 ...
 ?> 
						<form method="POST" name="form1" action="union_tusu.php?definido=1">
                            <table width="95%"  border="0" cellpadding="1" cellspacing="1">
                              <tr>
                                <td colspan="2" bgcolor="#006699" class="style45"><img src="../images/square-w.gif" width="8" height="8"><? echo $Mensajes["tf-10"]; ?></td>
                                </tr>
                              <tr>
                                <td width="150" class="style49"><div align="right"><? echo $Mensajes["ec-7"]; ?></div></td>
                              ...
                              <tr>
                                <td width="150" class="style49"><div align="right"><? echo $Mensajes["ec-8"];?></div></td>
                                <td class="style43"><div align="left">
...
<? } else {
   ...
   $expresion = "SELECT Codigo_Dependencia,Codigo_Institucion FROM Unidades WHERE Id=".$Id2;
   ...
   $expresion = "UPDATE Usuarios SET Codigo_Pais=".$Pais_Nuevo.",Codigo_Institucion=".$Inst_Nueva.",Codigo_Dependencia=".$Dep_Nueva;
   $expresion .= ",Codigo_Unidad=".$Id2." WHERE Codigo_Unidad=".$Id1;
   $result = mysql_query($expresion);
   echo mysql_error();
   $num[1]= mysql_affected_rows();
   
   $expresion = "UPDATE Candidatos SET Codigo_Pais=".$Pais_Nuevo.",Codigo_Institucion=".$Inst_Nueva.",Codigo_Dependencia=".$Dep_Nueva;
   $expresion.= ",Codigo_Unidad=".$Id2." WHERE Codigo_Dependencia=".$Id1;
   $result = mysql_query($expresion);
   echo mysql_error();
   $num[2]= mysql_affected_rows();
   
   $expresion = "DELETE FROM Unidades WHERE Id=".$Id1;
   $result = mysql_query($expresion);
   echo mysql_error();
   
   //nuevo Log
   global $Id_usuario;
   $expresion = "INSERT INTO Log (idOperador,fecha,tipoEvento,idNuevo) VALUES(".$Id_usuario.",NOW(),6,".$Id2.")";
   $result = mysql_query($expresion);
   echo mysql_error();
 ?><br>
<div align="center">
  ...
  <table border="1" width="88%" bgcolor="#5B97A4">
    <tr>
      <td width="31%" align="right" class="style49"><? echo $Mensajes["tf-11"]; ?>&nbsp;&nbsp; </td>
      <td width="56%" class="style49"><? echo $Nombre1; ?></td>
      <td width="13%">&nbsp;</td>
    </tr>
    <tr>
      <td width="31%" align="right" class="style49"><b><? echo $Mensajes["tf-12"]; ?>&nbsp;</b></font></td>
    ...
    <tr>
	  ...
	  <?
	  	  $cadena.=number_format($num[1],0)."/".number_format($num[2],0);
		?>
        <p align="center"><? echo "Usu/Cand <br>".$cadena; ?></b></td>
    </tr>
    <tr>
