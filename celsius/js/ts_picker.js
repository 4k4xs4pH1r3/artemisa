...
function show_calendar(str_target, str_datetime) {
	...
	var str_buffer = new String (
		...
		"<img src=\"../images/ts_picker/prev.gif\" width=\"16\" height=\"16\" border=\"0\""+
		...
		"<img src=\"../images/ts_picker/next.gif\" width=\"16\" height=\"16\" border=\"0\""+
...
//	var re_date = /^(\d+)\-(\d+)\-(\d+)\s+(\d+)\:(\d+)\:(\d+)$/;
  ...
  if ((str_datetime==null) || (str_datetime==''))
      ...
      var dia = str_datetime.substring(pos + 1,str_datetime.length);
	  str_datetime = str_datetime.substring(0,pos);
	  var pos = str_datetime.lastIndexOf('-');
      var mes = str_datetime.substring(pos + 1,str_datetime.length);
	  str_datetime = str_datetime.substring(0,pos);
	  var anio = str_datetime;
	  return (new Date(dia,mes-1,anio));
    }
