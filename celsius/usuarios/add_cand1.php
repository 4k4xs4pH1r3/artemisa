	...
	if (document.forms["partea"].Mail.value.length==0 || document.forms["partea"].Mail.value.substring(0,3)=="***")	 
		{
         ...
         if (document.forms["partea"].Mail.value.indexOf('@',0)== -1 || document.forms["partea"].Mail.value.indexOf('.',0)== -1)
           {
       		  document.forms["partea"].Mail.value =  "<? echo $Mensajes["me-17"];?>";
	            return false; }
		  else {
		      return true; }
         } 
...
function verifica_campos()
{
	...
	if (valor1==true)
	{
		...
		document.getElementById("B1").disabled = true; // desactivar botón
		document.body.style.cursor = 'wait'; // relojito
		setTimeout(function(){document.forms["partea"].disabled = false;document.body.style.cursor = 'default';},5000)
              ...
              <center>
                <table width="97%">
                  ...
                  <tr>
                    ...
                    <td width="*" valign="top" >
                      <div align="left">
                        <input name="Apellido"  type="text" class="style33" size="50">
                      </div></td>
                  </tr>
                  <tr>
                    ...
                    <td valign="top">
                      <div align="left">
                        <input name="Nombres"  type="text" class="style33" size="50">
                      </div></td>
                  </tr>
				   <tr>
                    ...
                    <td valign="top">
                      <div align="left">
                        <input name="Mail" type="text" class="style33" size="50">
                            </div></td>
                  </tr>
                  <tr>
					...
					<select name="Pais" class="style33" onChange="Generar(0)">
						...
						{                  
						 ...
						 echo "<option value='".$row[0]."'>".$row[1]."</option>";                       
						  ...
						  echo "<option value='0'>".$Mensajes["ofe-1"]."</option>";                          
					   ?>  					 
					 </select>
                    </td>
                  </tr>
				  ...
				  <tr>
                    ...
                    <td valign="top" align=left> <input type="text" name="OtroPais" class="style33" size="50" >                   
                    </td>
                  </tr>
				  ...
				  <tr>
                    ...
                    <td valign="top" align=left> <input type="text" name="OtraInstitucion" class="style33" size="50" >
                    </td>
                  </tr>
				   <tr>
				   ...
				   <td valign="middle" bgcolor="#CCCCCC" class="style22"><div align="right"><? echo $Mensajes['ec-12']; ?>:</div></td>
                    <td valign="top" align=left><select name="Categoria" class="style33">
                      ...
                      while ($row =mysql_fetch_row($result))
                     {
					   ...
					   echo "<option value='0'>".$Mensajes["oma-1"]."</option>";    
                     ?>
                   </select></td>
                  </tr>
				  <tr>
				   ...
				   <tr>
                    ...
                    <td valign="top" align=left><input name="Direccion" type="text" class="style33" size="50" >
                    </td>
                  </tr>
				  ...
				  <tr>
                    ...
                    <td valign="top" align=left> <input type="text" name="OtraLocalidad" class="style33" size="50" >
                    </td>
                  <tr>
                    <td valign="middle" bgcolor="#CCCCCC" class="style22"><div align="right"><? echo $Mensajes['ec-17']; ?></div></td>
                    <td valign="top" align=left><input name="Telefono" type="text" class="style33" size="50" >
                    </td>
                  </tr>
                  <tr>
                    <td valign="middle" bgcolor="#CCCCCC" class="style22"><div align="right"><? echo $Mensajes['ec-18']; ?></div></td>
                    <td valign="top" align=left><TEXTAREA NAME="Comentarios" ROWS="5" COLS="40" class="style33"></TEXTAREA>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2" class="style22"><div align="right"></div>                      <div align="center">					
                          <input name="B1" id="B1" type="submit" class="style22" value="<? echo $Mensajes["bot-1"]?>" >
