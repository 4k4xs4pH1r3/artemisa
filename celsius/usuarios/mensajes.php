...
{
	document.forms.form1.action = "mensajes.php?Letra="+Letra;
...
<br>
             <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#ECECEC">
             <tr>
             <td class="style43"><strong><?echo $row[0].",".$row[1] ; ?></strong></td>
             <td class="style43"><? echo $row[2]."-".$row[3]."-".$row[4]; ?></td>
             <td class="style43"><? echo $row[5]."-".$row[6]; ?></td>
                </tr>
                <tr>
<td colspan="3">
<?     if (!isset($operacion))
	       $operacion = 0;
		if ($operacion==1)  //envia un mensaje
		 { ?>
    <a href="escribir_msg.php?idUsuario=<?echo $row[7]; ?>&usuario=<? echo $row[0].', '.$row[1]; ?>"><div align="right"><? echo $Mensajes["h-2"]; ?></div></td></a>
	<? }
	  else
		 {
		  ?>
    <a href="listar_msg.php?idUsuario=<?echo $row[7]; ?>&usuario=<? echo $row[0].', '.$row[1]; ?>"><div align="right"><? echo $Mensajes["h-3"]; ?></div></td></a>
          ...
          <table width="100%" bgcolor="#ececec">
            <tr>
              <td valign="top" class="style28"><div align="center"><img src="../images/image001.jpg" width="150" height="118"><br>
                  <span class="style60"><a href="../admin/indexadm.php"><? echo $Mensajes["h-5"]?> </a></span></div>                <div align="center" class="style55"></div></td>
            </tr>
          </table>
          </div>
          </td>
