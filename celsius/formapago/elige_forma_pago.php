    ...
    <td bgcolor="#E4E4E4">
      ...
      <tr>
		...
		<table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#ECECEC">
                  <tr bgcolor="#006699">
                    <td height="20" class="style33"><span class="style34"><img src="../images/square-w.gif" width="8" height="8">Listado de Formas de Pagos</span></td>
                    </tr>
                  <tr align="left" valign="middle">
					...
					<?   
					   ...
					   $expresion = "SELECT id,nombre,recibo,descripcion FROM Forma_Pago ORDER BY nombre";   
						  ...
						  <center>
							 <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="0">
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; } ?>'>
									   <td width="110" class="style22"><div align="left"><img src="../images/square-w.gif" width="8" height="8">Nombre</div></td>
									   <td class="style33" align="left"><div align="left"><? echo $row[1];?></div></td>
									   <td ><div align="right">&nbsp;</div></td>
									</tr>
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; } ?>'>
									   <td ><div align="right">&nbsp;</div></td>
									   <td  colspan=2 class="style22"><div align="left">&nbsp;</div></td>
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; $ok=false;} else{echo "";$ok=true;}?>'>
											  <td colspan=2><div align="right">&nbsp;</div></td>
											  <td><div align="right" class="style33"><a href="form_pago.php?dedonde=1&Id=<?echo $row[0]; ?>">Modificar Forma de Pago</a></div></td>
									</tr>
							 </table>
