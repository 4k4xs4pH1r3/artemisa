                ...
                <tr>
                   <td width="150" class="style22"><div align="right"><? echo $Mensajes["ec-1"]; ?></div></td>
                        ...
                        <tr>
                          ...
                          <td><div align="right" class="style33"><a href="form_loc.php?dedonde=1&Id=<?echo $row[1]; ?>"><? echo $Mensajes["h-2"]; ?></a>|<a href="elige_localidad.php?dedonde=2&Id=<? echo $row[1]; ?>&Pais=<? echo $Pais; ?>" onClick="return confirmar()"><? echo $Mensajes["h-3"]; ?></a></div></td>
                        </tr>
                      </table>
