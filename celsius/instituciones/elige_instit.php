...
<?
      ...
      {      	
     ?> 
	 <form method="POST" action="elige_instit.php">
										...
										<tr>
										   ...
										   <td class="style33"><? if ($row[3]==1) { echo "<img border=0 src='../images/marca.gif' width='30' height='31'>";} ?></td>
												...
												<tr>
												  ...
												  <td colspan=2><div align="right" class="style33"><a  class="style33" href="form_instit.php?dedonde=1&Id=<?echo $row[2]; ?>"><? echo $Mensajes["h-2"]; ?></a></div></td>
												</tr>
											  </table>
