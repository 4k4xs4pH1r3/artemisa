						  ...
						  <center>
							 <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="0">
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; } ?>'>
									   <td width="80" class="style22"><div align="left"><img src="../images/square-w.gif" width="8" height="8"><? echo $Mensajes["ele-1"]; ?></div></td>
									   <td class="style33" align="left"><div align="left"><?echo $row[0];?></div></td>
									   <td ><div align="right">&nbsp;</div></td>
									</tr>
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; $ok=false;} else{echo "";$ok=true;}?>'>
											  <td colspan=2><div align="right">&nbsp;</div></td>
											  <td><div align="right" class="style33"><a href="form_cat.php?operacion=1&Id=<? echo $row[1]; ?>"><? echo $Mensajes["h-2"]; ?></div></td>
									</tr>
							 </table>
