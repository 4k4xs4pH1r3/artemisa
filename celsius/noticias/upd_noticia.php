...
<?
   ...
   $Fecha = ltrim($Anio)."-".ltrim($Mes)."-".ltrim($Dia);	
   
   if ($operacion==0)
   {   
    $Instruccion = "INSERT INTO Noticias (Fecha,Titulo,Texto_Noticia,Codigo_Idioma) VALUES('".$Fecha."','".$Titulo."','".$Texto."',".$Codigo_Idioma.")";	
   }
   else
   {
   	 $Instruccion = "UPDATE Noticias SET Fecha='".$Fecha."',Titulo='".$Titulo."',Texto_Noticia='".$Texto."',Codigo_Idioma=".$Codigo_Idioma." WHERE Id=".$Id;	
   } 
                          ...
                          <td valign="top"><div align="center">
							...
							if (mysql_affected_rows()>0)
                              ...
                              <tr>
                                ...
                                <td class="style43"><div align="left"> <?echo $Titulo;?></div></td>
                              </tr>
                              <tr>
                               
                                <td class="style43"><div align="left"><?echo $Texto; ?>
                                  </div></td>
                              </tr>

							   <tr>
                               
                                <td class="style43"><div align="left"><?echo $NombreIdioma; ?>
                                  </div></td>
                              </tr>

							   <tr>
                               
                                <td class="style43"><div align="left"><?echo $Fecha; ?>
                                  </div></td>
                              </tr>
									<? }
									else
									...
									<tr>                              
									<td class="style43"><div align="left"><?echo $Mensajes["err-2"] ?>
									  </div></td>
									</tr>
                              ...
                              <tr>
                                <td class="style49"><div align="right"></div>                                  
                                    <div align="center">

									  <? if ($operacion==0)
										  {?>
										   <a href="form_noticia.php?operacion=0" >;<? echo $Mensajes["h-1"]; ?></a></p>
										  <?
										  } else{  ?>
										   <a href="elige_not.php" ><? echo $Mensajes["h-2"]; ?></a></p>      
										  <? } ?> 
    ...
    <td height="44" bgcolor="#E4E4E4"><div align="center">      
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="50" class="style49"><div align="center" class="style11">fno-001</div></td>
        </tr>
      </table>
      </div></td>
  </tr>
