...
class nusoap_base {
	...
	*/
	function serialize_val($val,$name=false,$type=false,$name_ns=false,$type_ns=false,$attributes=false,$use='encoded',$soapval=false) {
    	...
    	if (is_object($val) && strtolower(get_class($val)) == 'soapval' && (! $soapval)) {
		...
		switch(true) {
			...
			case is_object($val):
		    	...
		    	if (strtolower(get_class($val)) == 'soapval') {
...
class nusoap_server extends nusoap_base {
	...
	*/
	function serialize_return() {
		...
		// if fault
		if (isset($this->methodreturn) && ((strtolower(get_class($this->methodreturn)) == 'soap_fault') || (strtolower(get_class($this->methodreturn)) == 'nusoap_fault'))) {
