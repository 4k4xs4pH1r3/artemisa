...
<?
 ...
 global $IdiomaSitio;
 $Mensajes = Comienzo ("epa-001",$IdiomaSitio);
        ...
        <td valign="top" bgcolor="#E4E4E4">            <div align="center">
              <center>
                <table width="97%" border="0" cellpadding="1" cellspacing="0">
                  <tr>
                    <td height="20" align="right" valign="middle" bgcolor="#006699" class="style22"><div align="left" class="style34"><img src="../images/square-w.gif" width="8" height="8"><? echo $Mensajes["et-1"]; ?></td>
											...
											<tr>
											   <td width="150" class="style22"><div align="right"><? echo $Mensajes["ec-1"]; ?></div></td>
												...
												<tr>
												  ...
												  <td width="200"><div align="right" class="style33"><a class="style33 " href="form_pais.php?dedonde=1&Id=<?echo $row[1]; ?>"><? echo $Mensajes["h-2"]; ?></a></div></td>
													</tr>
									</table>
