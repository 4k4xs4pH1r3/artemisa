...
<?
   ...
   If ($dedonde==0)
   {
	   $Instruccion = "INSERT INTO Paises (Nombre,Abreviatura) VALUES('".AddSlashes($Pais)."','".AddSlashes($Abreviatura)."')";	
	}   
	Else
	{
		$Instruccion = "UPDATE Paises SET Nombre='".AddSlashes($Pais)."' , Abreviatura='".AddSlashes($Abreviatura)."' WHERE Id=".$Id;	
                              ...
                              <tr>
                                <td colspan="2" class="style49"><div align="right"></div>                                  
                                    <div align="center">
                                     <? if ($dedonde==0)
											  { ?>
											   <a href="form_pais.php?dedonde=0" ><? echo $Mensajes["h-1"]; ?></a>
											  <?
											  } else { ?>
											   <a href="elige_pais.php" ><? echo $Mensajes["h-2"]; ?></a>
											  <? } ?>
