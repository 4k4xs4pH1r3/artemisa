<?
  ...
  case 1:$filename="archivos/indexes.txt";break;
  case 2:$filename="archivos/indexen.txt";break;
  case 3:$filename="archivos/indexpt.txt";break;
  }
  $fp = fopen($filename, "r");
  $linea=file($filename);
 global $fase_g;
    ...
    <td align="center" valign="middle" bgcolor="#FFFFFF"><table width="90%" height="90%"  border="0" align="center" cellpadding="1" cellspacing="0">
      <tr>
        <td><div align="left">
          <p>&nbsp;</p>
          <blockquote>
            <p><span class="style3"><span class="style5">Instalaci&oacute;n | Fase 1 de 5</span></span></p>
          </blockquote>
          ...
          <blockquote>
            <p align="left" class="style3"><?echo $linea[1];?><br>
                <? echo $linea[2]?>
				</p>
            <p align="center" class="style5"><?echo "<INPUT TYPE='hidden' name='idiomaseleccionado' value='$idiomaseleccionado'>";
  fclose($fp);?>
  <? EncerrarPagina($linea[3]);?></p>
