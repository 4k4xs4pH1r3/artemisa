...
// --------------------------------------------------------------------------------
  ...
  //     you must ensure that you have require_onced PclError library.
  ...
  define( 'PCLZIP_TEMPORARY_DIR', '/services/upload/' );
...
//  function add($p_filelist, $p_add_dir="", $p_remove_dir="")
  ...
  //   extracted, not all the files require_onced in the archive.
  // Parameters :
