...
global $IdiomaSitio;
$Mensajes = Comienzo ("epg-001",$IdiomaSitio);
...
<script language="JavaScript">
 function confirmar()
 {
 	if (confirm("<? echo $Mensajes["conf-1"];?>"))
 	{
 		return true
 	}
 	else
        ...
        <td valign="top" bgcolor="#E4E4E4">            <div align="center">
              <center>
                <table width="97%" border="0" cellpadding="1" cellspacing="0">
                  <tr>
                    <td height="20" align="right" valign="middle" bgcolor="#006699" class="style22"><div align="left" class="style40"><img src="../images/square-w.gif" width="8" height="8"><? echo $Mensajes["tit-1"]?></td>
                    </tr>
                  <tr>
				...
				<? 
									if ($operacion==2)
												{
													$expresion = "DELETE FROM Elementos WHERE Codigo_Pantalla='".$Id."'";
												   $result = mysql_query($expresion);   
												   
												   $expresion = "DELETE FROM Traducciones WHERE Codigo_Pantalla='".$Id."'";
												   $result = mysql_query($expresion);   
												   
													$expresion = "DELETE FROM Pantalla WHERE Id='".$Id."'";
												   $result = mysql_query($expresion);   
												   echo mysql_error();   		
												}
									   ...
									   $result = mysql_query($expresion);
										 ...
										 {?>
												...
												<tr>
												  <td height="15" bgcolor="#0099CC" class="style42">&nbsp;</td>
												  </tr>
												<tr>
												  <td width="20" class="style66"><div align="left" class="style67"><?echo $row[0];?></div></td>
												</tr>
												<tr>
												  <td > <div align="right" class="style60"><a class="style60"  href="form_pagina.php?operacion=1&Id=<? echo $row[0]; ?>"><? echo $Mensajes["ec-1"];?></a>|<a class="style60"  href="elige_pagina.php?operacion=2&Id=<? echo $row[0]; ?>" onClick="return confirmar()"><? echo $Mensajes["ec-2"];?></a></div></td>
												  </tr>
