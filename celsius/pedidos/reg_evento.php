...
$hayArchivos = vectorTieneArchivos($_FILES);
       ...
       if($hayArchivos) {
                        ...
                        $Instevento = "update Eventos set  Codigo_Evento=".Devuelve_Evento_Download()." where Id_Pedido='".$Id."' and Codigo_Evento=".Devuelve_Evento_recepcion(); 
                   		$resultevento = mysql_query($Instevento);
		 }
...
<table width="550" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#E4E4E4">
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="2">
      <tr>
        <td height="20" bgcolor="#006699" class="style18"><? echo $Mensajes["tf-1"]; ?>&nbsp;<?echo $Id; ?> </td>
      </tr>
      <tr>
        <td bgcolor="#F3F3F1" class="style2"><div align="center">
          <table width="100%" border="0" cellpadding="2" cellspacing="0">
            <tr>
              <td colspan="2"> <div align="center" class="style17"><? echo $Mensajes["tf-2"]; ?> </div></td>
              </tr>
            <tr>
              <td width="20"><div align="center"><img src="images/m_1_s.gif" width="14" height="11"></div></td>
              <td><div align="left">
               <input type="text" name="Direccion" size="51" class="style2" value="<? if ($Env_Mail=="ON"){echo $Mail; } ?>">
              </div></td>
            </tr>
            <tr>
              <td width="20"><div align="center">
          <input type="checkbox" name="Corrige_Direccion" class="style2" value="ON">  
              </div></td>
              <td><div align="left"><? echo $Mensajes["tf-3"]; ?></div></td>
            </tr>
            <tr>
              <td width="20"><div align="center"><img src="images/bubble.gif" width="16" height="16"></div></td>
              <td><div align="left">
                <input type="text" class="style2" name="Asunto" size="51" value="<? if (isset($Env_Mail)) {if(isset($roww)){ echo $roww[0];} } ?>" >
              </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div align="left">
                <textarea rows="8" cols="54"  class="style2" name="Texto"><? if(isset($roww)) {echo $roww[1];} ?></textarea>
              </div></td>
            </tr>
          </table>
        </div></td>
 ...
 <input type="hidden" name="usuario" value="<? echo $usuario; ?>">
  ...
  <input type="hidden" name="Biblioteca_Destino" value ="<? echo $Biblioteca_Destino; ?>">
        <td bgcolor="#E4E4E4" class="style2"><div align="center">
         <input type="submit" class="style2"value="<? echo $Mensajes["bot-1"]; ?>" name="B3" >
        </div></td>
      </tr>
    </table></td>
  </tr>
  ...
  else
  {
    if ($Direccion!="")
    {
      ...
      $hora = strftime ("%H:%M:%S"); 
  	  ...
  	  $Instruccion = $Instruccion." VALUES ($usuario,'$fecha','$hora','".AddSlashes($Direccion)."','".AddSlashes($Asunto)."','".AddSlashes($Texto)."','$Id')";
  	  $result = mysql_query($Instruccion);
  	  echo mysql_error();
