            ...
            bgColor=#ececec border=0>
              ...
              <TR bgColor=#006699>
                <TD class=style33 height=20><SPAN class=style34><IMG height=8 
                  src="../images/square-lb.gif" width=8> <? echo $Mensajes["tf-10"]; ?></SPAN></TD></TR>
                  ...
                  align=center border=0>
                    ...
                    <TR>
                      <TD class="style22" width=120>
                        <DIV align=right><? echo $Mensajes["tf-11"]; ?>:</DIV></TD>
                      <TD class="style33">
                    ...
                    <TR>
                      ...
                      <TD>
                        <DIV align=left><BR><input type="button" value="<? echo $Mensajes["bot-1"]; ?>" name="B1" class="style22" OnClick="Seteo_Modo()">
...
<?
  ...
  $expresion = $expresion." WHERE Titulo_Articulo LIKE '%".$Texto."%'";
   if ($dedonde==1)
   {
