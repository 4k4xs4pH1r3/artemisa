...
<?
  ...
  $expresion = $expresion."WHERE PedHist.Estado='".Devolver_Estado_Cancelado()."' and EvHist.Fecha<='".$Fin."'and (EvHist.Codigo_Evento=8 or EvHist.Codigo_Evento='".Devuelve_Evento_cancela()."')  and EvHist.Fecha>='".$Inicio."' ORDER BY PedHist.Fecha_Alta_Pedido DESC";
