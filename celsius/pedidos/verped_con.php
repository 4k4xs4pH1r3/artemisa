...
<title><? echo Devolver_Tipo_Material($VectorIdioma,5); ?> - <? echo Titulo_Sitio(); ?></title>
...
{
  ventana=window.open("help.php?Tabla="+tabla+"&campo="+campo,"Ayuda","dependent=yes,toolbar=no,width=530,height=120");
}
...
<?
    ...
    $Instruccion = "SELECT Tipo_Pedido,TituloCongreso,Organizador,NumeroLugar,Anio_Congreso,PaginaCapitulo,PonenciaActa,";
    $Instruccion = $Instruccion."Codigo_Pais_Congreso,Otro_Pais_Congreso,";
    $Instruccion = $Instruccion."Biblioteca_Sugerida,Observaciones,Usuarios.Apellido,Usuarios.Nombres";
...
<div align="left">
  ...
  <?
    ...
    <tr bgcolor="#D4D0C8">
      ...
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="TituloCongreso" value="<? echo $row[1]; ?>" class="style23" size="80">
      </td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC">
      <div align="center"><a href="javascript:ayuda(5,1)"> <img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23">
          <div align="right"><? echo $Campos[2][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="Organizador" value="<? echo $row[2]; ?>" class="style23" size="80">
      </td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC">
        <div align="center"><a href="javascript:ayuda(5,2)"><img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23">
      <div align="right"><? echo $Campos[3][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="NumeroLugar" value="<? echo $row[3]; ?>" class="style23" size="80"></td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
    ...
    <tr bgcolor="#D4D0C8">
      ...
      <td align="left" valign="middle" bgcolor="#ececec">
         <input type="text" name="AnioCongreso" value="<? echo $row[4]; ?>" class="style23" size="40"></td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
      <a href="javascript:ayuda(5,4)"><img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23"><div align="right"> <? echo $Campos[5][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
         <input type="text" name="PaginaCapitulo" size=30 value="<? echo $row[5]; ?>" class="style23"> </td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
      <a href="javascript:ayuda(5,5)"><img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    ...
    <tr bgcolor="#D4D0C8">
      ...
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="PonenciaActa" value = "<? echo $row[6]; ?>" class="style23" size="80"></td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
      <a href="javascript:ayuda(5,6)"><img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23">
      <div align="right"><? echo $Campos[7][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <select size="1" name="PaisCongreso" class="style23">
            <?
                 $Instruccion = "SELECT Id,Nombre FROM Paises ORDER BY Nombre";
                 $result = mysql_query($Instruccion);
                 while ($rowg =mysql_fetch_row($result))
                 {
                  echo $rowg[0]."Pais Actual";
				  echo $row[7].":Pais del pedidos";
				  if ($rowg[0]==$row[7])
                     {
      ...
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
      <a href="javascript:ayuda(5,7)"><img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23">
      <div align="right"><? echo $Campos[8][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="OtroPaisCongreso" value = "<? echo $row[8]; ?>" class="style23" size="80"></td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
      <a href="javascript:ayuda(5,8)"><img src="../images/help.gif" border=0 width="22" height="22"></a></div></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23">
      <div align="right"><? echo $CamposFijos[201][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="TardanzaAtencion" size="12" class="style23" value="<? echo $row[13]; ?>"></td>
    </tr>
       <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23"><div align="right"><? echo $CamposFijos[202][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="TardanzaBusqueda" size="12" class="style23" value="<? echo $row[14]; ?>"></td>
    </tr>
    <tr bgcolor="#D4D0C8">
      <td width="150" align="right" valign="middle" bgcolor="#CCCCCC" class="style23"><div align="right"><? echo $CamposFijos[203][0]; ?></div></td>
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="TardanzaRecepcion" size="12" class="style23" value="<? echo $row[15]; ?>"></td>
    </tr>
    ...
    <tr bgcolor="#D4D0C8">
      ...
      <td align="left" valign="middle" bgcolor="#ececec">
      <input type="text" name="Biblioteca" value = "<? echo $row[9]; ?>" class="style23" size="80"></td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
    ...
    <tr bgcolor="#D4D0C8">
      ...
      <td align="left" valign="middle" bgcolor="#ececec">
      <textarea rows="4" name="Observaciones" cols="80" class="style23"><? echo $row[10]; ?></textarea></td>
      <td width="30" align="center" valign="top" bgcolor="#ECECEC"><div align="center">
    ...
    <tr bgcolor="#D4D0C8">
      ...
      <td width="30" bgcolor="#ECECEC">&nbsp;</td>
	    ...
	    <input type="hidden" name="TipoMaterial" value=5>
  ...
  ?>
    <tr align="center" valign="middle" class="style23">
      <td width="20" height="20">
	  	  <a href="javascript:ver_evento(<? echo $row[7]; ?>)"><img src="../images/mas.gif" border=0 width="9" height="9"></a></td>
