...
<!-- saved from111 url=(0129)http://sedici.unlp.edu.ar/horde/imp/view.php?thismailbox=INBOX&index=4890&id=2&actionID=113&mime=7f9e3d002209a8e9d5ccebb847a38796 -->
...
<? 
  ...
  include_once "../inc/"."tabla_ped.inc" ;
...
<script language="JavaScript">
 function Seteo_Modo()
 {
    document.forms.form2.action="manpedcolauth.php";   
        ...
        <TR>
          <TD vAlign=top>
            ...
            bgColor=#ececec border=0>
              <TBODY>
              <TR bgColor=#006699>
                <TD class=style33 height=20><SPAN class=style34><IMG height=8 
                  src="../images/square-lb.gif" width=8> <? echo $Mensajes["tf-2"]; ?>&nbsp;&nbsp; </SPAN></TD></TR>
                ...
                <TD class="style22">
                  ...
                  align=center border=0>
                    ...
                    <TR>
                      ...
                      <TD>
                        <DIV align=left>
						<input type="radio" value="1" name="Lista" <? If (!isset($Lista)) {$Lista="";} If ($Lista==1) { echo " checked"; }?>><? echo $Mensajes["op-1"]; ?>
...
<?
 ...
 $expresion = armar_expresion_busqueda_hist();
   ...
   */
   ...
   $expresion .= "WHERE (Autor_Detalle1 like '%$Texto%' || Autor_Detalle2 like '%$Texto%' || Autor_Detalle3 like '%$Texto%')";
...
//	$total_records = mysql_num_rows($contarok);
 ...
 ?>  
            ...
            bgColor=#0099cc border=0>
              <TBODY>
              <TR>
                <TD class=style22 height=20><IMG height=8 src="../images/square-w.gif" width=8>    <? echo $Mensajes["tf-9"]; ?><SPAN 
...
//parte de paginado
    ...
    if ($pg <> 0)
     {
     $url = $pg - 1;
      echo "<a class='paginado' href='manpedcolauth.php?Texto=".$Texto."&pg=".$url."'><font face='MS Sans Serif' size='1' color='#000080'> &laquo; Anterior</font></a>&nbsp;";
      }
     else {
           echo " ";}
     if ($total_records)
	   { for ($i = 0; $i<($pages + 1); $i++) {
        if ($i == $pg) {
         ...
         echo "<a class='paginado' href='manpedcolauth.php?Texto=".$Texto."&pg=".$i."'><font face='MS Sans Serif' size='1' color='#000080'> ".$i."</font></a>&nbsp;";
         }
	   }
  }
...
if ($pg < $pages) {
$url = $pg + 1;
  echo "<a class='paginado' href='manpedcolauth.php?Texto=".$Texto."&pg=".$url."'><font face='MS Sans Serif' size='1' color='#000080'> Siguiente &raquo;</font></a>";}
   else {
echo " ";
}
echo "</p>";  
...
?>
		<form name="form3" method="POST"> 
			  <p align="center">
			  <input type="button" value="<? echo $Mensajes["bot-2"]; ?>" name="B3" style="font-family: MS Sans Serif; font-size: 10 px; font-weight: bold" OnClick="rutear_pedidos(<? echo $row[4]; ?>,'<? echo $row[1]; ?>')">
			 <? if ($dedonde!=1)
			  { ?>
			  <input type="button" value="<? echo $Mensajes["bot-3"]; ?>" name="B1" style="font-family: MS Sans Serif; font-size: 10 px; font-weight: bold" OnClick="genera_evento('<? echo $row[1]; ?>',<? echo $row[36]; ?>,'<? echo $row[46]; ?>','<? echo $row[2].",".$row[3]; ?>',<? echo $row[48];?>,<? echo $row[49];?>)">
			 <? }  ?>
			  </p>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD bgColor=#ececec>
                        ...
                        class=style33><A HREF="<? if ($dedonde==1) { echo "../admin/indexadm.php";} else {echo "../admin/indexadm.php";} ?>"><? echo $Mensajes["tf-8"]; ?></A></SPAN></P></DIV></TD></TR></TBODY></TABLE></DIV></TD></TR></TBODY></TABLE></DIV></DIV></TD></TR></TBODY></TABLE></CENTER></DIV></TD></TR>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          ...
          <TD width=50>
            ...
            <DIV 
  align=center>adm-003</DIV></DIV></TD></TR></TBODY></TABLE></DIV></TD></TR></TBODY></TABLE></DIV></BODY></HTML>
