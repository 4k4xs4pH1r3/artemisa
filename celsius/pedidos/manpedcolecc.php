 ...
 function genera_evento(Id,Estado,Mail,Nombre,Rol,IdCreador)
{
 ...
 function rutear_pedidos (TipoPed,Id)
 {
     ...
     switch (TipoPed)
	  {
	    case 1:
	      ventana=open("verped_col.php?Id="+Id+"&dedonde=2&Tabla=1","1","scrollbars=yes,width=700,height=450,alwaysLowered");   
	      break;
	    case 2:
	      ventana=open("verped_cap.php?Id="+Id+"&dedonde=2&Tabla=1","1","scrollbars=yes,width=700,height=450,alwaysLowered");
	      break;
	    case 3:           
          ventana=open("verped_pat.php?Id="+Id+"&dedonde=2&Tabla=1","1","scrollbars=yes,width=700,height=450,alwaysRaised");
          break;	
       case 4:           
          ventana=open("verped_tes.php?Id="+Id+"&dedonde=2&Tabla=1","1","scrollbars=yes,width=700,height=450,alwaysRaised");
          break;	
       case 5:           
          ventana=open("verped_con.php?Id="+Id+"&dedonde=2&Tabla=1","1","scrollbars=yes,width=700,height=450,alwaysRaised");
          break;	
                    ...
                    <td class="style22"><div align="center" class="style33">
                      <table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" class="style22">
                        <tr>
                          ...
                          <td colspan="2" class="style33"><div align="left"><? echo $Coleccion; ?></div></td>
                        </tr>
                        <tr>
                          <td width="120" class="style22"><div align="right"></div>
</td>
                          <td class="style22" colspan="2"><input type="radio" value="1" name="Lista" <? If (!isset($Lista)) {$Lista="";} If ($Lista==1) { echo " checked"; }?>><? echo $Mensajes["tf-3"]; ?>
        <input type="radio" name="Lista" value="2" <? If (!isset($Lista)) {$Lista="";} If ($Lista==2 || $Lista=="") { echo " checked";}?>><? echo $Mensajes["tf-4"]; ?> </td>
                  ...
                  <input type="button" value="<? echo $Mensajes["bot-1"]; ?>" name="B1" class="style22" OnClick="Seteo_Modo()">
                          ...
                          <td class="style22"><a href="../admin/elige_col.php?Letra=A&dedonde=1"><? echo $Mensajes["h-3"]; ?></a></td>
                        </tr>
                      </table>
                      </div>                      </td>
                    </tr>
...
<?
   ...
   $expresion = $expresion."WHERE Pedidos.Codigo_Titulo_Revista=".$Id_Colecc;
