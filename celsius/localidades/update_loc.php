...
<?
   ...
   if ($dedonde==0)
   {
      $Instruccion = "INSERT INTO Localidades (Nombre,Codigo_Pais) VALUES('".$Localidad."','".$Codigo_pais."')";	
   }
   else
   {
       $Instruccion = "UPDATE Localidades SET Nombre='".$Localidad."',Codigo_Pais=".$Codigo_pais." WHERE Id=".$Id;	
...
//   echo  $Instruccion;
 ...
 if (!mysql_error())
   { ?>
                          ...
                          <td valign="top"><div align="center">
                            <table width="95%"  border="0" cellpadding="1" cellspacing="1">
                              <tr>
                                ...
                                <td width="50%" class="style43"><div align="left"> <?echo $Pais;?></div></td>
                              </tr>
                              <tr>
                                <td width="50%" class="style49"><div align="right"><? echo $Mensajes["ec-2"]; ?></div></td>
                                <td width="50%" class="style43"><div align="left"><?echo $Localidad;?>
                                  </div></td>
                              </tr>
                              <tr>
                                <td colspan="2" class="style49"><div align="right"></div>                                  
                                    <div align="center">
                                     <? if ($dedonde==0)
											  { ?>
											   <a href="form_loc.php?dedonde=0" ><? echo $Mensajes["hc-1"]; ?></a>
											  <?
											  } else { ?>
											   <a href="elige_localidad.php" ><? echo $Mensajes["hc-2"]; ?></a>
											  <? } ?>
				...
				<tr><td>
					<p align='center'><font face='Impact' size='6' color='#FF0000'><?echo $Mensajes["me-2"]; ?></font></b></p></tr></td></table>
          ...
          <table width="100%" bgcolor="#ececec">
            <tr>
              <td class="style28"><div align="center"><img src="../images/image001.jpg" width="150" height="118"><br>
                  <span class="style33"><a href="../admin/indexadm.php" target="_self"><? echo $Mensajes["h-2"]; ?></a></span> </div>                <div align="center" class="style55"></div></td>
            </tr>
          </table>
          </div>
          </td>
