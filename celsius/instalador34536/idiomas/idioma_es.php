...
// Pagina Paso_3.php
 ...
 define('PASO5_LABEL_MAILCONTACTO','Mail para contactarse con los administardores de esta instancia de Celsius');
 ...
 //Pagina Paso_8.php
 define('PASO8_TEXT_1','Ha finalizado la instalacion de celsiusNT. <br> Borre la carpeta "instalador" del arbol web y luego haga click');
