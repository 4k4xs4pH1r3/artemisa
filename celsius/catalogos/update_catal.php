...
<?
   ...
   If ($dedonde==0)
   {
	   $Instruccion = "INSERT INTO Catalogos (Nombre,Link,observaciones,numero) VALUES('".$Nombre."','".$Link."','".$observaciones."','".$numero."')";	
	   
	}   
	Else
	{
		$Instruccion = "UPDATE Catalogos SET Nombre='".$Nombre."' , Link='".$Link."', observaciones='".$observaciones."', numero='".$numero."' WHERE Id=".$Id;	
									...
									<table width="95%"  border="0" cellpadding="1" cellspacing="1">
									  ...
									  <tr>
									   ...
									   <tr>
										...
										<td width="50%" class="style43"><div align="left"><?echo $Link; ?></div></td>
									  </tr>
									  <tr>
										<td width="50%" class="style49"><div align="right">Observaciones</div></td>
										<td width="50%" class="style43"><div align="left"><?echo $observaciones; ?></div></td>
									  </tr>
									  <tr>
										<td colspan="2" class="style49"><div align="right"></div>                                  
											<div align="center">
											 <? if ($dedonde==0)
											  { ?>
											   <a href="form_catal.php?dedonde=0"><? echo $Mensajes["h-1"]; ?></a>
											  <?
											  } else { ?>
											   <a href="elige_catal.php" ><? echo $Mensajes["h-2"]; ?></a>
											  <? } ?>  						  
										   </div></td>
										</tr>
