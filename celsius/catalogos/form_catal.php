...
<?
   ...
   $Mensajes = Comienzo ("fcg-001",$IdiomaSitio);
	...
	If ($dedonde==1)
	{
	  $expresion = "SELECT Nombre,Link,Id,observaciones,numero FROM Catalogos WHERE Id=".$Id;
...
<div align="left">
<form method="POST" action="update_catal.php?dedonde=<?echo $dedonde; ?>&Id=<? echo $Id; ?>">
                            ...
                            <table width="95%"  border="0" cellpadding="1" cellspacing="1">
                              ...
                              <tr>
                                ...
                                <td class="style43"><div align="left">
								   ...
								   <input type="text" name="Link" class="style43" value="<? if (isset($row))echo $row[1]; ?>" size="30">
                                </div></td>
                              </tr>

                        <tr>
                                <td width="150" class="style49"><div align="right">Observaciones</div></td>
                                <td class="style43"><div align="left">
                                    <TEXTAREA class="style43" NAME="observaciones" ROWS="4" COLS="30"><? if (isset($row))echo $row[3]; ?></TEXTAREA>
                                </div></td>
                              </tr>
      <tr>
                                <td width="150" class="style49"><div align="right">Numero de Orden</div></td>
                                <td class="style43"><div align="left">
                                 
								   <input type="text" name="numero" class="style43" value="<? if (isset($row))echo $row[4]; ?>" size="30">
                                </div></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td class="style49">
								 ...
								 <input type="submit" value="<? if ($dedonde==0) { echo $Mensajes["botc-1"]; } else { echo $Mensajes["botc-2"]; } ?>" name="B1" class="style43">
