		...
		<table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#ECECEC">
                  ...
                  <tr align="left" valign="middle">
					...
					<?   
					   ...
					   $expresion = "SELECT Id,Nombre,Link FROM Catalogos ORDER BY Nombre";   
						  ...
						  <center>
							 <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="0">
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; } ?>'>
									   <td width="110" class="style22"><div align="left"><img src="../images/square-w.gif" width="8" height="8"><? echo $Mensajes["ec-1"]; ?></div></td>
									   <td class="style33" align="left"><div align="left"><? echo $row[1];?></div></td>
									   <td ><div align="right">&nbsp;</div></td>
									</tr>
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; } ?>'>
									   <td ><div align="right">&nbsp;</div></td>
									   <td  colspan=2 class="style22"><div align="left"><? echo "<a href='' OnClick='javascript:window.open(\"".$row[2]."\")'>".$row[2]."</a>"; ?></div></td>
									<tr bgcolor='<? if ($ok){ echo"#CCCCCC" ; $ok=false;} else{echo "";$ok=true;}?>'>
											  <td colspan=2><div align="right">&nbsp;</div></td>
											  <td><div align="right" class="style33"><a href="form_catal.php?dedonde=1&Id=<?echo $row[0]; ?>"><? echo $Mensajes["h-4"]; ?></a></div></td>
									</tr>
							 </table>
