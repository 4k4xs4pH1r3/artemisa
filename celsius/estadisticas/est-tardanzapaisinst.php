...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion .= " AND Tipo_Pedido=" . $TPed . " AND Ultimo_Pais_Solicitado=" . $Pais;
...
<body topmargin="0">
<div align="left">
<form method="POST" action="est-tardanzapaisinst.php">
    ...
    <td bgcolor="#E4E4E4">
      ...
      <tr bgcolor="#EFEFEF">
        <td bgcolor="#E4E4E4">
            <div align="center">
              <center>
            <table width="576" border="0" class="table-form-top-blue" bordercolor="#111111" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top" bgcolor="#E4E4E4">
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="style43">
                <tr>
                    <td height="20" colspan="2" align="left" bgcolor="#006599" class="style45"><img src="../images/square-lb.gif" width="8" height="8" border="0"> <span class="style28"><?echo $Mensajes["tf-20"]?></span></td>
                </tr>
                  <tr>
                    ...
                    <tr>
                        ...
                        <td width="179" align="left">
                        	<select name="Pais" class="style54" size="1" style="width:170px"><? if (!isset($Pais)) { $Pais = 0;} ?>
                        	<?$Instruccion = "SELECT Id,Nombre FROM paises ORDER BY paises.Nombre";
							  ...
							  ?>
	            			  <option  value=<? echo $row[0]; ?> <? echo $sele; ?> ><? echo $row[1]; ?></option>
	                   		  <?}?>
                        	  </select>                        
                        </td>
                        <th>
                        	<div align="right"><?echo $Mensajes["tf-13"]?></div>
                        </th>
                        <td width="179" align="left">
                        	<select name="TipoGrafico" class="style54" size="1" style="width:170px">
								<? if (!isset($TipoGrafico)) { $TipoGrafico = 0;} ?>
                    ...
                    <tr>
                        ...
                        <td width="179" align="left">
                        	<select name="Modalidad" class="style54" size="1" style="width:170px">
