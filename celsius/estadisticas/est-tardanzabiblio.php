...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion .= " AND Tipo_Pedido=" . $TPed . " AND Ultima_Dependencia_Solicitado=" . $Dependencias;
...
<body topmargin="0">
<div align="left">
<form name="form2" method="POST" action="est-tardanzabiblio.php">
      ...
      <tr bgcolor="#EFEFEF">
        <td bgcolor="#E4E4E4">
            ...
            <table width="576" border="0" style="margin-bottom: 0; margin-top:0; border-collapse:collapse" bordercolor="#111111" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top" bgcolor="#E4E4E4"><table width="97%"  border="0" cellpadding="0" cellspacing="0" class="style43">
                  <tr>
                    <td height="20" colspan="2" align="left" bgcolor="#006599" class="style45"><img src="../images/square-lb.gif" width="8" height="8" border="0"> <span class="style28"><? echo $Mensajes["tf-25"]?> </span></td>
                  </tr>
                  <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                        	<select name="Paises" class="style54" onChange="Generar_Instituciones(0,0)" size="1" style="width:200px">
                        	</select>
                        </td>
                    </tr>
                    <tr>
...
<table  border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" class="style43">
 <tr bordercolor="#CCCCCC" bgcolor="#006699" class="style28">
   ...
   <?
	...
	if ($Modalidad == 1) { //primer if
		for ($i = 1; $i <= $columnastope; $i++) { //primer for
?>
...
?>
  ...
  <?
	...
	$descuento = 0;
	for ($i = 1; $i <= 11; $i++) { //segundo for
		if ($SumaPaises[$i] > 0) { //segundo if
			$buffer .= "\n";
?>
  ...
  <?
			...
			if ($Modalidad == 1) { //tercer if
				for ($j = 1; $j <= $columnastope; $j++) { //cuarto if
?>
...
<form name="formExport" action="exp_est.php">
  ...
  <input type='hidden' name='mifilename' value='tardanzabiblio.csv'>
