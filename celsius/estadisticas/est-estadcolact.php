...
function Armar_Instruccion($dedonde) {
	...
	if ($Modalidad == 1) {
		...
		$Instruccion = "SELECT YEAR(Fecha_Alta_Pedido) AS p, MONTH(Fecha_Alta_Pedido) AS m, Codigo_Titulo_Revista, COUNT(*) ";
		if ($dedonde == 1) {
		...
		$Instruccion .= " GROUP BY p,m,Codigo_Titulo_Revista";
	} else {
		$Instruccion = "SELECT YEAR(Fecha_Alta_Pedido) AS p, Codigo_Titulo_Revista, COUNT(*) ";
		if ($dedonde == 1) {
			$Instruccion .= "FROM pedhist ";
		} else {
			$Instruccion .= "FROM pedidos ";
		...
		$Instruccion .= " GROUP BY p,Codigo_Titulo_Revista";
	}
...
<body topmargin="0">
<div align="left">
<form method="POST" action="est-estadcolact.php">
            ...
            <tr>
                ...
                <tr>
                    <td height="20" colspan="2" align="left" bgcolor="#006599" class="style45">
                    	...
                    	<span class="style28"><? echo $Mensajes["pedidosIniciadosPorAnio"];?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <tr valign="middle">
                        <td colspan="4" class="style43"><div align="right"></div>                          <div align="center">
...
?>
                  <tr valign="top">
                    <td colspan="2" align="left" class="style45">
                      <div align="left">
                        <p><span class="style54"><img src="../images/sa6.gif" width="8" height="10"><? echo $Titulo." - expresado en Títulos de Revistas distintas"; ?>.</span></p>
                        </div>                      
                      <?
...
?>
          ...
          <tr valign="top">
          <td colspan="2" align="left" class="style45"><p class="style54"><img src="../images/sa6.gif" width="8" height="10"> <? echo $Mensajes["pedidosIniciadosPorAnio"]; ?> </p>
...
?>
		...
		<? } ?>
            ...
            <form name="formExport" action="exp_est.php">
  			...
  			<input type='hidden' name='mifilename' value='estadocolact.csv'>
		</form>
