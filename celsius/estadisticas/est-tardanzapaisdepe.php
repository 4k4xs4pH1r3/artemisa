...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion .= " AND Tipo_Pedido=" . $TPed . " AND Ultima_Institucion_Solicitado=" . $Institucion;
    ...
    <td bgcolor="#E4E4E4">
      ...
      <tr bgcolor="#EFEFEF">
        <td bgcolor="#E4E4E4">
            <div align="center">
              <center>
            <table width="576" border="0" class="table-form" bordercolor="#111111" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top" bgcolor="#E4E4E4">
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-form">
                <tr>
                    <td height="20" colspan="2" align="left" bgcolor="#006599" class="style45"><img src="../images/square-lb.gif" width="8" height="8" border="0"> <span class="style28"><? echo $Mensajes["tf-16"];?> </span></td>
                </tr>
                <tr>
                    <td height="15" colspan="2" align="left"><br>                      
                    ...
                    <tr>
                        ...
                        <td align="left">
                        	<select name="Pais" class="style54" onChange="Generar_Instituciones(0)" size="1" style="width:200px">
                        	<?$Instruccion = "SELECT Id,Nombre FROM paises ORDER BY paises.Nombre";
							  $result = mysql_query($Instruccion);
							  while ($row = mysql_fetch_row($result)) {
								$sele = "";
								if ($row[0] == $Pais) {$sele = "selected";}?>
                    ...
                    <tr>
                       ...
                       <td align="left">
                       		<select size="1" name="Institucion" class="style54" size="1" style="width:200px">
                       		</select>
                       </td>
                    </tr>
                    <tr>
...
?>
       <td align="center" bgcolor="#ECECEC"><?
			...
			echo number_format($PorcentajeAnios[$i], 2) . "%";
			$buffer .= "," . number_format($PorcentajeAnios[$i], 2) . "%";
?></td>
    <?
