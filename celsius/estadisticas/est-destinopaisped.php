...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion = "SELECT YEAR(Fecha_Alta_Pedido) AS p,paises.Nombre,COUNT(*),Ultimo_Pais_Solicitado ";
	if ($dedonde == 1) {
		$Instruccion .= "FROM pedhist ";
		$Instruccion .= "LEFT JOIN paises ON paises.Id=pedhist.Ultimo_Pais_Solicitado ";
		...
		$Instruccion .= "LEFT JOIN paises ON paises.Id=pedidos.Ultimo_Pais_Solicitado ";
		$Instruccion .= "WHERE YEAR(Fecha_Alta_Pedido)>=" . $Anio . " AND YEAR(Fecha_Alta_Pedido)<=" . $AnioFinal;
		$Instruccion .= " AND Tipo_Pedido=" . $TPed;
	}
	...
	$Instruccion .= " GROUP BY p,Ultimo_Pais_Solicitado";
	$Instruccion .= " ORDER BY p,paises.Nombre";
...
?>
<form method="POST" action="est-destinopaisped.php">
<div align="left">
        ...
        <td bgcolor="#E4E4E4">
            ...
            <table width="576" border="0" style="margin-bottom: 0; margin-top:0; border-collapse:collapse" bordercolor="#111111" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <tr>
                	<td height="20" class="table-form-top-blue" colspan="4">
                    	<img src="../images/square-lb.gif" width="8" height="8" border="0"> <span class="style28"><? echo $Mensajes["tit-27"]; ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td width="179" align="left">
                        	<select name="Caja" class="style54" size="1" style="width:170px">
...
?>
  ...
  <tr bordercolor="#CCCCCC" bgcolor="#006699" class="style28">
       <td align="right"><span class="style66"><? echo $Mensajes["ec-7"]; $buffer .= $Mensajes["ec-7"];?></span></td>
         <?
...
?>
   <tr bordercolor="#CCCCCC">
                          <td align="right" bgcolor="#CCCCCC"><a href="est-destinopaisinstped.php?Anio=<?


		echo $Anio;
?>&TPed=<? echo $TPed;?>&AnioFinal=<? echo $AnioFinal;?>&Pais=<? echo $de[$i];?>"><? echo $row[$i][0]; $buffer .= $row[$i][0];?>&nbsp;</a></td>
   <?
...
?>
                  ...
                  <tr valign="top">
                    <td colspan="2" align="left" class="style45"><p class="style54"><img src="../images/sa6.gif" width="8" height="10"> <? echo $Mensajes["mensaje.distribucionPorPais"]; ?> </p>
...
<form name="formExport" action="exp_est.php">
  ...
  <input type='hidden' name='mifilename' value='destinopaisped.csv'>
</form>
<script>
