...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion = "SELECT YEAR(Fecha_Alta_Pedido) AS p,dependencias.Nombre,COUNT(*),Ultima_Dependencia_Solicitado ";
	if ($dedonde == 1) {
		$Instruccion .= "FROM pedhist ";
		$Instruccion .= "LEFT JOIN dependencias ON dependencias.Id=pedhist.Ultima_Dependencia_Solicitado ";
	} else {
		$Instruccion .= "FROM pedidos ";
		$Instruccion .= "LEFT JOIN dependencias ON dependencias.Id=pedidos.Ultima_Dependencia_Solicitado ";
	}
	$Instruccion .= "WHERE YEAR(Fecha_Alta_Pedido)>=" . $Anio . " AND YEAR(Fecha_Alta_Pedido)<=" . $AnioFinal . " AND Ultima_Institucion_Solicitado=" . $Institucion;
	...
	$Instruccion .= " GROUP BY p,Ultima_Dependencia_Solicitado";
...
<body topmargin="0">
<div align="left">
  <form name="form1" method="POST" action="est-destinodepeped.php">
    ...
    <td bgcolor="#E4E4E4">
      ...
      <tr bgcolor="#EFEFEF">
        <td bgcolor="#E4E4E4">
            <div align="center">
              <center>
            <table width="576" border="0"  cellpadding="0" cellspacing="0" class="table-form">
              <tr>
                    ...
                    <td height="15" colspan="2" align="left" class="style45"><br>
                    	...
                    	<tr>
                			<td height="20" colspan="2" align="left" bgcolor="#006599" class="style45">
                				<img src="../images/square-lb.gif" width="8" height="8" border="0"><? echo $Mensajes["tit-29"]; ?>
                			</td>
                		</tr>
                      	<tr>
                        	<th width='150'>
                      ...
                      <tr>
                        	...
                        	<td align="left">
                        		<select name="Pais" class="style54" onChange="Generar_Instituciones(0)" size="1" style="width:190px">
                        		<?
                      ...
                      <tr>
                      		<th width='150'>
                       		...
                       		<td align="left">
                       			<select size="1" name="Institucion" class="style54" size="1" style="width:190px"><? if (!isset($Institucion)) { $Institucion = 0;} ?>
                       			</select>
                       		</td>
                      </tr>
                      <tr>
                        	...
                        	<td align="left">
                        		<select name="Modalidad" class="style54" size="1" style="width:190px"><? if (!isset($Modalidad)) { $Modalidad = 0;} ?>
                        			<option <? if ($Modalidad==1) { echo "selected"; } ?> value="1"><?=$Mensajes["opc-3"];?></option>
                        			<option <? if ($Modalidad!=1) { echo "selected"; } ?> value="2"><?=$Mensajes["opc-4"];?></option>
                        		</select>
                        	</td>
                      </tr>
                      <tr>
                        	...
                        	<td align="left">
                        		<select name="Caja" class="style54" size="1" style="width:190px"><? if (!isset($Caja)) { $Caja = 0;} ?>
                        			<option <? if ($Caja==0) { echo "selected"; } ?> value="0"><?=$Mensajes["otp-1"];?></option>
                        			<option <? if ($Caja==ESTADO__ENTREGADO_IMPRESO) { echo "selected"; } ?> value="<?= ESTADO__ENTREGADO_IMPRESO; ?>"><?=$Mensajes["otp-2"]; ?></option>
                        			<option <? if ($Caja==ESTADO__CANCELADO) { echo "selected"; } ?> value="<?=ESTADO__CANCELADO; ?>"><?=$Mensajes["otp-3"]; ?></option>
                        		</select>
                        	</td>
                      </tr>
                      <tr>
                        	...
                        	<td align="left">
                        		<select name="TipoGrafico" class="style54" size="1" style="width:190px"> <? if (!isset($TipoGrafico)) { $TipoGrafico = 0;} ?>
...
?>
   ...
   <td colspan="2" align="left" class="style45"><hr>
                      <div align="left">
...
<?
	...
	// este pais. Necesario para mantener el o      rden alfabetico
...
?>
     ...
     <table  border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" class="style43">
        <tr bordercolor="#CCCCCC" bgcolor="#006699" class="style28">
           <td align="right"><span class="style66"><? echo $Mensajes["ec-13"]; $buffer .=$Mensajes["ec-13"];?></span></td>
          <?
...
?>
                  ...
                  <td align="center" class="style28"><? echo $Mensajes["ec-4"]; $buffer .= ', '.$Mensajes["ec-8"];?></td>
        </tr>
          <?
...
?>
              <tr bordercolor="#CCCCCC">
                       <td align="right" bgcolor="#CCCCCC"><? echo $Mensajes["ec-3"]; $buffer .= $Mensajes["ec-3"]; ?></td>
                     <?
...
?>
  ...
  <tr valign="top">
      <td colspan="2" align="left" class="style45"><p class="style54"><img src="../images/sa6.gif" width="8" height="10"> <? echo $Mensajes["mensaje.distribucionPorDependencia"];?></p>
...
?>
  ...
  <input type='hidden' name='mifilename' value='destinodepeped.csv'>
