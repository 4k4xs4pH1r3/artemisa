...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion = "SELECT YEAR(Fecha_Alta_Pedido) AS p,instituciones.Nombre,COUNT(*),instituciones.Codigo ";
	...
	$Instruccion .= "LEFT JOIN instituciones ON instituciones.Codigo=usuarios.Codigo_Institucion ";
	$Instruccion .= "WHERE YEAR(Fecha_Alta_Pedido)>=" . $Anio . " AND YEAR(Fecha_Alta_Pedido)<=" . $AnioFinal . " AND usuarios.Codigo_Pais=" . $Pais;
	...
	$Instruccion .= " GROUP BY p,instituciones.Codigo";
...
<body topmargin="0">
<div align="left">
<form name="form1" method="POST" action="est-origeninstped.php">
              ...
              <tr>
                ...
                <tr>
                	<td height="20" colspan="2" align="left" bgcolor="#006599" class="style45">
                		<img src="../images/square-lb.gif" width="8" height="8" border="0"><span class="style28"><? echo $Mensajes["ec-18"];?></span>
                	</td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td width="179" align="left">
                        	<select name="Pais" class="style54" size="1" style="width:150px">
                        	<?
...
?></span></p>
     ...
     <table width="97%"  border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" class="style43">
        <tr bordercolor="#CCCCCC" bgcolor="#006699" class="style28">
           <td align="right"><span class="style66"><? echo $Mensajes["ec-22"]; $buffer .=$Mensajes["ec-22"];?></span></td>
        <?
...
?>
           <td align="center" class="style28"><? echo $Mensajes["ec-8"]; $buffer .= ', '.$Mensajes["ec-8"];?></td>
                  <td align="center" class="style28"><? echo $Mensajes["ec-31"]; $buffer .= ', '.$Mensajes["ec-31"]; ?></td>
              </tr>
        <?
...
?>
                   <tr bordercolor="#CCCCCC">
                      <td align="right" bgcolor="#CCCCCC"><a href="est-origendepeped.php?Anio=<? echo $Anio;?>&TPed=<? echo $TPed;?>&AnioFinal=<? echo $AnioFinal;?>&Institucion=<? echo $de[$i];?>"><? echo $row[$i][0]; $buffer .= $row[$i][0]; ?>&nbsp;</a></td>
                      <?
