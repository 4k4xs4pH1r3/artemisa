...
function Armar_Instruccion($dedonde) {
	...
	$Instruccion = "SELECT YEAR(Fecha_Alta_Pedido) AS p,paises.Nombre,COUNT(*),paises.Id ";
	if ($dedonde == 1) {
	...
	$Instruccion .= "LEFT JOIN paises ON paises.Id=usuarios.Codigo_Pais ";
...
<form name="form1" method="POST" action="est-origenpaisped.php">
<div align="left">
              ...
              <tr>
                ...
                <tr>
                    <td height="20" colspan="2" align="left" bgcolor="#006599" class="style45">
                    	<img src="../images/square-lb.gif" width="8" height="8" border="0">
                    		<span class="style28"><? echo $Mensajes["ec-16"]?></span>
                    </td>
                </tr>
                <tr>
...
?>
  ...
  <tr bordercolor="#CCCCCC" bgcolor="#006699" class="style28">
   <td align="right"><span class="style66"><? echo $Mensajes["ec-18"]; $buffer .= $Mensajes["ec-18"]; ?></span></td>
  <?
...
?>
           ...
           <td align="center" class="style28"><? echo $Mensajes["ec-19"];  $buffer .= ', '.$Mensajes["ec-19"];; ?> </td>
        </tr>
<?
...
?>
               ...
               <td align="right" bgcolor="#CCCCCC"><a href="est-origeninstped.php?Anio=<? echo $Anio;?>&TPed=<? echo $TPed;?>&AnioFinal=<? echo $AnioFinal;?>&Pais=<? echo $de[$i];?>">
	           <? echo $row[$i][0]; $buffer .= $row[$i][0]; ?>&nbsp;</a></td>
  <?
...
?>
      <hr></td>
                  ...
                  <tr valign="top">
                    <td colspan="2" align="left" class="style45"><p class="style54"><img src="../images/sa6.gif" width="8" height="10"> <? echo $Mensajes["mensaje.pedidosPorPaisOrigen"];?> </p>
