...
function armar_Instruccion($dedonde) {
	...
	$Instruccion = "SELECT YEAR(" . $FechaString . ") AS p, MONTH(" . $FechaString . ") AS m, SUM(Numero_Paginas) ";
	if ($dedonde == 1) {
	...
	if ($dedonde == 1) {
		$Instruccion .= " AND Estado=" . ESTADO__ENTREGADO_IMPRESO;
	} else {
...
// Si solicita todos los pedidos o los entregados o recibidos
// hay que ir a buscar en los que están en curso
...
<body topmargin="0">
<div align="left">
<form method="POST" action="est-paginasmes.php">
            ...
            <table width="576" border="0" style="margin-bottom: 0; margin-top:0; border-collapse:collapse" bordercolor="#111111" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top" bgcolor="#E4E4E4"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="style43">
                  <tr>
                    <td height="20" colspan="2" align="left" bgcolor="#006599" class="style45"><img src="../images/square-lb.gif" width="8" height="8" border="0"> <span class="style28"><?echo $Mensajes["tf-27"]?></span></td>
                  </tr>
                  <tr>
                    ...
                    <table width="97%"  border="0" align="center" cellpadding="1" cellspacing="0" class="table-form">
                      ...
                      <tr>
                        ...
                        <td width="179" align="left"> 
                        	<select name="Modalidad" class="style54" style="width:150px"><? if (!isset($Modalidad)) { $Modalidad = 0;} ?>
                        ...
                        <td width="179" align="left">
                        	<select name="TipoGrafico" class="style54" style="width:150px"> <? if (!isset($TipoGrafico)) { $TipoGrafico = 0;} ?>
                      ...
                      <tr>
                        <th>
                        	<div align="right"><? echo $Mensajes["tf-9"];?></div>
                        </th>
                        <td width="179" align="left">
                        	<select name="FechaParametro" class="style54" style="width:150px">
...
$Titulo .= $Mensajes["tf-27"];
?>
                   <tr valign="top">
                   <td colspan="2" align="left" class="style45">
                    <div align="left">
                     <p><span class="style54"><img src="../images/sa6.gif" width="8" height="10"><? echo $Titulo." - ".$Mensajes["tf-29"]; ?>.</span></p>
                      </div>
         <?
...
for ($i = 1; $i <= $filas; $i++) {
	$buffer .= "\n";
?>
                         <td align="right" bgcolor="#CCCCCC"><? echo $Anio+$i-1; $buffer .= ($Anio+$i-1); ?></td>
	      <?
...
?>
                     	...
                     	<tr bordercolor="#CCCCCC">
                        <td align="right" bgcolor="#CCCCCC"><? echo "%"; $buffer .= "\n ".$Mensajes["ec-4"]; ?></td>
          <?
...
?>
          ...
          <tr valign="top">
          <td colspan="2" align="left" class="style45"><p class="style54"><img src="../images/sa6.gif" width="8" height="10"><? echo $Mensajes["mensaje.paginasPorMes"]?> </p>
...
<form name="formExport" action="exp_est.php">
  ...
  <input type='hidden' name='mifilename' value='paginasmes.csv'>
