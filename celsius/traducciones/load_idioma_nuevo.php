        ...
        <td valign="top" bgcolor="#E4E4E4">            <div align="center">
              <center>
                <table width="97%" border="0" cellpadding="1" cellspacing="0">
                  <tr>
                    <td height="20" align="right" valign="middle" bgcolor="#006699" class="style22"><div align="left" class="style40"><img src="../images/square-w.gif" width="8" height="8">Wizard de importación - Idiomas</td>
                    </tr>
                  <tr>
												...
												<tr>
												  <td colspan="2"> <div align="right" class="style13">
												   <form enctype="multipart/form-data" method="POST" name="form1" action="load_idioma.php">
													...
													<input class="style22" type="submit" value="Upload Idioma">
											       </form> </div></td>
												</tr>
          ...
          <table width="100%" bgcolor="#ececec">
            <tr>
              <td valign="top" class="style28"><div align="center"><img src="../images/image001.jpg" width="150" height="118"><br>
                  <span class="style60"><a class="style60" href="../admin/indexadm.php">Volver a administraci&oacute;n </a></span></div>                <div align="center" class="style55"></div></td>
            </tr>
          </table>
          </div>
          </td>
