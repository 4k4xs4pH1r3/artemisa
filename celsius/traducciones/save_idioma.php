<?
   ...
   global $IdiomaSitio; 
   $Mensajes = Comienzo ("sid-001",$IdiomaSitio);
              ...
              <center>
				...
				<?
										 ...
										 {?>
												...
												<tr>
												  <td colspan="2"> <div align="right" class="style13"><a class="style60" href="save_idioma.php?operacion=1&Id=<? echo $row[1]; ?>" target="_blank"><? echo $Mensajes["ec-1"];?></a></div></td>
												  </tr>
