 ...
 */		return $array_interno;
	...
	function estudiante_graduado($codigoperiodo)
	{
		...
		AND m.codigomodalidadacademica in(200,300)
	...
	function codigoestudiante_inscrito($codigoperiodo){
		...
		";*/
            echo $query="SELECT e.codigoestudiante, e.codigocarrera,e.idestudiantegeneral FROM estudianteestadistica ee, carrera c, estudiante e
                 ...
                 and c.codigocarrera not in(13,468,560,554,92,6,204,417,94,120,355,434,117,561,562,578,581)
	...
	function codigoestudiante_admitido($codigoperiodo){
		...
		echo $query="SELECT distinct e.codigoestudiante, e.codigocarrera
                FROM estudianteestadistica ee, carrera c, estudiante e
                where c.codigomodalidadacademica in(200,300) and
                c.codigocarrera not in(1,12,79,96,117,262,264,355,434,468,2,3,6,7,13,30,39,74,92,94,97,120,138,204,417,554,560)
                and e.codigocarrera=c.codigocarrera
                and ee.codigoestudiante=e.codigoestudiante
                and ee.codigoperiodo = '".$codigoperiodo."'
