...
if ($_GET['ejecutar'] == 1) {
    ...
    //creaLista($service, $listadocentespregrado);     
     ...
     $cuentaintentos=0;
	  ...
	  if($cuentaintentos>10){
	    ...
	    echo "La lista ". $listadocentespregrado. "No pudo ser creada";
	    break;
	  ...
	  try{    
	      ...
	      creaLista($service, $listadocentespregrado);
	      echo "<br><h5>Creo la lista= " . $listadocentespregrado . "</h5><br>";
	      $secreo=false;
	  
	  } catch(Google_Service_Exception $miExcepcion) {
	  
	      echo "Intento fallido ".$cuentaintentos." Lista=".$listadocentespregrado;                                     
	      $secreo=true;
	  }
    ...
    try {
              ...
              if(!empty($listaemailpregrado)){
	      agregarCorreosLista($service, $service2, $listadocentespregrado, $listaemailpregrado);  
	      echo "<h4>Se agregan correos a la lista= " . $listadocentespregrado . "</h4>";
	       ...
	       echo "<br><h5>No se agregan correos por que no hay estudiantes matriculados en el periodo para la carrera = ". $emailList ."</h5>";
            ...
            echo "<h5>No pudo agregar correos al grupo:". $listadocentespregrado ."</h5>";
            echo "<pre>";
            print_r($miExcepcion);
            echo "</pre>";
        }   
