<?php 
function campotexto_novalida_post_bd($nombrevar,$validacion,$mensaje,$tamano,$tablaexistente,$indicetablaexistente,$valorindicetablaexistente,$datotablaexistente)
{ 
	$$tablaexistente = DB_DataObject::factory($tablaexistente);
	$$tablaexistente->get($indicetablaexistente,$valorindicetablaexistente);
	
?>
<input name="<?php echo $nombrevar;?>" type="text" id="<?php echo $nombrevar;?>" value="<?php echo $$tablaexistente->$datotablaexistente;?>" size="<?php echo $tamano;?>">
<?php 
}
/*
$valido['valido'] = 1;
