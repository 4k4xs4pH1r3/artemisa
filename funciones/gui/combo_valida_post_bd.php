<?php
function combo_valida_post_bd($nombrevar,$nombreobjeto,$dato,$etiqueta_dato,$accion,$where,$validasino,$mensaje,$tablaexistente,$indicetablaexistente,$valorindicetablaexistente,$datotablaexistente)
{
