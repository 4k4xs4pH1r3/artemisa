...
class DataObjects_Estadoconceptodetallefechafinanciera extends DB_DataObject 
{
    ...
    var $__table = 'estadoconceptodetallefechafinanciera';    // table name
    var $codigoestadoconceptodetallefechafinanciera;    // string(2)  not_null primary_key
    var $nombreestadoconceptodetallefechafinanciera;    // string(50)  not_null
