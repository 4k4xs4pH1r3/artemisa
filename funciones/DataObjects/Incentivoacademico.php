...
class DataObjects_Incentivoacademico extends DB_DataObject 
{
    ...
    var $__table = 'incentivoacademico';              // table name
    var $idincentivoacademico;            // int(11)  not_null primary_key auto_increment
    var $nombreincentivoacademico;        // string(100)  not_null
