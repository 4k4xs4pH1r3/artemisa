...
class DataObjects_Tipodocumentacionfacultad extends DB_DataObject 
{
    ...
    var $__table = 'tipodocumentacionfacultad';       // table name
    var $codigotipodocumentacionfacultad;    // string(3)  not_null primary_key
    var $nombretipodocumentacionfacultad;    // string(50)  not_null
