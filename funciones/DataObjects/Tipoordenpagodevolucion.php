...
class DataObjects_Tipoordenpagodevolucion extends DB_DataObject 
{
    ...
    var $__table = 'tipoordenpagodevolucion';         // table name
    var $codigotipoordenpagodevolucion;    // string(3)  not_null primary_key
    var $nombretipoordenpagodevolucion;    // string(50)  not_null
