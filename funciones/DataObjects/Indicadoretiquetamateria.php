...
class DataObjects_Indicadoretiquetamateria extends DB_DataObject 
{
    ...
    var $__table = 'indicadoretiquetamateria';        // table name
    var $codigoindicadoretiquetamateria;    // string(3)  not_null primary_key
    var $nombreindicadoretiquetamateria;    // string(50)  not_null
