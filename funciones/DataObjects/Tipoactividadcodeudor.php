...
class DataObjects_Tipoactividadcodeudor extends DB_DataObject 
{
    ...
    var $__table = 'tipoactividadcodeudor';           // table name
    var $codigotipoactividadcodeudor;     // string(2)  not_null primary_key
    var $nombretipoactividadcodeudor;     // string(30)  not_null
