...
class DataObjects_Indicadorcobroinscripcioncarrera extends DB_DataObject 
{
    ...
    var $__table = 'indicadorcobroinscripcioncarrera';    // table name
    var $codigoindicadorcobroinscripcioncarrera;    // string(3)  not_null primary_key
    var $nombreindicadorcobroinscripcioncarrera;    // string(50)  not_null
