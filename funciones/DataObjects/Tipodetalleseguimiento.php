...
class DataObjects_Tipodetalleseguimiento extends DB_DataObject 
{
    ...
    var $__table = 'tipodetalleseguimiento';          // table name
    var $codigotipodetalleseguimiento;    // string(3)  not_null primary_key
    var $nombretipodetalleseguimiento;    // string(50)  not_null
