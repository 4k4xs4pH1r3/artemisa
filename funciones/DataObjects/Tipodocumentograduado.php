...
class DataObjects_Tipodocumentograduado extends DB_DataObject 
{
    ...
    var $__table = 'tipodocumentograduado';           // table name
    var $codigotipodocumentograduado;     // int(11)  not_null primary_key auto_increment
    var $nombretipodocumentograduado;     // string(100)  not_null
