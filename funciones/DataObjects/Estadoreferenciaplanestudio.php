...
class DataObjects_Estadoreferenciaplanestudio extends DB_DataObject 
{
    ...
    var $__table = 'estadoreferenciaplanestudio';     // table name
    var $codigoestadoreferenciaplanestudio;    // string(3)  not_null primary_key
    var $nombreestadoreferenciaplanestudio;    // string(50)  not_null
