...
class DataObjects_Estadoclaveusuariopreinscripcion extends DB_DataObject 
{
    ...
    var $__table = 'estadoclaveusuariopreinscripcion';    // table name
    var $codigoestadoclaveusuariopreinscripcion;    // string(3)  not_null primary_key
    var $nombreestadoclaveusuariopreinscripcion;    // string(50)  not_null
