...
class DataObjects_Tiposervicioespecialidadrotacionpasantia extends DB_DataObject 
{
    ...
    var $__table = 'tiposervicioespecialidadrotacionpasantia';    // table name
    var $idtiposervicioespecialidadrotacionpasantia;    // int(11)  not_null primary_key auto_increment
    var $nombretiposervicioespecialidadrotacionpasantia;    // string(50)  not_null
