...
class DataObjects_Tipolugarorigennota extends DB_DataObject 
{
    ...
    var $__table = 'tipolugarorigennota';             // table name
    var $idtipolugarorigennota;           // int(11)  not_null primary_key auto_increment
    var $nombretipolugarorigennota;       // string(50)  not_null
