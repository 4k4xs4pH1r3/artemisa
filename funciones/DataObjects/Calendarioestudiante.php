...
class DataObjects_Calendarioestudiante extends DB_DataObject 
{
    ...
    var $__table = 'calendarioestudiante';            // table name
    var $codigocalendarioestudiante;      // string(3)  not_null primary_key
    var $nombrecalendarioestudiante;      // string(50)  not_null
