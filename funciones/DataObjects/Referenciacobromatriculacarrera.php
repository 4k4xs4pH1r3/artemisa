...
class DataObjects_Referenciacobromatriculacarrera extends DB_DataObject 
{
    ...
    var $__table = 'referenciacobromatriculacarrera';    // table name
    var $codigoreferenciacobromatriculacarrera;    // string(3)  not_null primary_key
    var $nombrereferenciacobromatriculacarrera;    // string(50)  not_null
