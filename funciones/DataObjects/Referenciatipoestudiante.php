...
class DataObjects_Referenciatipoestudiante extends DB_DataObject 
{
    ...
    var $__table = 'referenciatipoestudiante';        // table name
    var $codigoreferenciatipoestudiante;    // string(3)  not_null primary_key
    var $nombrereferenciatipoestudiante;    // string(50)  not_null
