...
class DataObjects_Estadoestudiantemediocomunicacion extends DB_DataObject 
{
    ...
    var $__table = 'estadoestudiantemediocomunicacion';    // table name
    var $codigoestadoestudiantemediocomunicacion;    // string(3)  not_null primary_key
    var $nombreestadoestudiantemediocomunicacion;    // string(50)  not_null
