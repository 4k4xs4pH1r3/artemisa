...
class DataObjects_Indicadorgrupomateria extends DB_DataObject 
{
    ...
    var $__table = 'indicadorgrupomateria';           // table name
    var $codigoindicadorgrupomateria;     // string(3)  not_null primary_key
    var $nombreindicadorgrupomateria;     // string(50)  not_null
