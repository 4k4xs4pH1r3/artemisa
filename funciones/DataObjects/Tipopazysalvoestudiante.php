...
class DataObjects_Tipopazysalvoestudiante extends DB_DataObject 
{
    ...
    var $__table = 'tipopazysalvoestudiante';         // table name
    var $codigotipopazysalvoestudiante;    // string(3)  not_null primary_key
    var $nombretipopazysalvoestudiante;    // string(50)  not_null
