...
class DataObjects_Indicadorprocesoadmicioncarrera extends DB_DataObject 
{
    ...
    var $__table = 'indicadorprocesoadmicioncarrera';    // table name
    var $codigoindicadorprocesoadmisioncarrera;    // string(3)  not_null primary_key
    var $nombreindicadorprocesoadmisioncarrera;    // string(50)  not_null
